  ...
  void debugPrint(Object data, String msg) {
    if (do_debug) {
      if (data != null) {
        ...
        if (jc.active) {
          System.out.println("DP> " + msg + "- type: " + jc.type_of_operand + ", operand: " + jc.generated_java);
        }
      }
    }
  }
...
//    }
  ...
  public Object visit(X_DerivedAttr node, Object data) throws SdaiException {
...
// jc.pw.println("// XIXIX 1: " + jc.entity + ", 2: " + node.attribute);
     ...
     * System.out.println("<X_DerivedAttr-2>: node.attribute: " + node.attribute + ", jc.entity: " + jc.entity + ", jc.ed: " +
     * jc.ed);
     * }
     * } else {
     * if (node.attribute.getName(null).equalsIgnoreCase("shaped_product")) {
     * System.out.println("<X_DerivedAttr-3>: node.attribute: " + node.attribute + ", jc.entity: " + jc.entity + ", jc.ed: " +
     * jc.ed);
     * }
     *
     * }
...
//  flag_pdb = false;
    ...
    int number_of_children = node.jjtGetNumChildren();
    for (int i = 0; i < number_of_children; i++) {
      Node a_node = node.jjtGetChild(i);
//jc.pw.println("// CHILDREN NODES, node: " + a_node);
      if (a_node instanceof X_PopulationDependentBound) {
//jc.pw.println("// CHILDREN NODE = PDB, pdb: " + ((X_PopulationDependentBound)a_node).pdb);
        if (((X_PopulationDependentBound) a_node).pdb == jc.entity) {
          let_in = true;
//				flag_pdb = true;
          break;
        }
...
//		if (true) {
    if ((jc.entity == node.attribute) || let_in) {
...
//									constructor_static_parameter_type_str = ((X_EntityConstructor)((X_Expression)node.children[0]).children[0]).getStaticTypeFieldName(jc);
                ...
                else if (((X_Expression) node.children[0]).children[0] instanceof X_MultiplicationLikeOp) {
...
//				jc.pw.println("XOXOXO-BEBBBBBBEEEEEE");
         ...
         *
         * return
         * (Value.alloc(jsdai.SRepresentation_schema.SRepresentation_schema._st_compound_item_definition).set(_context,
         * Value.alloc(ExpressTypes.GENERIC_TYPE).unset()));
         */

      }
      else if (is_entity_constructor) {
        jc.pw.println(constructor_tmp + jc.generated_java + "));");
      }
      else if (jc.generated_java.charAt(0) == '.') {
...
//System.out.println("<>EXPRESSION<>: " + jc.generated_java);
   ...
   * }
   */
  public Object visit(X_RelOpExtended node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
   ...
   * }
   */
  public Object visit(X_MultiplicationLikeOp node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
//System.out.println("RRX - in MultiplicationLikeOp, jc: " + jc);
  ...
  public Object visit(X_EnumerationRef node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
//      jc.generated_java = "Value.alloc(ExpressTypes.STRING_TYPE).set(_context, \"" + node.name + "\")";
   ...
   * }
   */
  public Object visit(X_ParameterRef node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
// System.out.println("OOO---" + jc.generated_java);
  ...
  public Object visit(X_TargetParameterRef node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
  ...
  public Object visit(X_SourceParameterRef node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
  ...
  public Object visit(X_VariableRef node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
//System.out.println("<>LITERAL<>: " + jc.generated_java);
  ...
  String constructSchemaClassNamePrefix(JavaClass jc) throws SdaiException {
    ...
    String type_schema_class = "S" + schema_name.substring(0, 1).toUpperCase() + schema_name.substring(1).toLowerCase() + ".";

    return type_schema_class;
  }

  // node.ed.findEntityInstanceSdaiModel().getName();
  String constructTypeSchemaPrefixFromModel(String model_name) throws SdaiException {
    ...
    String schema_package = "jsdai.S" + schema_name.substring(0, 1).toUpperCase() + schema_name.substring(1).toLowerCase();

    return schema_package;
  }

  String constructSchemaClassNamePrefixFromModel(String model_name) throws SdaiException {
    String schema_name = null;
    ...
    String schema_package = "S" + schema_name.substring(0, 1).toUpperCase() + schema_name.substring(1).toLowerCase();

    return schema_package;
  }

  String getStaticAttrNameOld(EAttribute attribute, JavaClass jc) throws SdaiException {
...
//    jsdai.dictionary.EGeneric_schema_definition the_parent_schema = parent_model.getUnderlyingSchema();
    ...
    if (is_complex) {
      ...
      jc.java_backend_inst.collectAttributes(parent_entity, parent_entity, all_attributes, all_flags, entities, inherited_branch);
    }
    ...
    printDDebug("parent entity: " + parent_entity + " all_attributes count: " + all_attributes.size());
...
//      String attr_name = attr0.getName(null);
      ...
      if (attr0.testOrder(null)) {
        printDDebug("all attributes: " + sj + ", name: " + attr_name + ", order: " + attr0.getOrder(null));
      }
      else {
        printDDebug("all attributes: " + sj + ", name: " + attr_name + ", order: UNSET");
      }

      int attribute_flag = ((Integer) all_flags.elementAt(sj)).intValue();
...
// System.out.println("XYX-10: " + internal);
    ...
    if (entity_prefix.equalsIgnoreCase("")) {
      ...
      result = schema_prefix + entity_prefix + "attribute" + attribute_name.substring(0, 1).toUpperCase() + attribute_name.substring(1).toLowerCase()
          + "(null)";
    }
   ...
   * }
   */
  public Object visit(X_AttributeRef node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
//      attr_name = node.attribute.getName(null);
      ...
      attr_name_method_body = attr_name.substring(0, 1).toUpperCase() + attr_name.substring(1).toLowerCase() + "(null)";
...
// System.out.println("static attribute name: " + static_attr_name);
        ...
        attr_name_method_part1 = var_name + "Value.alloc(" + node.getStaticTypeFieldName(jc) + ").set(_context, get(" + static_attr_name + "))";
...
// System.out.println("static attribute name: " + static_attr_name);
        ...
        if (jc.last_left_qualifier) {
          attr_name_method_part1 = ".setAttribute((jsdai.dictionary.EExplicit_attribute)" + static_attr_name + ", ";
...
// System.out.println("XYX-05: " + static_attr_name);
  ...
  public Object visit(X_EntityConstructor node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
  ...
  public Object visit(X_EntityConstructorParameter node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
// only for debugging
     ...
     * if (jc.entity instanceof EDerived_attribute) {
     * if (((EDerived_attribute)jc.entity).getName(null).equalsIgnoreCase("shaped_product")) {
     * // System.out.println("<X_EntityDecl-1>: jc.entity: " + jc.entity + ", jc.ed: " + jc.ed + ", node.entity_definition: "
     * + node.entity_definition + ", jc.sd: " + jc.sd);
     * // jc.pw.println("<X_EntityDecl-1>: jc.entity: " + jc.entity + ", jc.ed: " + jc.ed + ", node.entity_definition: " +
     * node.entity_definition + ", jc.sd: " + jc.sd);
     * }
     * if (node.entity_definition.getName(null).equalsIgnoreCase("Contextual_item_shape")) {
     * // System.out.println("<X_EntityDecl-2>: node.entity_definition: " + node.entity_definition + ", jc.entity: " +
     * jc.entity + ", jc.ed: " + jc.ed);
     * // jc.pw.println("<X_EntityDecl-2>: node.entity_definition: " + node.entity_definition + ", jc.entity: " + jc.entity +
     * ", jc.ed: " + jc.ed);
     * }
     * } else {
     * if (node.entity_definition.getName(null).equalsIgnoreCase("Contextual_item_shape")) {
     * // System.out.println("<X_EntityDecl-3>: node.entity_definition: " + node.entity_definition + ", jc.entity: " +
     * jc.entity + ", jc.ed: " + jc.ed);
     * // jc.pw.println("<X_EntityDecl-3>: node.entity_definition: " + node.entity_definition + ", jc.entity: " + jc.entity +
     * ", jc.ed: " + jc.ed);
     * }
     *
     * }
...
//    }
  ...
  public Object visit(X_QueryExpression node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
// debugging only
     ...
     * // System.out.println("<X_SchemaDecl-1>: jc.entity: " + jc.entity + ", jc.ed: " + jc.ed + ", node.schema_definition: "
     * + node.schema_definition + ", jc.sd: " + jc.sd);
     * jc.pw.println("// <X_SchemaDecl-1>: jc.entity: " + jc.entity + ", jc.ed: " + jc.ed + ", node.schema_definition: " +
     * node.schema_definition + ", jc.sd: " + jc.sd);
     * }
     * }
     */
...
// debugging
     ...
     * System.out.println("jc.entity: " + jc.entity + ", jc.ed: " + jc.ed + ", node.schema_definition: " +
     * node.schema_definition + ", jc.sd: " + jc.sd);
     * } else {
     ...
     * System.out.println("jc.entity.findEntityInstanceSdaiModel().getDefinedSchema() = null, model: " +
     * jc.entity.findEntityInstanceSdaiModel());
     * }
     * }
     * }
     * }
...
//			jc.pw.println("// jc.sd = node.schema_definition - YES, IT IS EQUAL - continue");
  ...
  public Object visit(X_AlgorithmHead node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
//         jc.print_string = "";
  ...
  public Object visit(X_CaseSelector node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
//		jc.active = false;
  ...
  public Object visit(X_CaseOtherwise node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
  ...
  public Object visit(X_CompoundStmt node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
    String indent_str = "";
    String tmp_str = "";
  ...
  public Object visit(X_ConstantDecl node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
//System.out.println("<CONSTANT-02> node: " + node + ", schema: " + jc.sd.getName(null) + ", entity: " + jc.entity + ", ed: " + jc.ed + ", inner: " + jc.inner_constant + ", model: " + jc.model + ", flag: " + jc.flag_value);
  ...
  public Object visit(X_ConstantBody node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
    String indent_str;
    ...
    String name = "c" + node.name.substring(0, 1).toUpperCase() + node.name.substring(1).toLowerCase();
    ...
    String signature = "\tpublic static Value " + name + "(SdaiContext _context) throws SdaiException {";
    String signature_inner = "\tpublic Value " + name + "(SdaiContext _context) throws SdaiException {";
...
//			jc.constant_method_str += signature + "\n";
    ...
    tmp_str = "\t\tif (" + field_name + " == null) { \n\t\t\t" + field_name + " = Value.alloc(" + static_parameter_type_str;
  ...
  public Object visit(X_ConstantRef node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
    ...
    if (node.depth > 0) {
      ...
      name = constructTypeSchemaPrefixFromModel(model_name) + "." + constructSchemaClassNamePrefixFromModel(model_name) + ".c"
          + node.name.substring(0, 1).toUpperCase() + node.name.substring(1).toLowerCase();
  ...
  public Object visit(X_FunctionDecl node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
    String signature = "";
    String type;
    String name;
...
// System.out.println("#@# starting outer function, setting keynode to: " + node.fd.getName(null));
      ...
      name = "f" + original_name.substring(0, 1).toUpperCase() + original_name.substring(1).toLowerCase();
...
//      	signature = "\tpublic static Value run(" + parameters + ") throws SdaiException {\n\t\tSystem.out.println(\"" + global_function_name + " starting, parameters: \"" + parameters + ");";
    ...
    if (jc.active) {
      if (node.fd != null) {
        printActive("XP Active: FunctionDecl: " + node.fd.getName(null) + ", ID: " + node.id);
...
// System.out.println("#@# ending outer function, keynode to NULL: " + node.fd.getName(null));
        ...
        else if (parent_f instanceof EProcedure_definition) {
          jc.in_function = false;
          jc.in_procedure = true;
        }
        else if (parent_f instanceof EGlobal_rule) {
          jc.in_function = false;
          jc.in_procedure = false;
        }
        jc.keynode = node;
// System.out.println("#@# ending inner function, setting keynode to (itself - cannot be right?): " + node.fd.getName(null) + ", parent: " + parent_f);
  ...
  public Object visit_prev(X_FunctionDecl node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
    String signature;
    String type;
    String name;
...
//System.out.println("jc.ed: " + jc.ed);
    ...
    if (jc.entity == node.fd) {
      ...
      if (flag_split_debug) {
//      	signature = "\tpublic static Value run(" + parameters + ") throws SdaiException {\n\t\tSystem.out.println(\"" + global_function_name + " starting, parameters: \"" + parameters + ");";
        signature = "\tpublic static Value run(" + parameters + ") throws SdaiException {\n\t\tSystem.out.println(\"" + global_function_name
            + " starting\");";
      }
      else {
        signature = "\tpublic static Value run(" + parameters + ") throws SdaiException {";
  ...
  public Object visit(X_FunctionHead node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
//      jc.pw.println("\t\t// End of declarations of local variables\n");
  ...
  public Object visit(X_AssignmentStmt node, Object data) throws SdaiException {
    ...
    if (jc.active) {
      ...
      printDDebug("XC assignment ECxGenerateJava indent: " + jc.indent + ", left: " + jc.value_instance);
    }

    if (jc.active) {
      printActive("XP Active: AssignmentStmt: " + node.id + ", parent: " + ((SimpleNode) node.parent).id);
    }
...
// jc.pw.println("//###-02 right_str: " + node.right_str);
    ...
    if (jc.active) {
      printDDebug("XP OUT: AssignmentStmt: " + node.id + ", parent: " + ((SimpleNode) node.parent).id);
    }
...
//        if (jc.inner) {
  ...
  public Object visit(X_LocalVariable node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
//System.out.println("<>LOCAL_VARIABLE<> 09");
              jc.local_initializations_str += "\t\t" + id + " = Value.alloc(" + static_parameter_type_str + ").set(_context, "
                  + jc.generated_java + ");\n";
            }
            else {
//            if (jc.entity instanceof EGlobal_rule) {
...
//System.out.println("<>LOCAL_VARIABLE<>INIT: " + jc.local_initializations_str);
  ...
  public Object visit_old(X_LocalVariable node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
// System.out.println("ECx-Local-01, jc.generated_java: " + jc.generated_java);
  ...
  public Object visit(X_ProcedureCallStmt node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
    ...
    if (jc.active) {
      ...
      if (node.java_contains_statements) {
        for (int i = 0; i < node.variable_declarations.size(); i++) {
          node.forwarded_java += ("\n" + indent_str + node.variable_declarations.elementAt(i));
          printDDebug("XPOORR AAA 1 in procedure_call: " + node.variable_declarations.elementAt(i));
        }
...
//         if (jc.inner) {
  ...
  public Object visit(X_ProcedureDecl node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
    String signature = "";
//    String type;
    String name;
...
// System.out.println("#@# starting outer procedure, setting keynode to: " + node.pd.getName(null));
      ...
      name = "p" + original_name.substring(0, 1).toUpperCase() + original_name.substring(1).toLowerCase();
//      type = node.getType(jc);
      parameters = node.getParameters();
...
//      	signature = "\tpublic static Value run(" + parameters + ") throws SdaiException {\n\t\tSystem.out.println(\"" + global_function_name + " starting, parameters: \"" + parameters + ");";
    ...
    if (jc.active) {
      if (node.pd != null) {
        printActive("XP Active: ProcedureDecl: " + node.pd.getName(null) + ", ID: " + node.id);
...
// System.out.println("#@# ending inner procedure, setting keynode to (itself - cannot be right?): " + node.pd.getName(null) + ", parent: " + parent_f);
  ...
  public Object visit(X_ProcedureHead node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
//        printActive("XP Active: ReturnStmt type after accept: " + jc.return_type);
        ...
        if (flag_split_debug) {
          tmp_str = "\n" + indent_str + "if (true) {\n\t" + indent_str + "Value rv = Value.alloc(" + node.getStaticTypeString(jc)
              + ").set(_context, " + jc.generated_java + ");\n\t" + indent_str + "System.out.println(\"" + global_function_name + " "
              + global_return_number++ + " return: \" + rv);\n\t" + indent_str + "return rv.check(_context, " + node.getStaticTypeString(jc)
              + ");\n" + indent_str + "};";
        }
        else {
          tmp_str = "\n" + indent_str + "if (true) return " + "Value.alloc(" + node.getStaticTypeString(jc) + ").set(_context, " + jc.generated_java
              + ").check(_context, " + node.getStaticTypeString(jc) + ");";
        }
...
//    jc.generated_java = "Value.alloc(ExpressTypes.SET_GENERIC_TYPE).set(_context, _context.domain.getInstances(" + the_name + "))";
  ...
  public Object visit(X_IncrementControl node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
  ...
  public Object visit(X_WhileControl node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
  ...
  public Object visit(X_UntilControl node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
  ...
  public Object visit(X_MapCall node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
  ...
  public Object visit(X_FunctionCall node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
    ...
    if (jc.active) {
      ...
      if (node.java_contains_statements) {
        for (int i = 0; i < node.variable_declarations.size(); i++) {
          node.forwarded_java += ("\n" + indent_str + node.variable_declarations.elementAt(i));
          printDDebug("XPOORR AAA 1 in function_call: " + node.variable_declarations.elementAt(i));
        }
...
//        node.generated_java = "";
  ...
  public Object visit(X_IfCondition node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
  ...
  public Object visit(X_AggregateInitializer node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
    ...
    if (jc.active) {
      printActive("XP Active: AggregateInitializer: " + node.been_here + ", ID: " + node.id + ", parent: " + ((SimpleNode) node.parent).id);
    }
    ...
    if (jc.active) {
      printDDebug("XP OUT: AggregateInitializer: " + node.been_here + ", ID: " + node.id + ", parent: " + ((SimpleNode) node.parent).id);
    }
...
//        } else {
  ...
  public Object visit(X_AggregateSource node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
  ...
  public Object visit(X_QueryLogicalExpression node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
//    node.getForwardedStuffFromChildren();
    ...
    printDDebug("X_QueryLogicalExpression after: " + (((JavaClass) data).generated_java += ".getLogical() == 2"));
  ...
  public Object visit(X_RuleDecl node, Object data) throws SdaiException {
    ...
    if (jc.entity == node.global_rule) {
      ...
      name = "r" + original_name.substring(0, 1).toUpperCase() + original_name.substring(1).toLowerCase();
  ...
  public Object visit(X_DomainRule node, Object data) throws SdaiException {
    ...
    if (node.global_rule) {
      ...
      if (jc.entity == node.where_rule) {
        ...
        else if (dt_candidate instanceof EEntity_definition) {
...
//      if (!node.map_definition) {
      if (!(node.map_definition || jc.foreach)) {
        ...
        if (where_rule_in_defined_type) {
          ...
          name = "r" + dt_name.substring(0, 1).toUpperCase() + dt_name.substring(1).toLowerCase() + original_name.substring(0, 1).toUpperCase()
              + original_name.substring(1).toLowerCase();

        }
        else if (where_rule_in_entity) {
...
// System.out.println("<DOMAIN RULE> : " + tmp_str);
   ...
   * }
   */
  public Object visit(X_WhereClause node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
  ...
  public Object visit(X_DomainRuleLogicalExpression node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
  ...
  public Object visit(X_AttributeQualifier node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
//    System.out.println("XYX-1 after attribute qualifier: " + jc.generated_java);
  ...
  public Object visit(X_GroupQualifier node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
    ...
    jc.generated_java = original + ".groupReference(_context, " + constructTypeSchemaPrefixFromModel(model_name) + ".C"
        + entity_name.substring(0, 1).toUpperCase() + entity_name.substring(1).toLowerCase() + ".class)";
  ...
  public Object visit(X_IdentifiedByClause node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
  ...
  public Object visit(X_IdParameter node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
  ...
  public Object visit(X_MapAttributeDeclaration node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
//    jc.active = false;
  ...
  public Object visit(X_CaseExpr node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
//    jc.active = false;
  ...
  public Object visit(X_CaseExprAction node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
//    jc.active = false;
  ...
  public Object visit(X_ForloopExpr node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
//    jc.active = false;
  ...
  public Object visit(X_ForeachExpr node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
//    jc.active = false;
  ...
  public Object visit(X_EntityInstantiationLoop node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
  ...
  public Object visit(X_InstantiationForeachControl node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
  ...
  public Object visit(X_ForwardPathQualifier node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
//    jc.active = false;
  ...
  public Object visit(X_BackwardPathQualifier node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
//    jc.active = false;
  ...
  public Object visit(X_IfExpr node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
//    jc.active = false;
  ...
  public Object visit(X_IndexQualifier node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
// original = jc.generated_java;
    ...
    jc.generated_java = original + ".indexing(_context, " + node.index[0] + ", " + node.index[1] + ")";
...
//	    jc.generated_java = original + ".replaceRange(" + node.index[0] + ", " + node.index[1] + ")";
  ...
  public Object visit(X_BuiltInConstant node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
    ...
    if (node.type == 1) { // E
      ...
      if (jc.ed instanceof EEntity_definition) {
        String entity_name = jc.ed.getName(null).replace('+', '$');
        String norm_entity_name = entity_name.substring(0, 1).toUpperCase() + entity_name.substring(1).toLowerCase();

        //        	String self_type = "jsdai." + norm_entity_name + ".definition";
        String self_type = "jsdai." + constructSchemaClassNamePrefix(jc) + "C" + norm_entity_name + ".definition";
...
//	        	jc.generated_java = "Value.alloc(" + self_type + ").set(_context, self)";
  ...
  public Object visit(X_PopulationDependentBound node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
...
//             }
      ...
      else if (jc.dt instanceof EDefined_type) {
        jc.pdb.addElement(method_signature + "\t\t" + jc.generated_java + "\n\t);");
        jc.pw.println(method_signature);
        jc.pw.println("\t\t" + jc.generated_java + "\n\t);\n\t}");
        jc.generated_java = "";
      ...
      jc.pdb.addElement("\tpublic Value " + node.pdb.getMethod_name(null) + "(SdaiContext _context) throws SdaiException {" + node.forwarded_java
          + "\n\t\treturn (\n\t\t\t" + jc.generated_java + "\n\t\t);\n\t}");
      jc.generated_java = "";
    }
...
// jc.pw.println("PDB-16");
  ...
  public Object visit(X_UnrecognizedReference node, Object data) throws SdaiException {
    JavaClass jc = (JavaClass) data;
  ...
  String getOriginalAttributeName(EAttribute attr) throws SdaiException {
    ...
    for (; ; ) {
      ...
      else if (attr2 instanceof EDerived_attribute) {
      ...
      else if (attr2 instanceof EInverse_attribute) {
  ...
  void processAttributes(EEntity_definition ed, Vector all_attributes, Vector all_flags) throws SdaiException {
    ...
    for (int sj = 0; sj < all_attributes.size(); sj++) {
      ...
      if ((attribute_flag == AA_JAVA_EXPLICIT) || (attribute_flag == AA_SUPERTYPE_EXPLICIT) || (attribute_flag == AA_CURRENT_EXPLICIT)) {
        for (int sjj = 0; sjj < all_attributes.size(); sjj++) {
          if (sj == sjj) {
            continue;
          }

          int attribute_flag2 = ((Integer) all_flags.elementAt(sjj)).intValue();

          if ((attribute_flag2 == AA_JAVA_DERIVED_REDECLARING) || (attribute_flag2 == AA_CURRENT_DERIVED_REDECLARING)
  ...
  String getStaticAttrName(EAttribute attribute, JavaClass jc) throws SdaiException {
    // System.out.println("><01>< calculating attribute internal name: " + attribute);
    // have to calculate the internal attribute number
    // also, it would be good to add entity and/or package information when needed.
    String result = null;
...
// System.out.println("><02>< calculating attribute internal name - result: " + result);
   ...
   * old:
   * ><02>< calculating attribute internal name - result:
   * jsdai.SDebug_01.CMulti_stratum_structured_template_armx.attributeLocation(null)
   * new:
   * ><02>< calculating attribute internal name - result:
   * jsdai.SDebug_01.CMulti_stratum_structured_template_armx.attributeLocation(null)
   *
