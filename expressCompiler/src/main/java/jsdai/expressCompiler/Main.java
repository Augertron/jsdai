...
//    public static int main(String args[], Vector par_express_files, boolean first_time_invoking, IProgressMonitor monitor, Vector compiled_schemas2) throws jsdai.lang.SdaiException, java.lang.ClassNotFoundException, java.io.IOException
    ...
    for (int j = 0; j < args.length - 1; j++) {
      ...
      else if (args[j].equals("-write_files")) {
...
//} catch (Exception eee) {
  ...
  public static Runnable initAsRunnable(final String sdaireposDirectory, final String[] args, final ECMonitor monitor) throws SdaiException {
  ...
  /*
   * public static int main(String args[]) throws java.lang.ClassNotFoundException, jsdai.lang.SdaiException,
   * java.io.IOException
   * {
   * Vector compiled_schemas = new Vector();
   *
