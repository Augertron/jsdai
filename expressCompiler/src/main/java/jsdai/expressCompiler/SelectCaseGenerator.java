  ...
  static void generateSelectCases(EEntity base_type) throws SdaiException {
    ...
    if (ut instanceof EAggregation_type) {
      ...
      for (; ; ) {
        ...
        else if (element instanceof EAggregation_type) {
          ut = element;
...
class SelectCase {
  ...
  void printCase(int nr) throws SdaiException {
    ...
    else if (value_type instanceof EInteger_type) {
      value_type_name = "INTEGER";
      java_type_name = "int";
    }
    else if (value_type instanceof ENumber_type) {
      value_type_name = "NUMBER";
      java_type_name = "double";
    }
    else if (value_type instanceof EReal_type) {
      value_type_name = "REAL";
      java_type_name = "double";
    }
    else if (value_type instanceof EString_type) {
      value_type_name = "STRING";
      java_type_name = "String";
    }
    else if (value_type instanceof ELogical_type) {
      value_type_name = "LOGICAL";
      java_type_name = "int";
    }
    else if (value_type instanceof EBoolean_type) {
      value_type_name = "BOOLEAN";
      java_type_name = "boolean";
    }
    else if (value_type instanceof EBinary_type) {
      value_type_name = "BINARY";
      java_type_name = "Binary";
    }
    else if (value_type instanceof EEnumeration_type) {
      value_type_name = "ENUMERATION";
      java_type_name = "int";
    }
    else if (value_type instanceof EAggregation_type) {
