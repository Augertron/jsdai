...
public class JavaClass {
  ...
  JavaClass(PrintWriter pw1, EEntity ee, EGeneric_schema_definition __sd, EEntity_definition __ed, SdaiModel current_model, boolean f_value,
      JavaBackend java_backend_instance) {
  ...
  JavaClass(EDefined_type __dt, PrintWriter pw1, EEntity ee, EGeneric_schema_definition __sd, EEntity_definition __ed, SdaiModel current_model,
      boolean f_value, JavaBackend java_backend_instance) {
  ...
  JavaClass(PrintWriter pw1, EEntity ee, EGeneric_schema_definition __sd, EEntity_definition __ed, SdaiModel current_model, boolean f_value,
      JavaBackend java_backend_instance, ArrayList global_all_attributes_all) {
  ...
  JavaClass(PrintWriter pw1, EEntity ee, EGeneric_schema_definition __sd, EEntity_definition __ed, SdaiModel current_model, boolean f_value,
      JavaBackend java_backend_instance, ArrayList global_all_attributes_all, int secondary_flag, JavaClass parent_traversing, Object reference_object) {
