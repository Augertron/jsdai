...
/* Generated By:JJTree: Do not edit this line. X_TypeDecl.java */
...
public class X_TypeDecl extends SimpleNode {

  String name;
  EDefined_type dt;
  SdaiModel current_model;

  public X_TypeDecl(int id) {
    super(id);
  }

  public X_TypeDecl(Compiler2 p, int id) {
    super(p, id);
  }
  ...
  public Object childrenAccept(Compiler2Visitor visitor, Object data)
    ...
    if (children != null) {
      ...
      for (int i = 0; i < children.length; ++i) {
        //System.out.println("XP - TypeDecl child: " + children[i]);
