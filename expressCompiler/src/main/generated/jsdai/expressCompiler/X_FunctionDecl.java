...
// %modified: 1016210364142 %

/* Generated By:JJTree: Do not edit this line. X_FunctionDecl.java */
...
public class X_FunctionDecl extends SimpleNode {
  ...
  public X_FunctionDecl(int id) {
    super(id);
  }

  public X_FunctionDecl(Compiler2 p, int id) {
    super(p, id);
  }

  EParameter getReturnTypeParameter() {
    return return_type_parameter;
  }
  ...
  String constructFunctionClassName() throws SdaiException {
    return constructFunctionProcedureRuleClassName(fd);
  }

  String constructFunctionClassName_O() throws SdaiException {
    String result = "";
...
/*
	String constructFunctionClassName (EEntity fd4) throws SdaiException {
	  String result = "";
		EAlgorithm_definition fd2 = null;
		EEntity fd3 = null;
		String f_name = null;
		
		if (fd4 instanceof EAlgorithm_definition) {
		} else 
		if (fd4 instanceof EGlobal_rule) {
		} else {
			return "_not_a_proper_parent_of_inner_function_";
		}
...
*/
  ...
  String constructFunctionProcedureRuleClassName(EFunction_definition fd4) throws SdaiException {
    String result = "";
    EFunction_definition fd2 = null;
    EFunction_definition fd3 = null;
    EEntity fd5 = null;
    EAlgorithm_definition fd6 = null;
    String f_name = null;

    fd6 = (EAlgorithm_definition) fd4;
    ...
    result = fd6.getName(null);
    result = result.substring(0, 1).toUpperCase() + result.substring(1).toLowerCase();

    for (; ; ) {
      // fd3 = Support.getParentFunctionDefinition(fd2);
      if (fd6 != null) {
        fd5 = Support.getParentFunctionProcedureRuleDefinition(fd6);
      }
      else {
        fd5 = null;
      }
      if (fd5 == null) {
        ...
        // still inner function, add names
        if (fd5 instanceof EAlgorithm_definition) {
          f_name = ((EAlgorithm_definition) fd5).getName(null);
          fd6 = (EAlgorithm_definition) fd5;
        }
        else if (fd5 instanceof EGlobal_rule) {
          f_name = ((EGlobal_rule) fd5).getName(null);
          fd6 = null;
        }
        result = f_name.substring(0, 1).toUpperCase() + f_name.substring(1).toLowerCase() + "$" + result;
      }
  ...
  // useful also for parent which may be also rule
  String constructFunctionProcedureRuleClassName(EEntity fd4) throws SdaiException {
    String result = "";
    String first_letter = "";
    EFunction_definition fd2 = null;
    EFunction_definition fd3 = null;
    ...
    if (fd4 == null) {
      result = "_NULL_function_procedure_rule_definition_";
      return result;
    }
    if (fd4 instanceof EFunction_definition) {
      first_letter = "F";
      result = ((EFunction_definition) fd4).getName(null);
      result = result.substring(0, 1).toUpperCase() + result.substring(1).toLowerCase();
      fd6 = (EAlgorithm_definition) fd4;
    }
    else if (fd4 instanceof EProcedure_definition) {
      first_letter = "P";
      result = ((EProcedure_definition) fd4).getName(null);
      result = result.substring(0, 1).toUpperCase() + result.substring(1).toLowerCase();
      fd6 = (EAlgorithm_definition) fd4;
    }
    else if (fd4 instanceof EGlobal_rule) {
      first_letter = "R";
      result = ((EGlobal_rule) fd4).getName(null);
      result = result.substring(0, 1).toUpperCase() + result.substring(1).toLowerCase();
      fd6 = null;
      ...
      result = "_not_function_procedure_or_rule_";
      return result;
    }
  ...
  String getType(JavaClass jc) throws SdaiException {
    ...
    if (rt instanceof EEntity_definition) {
      ...
      // not supported
      printActive("XP - FunctionDecl: not supported return type, EEntity used: " + rt, jc);
      type = "/* not supported return type */ EEntity";
    }
  ...
  String getAggregationTypeBaseTypeString(EAggregation_type rt1)
    ...
    if (element_type_set) {
      ...
      System.out.println("XP: In FunctionDecl, aggregate element type value unset:" + rt1);
    }
    ...
    for (; ; ) {
      ...
      if (an_ss instanceof EDefined_type) {
        ...
        if (domain_set) {
          ...
          System.out.println("XP: In FunctionDecl, in aggregate nested defined type domain unset:" +
              an_ss);
        }
      }
        ...
        if (element_type_set) {
          ...
          System.out.println("XP: In FunctionDecl, nested aggregate element type value unset:" +
              an_ss);
        }
      }
  ...
  String getDefinedTypeUnderlyingTypeString(EDefined_type rt1)
    ...
    if (domain_set) {
      ...
      System.out.println("XP: In FunctionDecl, defined type domain unset:" + rt1);
    }
  ...
  String getParameters() throws SdaiException {
    String parameters = "SdaiContext _context";
    String p_name;
    EEntity pt = null;
    AParameter lp = fd.getParameters(null);
    SdaiIterator ip = lp.createIterator();
    boolean use_value = true;
    boolean first_time = true;

    while (ip.next()) {
      EParameter par = (EParameter) lp.getCurrentMemberObject(ip);
      pt = par.getParameter_type(null);
      p_name = "_e_" + par.getName(null);
      parameters += ", ";

      if (pt instanceof EEntity_definition) {
        String base_entity_name = ((EEntity_definition) pt).getName(null);
        String base_name = getEntityPackage((EEntity_definition) pt) + "E" +
            base_entity_name.substring(0, 1).toUpperCase() +
            base_entity_name.substring(1).toLowerCase();
      ...
      else if (pt instanceof EInteger_type) {
        if (use_value) {
          parameters += "Value";
        }
        else {
      ...
      else if (pt instanceof EReal_type) {
        if (use_value) {
          parameters += "Value";
        }
        else {
      ...
      else if (pt instanceof ENumber_type) {
        if (use_value) {
          parameters += "Value";
        }
        else {
      ...
      else if (pt instanceof EBoolean_type) {
        if (use_value) {
          parameters += "Value";
        }
        else {
      ...
      else if (pt instanceof EBinary_type) {
        if (use_value) {
          parameters += "Value";
        }
        else {
      ...
      else if (pt instanceof EData_type) {
        if (use_value) {
          parameters += "Value";
        }
        else {
      ...
      else if (pt instanceof EAggregation_type) {
        if (use_value) {
          parameters += "Value";
        }
        else {
      ...
      else if (pt instanceof ELogical_type) {
        if (use_value) {
          parameters += "Value";
        }
        else {
      ...
      else if (pt instanceof EString_type) {
        if (use_value) {
          parameters += "Value";
        }
        else {
        ...
        if (use_value) {
          ...
          parameters += getAggregationTypeBaseTypeString((EAggregation_type) pt);
        }
      }
      else if (pt instanceof EDefined_type) {
        if (use_value) {
          parameters += "Value";
        }
        else {
          parameters += getDefinedTypeUnderlyingTypeString((EDefined_type) pt);
        }
      }
      else {
        // not supported
        System.out.println("XP - FunctionDecl: not supported parameter type, EEntity used: " + pt);

        if (use_value) {
          parameters += "Value";
        }
        else {
          parameters += "/* not supported parameter type */ EEntity";
        }
      }
  ...
  String getParameters_previous() throws SdaiException {
    String parameters = "";
    String p_name;
    EEntity pt = null;
    AParameter lp = fd.getParameters(null);
  ...
  String getParameters_old() throws SdaiException {
    String parameters = "";
    String p_name;
    EEntity pt = null;
    AParameter lp = fd.getParameters(null);
    ...
    while (ip.next()) {
      ...
      if (pt instanceof EInteger_type) {
        parameters += "int ";
      }
      else if (pt instanceof ELogical_type) {
        parameters += "int ";
      ...
      else if (pt instanceof ESet_type) {
        EEntity element;

        if (((ESet_type) pt).testElement_type(null)) {
          element = ((ESet_type) pt).getElement_type(null);
        }
        else {
          element = null;
          System.out.println("## In FunctionDecl - getParameters - element_type is NULL: " +
              fd.getName(null));
        }

        if (element == null) {
          parameters += "/* element of SET type is NULL */ AEntity ";
        }
        else if (element instanceof ESimple_type) {
          if (element instanceof EString_type) {
            parameters += "A_string ";
          }
          else if (element instanceof EInteger_type) {
            parameters += "A_integer ";
          }
          else if (element instanceof ELogical_type) {
            parameters += "A_integer ";
          }
          else if (element instanceof ENumber_type) {
            parameters += "A_double ";
          }
          else if (element instanceof EReal_type) {
            parameters += "A_double ";
          }
          else if (element instanceof EBoolean_type) {
            parameters += "A_boolean ";
          }
          else {
            parameters += "/* Set of simple type */ AEntity ";
          }
        }
        else if (element instanceof EAggregation_type) {
          parameters += "/* SET of aggregate */ AEntity ";
        } // may go deeper later on
        else if (element instanceof EEntity_definition) {
          parameters += "/* SET OF some entity */ AEntity ";
        } // may add specific entity - may need short form support
        else {
          parameters += "/* SET of other type */ AEntity ";
        }
      }
      else if (pt instanceof EList_type) {
        EEntity element;

        if (((EList_type) pt).testElement_type(null)) {
          element = ((EList_type) pt).getElement_type(null);
        }
        else {
          element = null;
          System.out.println("## In FunctionDecl - getParameters - element_type is NULL: " +
        ...
        if (element == null) {
          parameters += "/* element of LIST type is NULL */ AEntity ";
        }
        else if (element instanceof ESimple_type) {
          if (element instanceof EString_type) {
            parameters += "A_string ";
            ...
            parameters += "/* List of simple type */ AEntity ";
          }
        }
        else if (element instanceof EAggregation_type) {
          parameters += "/* List of aggregate */ AEntity ";
        } // may go deeper later on
        else if (element instanceof EEntity_definition) {
          parameters += "/* List OF some entity */ AEntity ";
        } // may add specific entity - may need short form support
        else {
          parameters += "/* List of other type */ AEntity ";
        }
      }
      else if (pt instanceof EArray_type) {
        EEntity element;

        if (((EArray_type) pt).testElement_type(null)) {
          element = ((EArray_type) pt).getElement_type(null);
        }
        else {
          element = null;
          System.out.println("## In FunctionDecl - getParameters - element_type is NULL: " +
        ...
        if (element == null) {
          parameters += "/* element of Array type is NULL */ AEntity ";
        }
        else if (element instanceof ESimple_type) {
          if (element instanceof EString_type) {
            parameters += "A_string ";
            ...
            parameters += "/* Array of simple type */ AEntity ";
          }
        }
        else if (element instanceof EAggregation_type) {
          parameters += "/* Array of aggregate */ AEntity ";
        } // may go deeper later on
        else if (element instanceof EEntity_definition) {
          parameters += "/* Array OF some entity */ AEntity ";
        } // may add specific entity - may need short form support
        else {
          parameters += "/* Array of other type */ AEntity ";
        }
      }
      else if (pt instanceof EBag_type) {
        EEntity element;

        if (((EBag_type) pt).testElement_type(null)) {
          element = ((EBag_type) pt).getElement_type(null);
        }
        else {
          element = null;
          System.out.println("## In FunctionDecl - getParameters - element_type is NULL: " +
        ...
        if (element == null) {
          parameters += "/* element of BAG type is NULL */ AEntity ";
        }
        else if (element instanceof ESimple_type) {
          if (element instanceof EString_type) {
            parameters += "A_string ";
            ...
            parameters += "/* Bag of simple type */ AEntity ";
          }
        }
        else if (element instanceof EAggregation_type) {
          parameters += "/* Bag of aggregate */ AEntity ";
        } // may go deeper later on
        else if (element instanceof EEntity_definition) {
          parameters += "/* Bag OF some entity */ AEntity ";
        } // may add specific entity - may need short form support
        else {
          parameters += "/* Bag of other type */ AEntity ";
        }
      }
      else if (pt instanceof EEntity_definition) {
        String specific_entity_type_name = ((EEntity_definition) pt).getName(null);
        String entity_type_name = "E" + specific_entity_type_name.substring(0, 1).toUpperCase() +
            specific_entity_type_name.substring(1).toLowerCase();

        // String schema_package = "jsdai" + File.separator + "S" + schema_name.substring(0,1).toUpperCase() + schema_name.substring(1).toLowerCase();
        String entity_schema_name = "";
        String complete_entity_type_name = entity_schema_name + entity_type_name + " ";
        parameters += complete_entity_type_name;
      }
      else {
        System.out.println("XP - FunctionRef: not yet supported parameter type: " + pt);
        parameters += " /* not (yet) supported parameter type */ EEntity ";
      }
  ...
  void restoreNonVar(JavaClass jc) throws SdaiException {
    // makes variables with required parameter types,
    // creates Value instances with declared types,
    // and sets arguments as values,
    // that ensures type checking. Also in parameter nodes, the name field is changed to this new variable name.
    // that ensures non-VAR behaviour of parameters, all the references to parameters
    // now will be changed to references to these new variables
    String p_name;
    String new_name;
    String name_prefix = "_nonvar_";
    String variable_string;
    String static_type_string;
    EEntity pt = null;
    AParameter lp = fd.getParameters(null);
    SdaiIterator ip = lp.createIterator();
    boolean use_value = true;
    ...
    while (ip.next()) {
      ...
      pt = par.getParameter_type(null);
      p_name = "_e_" + par.getName(null);
      new_name = name_prefix + p_name;
//      new_name = name_prefix + par.getName(null);

      //      static_type_string = getStaticTypeString(pt, jc);
//      variable_string = "\t\t" + p_name + ".set(_context, " + new_name + ");";
      variable_string = "\t\t" + p_name + ".set(" + new_name + ");";
      jc.pw.println(variable_string);
    }
  }

  void makeNonVar(JavaClass jc) throws SdaiException {
    // makes variables with required parameter types,
    // creates Value instances with declared types,
    // and sets arguments as values,
    // that ensures type checking. Also in parameter nodes, the name field is changed to this new variable name.
    ...
    String name_prefix = "_nonvar_";
    String variable_string;
    String static_type_string = null;
    EEntity pt = null;
    AParameter lp = fd.getParameters(null);
    SdaiIterator ip = lp.createIterator();
    boolean use_value = true;
    hm_labels = new HashMap();

    jc.parameter_declarations_str += "\t// declaration of non-VAR parameters\n";
...
//      new_name = name_prefix + par.getName(null);
      ...
      if (label != null) {
        ...
        if (!(hm_labels.containsKey(label))) {
          hm_labels.put(label, p_name);
        }
      }

      static_type_string = getStaticTypeString(par, jc);

      //	  jc.pw.println("TYPE_NAME AFTER CRAP:" +static_type_string);
//      variable_string = "\t\tValue " + new_name + " = Value.alloc(" + static_type_string + ").set(_context, " + p_name + ");";

//      variable_string = "\t\tValue " + new_name + " = Value.alloc(" + static_type_string + ").set(" + p_name + ");";
      jc.parameter_declarations_str += "\tValue " + new_name + ";\n";
      jc.parameter_initializations_str += "\t\t" + new_name + " = Value.alloc(" + static_type_string + ").set(" + p_name + ");\n";
//      jc.pw.println(variable_string);
    }
    jc.parameter_declarations_str += "\t// end of declaration of non-VAR parameters\n";
    jc.parameter_initializations_str += "\t\t// end of initialization of non-VAR parameters\n";
  }

  String getStaticTypeString(EParameter par0, JavaClass jc)
      throws SdaiException {
    current_model = jc.model;

    return_type_parameter = ((X_FunctionHead) children[0]).return_type_parameter;

    String type_name = "";
    EEntity rt = par0.getParameter_type(null);
    String p_name = "_e_" + par0.getName(null);
    A_string labels = null;
    String label = null;

    if (par0.testType_labels(null)) {
      labels = par0.getType_labels(null);
      if (labels.getMemberCount() > 0) {
        // ignore nested labels, at least for now
        label = labels.getByIndex(1);
      }
    ...
    if (label != null) {
      // see if we already have this label
      if (hm_labels.containsKey(label)) {
        String first_name = (String) hm_labels.get(label);
        if (!(first_name.equals(p_name))) {
    ...
    if (rt instanceof EEntity_definition) {
      ...
      if (((EData_type) rt).testName(null)) {
        ...
        else if (data_name.equals("_ENTITY")) {
