              ...
              if (elsif_count > 0) { // elsif present
                if (i > 1) { // not needed, always > 1, already tested
                  if (elsif_current_count < elsif_count) { // still in elsif
                    ...
                    if (else_present) {
                      ...
                      // should not happen
                      System.out.println("Express-X compiler: IF expression, INTERNAL ERROR 1 - node index: " + i + ", node: " + children[i] + ", expression: "
                          + jc.generated_java);
                    }
                  }
                }
                  ...
                  // covered already
                  System.out.println("Express-X compiler: IF expression, INTERNAL ERROR 2 - node index: " + i + ", node: " + children[i] + ", expression: "
                      + jc.generated_java);
                }
              }
                ...
                if (else_present) {
                  if (i == 2) {
                    ...
                    // error
                    System.out.println("Express-X compiler: IF expression, INTERNAL ERROR 3 - node index: " + i + ", node: " + children[i] + ", expression: "
                        + jc.generated_java);
                  }
                }
                else {
                  // should not occur, error
                  System.out.println("Express-X compiler: IF expression, INTERNAL ERROR 4 - node index: " + i + ", node: " + children[i] + ", expression: "
                      + jc.generated_java);
                }
