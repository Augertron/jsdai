...
// %modified: 1016210366978 %

/* Generated By:JJTree: Do not edit this line. X_BuiltInConstant.java */
package jsdai.expressCompiler;

import jsdai.SExtended_dictionary_schema.*;
import jsdai.lang.*;

public class X_BuiltInConstant
    extends SimpleNode {
  int type = 0;
  SdaiModel current_model;

  public X_BuiltInConstant(int id) {
    super(id);
    type = 0;
  }

  public X_BuiltInConstant(Compiler2 p, int id) {
    super(p, id);
    type = 0;
  }
  ...
  String getStaticTypeString(EDefined_type dt, JavaClass jc) throws SdaiException {
    current_model = jc.model;

    String type_name = "";
    EEntity rt;
    EParameter pt;
    // not sure, is it better  the type itself or its domain? What about select and enumeration, domain not possible
//    rt = dt.getDomain(null);
    rt = dt;

    // here we need the string for every type possible: entity, defined_type or no-name type
    if (rt instanceof EEntity_definition) {
      // not possible in defined_type
