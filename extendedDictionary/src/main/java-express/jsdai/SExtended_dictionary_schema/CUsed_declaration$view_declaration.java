...
// Java class implementing entity used_declaration$view_declaration

package jsdai.SExtended_dictionary_schema;

import jsdai.lang.*;

public class CUsed_declaration$view_declaration extends CEntity implements EUsed_declaration, EView_declaration {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CUsed_declaration$view_declaration.class,
...
//###-01 jc.generated_java: (new jsdai.SExtended_dictionary_schema.FGet_schema_definition()).run(_context, Value.alloc(jsdai.SExtended_dictionary_schema.CGeneric_schema_definition.definition).set(_context, get(jsdai.SExtended_dictionary_schema.CDeclaration.attributeParent(null))))
  ...
  //going through all the attributes: #1870=EXPLICIT_ATTRIBUTE('definition',#1867,$,#1871,#1598,.F.);
  //<02> NOT generating methods for NOT consolidated attribute:  definition
  //going through all the attributes: #1869=EXPLICIT_ATTRIBUTE('parent',#1867,$,#1528,#1597,.F.);
