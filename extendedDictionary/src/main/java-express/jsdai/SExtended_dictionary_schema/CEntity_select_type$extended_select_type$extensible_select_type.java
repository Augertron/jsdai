...
public class CEntity_select_type$extended_select_type$extensible_select_type extends CEntity
    implements EEntity_select_type, EExtended_select_type, EExtensible_select_type {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(
      CEntity_select_type$extended_select_type$extensible_select_type.class, SExtended_dictionary_schema.ss);
...
*/
  ...
  public int rSelect_typeWr1(SdaiContext _context) throws SdaiException {
    ...
    return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE)
        ...
        .IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.EXTENSIBLE_SELECT_TYPE", "EXTENDED_DICTIONARY_SCHEMA"),
            Value.alloc(jsdai.SExtended_dictionary_schema.CEntity_select_type$extended_select_type$extensible_select_type.definition).set(_context, this)
