...
/*
	...
	// source_parameters: protected Object  - inverse redeclaring - current -  ENTITY dependent_source_parameter
*/
...
*/
  ...
  //going through all the attributes: #1607=EXPLICIT_ATTRIBUTE('parent',#1605,$,#1603,#1742,.F.);
  //<02> NOT generating methods for NOT consolidated attribute:  parent
  //going through all the attributes: #1608=INVERSE_ATTRIBUTE('source_parameters',#1605,$,#1609,#1744,#1737,#2171,$,.F.);
  //<02> NOT generating methods for NOT consolidated attribute:  source_parameters
