...
*/
  ...
  protected static final jsdai.dictionary.CExplicit_attribute a0$ = CEntity.initExplicitAttribute(definition, 0);
  protected String a0;
  // entities - explicit - current entity
  protected static final jsdai.dictionary.CExplicit_attribute a1$ = CEntity.initExplicitAttribute(definition, 1);
  protected AEntity_definition a1;
...
*/
  ...
  //going through all the attributes: #1688=EXPLICIT_ATTRIBUTE('name',#1686,0,#1522,$,.F.);
  ...
  //going through all the attributes: #1689=EXPLICIT_ATTRIBUTE('entities',#1686,1,#2057,$,.F.);
  //<01> generating methods for consolidated attribute:  entities
  //<01-0> current entity
  //<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
  ...
  //going through all the attributes: #1690=INVERSE_ATTRIBUTE('where_rules',#1686,0,#1883,$,#1886,#2202,$,.F.);
