...
public class CExtended_select_type$extensible_select_type extends CEntity implements EExtended_select_type, EExtensible_select_type {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CExtended_select_type$extensible_select_type.class,
...
*/
  ...
  public int rSelect_typeWr1(SdaiContext _context) throws SdaiException {
    ...
    return (Value.alloc(ExpressTypes.LOGICAL_TYPE).set(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE).OR(_context, Value.alloc(ExpressTypes.LOGICAL_TYPE)
        ...
        .IN(_context, Value.alloc(ExpressTypes.STRING_TYPE).set(_context, "*.EXTENSIBLE_SELECT_TYPE", "EXTENDED_DICTIONARY_SCHEMA"),
            Value.alloc(jsdai.SExtended_dictionary_schema.CExtended_select_type$extensible_select_type.definition).set(_context, this).typeOfV(_context))))
        .getLogical());
  }
}
