...
public class FGet_entity_definition {
  ...
  Value _e_parent_entity;
  // end of declaration of local variables

  public Value run(SdaiContext _context, Value _e_parent) throws SdaiException {

    // initialization of non-VAR parameters
    _nonvar__e_parent = Value.alloc(jsdai.SExtended_dictionary_schema.CEntity_or_view_definition.definition).set(_e_parent);
    // end of initialization of non-VAR parameters

    // initialization of local variables
    _e_parent_entity = Value.alloc(jsdai.SExtended_dictionary_schema.CEntity_definition.definition);
    ...
    if (true) {
      return Value.alloc(jsdai.SExtended_dictionary_schema.CEntity_definition.definition).set(_context, _e_parent_entity)
          .check(_context, jsdai.SExtended_dictionary_schema.CEntity_definition.definition);
    }
