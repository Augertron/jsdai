...
public class CReference_from_specification_as extends CReference_from_specification implements EReference_from_specification_as {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CReference_from_specification_as.class,
...
*/
  ...
  // alias_name - explicit - current entity
  protected static final jsdai.dictionary.CExplicit_attribute a3$ = CEntity.initExplicitAttribute(definition, 3);
  protected String a3;
