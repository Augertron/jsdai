...
*/
  ...
  //going through all the attributes: #1823=EXPLICIT_ATTRIBUTE('width',#1821,0,#1577,$,.T.);
  ...
  //going through all the attributes: #1824=EXPLICIT_ATTRIBUTE('fixed_width',#1821,1,#6,$,.F.);
