...
// Java class implementing entity entity_declaration$implicit_declaration

package jsdai.SExtended_dictionary_schema;

import jsdai.lang.*;

public class CEntity_declaration$implicit_declaration extends CEntity implements EEntity_declaration, EImplicit_declaration {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CEntity_declaration$implicit_declaration.class,
...
//###-01 jc.generated_java: (new jsdai.SExtended_dictionary_schema.FGet_schema_definition()).run(_context, Value.alloc(jsdai.SExtended_dictionary_schema.CGeneric_schema_definition.definition).set(_context, get(jsdai.SExtended_dictionary_schema.CDeclaration.attributeParent(null))))
  ...
  //going through all the attributes: #1632=EXPLICIT_ATTRIBUTE('definition',#1630,$,#1633,#1598,.F.);
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a2 = av.entityValues[4].getString(0);
	}
*/
