...
*/
  ...
  protected static final jsdai.dictionary.CExplicit_attribute a0$ = CEntity.initExplicitAttribute(definition, 0);
  protected String a0;
  // generic_supertype - explicit - current entity
  protected static final jsdai.dictionary.CExplicit_attribute a1$ = CEntity.initExplicitAttribute(definition, 1);
  protected Object a1;
  // total_cover - explicit - current entity
  protected static final jsdai.dictionary.CExplicit_attribute a2$ = CEntity.initExplicitAttribute(definition, 2);
  protected AEntity_definition a2;
  // constraint - explicit - current entity
  protected static final jsdai.dictionary.CExplicit_attribute a3$ = CEntity.initExplicitAttribute(definition, 3);
  protected Object a3;
  // abstract_supertype - explicit - current entity
  protected static final jsdai.dictionary.CExplicit_attribute a4$ = CEntity.initExplicitAttribute(definition, 4);
  protected int a4;
  // super_type - derived - current entity
  protected static final jsdai.dictionary.CDerived_attribute d0$ = CEntity.initDerivedAttribute(definition, 0);
...
*/
  ...
  //going through all the attributes: #1827=EXPLICIT_ATTRIBUTE('name',#1825,0,#1522,$,.T.);
  ...
  //going through all the attributes: #1828=EXPLICIT_ATTRIBUTE('generic_supertype',#1825,1,#1644,$,.F.);
  //<01> generating methods for consolidated attribute:  generic_supertype
  //<01-0> current entity
  //<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
  // attribute (current explicit or supertype explicit) : generic_supertype, base type: entity entity_or_view_definition
  public static int usedinGeneric_supertype(ESub_supertype_constraint type, EEntity_or_view_definition instance, ASdaiModel domain, AEntity result)
  ...
  //going through all the attributes: #1829=EXPLICIT_ATTRIBUTE('total_cover',#1825,2,#2079,$,.T.);
  //<01> generating methods for consolidated attribute:  total_cover
  //<01-0> current entity
  //<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
  ...
  //going through all the attributes: #1830=EXPLICIT_ATTRIBUTE('constraint',#1825,3,#1835,$,.T.);
  //<01> generating methods for consolidated attribute:  constraint
  //<01-0> current entity
  //<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
  // attribute (current explicit or supertype explicit) : constraint, base type: entity subtype_expression
  ...
  public ESubtype_expression getConstraint(ESub_supertype_constraint type) throws SdaiException {
    return (ESubtype_expression) get_instance(a3);
  }
  ...
  //going through all the attributes: #1831=EXPLICIT_ATTRIBUTE('abstract_supertype',#1825,4,#6,$,.F.);
  //<01> generating methods for consolidated attribute:  abstract_supertype
  //<01-0> current entity
  //<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
  ...
  //going through all the attributes: #1832=DERIVED_ATTRIBUTE('super_type',#1825,0,#1633,$);
  ...
  // derived attribute (current derived or supertype derived): super_type, base type: entity entity_definition
...
//###-01 jc.generated_java: (new jsdai.SExtended_dictionary_schema.FGet_entity_definition()).run(_context, Value.alloc(jsdai.SExtended_dictionary_schema.CEntity_or_view_definition.definition).set(_context, get(a1$)))
  ...
  public EEntity_definition getSuper_type(ESub_supertype_constraint type) throws SdaiException {
    ...
    return (EEntity_definition) getSuper_type((ESub_supertype_constraint) null, _context).getInstance();
  }
