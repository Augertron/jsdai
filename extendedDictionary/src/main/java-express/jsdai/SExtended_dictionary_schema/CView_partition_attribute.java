...
*/
  ...
  // parent_view_attribute - explicit - current entity
  protected static final jsdai.dictionary.CExplicit_attribute a0$ = CEntity.initExplicitAttribute(definition, 0);
  protected Object a0;
  // related_partition - explicit - current entity
  protected static final jsdai.dictionary.CExplicit_attribute a1$ = CEntity.initExplicitAttribute(definition, 1);
  protected Object a1;
...
*/
  ...
  //going through all the attributes: #1881=EXPLICIT_ATTRIBUTE('parent_view_attribute',#1879,0,#1862,$,.F.);
  //<01> generating methods for consolidated attribute:  parent_view_attribute
  //<01-0> current entity
  //<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
  // attribute (current explicit or supertype explicit) : parent_view_attribute, base type: entity view_attribute
  public static int usedinParent_view_attribute(EView_partition_attribute type, EView_attribute instance, ASdaiModel domain, AEntity result)
  ...
  public EView_attribute getParent_view_attribute(EView_partition_attribute type) throws SdaiException {
    return (EView_attribute) get_instance(a0);
  }
  ...
  //going through all the attributes: #1882=EXPLICIT_ATTRIBUTE('related_partition',#1879,1,#1875,$,.F.);
  //<01> generating methods for consolidated attribute:  related_partition
  //<01-0> current entity
  //<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
  // attribute (current explicit or supertype explicit) : related_partition, base type: entity view_partition
  ...
  public EView_partition getRelated_partition(EView_partition_attribute type) throws SdaiException {
    return (EView_partition) get_instance(a1);
  }
