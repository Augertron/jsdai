...
*/
  ...
  protected static final jsdai.dictionary.CExplicit_attribute a1$ = CEntity.initExplicitAttribute(definition, 1);
  protected Object a1;
  // constant_value - explicit - current entity
  protected static final jsdai.dictionary.CExplicit_attribute a2$ = CEntity.initExplicitAttribute(definition, 2);
  protected Object a2;
...
*/
  ...
  //going through all the attributes: #1584=EXPLICIT_ATTRIBUTE('name',#1582,0,#1522,$,.F.);
  ...
  //going through all the attributes: #1585=EXPLICIT_ATTRIBUTE('domain',#1582,1,#1506,$,.F.);
  ...
  //going through all the attributes: #1586=EXPLICIT_ATTRIBUTE('constant_value',#1582,2,#1506,$,.F.);
  //<01> generating methods for consolidated attribute:  constant_value
  //<01-0> current entity
  //<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
  // -2- methods for SELECT attribute: constant_value
