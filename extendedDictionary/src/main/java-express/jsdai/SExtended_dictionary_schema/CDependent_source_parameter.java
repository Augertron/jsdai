...
// Java class implementing entity dependent_source_parameter

package jsdai.SExtended_dictionary_schema;

import jsdai.lang.*;

public class CDependent_source_parameter extends CSource_parameter implements EDependent_source_parameter {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CDependent_source_parameter.class, SExtended_dictionary_schema.ss);
...
*/
  ...
  //going through all the attributes: #1612=EXPLICIT_ATTRIBUTE('extent',#1609,$,#1530,#1738,.F.);
  //<02> NOT generating methods for NOT consolidated attribute:  extent
  //going through all the attributes: #1611=EXPLICIT_ATTRIBUTE('name',#1609,$,#1522,#1736,.F.);
  //<02> NOT generating methods for NOT consolidated attribute:  name
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		// partial entity: dependent_source_parameter
