...
// Java class implementing entity inner_declaration$type_declaration

package jsdai.SExtended_dictionary_schema;

import jsdai.lang.*;

public class CInner_declaration$type_declaration extends CEntity implements EInner_declaration, EType_declaration {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CInner_declaration$type_declaration.class,
...
//###-01 jc.generated_java: (new jsdai.SExtended_dictionary_schema.FGet_schema_definition()).run(_context, Value.alloc(jsdai.SExtended_dictionary_schema.CGeneric_schema_definition.definition).set(_context, get(jsdai.SExtended_dictionary_schema.CDeclaration.attributeParent(null))))
  ...
  //going through all the attributes: #1847=EXPLICIT_ATTRIBUTE('definition',#1845,$,#1600,#1598,.F.);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: type_declaration
	}
*/
