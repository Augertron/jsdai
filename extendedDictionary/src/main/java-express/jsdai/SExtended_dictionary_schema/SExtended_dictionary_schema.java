...
public class SExtended_dictionary_schema extends SSuper {
  ...
  static void initDefinedDataTypes() {
    ...
    _st_constructed_type = (jsdai.dictionary.EDefined_type) SdaiSession
        .findDataType("constructed_type", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
    _st_declaration_scope_type = (jsdai.dictionary.EDefined_type) SdaiSession
        .findDataType("declaration_scope_type", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
    _st_declaration_type = (jsdai.dictionary.EDefined_type) SdaiSession
        .findDataType("declaration_type", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
    _st_documentation_object = (jsdai.dictionary.EDefined_type) SdaiSession
        .findDataType("documentation_object", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
    _st_entity_or_subtype_expression = (jsdai.dictionary.EDefined_type) SdaiSession
        .findDataType("entity_or_subtype_expression", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
    _st_entity_or_view_or_subtype_expression = (jsdai.dictionary.EDefined_type) SdaiSession
        .findDataType("entity_or_view_or_subtype_expression", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
    _st_explicit_or_derived = (jsdai.dictionary.EDefined_type) SdaiSession
        .findDataType("explicit_or_derived", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
    _st_express_id = (jsdai.dictionary.EDefined_type) SdaiSession
        .findDataType("express_id", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
    _st_info_object_id = (jsdai.dictionary.EDefined_type) SdaiSession
        .findDataType("info_object_id", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
    _st_map_or_view_definition_select = (jsdai.dictionary.EDefined_type) SdaiSession
        .findDataType("map_or_view_definition_select", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
    _st_schema_map_or_view_definition = (jsdai.dictionary.EDefined_type) SdaiSession
        .findDataType("schema_map_or_view_definition", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
    _st_entity_or_view_definition_or_simple_type = (jsdai.dictionary.EDefined_type) SdaiSession
        .findDataType("entity_or_view_definition_or_simple_type", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
    _st_type_or_rule = (jsdai.dictionary.EDefined_type) SdaiSession
        .findDataType("type_or_rule", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
    _st_underlying_type = (jsdai.dictionary.EDefined_type) SdaiSession
        .findDataType("underlying_type", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
  }
  ...
  static void initNonDefinedDataTypes() {
    _st_set_1_referenced_declaration = SdaiSession
        .findDataType("_SET_1_referenced_declaration", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
    ...
    _st_list_0_unique_view_definition = SdaiSession
        .findDataType("_LIST_0_UNIQUE_view_definition", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
    _st_list_0_unique_entity_definition = SdaiSession
        .findDataType("_LIST_0_UNIQUE_entity_definition", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
    ...
    _st_generallist_0_entity_or_view_definition = SdaiSession
        .findDataType("_GENERALLIST_0_entity_or_view_definition", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
    _st_set_1_entity_or_subtype_expression = SdaiSession
        .findDataType("_SET_1_entity_or_subtype_expression", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
    _st_set_1_entity_or_view_or_subtype_expression = SdaiSession
        .findDataType("_SET_1_entity_or_view_or_subtype_expression", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
    ...
    _st_generalset_0_entity_or_view_or_subtype_expression = SdaiSession
        .findDataType("_GENERALSET_0_entity_or_view_or_subtype_expression", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
    ...
    _st_list_0_unique_entity_or_view_definition = SdaiSession
        .findDataType("_LIST_0_UNIQUE_entity_or_view_definition", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
    ...
    _st_generalset_0_entity_or_subtype_expression = SdaiSession
        .findDataType("_GENERALSET_0_entity_or_subtype_expression", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
    _st_set_1_interfaced_declaration = SdaiSession
        .findDataType("_SET_1_interfaced_declaration", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
    _st_generallist_0_entity_definition = SdaiSession
        .findDataType("_GENERALLIST_0_entity_definition", jsdai.SExtended_dictionary_schema.SExtended_dictionary_schema.class);
