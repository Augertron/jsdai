...
*/
  ...
  // generic_operands - explicit - current entity
  protected static final jsdai.dictionary.CExplicit_attribute a0$ = CEntity.initExplicitAttribute(definition, 0);
  protected AEntity_or_view_or_subtype_expression a0;
  // operands - derived - current entity
  protected static final jsdai.dictionary.CDerived_attribute d0$ = CEntity.initDerivedAttribute(definition, 0);
...
//###-01 jc.generated_java: (new jsdai.SExtended_dictionary_schema.FGet_operands()).run(_context, Value.alloc(ExpressTypes.SET_GENERIC_TYPE).set(_context, get(a0$)))
    return ((new jsdai.SExtended_dictionary_schema.FGet_operands()).run(_context, Value.alloc(ExpressTypes.SET_GENERIC_TYPE).set(_context, get(a0$))));
  }
