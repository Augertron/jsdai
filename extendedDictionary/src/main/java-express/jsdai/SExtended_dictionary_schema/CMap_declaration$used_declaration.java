...
// Java class implementing entity map_declaration$used_declaration

package jsdai.SExtended_dictionary_schema;

import jsdai.lang.*;

public class CMap_declaration$used_declaration extends CEntity implements EMap_declaration, EUsed_declaration {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CMap_declaration$used_declaration.class,
...
//###-01 jc.generated_java: (new jsdai.SExtended_dictionary_schema.FGet_schema_definition()).run(_context, Value.alloc(jsdai.SExtended_dictionary_schema.CGeneric_schema_definition.definition).set(_context, get(jsdai.SExtended_dictionary_schema.CDeclaration.attributeParent(null))))
  ...
  //going through all the attributes: #1727=EXPLICIT_ATTRIBUTE('definition',#1724,$,#1728,#1598,.F.);
  //<02> NOT generating methods for NOT consolidated attribute:  definition
  //going through all the attributes: #1726=EXPLICIT_ATTRIBUTE('parent',#1724,$,#1800,#1597,.F.);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: map_declaration
		// partial entity: used_declaration
	}
*/
