...
public class COr_constraint_relationship extends CInstance_constraint implements EOr_constraint_relationship {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(COr_constraint_relationship.class, SMapping_schema.ss);
