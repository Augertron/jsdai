...
public class CLogical_constraint extends CAttribute_value_constraint implements ELogical_constraint {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CLogical_constraint.class, SMapping_schema.ss);
...
*/
  ...
  //going through all the attributes: #1363=EXPLICIT_ATTRIBUTE('constraint_value',#1360,0,#5,$,.F.);
