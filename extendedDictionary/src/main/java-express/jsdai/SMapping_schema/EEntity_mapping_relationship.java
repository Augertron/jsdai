...
public interface EEntity_mapping_relationship extends EEntity {
  ...
  EEntity getConstraints(EEntity_mapping_relationship type) throws SdaiException; // case 1

  void setConstraints(EEntity_mapping_relationship type, EEntity value) throws SdaiException; // case 1
