...
public class CInverse_attribute_constraint extends CConstraint implements EInverse_attribute_constraint {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CInverse_attribute_constraint.class, SMapping_schema.ss);
...
*/
  ...
  //going through all the attributes: #1358=EXPLICIT_ATTRIBUTE('inverted_attribute',#1355,0,#1287,$,.F.);
