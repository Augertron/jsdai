...
public class CAggregate_member_constraint extends CConstraint_attribute implements EAggregate_member_constraint {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CAggregate_member_constraint.class, SMapping_schema.ss);
...
*/
  ...
  //going through all the attributes: #1299=EXPLICIT_ATTRIBUTE('member',#1296,0,#2,$,.T.);
  ...
  //going through all the attributes: #1301=EXPLICIT_ATTRIBUTE('attribute',#1296,1,#1275,$,.F.);
