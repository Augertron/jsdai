...
public interface EEntity_constraint extends EConstraint_attribute {
  ...
  EEntity getAttribute(EEntity_constraint type) throws SdaiException; // case 1

  void setAttribute(EEntity_constraint type, EEntity value) throws SdaiException; // case 1
