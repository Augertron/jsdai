...
public class CString_constraint extends CAttribute_value_constraint implements EString_constraint {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CString_constraint.class, SMapping_schema.ss);
...
*/
  ...
  //going through all the attributes: #1401=EXPLICIT_ATTRIBUTE('constraint_value',#1398,0,#7,$,.F.);
