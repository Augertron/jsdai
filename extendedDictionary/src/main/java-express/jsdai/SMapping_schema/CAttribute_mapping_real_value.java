...
public class CAttribute_mapping_real_value extends CAttribute_mapping_value implements EAttribute_mapping_real_value {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CAttribute_mapping_real_value.class, SMapping_schema.ss);
...
*/
  ...
  //<01-1> supertype, java inheritance
  //<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
  //going through all the attributes: #1463=EXPLICIT_ATTRIBUTE('mapped_value',#1460,0,#3,$,.F.);
