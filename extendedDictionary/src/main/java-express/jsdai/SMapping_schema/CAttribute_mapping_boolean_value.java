...
public class CAttribute_mapping_boolean_value extends CAttribute_mapping_value implements EAttribute_mapping_boolean_value {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CAttribute_mapping_boolean_value.class, SMapping_schema.ss);
...
*/
  ...
  //<01-1> supertype, java inheritance
  //<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
  //going through all the attributes: #1443=EXPLICIT_ATTRIBUTE('mapped_value',#1440,0,#6,$,.F.);
