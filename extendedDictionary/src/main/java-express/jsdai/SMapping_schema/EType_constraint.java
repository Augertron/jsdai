...
public interface EType_constraint extends EConstraint {
  ...
  public jsdai.SExtended_dictionary_schema.EEntity_definition getDomain(EType_constraint type) throws SdaiException;

  public void setDomain(EType_constraint type, jsdai.SExtended_dictionary_schema.EEntity_definition value) throws SdaiException;
  ...
  EEntity getConstraints(EType_constraint type) throws SdaiException; // case 1

  void setConstraints(EType_constraint type, EEntity value) throws SdaiException; // case 1
