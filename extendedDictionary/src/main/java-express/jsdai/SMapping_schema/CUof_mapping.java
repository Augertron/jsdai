...
public class CUof_mapping extends CEntity implements EUof_mapping {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CUof_mapping.class, SMapping_schema.ss);
...
*/
  ...
  //going through all the attributes: #1271=EXPLICIT_ATTRIBUTE('name',#1268,0,#7,$,.F.);
  ...
  //going through all the attributes: #1273=EXPLICIT_ATTRIBUTE('mappings',#1268,1,#2039,$,.F.);
