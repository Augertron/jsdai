...
// Java class implementing entity attribute_mapping_int_value

package jsdai.SMapping_schema;

import jsdai.lang.*;

public class CAttribute_mapping_int_value extends CAttribute_mapping_value implements EAttribute_mapping_int_value {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CAttribute_mapping_int_value.class, SMapping_schema.ss);
...
/*
	...
	protected int a5; // mapped_value - current entity - INTEGER
...
*/
  ...
  //<01-1> supertype, java inheritance
  //<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
  //going through all the attributes: #1453=EXPLICIT_ATTRIBUTE('mapped_value',#1450,0,#2,$,.F.);
  ...
  public static jsdai.dictionary.EAttribute attributeMapped_value(EAttribute_mapping_int_value type) throws SdaiException {
    return a5$;
  }
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		// partial entity: attribute_mapping_int_value
