...
public class CGeneric_attribute_mapping extends CEntity implements EGeneric_attribute_mapping {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CGeneric_attribute_mapping.class, SMapping_schema.ss);
...
/*
	...
	protected jsdai.SExtended_dictionary_schema.ANamed_type a3; // data_type - current entity - LIST OF ENTITY
...
*/
  ...
  public jsdai.SExtended_dictionary_schema.EAttribute getSource(EGeneric_attribute_mapping type) throws SdaiException {
    return (jsdai.SExtended_dictionary_schema.EAttribute) get_instance(a1);
  }
  ...
  public jsdai.SExtended_dictionary_schema.ANamed_type getData_type(EGeneric_attribute_mapping type) throws SdaiException {
    return (jsdai.SExtended_dictionary_schema.ANamed_type) get_aggregate(a3);
  }
  ...
  public jsdai.SExtended_dictionary_schema.ANamed_type createData_type(EGeneric_attribute_mapping type) throws SdaiException {
    a3 = (jsdai.SExtended_dictionary_schema.ANamed_type) create_aggregate_class(a3, a3$, jsdai.SExtended_dictionary_schema.ANamed_type.class, 0);
    return a3;
  }
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a3 = (jsdai.SExtended_dictionary_schema.ANamed_type)av.entityValues[0].getInstanceAggregate(3, a3$, this);
