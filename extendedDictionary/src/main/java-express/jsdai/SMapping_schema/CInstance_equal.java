...
public class CInstance_equal extends CInstance_constraint implements EInstance_equal {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CInstance_equal.class, SMapping_schema.ss);
...
*/
  ...
  //going through all the attributes: #1371=EXPLICIT_ATTRIBUTE('element1',#1368,0,#1284,$,.F.);
