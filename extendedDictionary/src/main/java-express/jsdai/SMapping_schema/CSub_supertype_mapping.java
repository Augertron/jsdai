...
public class CSub_supertype_mapping extends CEntity_mapping_relationship implements ESub_supertype_mapping {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CSub_supertype_mapping.class, SMapping_schema.ss);
...
*/
  ...
  //going through all the attributes: #1476=EXPLICIT_ATTRIBUTE('relating',#1473,0,#1242,$,.F.);
  ...
  //going through all the attributes: #1478=EXPLICIT_ATTRIBUTE('related',#1473,1,#1242,$,.F.);
  ...
  //going through all the attributes: #1480=EXPLICIT_ATTRIBUTE('constraints',#1473,2,#1284,$,.T.);
  ...
  //going through all the attributes: #1482=EXPLICIT_ATTRIBUTE('path',#1473,3,#2043,$,.T.);
