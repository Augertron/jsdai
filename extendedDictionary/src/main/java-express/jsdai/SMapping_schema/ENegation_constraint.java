...
public interface ENegation_constraint extends EConstraint {
  ...
  EEntity getConstraints(ENegation_constraint type) throws SdaiException; // case 1

  void setConstraints(ENegation_constraint type, EEntity value) throws SdaiException; // case 1
