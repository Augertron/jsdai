...
public class CReal_constraint extends CAttribute_value_constraint implements EReal_constraint {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CReal_constraint.class, SMapping_schema.ss);
...
*/
  ...
  //going through all the attributes: #1389=EXPLICIT_ATTRIBUTE('constraint_value',#1386,0,#3,$,.F.);
