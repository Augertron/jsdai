...
public class CAnd_constraint_relationship extends CInstance_constraint implements EAnd_constraint_relationship {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CAnd_constraint_relationship.class, SMapping_schema.ss);
