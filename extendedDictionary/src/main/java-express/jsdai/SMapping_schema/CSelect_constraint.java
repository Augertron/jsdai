...
public class CSelect_constraint extends CConstraint_attribute implements ESelect_constraint {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CSelect_constraint.class, SMapping_schema.ss);

  /*----------------------------- Attributes -----------*/

/*
	protected jsdai.SExtended_dictionary_schema.ADefined_type a0; // data_type - current entity - LIST OF ENTITY
...
*/
  ...
  protected static final jsdai.dictionary.CExplicit_attribute a0$ = CEntity.initExplicitAttribute(definition, 0);
  protected jsdai.SExtended_dictionary_schema.ADefined_type a0;
...
*/
  ...
  //going through all the attributes: #1394=EXPLICIT_ATTRIBUTE('data_type',#1391,0,#2040,$,.F.);
  ...
  public static int usedinData_type(ESelect_constraint type, jsdai.SExtended_dictionary_schema.EDefined_type instance, ASdaiModel domain, AEntity result)
  ...
  public jsdai.SExtended_dictionary_schema.ADefined_type getData_type(ESelect_constraint type) throws SdaiException {
    return (jsdai.SExtended_dictionary_schema.ADefined_type) get_aggregate(a0);
  }

  public jsdai.SExtended_dictionary_schema.ADefined_type createData_type(ESelect_constraint type) throws SdaiException {
    a0 = (jsdai.SExtended_dictionary_schema.ADefined_type) create_aggregate_class(a0, a0$, jsdai.SExtended_dictionary_schema.ADefined_type.class, 0);
    return a0;
  }
  ...
  //going through all the attributes: #1396=EXPLICIT_ATTRIBUTE('attribute',#1391,1,#1293,$,.F.);
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a0 = (jsdai.SExtended_dictionary_schema.ADefined_type)av.entityValues[2].getInstanceAggregate(0, a0$, this);
