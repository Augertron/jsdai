...
public class CNegation_constraint extends CConstraint implements ENegation_constraint {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CNegation_constraint.class, SMapping_schema.ss);
...
*/
  ...
  //going through all the attributes: #1322=EXPLICIT_ATTRIBUTE('constraints',#1319,0,#1284,$,.F.);
  ...
  public EEntity getConstraints(ENegation_constraint type) throws SdaiException { // case 1
    return get_instance_select(a0);
  }

  public void setConstraints(ENegation_constraint type, EEntity value) throws SdaiException { // case 1
