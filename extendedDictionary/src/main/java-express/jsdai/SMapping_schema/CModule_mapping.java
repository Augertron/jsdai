...
// Java class implementing entity module_mapping

package jsdai.SMapping_schema;

import jsdai.lang.*;

public class CModule_mapping extends CSchema_mapping implements EModule_mapping {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CModule_mapping.class, SMapping_schema.ss);
