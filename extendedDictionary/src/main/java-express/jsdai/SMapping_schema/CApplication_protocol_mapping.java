...
public class CApplication_protocol_mapping extends CSchema_mapping implements EApplication_protocol_mapping {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CApplication_protocol_mapping.class, SMapping_schema.ss);
