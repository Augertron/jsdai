...
public class CInteger_constraint extends CAttribute_value_constraint implements EInteger_constraint {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CInteger_constraint.class, SMapping.ss);
...
*/
  ...
  //going through all the attributes: #528=EXPLICIT_ATTRIBUTE('constraint_value',#525,0,#2,$,.F.);
