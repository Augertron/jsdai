...
public class CAttribute_mapping_logical_value extends CMappingAttribute_mapping_logical_value implements EAttribute_mapping_logical_value {
...
*/
  ...
  //<01-1> supertype, java inheritance
  //<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
  //going through all the attributes: #633=EXPLICIT_ATTRIBUTE('mapped_value',#630,0,#5,$,.F.);
