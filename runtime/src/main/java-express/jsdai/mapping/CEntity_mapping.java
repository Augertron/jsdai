...
*/
  ...
  //going through all the attributes: #420=EXPLICIT_ATTRIBUTE('source',#417,0,#144,$,.F.);
  ...
  //going through all the attributes: #422=EXPLICIT_ATTRIBUTE('target',#417,1,#412,$,.F.);
  ...
  //going through all the attributes: #424=EXPLICIT_ATTRIBUTE('constraints',#417,2,#459,$,.T.);
  ...
  //going through all the attributes: #426=EXPLICIT_ATTRIBUTE('entry_point',#417,3,#6,$,.F.);
  ...
  //going through all the attributes: #428=EXPLICIT_ATTRIBUTE('strong_users',#417,4,#6,$,.F.);
