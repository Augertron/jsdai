...
public class CEntity_constraint extends CMappingEntity_constraint implements EEntity_constraint {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CEntity_constraint.class, SMapping.ss);
