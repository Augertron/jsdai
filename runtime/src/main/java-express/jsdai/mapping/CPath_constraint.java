...
public class CPath_constraint extends CMappingPath_constraint implements EPath_constraint {
...
*/
  ...
  //going through all the attributes: #554=EXPLICIT_ATTRIBUTE('element1',#551,0,#465,$,.F.);
