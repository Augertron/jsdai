...
public class CNegation_constraint extends CMappingNegation_constraint implements ENegation_constraint {
...
*/
  ...
  //going through all the attributes: #497=EXPLICIT_ATTRIBUTE('constraints',#494,0,#459,$,.F.);
