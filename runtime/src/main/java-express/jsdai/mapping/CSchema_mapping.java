...
public class CSchema_mapping extends CEntity implements ESchema_mapping {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CSchema_mapping.class, SMapping.ss);
...
*/
  ...
  public jsdai.dictionary.ESchema_definition getSource(ESchema_mapping type) throws SdaiException {
    return (jsdai.dictionary.ESchema_definition) get_instance(a0);
  }
  ...
  public jsdai.dictionary.ESchema_definition getTarget(ESchema_mapping type) throws SdaiException {
    return (jsdai.dictionary.ESchema_definition) get_instance(a1);
  }
