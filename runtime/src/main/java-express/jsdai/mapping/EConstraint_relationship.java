...
public interface EConstraint_relationship extends EConstraint {
  ...
  EEntity getElement2(EConstraint_relationship type) throws SdaiException; // case 1

  void setElement2(EConstraint_relationship type, EEntity value) throws SdaiException; // case 1
