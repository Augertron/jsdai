...
public class CAttribute_mapping_string_value extends CMappingAttribute_mapping_string_value implements EAttribute_mapping_string_value {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CAttribute_mapping_string_value.class, SMapping.ss);
...
*/
  ...
  //<01-1> supertype, java inheritance
  //<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
  //going through all the attributes: #643=EXPLICIT_ATTRIBUTE('mapped_value',#640,0,#7,$,.F.);
