...
// Java class implementing entity attribute_mapping_enumeration_value

package jsdai.mapping;

import jsdai.lang.*;

public class CAttribute_mapping_enumeration_value extends CMappingAttribute_mapping_enumeration_value implements EAttribute_mapping_enumeration_value {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CAttribute_mapping_enumeration_value.class, SMapping.ss);
...
*/
  ...
  //<01-1> supertype, java inheritance
  //<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
  //going through all the attributes: #623=EXPLICIT_ATTRIBUTE('mapped_value',#620,0,#7,$,.F.);
  ...
  public boolean testMapped_value(EAttribute_mapping_enumeration_value type) throws SdaiException {
    return test_string(a5);
  }

  public String getMapped_value(EAttribute_mapping_enumeration_value type) throws SdaiException {
    return get_string(a5);
  }

  public void setMapped_value(EAttribute_mapping_enumeration_value type, String value) throws SdaiException {
    a5 = set_string(value);
  }

  public void unsetMapped_value(EAttribute_mapping_enumeration_value type) throws SdaiException {
    a5 = unset_string();
  }

  public static jsdai.dictionary.EAttribute attributeMapped_value(EAttribute_mapping_enumeration_value type) throws SdaiException {
    return a5$;
  }
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		// partial entity: attribute_mapping_enumeration_value
