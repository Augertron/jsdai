...
public interface EAttribute_value_constraint extends EConstraint_attribute {
  ...
  EEntity getAttribute(EAttribute_value_constraint type) throws SdaiException; // case 1

  void setAttribute(EAttribute_value_constraint type, EEntity value) throws SdaiException; // case 1
