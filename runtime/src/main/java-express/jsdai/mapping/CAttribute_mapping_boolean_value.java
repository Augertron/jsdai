...
// Java class implementing entity attribute_mapping_boolean_value

package jsdai.mapping;

import jsdai.lang.*;

public class CAttribute_mapping_boolean_value extends CMappingAttribute_mapping_boolean_value implements EAttribute_mapping_boolean_value {
  public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CAttribute_mapping_boolean_value.class, SMapping.ss);
...
/*
	...
	protected int a5; // mapped_value - current entity - BOOLEAN
...
*/
  ...
  //<01-1> supertype, java inheritance
  //<01-1-0> explicit - generateExplicitSupertypeJavaInheritedMethodsX()
  //going through all the attributes: #618=EXPLICIT_ATTRIBUTE('mapped_value',#615,0,#6,$,.F.);
  //<01> generating methods for consolidated attribute:  mapped_value
  //<01-0> current entity
  //<01-0-0> explicit attribute - generateExplicitCurrentEntityMethodsX()
  /// methods for attribute: mapped_value, base type: BOOLEAN
  public boolean testMapped_value(EAttribute_mapping_boolean_value type) throws SdaiException {
    return test_boolean(a5);
  }

  public boolean getMapped_value(EAttribute_mapping_boolean_value type) throws SdaiException {
    return get_boolean(a5);
  }

  public void setMapped_value(EAttribute_mapping_boolean_value type, boolean value) throws SdaiException {
    a5 = set_boolean(value);
  }

  public void unsetMapped_value(EAttribute_mapping_boolean_value type) throws SdaiException {
    a5 = unset_boolean();
  }

  public static jsdai.dictionary.EAttribute attributeMapped_value(EAttribute_mapping_boolean_value type) throws SdaiException {
    return a5$;
  }
...
/* *** old implementation ***
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a5 = av.entityValues[0].getBoolean(0);
...
/* *** old implementation ***
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		// partial entity: attribute_mapping_boolean_value
		av.entityValues[0].setBoolean(0, a5);
