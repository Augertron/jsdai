...
public interface EInstance_constraint extends EConstraint_relationship {
  ...
  EEntity getElement1(EInstance_constraint type) throws SdaiException; // case 1

  void setElement1(EInstance_constraint type, EEntity value) throws SdaiException; // case 1
