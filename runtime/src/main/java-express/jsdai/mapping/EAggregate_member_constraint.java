...
public interface EAggregate_member_constraint extends EConstraint_attribute {
  ...
  EEntity getAttribute(EAggregate_member_constraint type) throws SdaiException; // case 1

  void setAttribute(EAggregate_member_constraint type, EEntity value) throws SdaiException; // case 1
