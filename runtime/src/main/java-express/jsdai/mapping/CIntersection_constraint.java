...
public class CIntersection_constraint extends CMappingIntersection_constraint implements EIntersection_constraint {
...
*/
  ...
  //going through all the attributes: #678=EXPLICIT_ATTRIBUTE('subpaths',#675,0,#884,$,.F.);
