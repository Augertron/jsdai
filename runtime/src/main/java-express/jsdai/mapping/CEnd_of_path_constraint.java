...
public class CEnd_of_path_constraint extends CMappingEnd_of_path_constraint implements EEnd_of_path_constraint {
...
*/
  ...
  //going through all the attributes: #559=EXPLICIT_ATTRIBUTE('constraints',#556,0,#459,$,.F.);
