...
public interface EEntity_mapping extends EEntity {
  ...
  EEntity getTarget(EEntity_mapping type) throws SdaiException; // case 1

  void setTarget(EEntity_mapping type, EEntity value) throws SdaiException; // case 1
  ...
  EEntity getConstraints(EEntity_mapping type) throws SdaiException; // case 1

  void setConstraints(EEntity_mapping type, EEntity value) throws SdaiException; // case 1
