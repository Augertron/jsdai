...
//		return getBound_valueInternal(context); // commented, April 2012
    throw new SdaiException(SdaiException.FN_NAVL, em_wrong_method_used); // added, April 2012
  }

  public int getBound_value(EBound type, CEntity inst, SdaiContext context) throws SdaiException { // added, April 2012
    return getBound_valueInternal(context, inst); // added, April 2012
  } // added, April 2012
