...
public class RepositoryImportResult extends JFrame {
  ...
  private void copyAllToClipboard() {
    StringSelection selection = new StringSelection(list.getText());
  ...
  private class AreaKeyListener implements KeyListener {
    public void keyPressed(KeyEvent e) {
      if ((e.getModifiers() & InputEvent.CTRL_MASK) != 0 && e.getKeyCode() == KeyEvent.VK_INSERT) {
        StringSelection selection = new StringSelection(list.getSelectedText());
