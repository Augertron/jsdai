...
public class MoveRepositoryDialog extends JDialog implements ActionListener, ItemListener, KeyListener {
  ...
  private void initComponents() {
    ...
    repositoryInput.setToolTipText("Select repository or enter name of new local repository which will be created");
  ...
  public void actionPerformed(ActionEvent actionEvent) {
    ...
    if (actionCommand.equals(CLOSE)) {
      ...
      try {
        ...
        JOptionPane.showMessageDialog(this, "Failed to move schema instance:\n" + ex.getMessage(), "Schema instance move", JOptionPane.ERROR_MESSAGE);
        ex.printStackTrace();
      }
    }
  }
