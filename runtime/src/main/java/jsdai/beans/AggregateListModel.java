...
/**
 * The AggregateListModel provides a JList and JComboBox contents. Contens are jsdai.lang.Aggregate and supports all functionality
 * from it.
 */
public class AggregateListModel extends AbstractListModel implements ComboBoxModel {
  ...
  public void setAggregate(Aggregate aggregate) throws SdaiException {
    if (this.aggregate != null) {
      this.aggregate.removeSdaiListener(sdaiListener);
    }
