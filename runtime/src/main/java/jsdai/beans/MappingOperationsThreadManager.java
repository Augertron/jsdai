...
public class MappingOperationsThreadManager {
  ...
  protected static class TestMappedAttributeWorker extends SwingWorker {
    ...
    public void setParams(EEntity _instance, EGeneric_attribute_mapping _sourceAttribute, ASdaiModel _targetDomain, ASdaiModel _mappingDomain, int _mode) {
      instance = _instance;
  ...
  public static boolean testMappedAttribute(EEntity instance, EGeneric_attribute_mapping sourceAttribute, ASdaiModel targetDomain, ASdaiModel mappingDomain,
      int mode) {
  ...
  protected static class FindMappedUsersWorker extends SwingWorker {
    ...
    public void setParams(EEntity _instance, EEntity_mapping _source_type, AAttribute_mapping _attribute, ASdaiModel _data_domain,
        ASdaiModel _mapping_domain, AAttribute_mapping _users, int _mode) {
      instance = _instance;
  ...
  public static AEntity findMappedUsers(EEntity instance, EEntity_mapping source_type, AAttribute_mapping attribute, ASdaiModel data_domain,
      ASdaiModel mapping_domain, AAttribute_mapping users, int mode) {
