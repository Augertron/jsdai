...
public class SdaiServerBean extends JDialog implements ActionListener, FocusListener, ItemListener {
  ...
  private void loadData() throws SdaiException {
    try {
      ...
      StringTokenizer lastServerOrderString = new StringTokenizer(savedProperties.getProperty("lastServerOrder", ""), ",");
      while (lastServerOrderString.hasMoreTokens() && lastServers.size() <= SERVER_ENTRY_MAX) {
        ...
        if (server == null || user == null) {
          throw new SdaiException(SdaiException.SY_ERR, "Corrupted SdaiServerBean property file");
        }
      ...
      if (lastServers.size() > 0) {
        ...
        passwordInput.setText(selectedServerEntry.password != null ? new String(selectedServerEntry.password) : "");
  ...
  private void saveData() throws SdaiException {
    ...
    SdaiSession.getSession().storeApplicationProperties(getClass(), savedProperties, "Automatically generated data. DO NOT EDIT!");
  }
  ...
  public void actionPerformed(ActionEvent actionEvent) {
    ...
    if (actionCommand.equals(CLOSE)) {
      ...
      try {
        ...
        JOptionPane.showMessageDialog(this, "Failed to link to SQL Bridge:\n" + ex.getMessage(), "SQL Bridge connection", JOptionPane.ERROR_MESSAGE);
        ex.printStackTrace();
      }
    }
      ...
      try {
        ...
        JOptionPane.showMessageDialog(getParent(), "SQL Bridge link dialog failed:\n" + ex.getMessage(), "SQL Bridge connection",
      ...
      try {
        ...
        JOptionPane.showMessageDialog(getParent(), "Failed to unlink from SQL Bridge:\n" + ex.getMessage(), "SQL Bridge connection",
            JOptionPane.ERROR_MESSAGE);
        ex.printStackTrace();
      }
    }
  ...
  private void loadServerEntry(String server) {
    ...
    if (serverEntryObject instanceof ServerEntry) {
      ...
      if (serverEntry != selectedServerEntry) {
        ...
        passwordInput.setText(serverEntry.password != null ? new String(serverEntry.password) : "");
