    ...
    switch (type) {
      ...
      case LIMITED: {
        ...
        if (domain instanceof EEnumeration_type) {
          ...
          comboValue.setModel(new AggregateListModel(et.getElements(null, SdaiSession.getSession().getSdaiContext())));
        }
      ...
      case MIXED: {
        ...
        SimpleOperations.getNodes(SdaiSession.getSession().getSdaiContext(), st, nodes, new Vector());
...
//        dataDomain.addByIndex(1, owning_model, null);
    ...
    public void actionPerformed(ActionEvent e) {
      if (domain instanceof EAggregation_type) {
        ...
        if (agg.getMemberCount() > 0) {
          ...
          if (SimpleOperations.canSetForThisDomain(SdaiSession.getSession().getSdaiContext(), value.getInstanceType(), domain) && (textValue != null)) {
   ...
   */
  static Collection/* <EEntity_definition> */getDomainEntityDefinitions(SdaiContext sdaiContext, EEntity domain, Collection/*
   * <
   * EEntity_definition
   * >
   */entDefinitions)
    ...
    if (domain instanceof ESelect_type) {
      ...
      ANamed_type sels = sdaiContext != null ? selectDomain.getSelections(null, sdaiContext) : selectDomain.getSelections(null);
   ...
   * Method is used by this class and AggregateBean
   */
  static Collection getEntity_definition_list(Collection/* <EEntity_definition> */entDefinitions, ASdaiModel dataDomain, Collection/*
   * <
   * EEntity_definition_list_item
   * >
   */edList)
      throws SdaiException {
    if (entDefinitions != null) {
    ...
    public void actionPerformed(ActionEvent e) {
      try {
        if (attribute instanceof EExplicit_attribute) {
          ...
          Collection entDefinitions = getDomainEntityDefinitions(SdaiSession.getSession().getSdaiContext(), entity, null);
          ...
          if (edList != null) {
            ...
            if (selectedEntity != null) {
              ...
              if (SimpleOperations.canSetForThisDomain(SdaiSession.getSession().getSdaiContext(), instance.getInstanceType(), domain)
                  && (textValue != null)) {
