...
public class GoList extends JList {
  ...
  void setUnderlyingRow(int i) {
    ...
    if (underlyingRow != -1) {
      ...
      if (r != null) {
        repaint((int) r.getX(), (int) r.getY(), (int) r.getMaxX(), (int) r.getMaxY());
      }
    }
    underlyingRow = i;
    if (i != -1) {
      ...
      g2.drawRect((int) r.getX(), (int) r.getY(), (int) r.getMaxX() - 1, (int) r.getMaxY() - (int) r.getY() - 2);
    }
  }
  ...
  MouseListener mouseListener = new MouseAdapter() {
    ...
    public void mousePressed(MouseEvent e) {
      if (((e.getModifiers() & InputEvent.BUTTON3_MASK) == 0) && timer.isRunning() && (row == getSelectedIndex())) {
        timer.stop();
