...
abstract public class Inv extends Constraint {
  ...
  protected void parse(Node containerNode, ConstraintContainer parent, Context context) throws SdaiException {
    ...
    if (xmlAttribute == null) {
      throw new SdaiException(SdaiException.FN_NAVL, SdaiQueryEngine.formatMessage(containerNode, "Attribute ent is required", null));
    }
  ...
  abstract protected void setParameters(String entityName, String attributeName, Node containerNode, Context context) throws SdaiException;
