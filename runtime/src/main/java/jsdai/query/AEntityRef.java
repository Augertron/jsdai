...
public final class AEntityRef implements SerializableRef {
  ...
  public int hashCode() {
    return new HashCodeBuilder(3613, 9161).append(memberEntityRefs).toHashCode();
  }
  ...
  public boolean equals(Object obj) {
    ...
    return new EqualsBuilder().append(memberEntityRefs, rhs.memberEntityRefs).isEquals();
  }

  public String toString() {
    return new ToStringBuilder(this).append("memberEntityRefs", memberEntityRefs).toString();
  }
