...
public interface SerializableRef extends Serializable {
   ...
   *
   * @return the type of the reference as <code>SDAI_REPOSITORY_REF</code> <code>SCHEMA_INSTANCE_REF</code>,
   * <code>SDAI_MODEL_REF</code>, <code>EENTITY_REF</code>, <code>ASCHEMA_INSTANCE_REF</code>,
   * <code>ASDAI_MODEL_REF</code>, or <code>AENTITY_REF</code>
   */
  public int getType();
   ...
   * case it is a reference to <code>ASchemaInstance</code>, <code>ASdaiModel</code> or <code>AEntity</code>.
   *
