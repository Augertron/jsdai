...
public abstract class ConstraintContainer {
  ...
  protected void removeConstraint(Constraint constraint) {
    for (Constraint currConstraint = constraints; currConstraint != constraintsInv; currConstraint = currConstraint.next) {
  ...
  protected abstract void parse(Node containerNode, ConstraintContainer parent, Context context) throws SdaiException;
   ...
   */
  protected void parseFromConstraintList(Node containerNode, ConstraintContainer parent, Context context, boolean split, ConstraintFactory constraintFactory)
...
// 			}
  ...
  protected static void executeChildren(ConstraintContainer constraintContainer, Context context, boolean split) throws SdaiException {
  ...
  protected static void checkSiblings(ConstraintContainer constraintContainer, Node containerNode) throws SdaiException {
  ...
  public String toString() {
    ...
    asString.append(":");
    for (Constraint childConstraint = constraints; childConstraint != null; childConstraint = childConstraint.next) {
      asString.append(" ");
