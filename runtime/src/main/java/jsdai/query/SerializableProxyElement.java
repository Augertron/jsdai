...
public class SerializableProxyElement implements InvocationHandler {
  ...
  private static final String[] PROXIED_METHOD_NAMES = { "getAttribute", "getAttributeNode", "getAttributeNodeNS", "getAttributeNS", "getAttributes",
      "hasAttribute", "hasAttributeNS", "hasAttributes", "removeAttribute", "removeAttributeNode", "removeAttributeNS", "setAttribute",
  ...
  static {
    try {
      Class elementProxyClass = Proxy.getProxyClass(SerializableProxyElement.class.getClassLoader(), new Class[] { Element.class });
  ...
  public String getAttribute(String name) {
    ...
    Node attrNode;
    return (attrNode = elementAttributes.getNamedItem(name)) != null ? attrNode.getNodeValue() : null;
  }
  ...
  public String getAttributeNS(String namespaceURI, String localName) {
    ...
    Node attrNode;
    return (attrNode = elementAttributes.getNamedItemNS(namespaceURI, localName)) != null ? attrNode.getNodeValue() : null;
  }
  ...
  private class NamedNodeMapImpl implements NamedNodeMap {
    ...
    public NamedNodeMapImpl() {
      ...
      Element localElement = parentNode != null && parentNode.getNodeType() == Node.ELEMENT_NODE ? (Element) parentNode : null;
      while (localElement != null) {
        ...
        localElement = parentNode != null && parentNode.getNodeType() == Node.ELEMENT_NODE ? (Element) parentNode : null;
      }
    }
    ...
    public Node item(int index) {
      ...
      try {
        return index < origLength ? attrNodes.item(index) : (Node) parentAttrList.get(index - origLength);
      }
    ...
    public Node setNamedItemNS(Node node) throws DOMException {
      Node oldNode = attrNodes.setNamedItem(node);
      int parentIndex;
      if ((parentIndex = parentAttrList.indexOf(new NamedItemNSLookup(node.getNamespaceURI(), node.getLocalName()))) >= 0) {
        parentAttrList.remove(parentIndex);
      }
      return oldNode;
    }
  ...
  private static class NamedItemNSLookup {
    ...
    public boolean equals(Object other) {
      Node otherNode = (Node) other;
      return namespaceURI.equals(otherNode.getNamespaceURI()) && localName.equals(otherNode.getLocalName());
    }
