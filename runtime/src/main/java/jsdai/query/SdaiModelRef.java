...
public final class SdaiModelRef implements SerializableRef {
  ...
  /**
   * <p>
   * Creates a reference to a remote model using specified database ids of a remote repository and a remote model.
   * </p>
   * <p>
   * Note that users should not use this constructor, but may obtain <code>SdaiModelRef</code> object using the
   * {@link EEntityRef#getSdaiModelRef() EEntityRef.getSdaiModelRef()} method instead.
   * </p>
   *
   * @param repositoryId
   * @param modelId
  ...
  /**
   * <p>
   * Creates a reference to a remote model using a specified reference to a remote repository and a database id of a remote
   * model.
   * </p>
   * <p>
   * Note that users should not use this constructor, but may obtain <code>SdaiModelRef</code> object using the
  ...
  public boolean equals(Object obj) {
    ...
    return new EqualsBuilder().append(repositoryId, rhs.repositoryId).append(modelId, rhs.modelId).isEquals();
  }

  public String toString() {
    return new ToStringBuilder(this).append("repositoryId", repositoryId).append("modelId", modelId).toString();
  }
