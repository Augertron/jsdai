...
public final class SdaiRepositoryRef implements SerializableRef {
  ...
  /**
   * <p>
   * Creates a reference to a remote repository using the specified database id of a remote repository.
   * </p>
   * <p>
   * Note that users should not use this constructor, but may obtain <code>SdaiRepositoryRef</code> object using the
   * {@link EEntityRef#getRepositoryRef() EEntityRef.getRepositoryRef()} method instead.
   * </p>
   *
   * @param repositoryId
   */
