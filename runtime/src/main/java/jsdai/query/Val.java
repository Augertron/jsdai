...
abstract public class Val extends Constraint {
  ...
  protected void parse(Node containerNode, ConstraintContainer parent, Context context) throws SdaiException {
    ...
    if (xmlAttribute == null) {
      throw new SdaiException(SdaiException.FN_NAVL, SdaiQueryEngine.formatMessage(containerNode, "Attribute attr is required", null));
    }
    ...
    parseFromConstraintList(containerNode, null, context, true, context.query.valConstraintFactory);
  ...
  protected void checkSiblings(Node containerNode) throws SdaiException {
    ...
    if (sibling != null) {
      throw new SdaiException(SdaiException.FN_NAVL, SdaiQueryEngine.formatMessage(containerNode, "val has too many children", null));
    }
  }
  ...
  abstract protected void setParameters(String entityName, String attributeName, String selectNames, Node containerNode, Context context)
