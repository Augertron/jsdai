...
abstract public class Constraint extends ConstraintContainer {
  ...
  /**
   * Executes in inverse direction. This method gets called from <code>QueryFwd</code> when query lib <code>inv</code> is
   * executed. It has to be overriden for constraints
