...
public final class SchemaInstanceRef implements SerializableRef {
  ...
  /**
   * <p>
   * Creates a reference to a remote schema instance using specified database ids of a remote repository and a remote schema
   * instance.
   * </p>
   * <p>
   * Note that users should not use this constructor.
   * </p>
   *
   * @param repositoryId
   * @param schemaInstanceId
   */
  ...
  /**
   * <p>
   * Creates a reference to a remote schema instance using a specified reference to a remote repository and a database id of a
   * remote schema instance.
   * </p>
   * <p>
   * Note that users should not use this constructor.
   * </p>
  ...
  public boolean equals(Object obj) {
    ...
    return new EqualsBuilder().append(repositoryId, rhs.repositoryId).append(schemaInstanceId, rhs.schemaInstanceId).isEquals();
  }

  public String toString() {
    return new ToStringBuilder(this).append("repositoryId", repositoryId).append("schemaInstanceId", schemaInstanceId).toString();
  }
