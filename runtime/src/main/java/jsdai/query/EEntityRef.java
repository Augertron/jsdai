...
public final class EEntityRef implements SerializableRef {
  ...
  /**
   * <p>
   * Creates a reference to a remote entity instance using specified database ids of a remote repository and a remote model and
   * a persistent label of a remote entity instance.
   * </p>
   * <p>
   * Note that users should not use this constructor, but may obtain <code>EEntityRef</code> object using the
   * {@link jsdai.lang.QueryResultSet#getItem(int) jsdai.lang.QueryResultSet.getItem(int)} method instead, if the query result
   * set contains references to entity instances.
   * </p>
   *
   * @param repositoryId
   * @param typeIndex
  ...
  /**
   * <p>
   * Creates a reference to a remote entity instance using specified references to a remote repository and a remote model and a
   * persistent label of a remote entity instance.
   * </p>
   * <p>
   * Note that users should not use this constructor, but may obtain <code>EEntityRef</code> object using the
   * {@link jsdai.lang.QueryResultSet#getItem(int) jsdai.lang.QueryResultSet.getItem(int)} method instead, if the query result
  ...
  public int hashCode() {
    return new HashCodeBuilder(3593, 9151).append(repositoryId).append(modelId).append(persistentLabel).toHashCode();
  }
  ...
  public boolean equals(Object obj) {
    ...
    return new EqualsBuilder().append(repositoryId, rhs.repositoryId).append(modelId, rhs.modelId).append(persistentLabel, rhs.persistentLabel).isEquals();
  }

  public String toString() {
    return new ToStringBuilder(this).append("repositoryId", repositoryId).append("modelId", modelId).append("persistentLabel", persistentLabel).toString();
  }
