...
class SchemaVal extends Val {
  ...
  protected void setParameters(String entityName, String attributeName, String selectNames, Node containerNode, Context context) throws SdaiException {
    ...
    attribute = LocalSdaiQuery.getAttribute(schema, entityName, attributeName, containerNode, localContext, false);
    ...
    if (selectNames != null) {
      ...
      while (selTokenizer.hasMoreTokens()) {
        ...
        EDefined_type selectType = JsdaiLangAccessorLocal.findSchemaDefinedType(schema, selectStr);
