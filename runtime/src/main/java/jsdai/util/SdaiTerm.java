...
public class SdaiTerm implements SdaiListener {
  ...
  String sHeadLine = "Terminal Interface for JSDAI(TM), " + Implementation.copyright;
  String sSepartorLine = "-------------------------------------------------------------------------------";
  String sObjectLine = " Invoked method - parametres - explanation";

  String[] asHelpMain = { sHeadLine, sSepartorLine, "      SdaiSession s: o(open)  m(import-r) i(implementation) l(list)",
      "                     c(close) r(create-r) f(link-r) s(server) g(log)",
      "  SdaiTransaction t: r(start read only)  c(commit) e(commit+end)   i(info)", "                     w(start read write) a(abort)  b(abort+end)",
      ...
      "                   : n(rename) w(startReadWrite) f(endReadWrite) i(info)", "                   : =(nr) c(create) l(list) o(reduce to RO)",
      "     EntityExtent x: =(nr) i(info) l(list)", " EntityDefinition e: =(nr) i(info) l(list)", "      DefinedType d: =(nr) i(info",
      "  Entity Instance i: =(nr) i(info) l(list) d(delete)", "        Attribute a: =(nr) s(set) u(unset) c(create) i(info)",
      "        Aggregate g: =(nr) a(add) r(remove) c(create) l(list)", "           Member b: =(nr)", "Schema_definition h: =(nr) i(info) l(list)",
      "   SchemaInstance c: =(nr) d(dictionary) i(info) l(list) n(rename) r, a, e, m", "  ASchemaInstance n: =(nr) a(add) c(clear) l(list) - domain",
      " Run command file f: o(file_name)", "            Debug .: c(check-mode) n(normal-mode) !(compare) *(skip) i(info)",
      "             help ?: s, t, r, m, x, e, d, i, p, a, g, b, h, c, f, ., ?", "             quit q:   ", sSepartorLine, };

  String[] asHelpSession = { sHeadLine, sSepartorLine, sObjectLine, sSepartorLine, "so : openSession - () - Open this session.",
      "sc : closeSession - () - Close this session.", "si : getSdai_implementation - () - Show information about this session.",
      "sl : getKnown_servers - () - List repositories in this session.", "sr : createRepository - (name, [location]) - Create repository.",
      ...
      "sb : linkDataBaseBridge(String bridgeURL, String user, char password[])", "su : unlinkDataBaseBridge()", sSepartorLine, };

  String[] asHelpTransaction = { sHeadLine, sSepartorLine, sObjectLine, sSepartorLine, "ti : getMode - () - Show information about this transection.",
      "tr : startTransactionReadOnlyAccess - () - Start R/O access.", "tw : startTransactionReadWriteAccess - () - Start R/W access.",
      "tc : commit - () - Commit this transection. All changes are saved.", "ta : abort - ()- Abort this transection. All changes will disapear.",
      "te : endTransactionAccessCommit - () - Commint and end transeciton.", "tb : endTransactionAccessAbort - () - Abort and end transeciton.",
      sSepartorLine, };

  String[] asHelpRepository = { sHeadLine, sSepartorLine, sObjectLine, sSepartorLine, "ro : openRepository - () - Open this repository.",
      "rc : closeRepository - () - Close this repository.", "rd : deleteRepository - () - Imediatly delete this repository.",
      "rx : importXml p28 - (path, [name, [location]]) - Import part28 file.", "re : exportClearTextEncoding - (path) - Export to phisical file",
      "ri : getName.. - () - Show information about this repository.", "rl : getModels, getSchemas - () - List all models and schemas of repository.",
      "rm : createSdaiModel - (name, @h | package_name) - Create model.", "rs : createSchemaInstance - (name, @h | package_name) - Create schema.",
      "ra : import p21 to existing repository util.Move Class", sSepartorLine, };

  String[] asHelpModel = { sHeadLine, sSepartorLine, sObjectLine, sSepartorLine, "mn : renameSdaiModel - (name) - Change name of this model.",
      "mr : startReadOnlyAccess - () - Start R/O acces. No changes will be available",
      "mw : startReadWriteAccess - () - Start R/W acces. Changes need to commit with transection", "me : endReadOnlyAccess - () - End R/O access.",
      "mf : endReadWriteAccess - ()- End R/W acces. Changes are discarded.", "mp : promoteSdaiModelToRW - () - Change access from R/O to R/W.",
      "mo : reduceSdaiModelToRO - () - Change access from R/W to R/O.", "md : deleteSdaiModel - () - Delete this model.",
      "mc : createEntityInstance - (@e | class_name) - Create entity instance.", "mi : getName.. - () - Show information about this model.",
      "ml : getPopulated_folders - () List populated entity extnends", sSepartorLine, };

  String[] asHelpExtent = { sHeadLine, sSepartorLine, sObjectLine, sSepartorLine, "xi : getDefinition - () - Show information about this Extend.",
      "xl : getInstances - () - List all entity instance in this extend", sSepartorLine, };

  String[] asHelpEntityDef = { sHeadLine, sSepartorLine, sObjectLine, sSepartorLine, "ei : getName - () - Print information about this entity definition.",
      "el : getExplicit_attributes -() - List attribute of this entity definition.", sSepartorLine, };

  String[] asHelpDefinedType = { sHeadLine, sSepartorLine, sObjectLine, sSepartorLine, "di : getName - () - Print information about this defined type.",
      sSepartorLine, };

  String[] asHelpEntity = { sHeadLine, sSepartorLine, sObjectLine, sSepartorLine, "ii : toString - () - Shows instance representation in phisical file.",
      ...
      "iu : prints all instance users. (Instance which have attribute set with this instance)", sSepartorLine, };

  String[] asHelpAttribute = { sHeadLine, sSepartorLine, sObjectLine, sSepartorLine, "ai : getName - () - Shows attribute information.",
      ...
      "ac : createAggregate - (@i) - Create aggregate for attribute. Aplicable if attribute type is aggregate.", sSepartorLine, };

  String[] asHelpMapping = { sHeadLine, sSepartorLine, sObjectLine, sSepartorLine,
      ...
      "pk : findMappingInstances - (@i, @n, @n) - Returns instances on which can be used this entity mapping.", sSepartorLine, };

  String[] asHelpAggregate = { sHeadLine, sSepartorLine, sObjectLine, sSepartorLine, "gl : get... - () - List aggregate members.",
      ...
      "ac : createAggregate - () - Create aggregate for element. Aplicable if element type is aggregate. Index must be specified, see b.", sSepartorLine, };

  String[] asHelpMember = { sHeadLine, sSepartorLine, "b= : Chosing aggregate member by index. It will be used in aggregate operations.", sSepartorLine, };

  String[] asHelpSchemaDefinition = { sHeadLine, sSepartorLine, sObjectLine, sSepartorLine,
      "hi : getName - () - Shows information for this schema definition.",
      "hl : getDeclarations - () - List all entity_definitions and defined_types belonging to this schema.", sSepartorLine, };

  String[] asHelpSchemaInstance = { sHeadLine, sSepartorLine, sObjectLine, sSepartorLine, "ci : getName - () - Show information for this schema instance.",
      ...
      "cm : getDataMapping - () - Chosing standart mapping schema instance.", "cn : rename - (name) - Rename schema instance.",
      "ce : delete - () - Delete schema instance.", "ca : addSdaiModel - (@m) - Add model to schema.",
      "cr : removeSdaiModel - (@m) - Remove model from schema.", sSepartorLine, };

  String[] asHelpASchemaInstance = { sHeadLine, sSepartorLine, sObjectLine, sSepartorLine, "na : add - (@c) - Add SchemaInstance to this aggregate.",
      "nc : clear - () - Clear this aggregate.", "nl : get - () - List member schema instances of this aggregate.", sSepartorLine, };

  String[] asHelpCheck = { sHeadLine, sSepartorLine, ".c : Going to check mode where command .!, .* will be available.",
      ".n : Going to normal working mode.", ".! : Checking, will next command ganerate the same output, as it is.",
      ".* : Any output for next command will be correct.", ".i : Show current mode.", sSepartorLine, };

  String[] asHelpFile = { sHeadLine, sSepartorLine, "fo : Open given file by parameter and execute it interpreting by one line.", sSepartorLine, };

  String[] asHelp1 = { sHeadLine, sSepartorLine, "  There are stored some remarks which are important to understand base", "functionality of SdaiTerm.",
      sSepartorLine, "  If any command generate indexed list, this meen that following commands can",
      ...
      "possibility to use one index at time. For every object you can assign with", "simbol = from listing.", sSepartorLine,
      "  In the help you will see symbol @ sometimes passed as parameter. This meen",
      "that here you are using another commands from SdaiTerm following letter means", "which instance you must put there.", sSepartorLine,
      ...
      "by default it operate on 0. Some creating commands directly sore created object", "to 0, like rm, mc.", sSepartorLine,
      "  If you are specifying String which have space char you must place this String",
      "double quates \"string\". Also you cann't use double quates in any ather cases.", sSepartorLine,
      ...
      "-\"def\" meens default name or location. This parameter are used if nothing is", "specified.", sSepartorLine };
...
//					log("Create repository(\"" + tokens[1] + "\", \"" + tokens[2] + "\")");
                repositories[0] = session.createRepository(getRepoName(((tokens.length > 1) ? tokens[1] : "def")),
                    getRepoLocation(((tokens.length > 2) ? tokens[2] : "def")));
                break;
              case 'm':
//					log("Import clear text encoding(\"" + tokens[2] + "\", \"" + tokens[1] + "\", \"" + tokens[3] + "\")");
                repositories[0] = session.importClearTextEncoding(getRepoName(((tokens.length > 2) ? tokens[2] : "def")), tokens[1],
                    getRepoLocation(((tokens.length > 3) ? tokens[3] : "def")));
                break;
              case 'f':
                if (isNumber(tokens[1]) && (server != "")) {
                  ...
                  repositories[0] = session.linkRepository(getRepoName(((tokens.length > 1) ? tokens[1] : "def")),
                      getRepoLocation(((tokens.length > 2) ? tokens[2] : "def")));
                }
                break;
              case 'b':
          ...
          case 't': // Transaction
            switch (c2) {
              case 'i': // Transaction-Information
                if (transaction != null) {
          ...
          case 'r':
            ...
            switch (c2) {
              ...
              case 'i':
                ...
                listStrings("               description: ", "                          : ", repositories[ir].getDescription());
                out.println("                time_stamp: " + repositories[ir].getChangeDate());
                listStrings("                    author: ", "                          : ", repositories[ir].getAuthor());
                listStrings("              organization: ", "                          : ", repositories[ir].getOrganization());
...
//					models[im].renameSdaiModel(tokens[1]);
              ...
              case 'c':
                if (tokens[1] != null/* && !s1.isEmpty() */) {
                  if (!isCommand(tokens[1])) {
                    /*
                     * s = "jsdai.S" + sdaiName(models[im].getUnderlyingSchema().getName(null)) + ".C" +
                     * sdaiName(tokens[1]);
                     * clas = Class.forName(s);
                     * instances[0] = models[im].createEntityInstance(clas);
                     */
                    instances[0] = models[im].createEntityInstance(SimpleOperations.findEntity_definition(tokens[1],
                        models[im].getUnderlyingSchema()));
                  }
                  else {
              ...
              case 'i':
                ...
                out.println("         underlying_schema: " + models[im].getUnderlyingSchemaString());
                out.println("                repository: " + models[im].getRepository().getName());
                out.println("               change_date: " + models[im].getChangeDate());
          ...
          case 'p':
            ...
            switch (c2) {
              case 'a': { //findEntityMappings
                ...
                instances[ii].findEntityMappings(((ASchemaInstance) encodeToken(tokens[1])).getAssociatedModels(),
                    ((ASchemaInstance) encodeToken(tokens[2])).getAssociatedModels(), mappings, EEntity.NO_RESTRICTIONS);
              ...
              case 'b': { //testSourceEntity
                AEntity_mapping mappings = instances[ii].testMappedEntity((EEntity_definition) encodeToken(tokens[1]),
                    ((ASchemaInstance) encodeToken(tokens[2])).getAssociatedModels(),
                    ((ASchemaInstance) encodeToken(tokens[3])).getAssociatedModels(), EEntity.NO_RESTRICTIONS);
                if (mappings == null) {
              ...
              case 'c': { //testMappedEntity
                boolean result = instances[ii].testMappedEntity((EEntity_mapping) encodeToken(tokens[1]),
                    ((ASchemaInstance) encodeToken(tokens[2])).getAssociatedModels(),
                    ((ASchemaInstance) encodeToken(tokens[3])).getAssociatedModels(), EEntity.NO_RESTRICTIONS);
              ...
              case 'd': { //testSourceAttribute
                AGeneric_attribute_mapping mappings = instances[ii].testMappedAttribute((EAttribute) encodeToken(tokens[1]),
                    ((ASchemaInstance) encodeToken(tokens[2])).getAssociatedModels(),
                    ((ASchemaInstance) encodeToken(tokens[3])).getAssociatedModels(), EEntity.NO_RESTRICTIONS);
                SdaiIterator mappings_it = mappings.createIterator();
                while (mappings_it.next()) {
              ...
              case 'e': { //testMappedAttribute
                boolean result = instances[ii].testMappedAttribute((EAttribute_mapping) encodeToken(tokens[1]),
                    ((ASchemaInstance) encodeToken(tokens[2])).getAssociatedModels(),
                    ((ASchemaInstance) encodeToken(tokens[3])).getAssociatedModels(), EEntity.NO_RESTRICTIONS);
                out.println(String.valueOf(result));
                break;
              ...
              case 'f': { //getMappedAttribute
                Object result[] = instances[ii].getMappedAttribute((EAttribute) encodeToken(tokens[1]),
                    ((ASchemaInstance) encodeToken(tokens[2])).getAssociatedModels(),
                    ((ASchemaInstance) encodeToken(tokens[3])).getAssociatedModels(), EEntity.NO_RESTRICTIONS);
              ...
              case 'g': { //getMappedAttribute
                Object result = instances[ii].getMappedAttribute((EGeneric_attribute_mapping) encodeToken(tokens[1]),
                    ((ASchemaInstance) encodeToken(tokens[2])).getAssociatedModels(),
                    ((ASchemaInstance) encodeToken(tokens[3])).getAssociatedModels(), EEntity.NO_RESTRICTIONS);
                out.println(result);
                break;
              ...
              case 'i': { //findMappingInstances
                AEntity mappings = models[im].findMappingInstances((EEntity_definition) encodeToken(tokens[1]),
                    ((ASchemaInstance) encodeToken(tokens[2])).getAssociatedModels(),
                    ((ASchemaInstance) encodeToken(tokens[3])).getAssociatedModels(), EEntity.NO_RESTRICTIONS);
                SdaiIterator mappings_it = mappings.createIterator();
                while (mappings_it.next()) {
              ...
              case 'k': { //findMappingInstances
                AEntity mappings = models[im].findMappingInstances((EEntity_mapping) encodeToken(tokens[1]),
                    ((ASchemaInstance) encodeToken(tokens[2])).getAssociatedModels(),
                    ((ASchemaInstance) encodeToken(tokens[3])).getAssociatedModels(), EEntity.NO_RESTRICTIONS);
                SdaiIterator mappings_it = mappings.createIterator();
                while (mappings_it.next()) {
          ...
          case 'a':
            ...
            switch (c2) {
              ...
              case 'c':
                ...
                break;
              case 'i':
                out.println(attributes[ia].getName(null)
                    + ((tokens.length > 1) ? (" = " + value_attr(attributes[ia], (EEntity) encodeToken(tokens[1]), "", 0, "", null)) : ""));
                break;
              default:
                fError = true;
...
//working on supertypes
    if (def.getComplex(null)) {
      ...
      while (it_attributes.next()) {
        EAttribute attr = attributes.getCurrentMember(it_attributes);
        out.println("  " + attr_index + " " + attr.getName(null) + ((isValue) ? " = " + value_attr(attr, inst, "", 0, "", null) : ""));
        listing[attr_index] = attr;
        attr_index++;
      }
