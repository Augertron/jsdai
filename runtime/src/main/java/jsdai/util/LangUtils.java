...
/**
 * This class cannot be instantiated. It contains some utility functions to do some common operations with jsdai. They can be
 * groped into three groups:
 * <ul>
 * <li>Operations to work with aggregates
 * <ul>
 ...
 * </ul>
 * </li>
 * <li>Operations to work with SDAI dictionary (to find some data in SDAI dictionary).
 * <ul>
 ...
 * </ul>
 * </li>
 * <li>Mapping operations. They help to find some information about mapping constraints.
 * <ul>
...
public class LangUtils {
  /**
   * It checks does specified attribute have specified entity as a domain or as a nested domain (in the case of aggregates and
   * selects).
   *
   ...
   * @return
   */
  public static boolean hasAggregateInsideForEntityType(EAttribute attribute, EEntity_definition type) throws jsdai.lang.SdaiException {
    boolean rv = false;
  ...
  /**
   * It checks does specified domain has specified entity as base_type or as a nested domain (in the case of aggregates and
   * selects).
   *
   ...
   * @return
   */
  public static boolean hasEntityInsideAggregate(EEntity domain, EEntity_definition type, boolean firstLevel) throws jsdai.lang.SdaiException {
    boolean rv = false;
  ...
  /**
   * This method adds entity to attribute, which is of aggregate type. If attribute is not set it does not set it (or does not
   * create aggregate if entity must be set in nested aggregate).
   *
   * @param entity
   * @param value
   * @param attribute <p>
   * @return
   */
  public static boolean tryAddToAttributeAggregate(EEntity entity, EAttribute attribute, EEntity value) throws jsdai.lang.SdaiException {
    boolean rv = false;
    if (attribute instanceof EExplicit_attribute) {
   ...
   *
   * @param type . Its domain may be defined type (which domain at the end goes enumeration_type) or enumeration_type or
   *             aggregation_type.
   * @return enumeration type, or null if there was some problems.
   */
   ...
   *
   * @param type . Its element type may be defined_type (which domain at the end goes enumeration_type) or enumeration_type or
   *             aggregation_type.
   * @return
   */
   ...
   * @param value
   */
  public static void setAttribute(EEntity targetInstance, EAttribute la, Object value, EDefined_type[] types) throws SdaiException {
  ...
  /**
   * Add value to aggregate. It comes around lang but with add(Integer or Double) and diferences in adding elements to diferent
   * types of aggregates.
   *
   * @param aggregate aggregate to which value will be added
   * @param value     this value will be added to aggregate
   * @param types     clarification of types for selects only
   *                  <p>
   * @param index     index in aggregate where to add new value
   * @param useIndex  is there need to add using index, else value will be added at the end of aggregate
   */
  public static void addToAggregate(Aggregate aggregate, Object value, EDefined_type[] types, int index, boolean useIndex) throws SdaiException {
   ...
   * @return entity wiht the specified name. It returns null if it did not find entity with specified name.	 *          Note. This method works only in one model.
   */
  public static EEntity_definition findEntityDefinition(String entityName, ESchema_definition dictionarySchema) throws SdaiException {
   ...
   *
   * @param s        *        name of entity which will be searched in schema
   * @param entities definition list where to search
   *                 <p>
   * @return entity with the specified name. It returns null if it did not find entity with specified name. Note. This
   * method works only in one model.
   */
   ...
   * @return all entities visible in this schema. Entities are sorded in ascending order by their names ignoring cases.
   */
   ...
   * @return all named types visible in this schema.
   */
   ...
   * @return all defined types visible in this schema.
   */
   ...
   * @return attribute that is constraint.
   */
   ...
   * @return instance of schema definition. It returns null if it does not find instance of schema definition.
   */
   ...
   * @param sufix the sufix for model name
   *              <p>
   * @return with name (specified name + specified sufix). It returns null if it does not find model with such name.
   */
   ...
   *
   * @param name the name of the model without sufux
   * @return with name (specified name + dictionary sufix). It returns null if it does not find model with such name.
   */
   ...
   *
   * @param name the name of the model without sufux
   * @return with name (specified name + mapping sufix). It returns null if it does not find model with such name.
   */
  ...
  /**
   * Accepts mapping elements that may be as attribute for mapping constraints and returns enumeration type which is domain (may
   * be nested) of this attribute.
   *
   ...
   * @param schemaInstance <p>
   * @return enumeration type, or null if there was some problems.
   */
  public static jsdai.dictionary.EEnumeration_type getEnumerationTypeFromMappingAttribute(EEntity attribute, ASdaiModel schemaInstance) throws SdaiException {
   ...
   * @return enumeration type, or null if there was some problems.
   */
  public static jsdai.dictionary.EEnumeration_type getEnumerationTypeFromAggregateType(EAggregation_type type, ASdaiModel schemaInstance)
   ...
   *
   * @param attribute constraint that is checked
   *                  <p>
   * @return true if there is inverse constraint, false otherwise.
   */
   ...
   * @return
   */
  public static AEntity getInstancesOfEntity(SdaiModel model, jsdai.dictionary.EEntity_definition entity) throws SdaiException {
   ...
   * @return true if base is supertype of derived, false otherwise.
   */
   ...
   * @return Java array with elements for aggregate.
   */
   ...
   * @return Java array with elements for aggregate. Returned array is of specified type.
   */
  ...
  private static void removeDerivedAttribute(EDerived_attribute attribute, List v) throws SdaiException {
    if (attribute.testRedeclaring(null)) {
      EEntity redAttribute = attribute.getRedeclaring(null);
   ...
   * @param definedType <p>
   * @return
   * @deprecated Use convertEnumerationStringToInt(String, EDefined_type, SdaiContext) instead.
   */
   ...
   * @param definedType enumeration type where constant is defined
   * @param context     <p>
   * @return integer value that represent specified value. 0 if there is no element in enumeration with specified name.
   */
  public static int convertEnumerationStringToInt(String value, EDefined_type definedType, SdaiContext context) throws SdaiException {
   ...
   * @param type  <p>
   * @return
   * @deprecated Use convertEnumerationStringToInt(String, EEnumeration_type, SdaiContext) instead.
   */
   ...
   * @return integer value that represent specified value.	 *          0 if there is no element in enumeration with specified name.
   */
  public static int convertEnumerationStringToInt(String value, EEnumeration_type type, SdaiContext context) throws jsdai.lang.SdaiException {
  ...
  public static int convertEnumerationStringToInt(SdaiContext context, String value, EEnumeration_type type) throws SdaiException {
   ...
   * @return integer value that represent specified value. 0 if there is no element in enumeration with specified name.
   */
  public static String convertEnumerationIntToString(int value, EEnumeration_type type) throws jsdai.lang.SdaiException {
   ...
   * @return string without standard dictinary sufix. It returns the same string as parameter name if name does not have
   * standart sufix.
   */
   ...
   * @param repository <p>
   * @return model with name (specified name + specified sufix). It returns null if it does not find model with such
   * name.
   */
  ...
  /**
   * This method need to be enhanced to accept elements like and(c1, c2) and and(c2, c1) as equal.
   * The same is for "or".
   *
   * @param ea <p>
   * @return
  ...
  public static jsdai.lang.EEntity findSubstitute(jsdai.lang.EEntity ea) throws jsdai.lang.SdaiException {
    ...
    if (f) {
      ...
      entities = model.getEntityExtentInstances(ea.getClass());
    }
    i = entities.createIterator();
    while (i.next()) {
      rv = (jsdai.lang.EEntity) entities.getCurrentMemberObject(i);
      if (rv.compareValuesBoolean(ea) && (ea != rv)) {
...
//         }
   ...
   * @return
   */
  public static EExplicit_attribute findExplicitAttribute(EEntity_definition entity, String attribute) throws SdaiException {
  ...
  public static EEntity createInstanceIfNeeded(SdaiContext context, EEntity_definition instanceType, Attribute_and_value_structure[] structure)
      throws SdaiException {
  ...
  public static EEntity createInstanceIfNeeded(SdaiModel model, ASdaiModel domain, EEntity_definition instanceType, Attribute_and_value_structure[] structure)
      throws SdaiException {
    if (model == null) {
    ...
    if (instanceType == null) {
      throw new SdaiException(SdaiException.VA_NVLD, " type = NULL");
    }
    ...
    for (int i = 0; i < structure.length; i++) {
      ...
      throw new SdaiException(SdaiException.VA_NVLD, "Attribute " + structure[i].attribute + " not found in " + instanceType);
    }
...
//				System.err.println(entity+" is not suitable " + instanceType+" "+entity.isInstanceOf(instanceType));
      ...
      for (int k = 0; k < structure.length; k++) {
        ...
        if (entity.testAttribute(attributes.getByIndex(k + 1), types) != 0) {
          if (structure[k].value == null) {
            ...
            if (entity.get_boolean(attributes.getByIndex(k + 1)) != ((Boolean) (structure[k].value)).booleanValue()) {
              continue l1;
            }
          }
          else if (structure[k].value instanceof Double) {
            if (entity.get_double(attributes.getByIndex(k + 1)) != ((Double) (structure[k].value)).doubleValue()) {
              continue l1;
            }
          }
          else if (structure[k].value instanceof Integer) {
            if (entity.get_int(attributes.getByIndex(k + 1)) != ((Integer) (structure[k].value)).intValue()) {
              continue l1;
            }
          }
          else {
            ...
            if (obj instanceof AEntity) {
              ...
              if (agg.getMemberCount() == 1) {
                ...
                else if ((structure[k].value instanceof Boolean) || (structure[k].value instanceof Double)
                    || (structure[k].value instanceof Integer)) {
                  throw new SdaiException(SdaiException.FN_NAVL,
                      "Unsupported case - when value is of type other than entity and attribute is aggregate" + structure[k].value);
                }
              }
   ...
   * @deprecated
   */
  public static EDefined_type getDefinedTypeOfSchema(ESchema_definition schema, String defined_typeName) throws SdaiException {
...
//      return dt;
  ...
  public static void setSimpleAttributes(EEntity mainInstance, EEntity_definition exactAIMType, EEntity armInstance, SdaiContext context,
      EAttribute[] attributePairs) throws SdaiException {
    setSimpleAttributes((EMappedARMEntity) mainInstance, exactAIMType, null, (EMappedARMEntity) armInstance, context, attributePairs);
  }
   ...
   * @param armInstance
   */
  public static void setSimpleAttributes(EMappedARMEntity mainInstance, EEntity_definition exactAIMType, EEntity attributesInstance,
      EMappedARMEntity armInstance, SdaiContext context, EAttribute[] attributePairs) throws SdaiException {
    ...
    for (int i = 0; i < attributePairs.length; i += 2) {
      ...
      if (exactAIMType == null) {
        ...
        if (aimAttribute == null) {
          throw new SdaiException(SdaiException.VA_NVLD, " attribute " + exactAIMType.getName(null) + "." + attributePairs[i]
              + " not found in schema ");
        }
      }
  ...
  public static void setSimpleAttribute(EEntity armInstance, EEntity attributesInstance, EAttribute aimAttribute, EAttribute armAttribute, SdaiContext context)
      throws SdaiException {
  ...
  public static void setSimpleAttribute(EEntity armInstance, EEntity attributesInstance, EAttribute aimAttribute, EAttribute armAttribute,
      SdaiContext context, EDefined_type[] types) throws SdaiException {
    if (attributesInstance == null) {
    ...
    switch (type) {
      ...
      case 1: {
        ...
        if ((value instanceof AEntity) && !(aimAttributeDomain instanceof EAggregation_type)) {
        ...
        if (value instanceof String) {
          ...
          if (aimAttributeDomain instanceof EAggregation_type) {
            ((CMappedARMEntity) armInstance).addAggregateItemSimple(attributesInstance, (EExplicit_attribute) aimAttribute, aimSubInstance, true, 1);
          }
          else {
          ...
          throw new SdaiException(SdaiException.FN_NAVL, " type " + value + " is not supported for automatic setting ");
        }
        break;
      }
      // For integer
  ...
  public static boolean deleteInstanceIfUsageCountLessThan(ASdaiModel domain, EEntity instance, int count) throws SdaiException {
   ...
   * @throws SdaiException
   */
  public static boolean deleteInstanceIfUnusedRecursive(ASdaiModel domain, EEntity instance) throws SdaiException {
    AEntity result = new AEntity();
    instance.findEntityInstanceUsers(domain, result);
  ...
  public static Set<EAttribute> findAttributes(EEntity_definition def, Set rdAttrSet) throws SdaiException {
    Set<EAttribute> attrSet = new HashSet<EAttribute>();
    if (rdAttrSet == null) {
  ...
  public static void findRelated(AEntity aggr, EEntity ent) throws SdaiException {
