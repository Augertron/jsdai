...
public class Debug {
  ...
  /**
   * Output stram where to write error messages. Default value is System.err. Note. Changing this value will not change output
   * of stack trace.
   */
  ...
  static {
    try {
      ...
      if (debugPropertiesStream != null) {
        ...
        if (output == null || (!output.equalsIgnoreCase("yes") && !output.equalsIgnoreCase("true"))) {
          debugOutput = false;
        }
      }
    }
