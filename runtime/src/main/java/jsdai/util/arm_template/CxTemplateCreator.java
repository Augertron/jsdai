...
/**
 * <p>
 * Class to create CxXXX template classes from CXXX class.
 * </p>
...
public class CxTemplateCreator {
  ...
  public static void main(String[] args) throws IOException, SdaiException, ClassNotFoundException {
    ...
    if ((args == null) || (args.length < 1)) {
      ...
      System.out
          .println(
              "\tFirst parameter mapping file name or reference to folder which contains files with mapping data (example1: clause5-1.path example2: c:/mappingDir)");
  ...
  protected static void createTemplate(String entityNameString, ESchema_definition dictionarySchema) throws SdaiException, IOException {
    ...
    if (definition == null) {
      throw new SdaiException(SdaiException.VA_NVLD, entityNameString + " definition not found");
    }
  ...
  protected static void createRemoveMethod(EEntity_definition definition, PrintWriter out) throws SdaiException {
    ...
    out.println("\t" + "\t" + targetPackageName + "E" + getNameWithFirstUpper(target) + " aimEntity = (" + targetPackageName + "E"
        + getNameWithFirstUpper(target) + ") getAimInstance();");
   ...
   * @throws SdaiException
   */
  protected static void createSetMethodReferences(EEntity_definition entityDefinition, EEntity_definition topEntityDefinition, PrintWriter out)
      throws SdaiException {
   ...
   * @throws SdaiException
   */
  protected static void createUnsetMethodReferences(EEntity_definition entityDefinition, EEntity_definition topEntityDefinition, PrintWriter out)
      throws SdaiException {
    AEntity_definition directSupertypes = entityDefinition.getSupertypes(null);
    String tabs = "\t\t";
  ...
  public static void createSetMappingConstraintsStub(EEntity_definition entityDefinition, PrintWriter out, String tabs) throws SdaiException {
    ...
    AEntity_definition directSupertypes = entityDefinition.getSupertypes(null);
    for (int i = 1; i <= directSupertypes.getMemberCount(); i++) {
      out.println(tabs + "\t" + "Cx" + getNameWithFirstUpper(directSupertypes.getByIndex(i).getName(null))
          + ".setMappingConstraints(context, armEntity);");
    }
    //mapping target detection
    ...
    //mapping target and attribute processing
    out.println(tabs + "\t" + targetPackageName + "E" + getNameWithFirstUpper(target) + " aimEntity = (" + targetPackageName + "E"
        + getNameWithFirstUpper(target) + ") armEntity.getAimInstance();");
   ...
   * @throws SdaiException
   */
  public static void createAttributeSetterStub(EEntity_definition entityDefinition, EEntity_definition topEntityDefinition, EAttribute attribute,
      PrintWriter out, String tabs) throws SdaiException {
   ...
   * @throws SdaiException
   */
  public static void createAttributeUnsetterStub(EEntity_definition entityDefinition, EEntity_definition topEntityDefinition, EAttribute attribute,
      PrintWriter out, String tabs) throws SdaiException {
    String aNameWithFirstUpper = getNameWithFirstUpper(attribute.getName(null));
