...
/**
 * <p>
 * Processes mapping data file to get mapping data for entity attributes.
 * </p>
...
public class MappingProcessor {
  ...
  /**
   * Initializes processor with new data file. Must be at least once called before data request.
   *
   * @param readers array of Reader instances which used to read mapping data.
   *                <p>
   * @throws IOException
   */
