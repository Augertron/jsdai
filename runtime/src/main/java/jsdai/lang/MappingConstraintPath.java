...
public interface MappingConstraintPath {
  ...
  /**
   * Makes a step in resolving the result of {@link EEntity#findMappedUsers} result in a forward direction.
   *
  ...
  /**
   * Makes a step in resolving the result of {@link EEntity#findMappedUsers} result in a backward direction.
   *
   * @param mappingContext <code>ObjectMapping</code> as this operation context
   * @param instances      input and output instance set to work with
   * @throws SdaiException if an error occurs
