...
public interface QueryResultSet {
   ...
   * on the result set after it was closed other than <code>close</code> may give unpredictable result. This method does not
   * have to be
   ...
   * value in an efficient way. It implements interface <code>SerializableRef</code> therefore objects of class can
  ...
  public static class ItemStruct implements SerializableRef {
     ...
     * The following fields are filled in it: <code>repositoryId</code>, <code>modelId</code>, <code>persistentLabel</code>
     * and <code>typeIndex</code>.
     ...
     * It can be one of: <code>TYPE_ENTITY</code>, <code>TYPE_NUMERIC</code> or <code>TYPE_STRING</code>
     */
    ...
    /**
     * Not implemented method of <code>SerializableRef</code> because this structure can not contain this type of information.
     *
     * @return -1
     */
