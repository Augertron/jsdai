 ...
 * <ul>
 * <li>Express environment for expressions. The instance of SdaiContext class is the first parameter in the methods that
 * correspond to express functions, procedures, rules and derived attributes.</li>
 * <li>Execution context for some mapping read or write operations</li>
 * <li>Execution context for Express-X operations</li>
 * <li>Schema information for extensible selects, extensible enumerations, and population dependent bounds</li>
 * </ul>
 *
