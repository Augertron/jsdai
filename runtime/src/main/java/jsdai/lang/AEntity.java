...
public class AEntity extends CAggregate {
  ...
  /**
   * Constructs a new object of aggregate <code>AEntity</code> without aggregation type. The aggregates of such kind are used
  ...
  /**
   * Constructs a new object linked to the session of aggregate <code>AEntity</code> without aggregation type. The aggregates
...
//	}
  ...
  /**
   * It is a specialization of {@link Aggregate#setByIndex(int, Object, EDefined_type []) setByIndex(int, Object, EDefined_type
...
//	}
  ...
  /**
   * It is a specialization of {@link Aggregate#addByIndex(int, Object, EDefined_type []) addByIndex(int, Object, EDefined_type
   * [])} method - the second parameter is of type <code>EEntity</code> and the third parameter is dropped.
   *
   * @param index
   * @param value
...
//	}
  ...
  /**
   * It is a specialization of {@link Aggregate#addUnordered(Object, EDefined_type []) addUnordered(Object, EDefined_type [])}
...
//	}
  ...
  /**
   * It is a specialization of {@link Aggregate#setCurrentMember(SdaiIterator, Object, EDefined_type [])
   * setCurrentMember(SdaiIterator, Object, EDefined_type [])} method - the second parameter is of type <code>EEntity</code> and
   * the third parameter is dropped.
   *
   * @param it
   * @param value
   */
...
//	}
  ...
  /**
   * It is a specialization of {@link Aggregate#addBefore(SdaiIterator, Object, EDefined_type []) addBefore(SdaiIterator,
...
//	}
  ...
  /**
   * It is a specialization of {@link Aggregate#addAfter(SdaiIterator, Object, EDefined_type []) addAfter(SdaiIterator, Object,
...
//	}
   ...
   * is invoked in <code>getInstancesInternal2</code> in class <code>SdaiModel</code>.
   */
   ...
   * Instances that satisfies mapping constraints must be in this aggregate of instances, but other instances required by
   * mapping constraints may be in other models within given data domain.
   ...
   *    AEntity instances = ae.findMappingInstances(sourceEntity, targetDomain, mappingDomain, EEntity.NO_RESTRICTIONS);</pre>
   * <p>
   ...
   * @param mode          {@link EEntity#NO_RESTRICTIONS} - no restrictions, {@link EEntity#MOST_SPECIFC_ENTITY} - returned mappings are
   *                      restricted to most specific, {@link EEntity#MANDATORY_ATTRIBUTES_SET} - in addition to MOST_SPECIFIC_ENTITY it also
   *                      requires, that all explicit mandatory attributes are set.
   ...
   * Instances that satisfy mapping constraints must be in supplied this aggregate of instances, but other instances required by
   * mapping constraints may be in other models within data domain.
   * <p>
   * <B>Example:</B>
   * <p>
   * <pre>    AEntity ae = ...;
   ...
   * @see <a href="package-summary.html#MappingExtension">JSDAI Mapping Extension</a>
   */
  public AEntity_mapping findMostSpecificMappings(ASdaiModel dataDomain, ASdaiModel mappingDomain, AEntity_mapping baseMappings, int mode)
  ...
  public SerializableRef getQuerySourceInstanceRef() throws SdaiException {
    ...
    while (instanceIter.next()) {
      ...
      if (instModRemote != null) {
        instanceRefs[instanceRefsIdx++] = new EEntityRef(instModRemote.getRemoteRepository().getRemoteId(), instModRemote.getRemoteId(),
