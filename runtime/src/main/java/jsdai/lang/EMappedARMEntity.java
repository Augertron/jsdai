...
public interface EMappedARMEntity extends EEntity {
   ...
   *                of <code>SdaiContext</code> have to be set: <code>domain</code>, <code>mappingDomain</code>, and
   *                <code>working_model</code>
   * @throws SdaiException if an error occurs during AIM data creation
   ...
   *                of <code>SdaiContext</code> have to be set: <code>domain</code>, <code>mappingDomain</code>, and
   *                <code>working_model</code>
   * @throws SdaiException if an error occurs during removal of AIM data
   *                       or in underlying JSDAI operations
   * @see <a href="package-summary.html#MappingExtension">JSDAI Mapping Extension</a>
   */
   ...
   *
   * @param context       The context of this operation. The following fields
   *                      of <code>SdaiContext</code> have to be set: <code>domain</code>, <code>mappingDomain</code>,
   *                      <code>working_model</code>, and <code>mappedWorkingModel</code>
   * @param attribute     The attribute to assign value to
   * @param attrValue     The attribute value. This can be one of:
   *                      <ul>
   *                      <li>object corresponding simple type;</li>
   *                      <li><code>EEntity</code> for entity instances;</li>
   *                      <li>either <code>AEntity</code> or {@link java.util.Collection} for aggregates</li>
   *                      </ul>
   ...
   * @throws SdaiException if an error occurs during attribute assignment
   ...
   *
   * @param context   The context of this operation. The following fields
   *                  of <code>SdaiContext</code> have to be set: <code>mappedWorkingModel</code>
   * @param attribute The attribute to assign value to
   * @param attrValue The attribute value. This can be one of:
   *                  <ul>
   *                  <li>object corresponding simple type;</li>
   ...
   * attribute values to be applied. An <code>SdaiException</code> is thrown if this instance is in ATTRIBUTES_MODIFIED state.
   ...
   * The instance is in this state when the instance is returned from {@link EEntity#buildMappedInstance} method.
   */
   ...
   *
   * @param context The context of this operation. The following fields
   *                of <code>SdaiContext</code> have to be set: <code>domain</code> and <code>mappingDomain</code>,
   ...
   *
   * @param context  The context of this operation. The following fields
   *                 of <code>SdaiContext</code> have to be set: <code>mappingDomain</code>,
