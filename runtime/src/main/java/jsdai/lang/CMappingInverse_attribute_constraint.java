...
public class CMappingInverse_attribute_constraint extends CConstraint implements MappingConstraintPath, MappingConstraintMatcher {
  ...
  public void mapUsersForward(ObjectMapping mappingContext, Set instances) throws SdaiException {
    ...
    ((MappingConstraintPath) selfInterface.getInverted_attribute(null)).mapUsersBackward(mappingContext, instances);
  }

  public void mapUsersBackward(ObjectMapping mappingContext, Set instances) throws SdaiException {
    throw new SdaiException(SdaiException.FN_NAVL, "Inverse constraint can not be inside of another inverse constraint: " + this);
  }
  ...
  public MatcherInstances findForward(MappingContext mappingContext, MatcherInstances instances, boolean decCacheUseCnt) throws SdaiException {
    ...
    if (outInstances != null) {
      ...
      outInstances = ((MappingConstraintMatcher) selfInterface.getInverted_attribute(null)).findBackward(mappingContext,
          instances.dup(null, MatcherInstances.STATUS_BACKWARD), false);

      mappingContext.setCacheInstances(this, instances, outInstances, decCacheUseCnt, new EEntity[] { selfInterface.getInverted_attribute(null) });
      return outInstances;
    }
  }
  ...
  public MatcherInstances findPathForward(MappingContext mappingContext, MatcherInstances instances, boolean decCacheUseCnt) throws SdaiException {
    ...
    if (outInstances != null) {
      ...
      outInstances = ((MappingConstraintMatcher) selfInterface.getInverted_attribute(null)).findPathBackward(mappingContext,
