...
public class A_binary extends CAggregate {
   ...
   * the first parameter is of type Binary and the second parameter is dropped.
   *
   * @param value
   * @return
   */
...
//		} // syncObject
   ...
   * setCurrentMember(SdaiIterator, Object, EDefined_type [])} method - the second parameter is of type Binary and the third
...
//		} // syncObject
   ...
   * Object, EDefined_type [])} method - the second parameter is of type Binary and the third parameter is dropped.
   *
   * @param iter
   * @param value
   */
...
//		} // syncObject
   ...
   * EDefined_type [])} method - the second parameter is of type Binary and the third parameter is dropped.
   *
   * @param iter
   * @param value
   */
