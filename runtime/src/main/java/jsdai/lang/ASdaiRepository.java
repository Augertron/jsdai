...
public class ASdaiRepository extends SessionAggregate {
  ...
  /**
   * Constructs a new object of aggregate <code>ASdaiRepository</code> without aggregation type. The aggregates of such kind are
   * used
   ...
   * the first parameter is of type <code>SdaiRepository</code> and the
   ...
   * [])} method - the second parameter is of type <code>SdaiRepository</code> and the third parameter is dropped.
   *
   * @param index
   * @param value
   * @since 4.1.0
   ...
   * <B>Example:</B>
   * <p>
   * <pre>    ASdaiRepository repo_aggr = ...;
   *    System.out.println(repo_aggr);</pre> &nbsp;&nbsp;&nbsp;&nbsp;The string printed will be like this:
   *
   * <pre>
