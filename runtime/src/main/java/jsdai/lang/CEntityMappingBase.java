...
public abstract class CEntityMappingBase extends CEntity implements MappingConstraintMatcher {
  ...
  void collectStrongAttributes() throws SdaiException {
    if (!strongAttributesCollected) {
      ...
      CGeneric_attribute_mapping.usedinParent_entity(null, (EEntity_mapping) this, null, attributeMappings);
      SdaiIterator attributeMappingIter = attributeMappings.createIterator();
      while (attributeMappingIter.next()) {
        EGeneric_attribute_mapping attributeMapping = attributeMappings.getCurrentMember(attributeMappingIter);
        if (attributeMapping.getStrong(null)) {
          if (strongAttributes == null) {
            strongAttributes = new HashMap();
          }
  ...
  void findSubtypeMappings(ASdaiModel mappingDomain) throws SdaiException {
    if (armSubtypeLevels == null) {
      ...
      armSubtypeLevelSize = findSubtypeMappings(selfInterface.getSource(null), mappingDomain, armSubtypeLevelsIter, null, selfInterface.getTarget(null),
          0);
    }
  }

  private static int findSubtypeMappings(EEntity_definition armEntity, ASdaiModel mappingDomain, ListIterator subtypeLevelsIter, SubtypeNode parentNode,
    ...
    if (armSubtypes.getMemberCount() > 0) {
      ...
      while (armSubtypeIter.next()) {
        ...
        nextNodeIndex = findSubtypeMappings(armSubtype, mappingDomain, subtypeLevelsIter, newNode, aimEntity, nextNodeIndex);
        ...
        if (armSubtype.getInstantiable(null)) {
          ...
          while (oneSubtypeMappingIter.next()) {
            EEntity_mapping oneSubtypeMapping = oneSubtypeMappings.getCurrentMember(oneSubtypeMappingIter);
  ...
  private static boolean isMappingEqualEntity(EEntity_definition entityDefinition, EEntity_definition testEntityDefinition) throws SdaiException {
  ...
  public MatcherInstances findForward(MappingContext mappingContext, MatcherInstances instances, boolean decCacheUseCnt) throws SdaiException {
    try {
      MappingMatcherInstances mappingInstances = mappingContext.getCacheMappingInstances(this, instances);
      if (mappingInstances != null) {
        ...
        Set preprocessedInstances = mappingContext.creator.preprocessTargetInstances(selfInterface);
        if (preprocessedInstances != null) {
          Map preprocessedInstanceMap = new FixedValueMap(preprocessedInstances, NON_PATH_VALUE);
          outInstances = new MatcherInstances(preprocessedInstanceMap, MatcherInstances.STATUS_FORWARD);
          mappingContext.setPersistentCacheInstances(this, instances, outInstances);
          return outInstances;
        }
        ...
        MatcherInstances attributeStartInstances = mappingContext.newAllInstances(MatcherInstances.STATUS_PATH_FORWARD);
        MatcherInstances entityStartInstances = mappingContext.newAllInstances(MatcherInstances.STATUS_FORWARD);

        if (selfInterface.testConstraints(null)) {
          outInstances = ((MappingConstraintMatcher) selfInterface.getConstraints(null)).findForward(mappingContext, entityStartInstances, true)
            ...
            try {
              ...
              while (strongAttrIter.hasNext()) {
                ...
                if (oneAttrIter.hasNext()) {
                  MatcherInstances strongInstances = ((MappingConstraintMatcher) oneAttrIter.next()).findPathForward(mappingContext,
                      attributeStartInstances, true);
                  while (oneAttrIter.hasNext()) {
                    MatcherInstances attributeInstances = ((MappingConstraintMatcher) oneAttrIter.next()).findPathForward(mappingContext,
                        attributeStartInstances, true);
        ...
        if (selfInterface.getStrong_users(null)) {
          ...
          MatcherInstances strongUserInstances = findAllUsers(selfInterface, mappingContext, attributeStartInstances, entityStartInstances, target,
              userAttrMappings, null);
        ...
        if (!outInstances.isEmpty()) {
          ...
          if (source.getInstantiable(null)) {
            ...
            while (armSubtypeLevelsIter.hasNext()) {
              ...
              while (levelSubtypeNodesIter.hasNext()) {
                ...
                while (mappingsIter.hasNext()) {
                  MatcherInstances subtypeInstances = ((MappingConstraintMatcher) mappingsIter.next()).findForward(mappingContext, instances,
                      false);
            ...
            if (mappingContext.preprocessInstances) {
              mappingContext.setPersistentCacheInstances(this, instances, new MappingPreInstances(outInstances, concreteInstances));
            }
            else {
            ...
            while (armSubtypeLevelsIter.hasNext()) {
              ...
              while (levelSubtypeNodesIter.hasNext()) {
                ...
                Iterator mappingsIter = subtypeNode.mappings.iterator();
                while (mappingsIter.hasNext()) {
                  ((MappingConstraintMatcher) mappingsIter.next()).findForward(mappingContext, instances, false);
                }
              }
            }
      ...
      SdaiException wrapper = new SdaiException(e.getErrorId(), e, ((EEntity) this).getPersistentLabel());
      wrapper.initCause(e);
      throw wrapper;
    }
      ...
      if (cause instanceof SdaiException) {
        ...
        throw (SdaiException) new SdaiException(sdaiCause.getErrorId(), sdaiCause, ((EEntity) this).getPersistentLabel()).initCause(sdaiCause);
      }
      else {
        throw (SdaiException) new SdaiException(SdaiException.SY_ERR, e.toString(), ((EEntity) this).getPersistentLabel()).initCause(e);
      }
    }
  }
  ...
  public MatcherInstances findBackward(MappingContext mappingContext, MatcherInstances instances, boolean decCacheUseCnt) throws SdaiException {
    throw new SdaiException(SdaiException.FN_NAVL, "This constraint can not be called as part of backward references");
  }
  ...
  public MatcherInstances findPathForward(MappingContext mappingContext, MatcherInstances instances, boolean decCacheUseCnt) throws SdaiException {
    throw new SdaiException(SdaiException.FN_NAVL, "This constraint can not be called as part of path forward references");
  }
  ...
  public EEntity[] findDependentInstances() throws SdaiException {
    throw new SdaiException(SdaiException.FN_NAVL, "This constraint can not be called as part of path forward references: " + this);
  }
  ...
  public MatcherInstances findPathBackward(MappingContext mappingContext, MatcherInstances instances, boolean decCacheUseCnt) throws SdaiException {
    throw new SdaiException(SdaiException.FN_NAVL, "This constraint can not be called as part of path backward references");
  }

  private static MatcherInstances findAllUsers(EEntity_mapping entityMapping, MappingContext mappingContext, MatcherInstances attributeStartInstances,
      MatcherInstances entityStartInstances, EEntity_definition target, AAttribute_mapping userAttrMappings, MatcherInstances strongUserInstances)
      throws SdaiException {

    userAttrMappings.clear();
    CAttribute_mapping.usedinDomain(null, entityMapping, mappingContext.context.mappingDomain, userAttrMappings);
    SdaiIterator userAttrMappingIter = userAttrMappings.createIterator();
    while (userAttrMappingIter.next()) {
      EAttribute_mapping userAttrMapping = userAttrMappings.getCurrentMember(userAttrMappingIter);
      MatcherInstances entityInstances = ((MappingConstraintMatcher) userAttrMapping.getParent_entity(null)).findForward(mappingContext,
          entityStartInstances, true);
      if (!entityInstances.instances.isEmpty()) {
        MatcherInstances attributeInstances = ((MappingConstraintMatcher) userAttrMapping).findPathForward(mappingContext, attributeStartInstances,
            true).intersect(entityInstances);
        strongUserInstances = strongUserInstances == null ? attributeInstances : strongUserInstances.union(attributeInstances);
      }
    }
    ...
    while (supertypeIter.next()) {
      ...
      CEntity_mapping.usedinSource(null, supertype, mappingContext.context.mappingDomain, supertypeMappings);
      SdaiIterator supertypeMappingIter = supertypeMappings.createIterator();
      while (supertypeMappingIter.next()) {
        EEntity_mapping supertypeMapping = supertypeMappings.getCurrentMember(supertypeMappingIter);
        ...
        if (supertypeTarget == target || target.isSubtypeOf((CEntityDefinition) supertypeTarget)) {
          strongUserInstances = findAllUsers(supertypeMapping, mappingContext, attributeStartInstances, entityStartInstances, target,
  ...
  private void callAttrCreators(MappingContext mappingContext, MatcherInstances concreteInstances) throws SdaiException {
    if (!concreteInstances.isEmpty()) {
      ...
      CGeneric_attribute_mapping.usedinParent_entity(null, selfInterface, mappingContext.context.mappingDomain, attributeMappings);
      if (attributeMappings.getMemberCount() > 0) {
        SdaiIterator attributeMappingIter = attributeMappings.createIterator();
        while (attributeMappingIter.next()) {
          Object attributeMapping = attributeMappings.getCurrentMemberObject(attributeMappingIter);
          MatcherInstances attributeInstances = ((MappingConstraintMatcher) attributeMapping).findPathForward(mappingContext,
              attributeStartInstances, true);
          mappingList.add(attributeMapping);
          Map attributeInstanceMap = attributeInstances.getInstanceMap();
          if (!mappingContext.interleavedCreation && attributeInstanceMap instanceof AEntityMap) {
  ...
  private void releaseAttrConstraints(MappingContext mappingContext) throws SdaiException {
    ...
    for (SdaiIterator i = attributeMappings.createIterator(); i.next(); ) {
      EGeneric_attribute_mapping genAttributeMapping = (EGeneric_attribute_mapping) attributeMappings.getCurrentMemberEntity(i);
      ...
      if (!asStrongUser && genAttributeMapping.testConstraints(null) && mappingContext.getCacheInstances(genAttributeMapping) == null) {
  ...
  static final class SubtypeNode {
    ...
    public String toString() {
      return "(parent: " + parent + ", mappings: " + mappings + ", index: " + index + ")@" + System.identityHashCode(this) + "\n";
    }
  }
}
