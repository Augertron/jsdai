...
public class CMappingAttribute_value_constraint extends CConstraint_attribute implements MappingConstraintMatcher {
  ...
  public MatcherInstances findForward(MappingContext mappingContext, MatcherInstances instances, boolean decCacheUseCnt) throws SdaiException {
    ...
    if (outInstances != null) {
      ...
      MappingConstraintMatcher attrMatcher = (MappingConstraintMatcher) selfInterface.getAttribute(null);
