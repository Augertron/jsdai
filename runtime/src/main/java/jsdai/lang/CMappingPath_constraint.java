...
public class CMappingPath_constraint extends CConstraint_relationship implements MappingConstraintPath, MappingConstraintMatcher {
  ...
  public void mapUsersForward(ObjectMapping mappingContext, Set instances) throws SdaiException {
    ...
    if (value != null) {
      ...
      ((MappingConstraintPath) selfInterface.getElement2(null)).mapUsersForward(mappingContext, instances);
  ...
  public void mapUsersBackward(ObjectMapping mappingContext, Set instances) throws SdaiException {
    throw new SdaiException(SdaiException.FN_NAVL, "Path constraint can not be called as part of backward references");
  }
  ...
  public MatcherInstances findForward(MappingContext mappingContext, MatcherInstances instances, boolean decCacheUseCnt) throws SdaiException {
    ...
    if (outInstances != null) {
      ...
      EPath_constraint selfInterface = (EPath_constraint) this;
      outInstances = ((MappingConstraintMatcher) selfInterface.getElement2(null)).findForward(mappingContext, instances, false);
      outInstances = ((MappingConstraintMatcher) selfInterface.getElement1(null)).findForward(mappingContext, outInstances, false);
  ...
  public MatcherInstances findPathForward(MappingContext mappingContext, MatcherInstances instances, boolean decCacheUseCnt) throws SdaiException {
    ...
    if (outInstances != null) {
      ...
      EPath_constraint selfInterface = (EPath_constraint) this;
      outInstances = ((MappingConstraintMatcher) selfInterface.getElement2(null)).findPathForward(mappingContext, instances, false);
      outInstances = ((MappingConstraintMatcher) selfInterface.getElement1(null)).findPathForward(mappingContext, outInstances, false);
      mappingContext.setCacheInstances(this, instances, outInstances, decCacheUseCnt,
          new EEntity[] { selfInterface.getElement1(null), selfInterface.getElement2(null) });
      return outInstances;
    }
