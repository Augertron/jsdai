 ...
 */
public class Aa_boolean extends CAggregate {

  Aa_boolean() {
    super();
  }

  Aa_boolean(EAggregation_type provided_type, CEntity instance) {
   ...
   * the first parameter is of type <code>A_boolean</code> and the second parameter is dropped.
   *
   * @param value
   * @return
   */
   ...
   * with return value of type <code>A_boolean</code> instead of <code>Object</code>.
   *
   * @param index
   * @return
   */
  public A_boolean getByIndex(int index) throws SdaiException {
    return (A_boolean) getByIndexObject(index);
  }
   ...
   * EDefined_type [])} method - the return value is of type <code>A_boolean</code> instead of <code>Object</code> and the
  ...
  public A_boolean createAggregateByIndex(int index) throws SdaiException {
    return (A_boolean) createAggregateByIndex(index, null);
  }
  ...
  public A_boolean addAggregateByIndex(int index) throws SdaiException {
    return (A_boolean) addAggregateByIndex(index, null);
  }
   ...
   * createAggregateUnordered(EDefined_type [])} method - the return value is of type <code>A_boolean</code> instead of
   * <code>Object</code> and the parameter is dropped.
   *
   * @return
   */
  public A_boolean createAggregateUnordered() throws SdaiException {
    return (A_boolean) createAggregateUnordered(null);
  }

  /**
   * It is a specialization of {@link Aggregate#removeUnordered(Object, EDefined_type []) removeUnordered(Object, EDefined_type
   * [])} method - the first parameter is of type <code>A_boolean</code> and the second parameter is dropped.
   *
   * @param value
   */
  ...
  public A_boolean getCurrentMember(SdaiIterator iter) throws SdaiException {
    return (A_boolean) getCurrentMemberObject(iter);
  }
   ...
   * createAggregateAsCurrentMember(SdaiIterator, EDefined_type [])} method - the return value is of type <code>A_boolean</code>
  ...
  public A_boolean createAggregateAsCurrentMember(SdaiIterator iter) throws SdaiException {
    return (A_boolean) createAggregateAsCurrentMember(iter, null);
  }
   ...
   * createAggregateBefore(SdaiIterator, EDefined_type [])} method - the return value is of type <code>A_boolean</code> instead
  ...
  public A_boolean createAggregateBefore(SdaiIterator iter) throws SdaiException {
    return (A_boolean) createAggregateBefore(iter, null);
  }
   ...
   * createAggregateAfter(SdaiIterator, EDefined_type [])} method - the return value is of type <code>A_boolean</code> instead
   * of <code>Object</code> and the second parameter is dropped.
   *
   * @param iter
   * @return
  ...
  public A_boolean createAggregateAfter(SdaiIterator iter) throws SdaiException {
    return (A_boolean) createAggregateAfter(iter, null);
  }
