...
public class A_enumeration extends A_integerPrimitive {
  ...
  /**
   * It is a specialization of {@link Aggregate#isMember(int, EDefined_type []) isMember(int, EDefined_type [])} method - the
...
//		} // syncObject
  ...
  /**
   * It is a specialization of {@link Aggregate#setByIndex(int, int, EDefined_type []) setByIndex(int, int, EDefined_type [])}
...
//		} // syncObject
  ...
  /**
   * It is a specialization of {@link Aggregate#addByIndex(int, int, EDefined_type []) addByIndex(int, int, EDefined_type [])}
   * method - the third parameter is dropped.
   *
   * @param index
   * @param value
...
//		} // syncObject
  ...
  public final void addByIndex(int index, int value, EDefined_type select[]) throws SdaiException {
...
//		} // syncObject
  ...
  /**
   * It is a specialization of {@link Aggregate#addUnordered(int, EDefined_type []) addUnordered(int, EDefined_type [])} method
...
//		} // syncObject
  ...
  /**
   * It is a specialization of {@link Aggregate#removeUnordered(int, EDefined_type []) removeUnordered(int, EDefined_type [])}
...
//		} // syncObject
  ...
  /**
   * It is a specialization of {@link Aggregate#setCurrentMember(SdaiIterator, int, EDefined_type [])
   * setCurrentMember(SdaiIterator, int, EDefined_type [])} method - the third parameter is dropped.
   *
   * @param iter
   * @param value
   */
...
//		} // syncObject
  ...
  public final void setCurrentMember(SdaiIterator iter, int value, EDefined_type select[]) throws SdaiException {
...
//		} // syncObject
  ...
  /**
   * It is a specialization of {@link Aggregate#addBefore(SdaiIterator, int, EDefined_type []) addBefore(SdaiIterator, int,
...
//		} // syncObject
  ...
  public final void addBefore(SdaiIterator iter, int value, EDefined_type select[]) throws SdaiException {
...
//		} // syncObject
  ...
  /**
   * It is a specialization of {@link Aggregate#addAfter(SdaiIterator, int, EDefined_type []) addAfter(SdaiIterator, int,
   * EDefined_type [])} method - the third parameter is dropped.
   *
   * @param iter
   * @param value
...
//		} // syncObject
  ...
  public final void addAfter(SdaiIterator iter, int value, EDefined_type select[]) throws SdaiException {
    addAfter(iter, value);
  }
