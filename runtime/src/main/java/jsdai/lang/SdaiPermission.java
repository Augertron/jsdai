...
/**
 * Enumeration class for representing access rights to remote <code>SdaiRepositories</code>, <code>SdaiModels</code> and
 * <code>SchemaInstances</code>. On JSDAI-DB access rights can
...
public class SdaiPermission implements Comparable {
  ...
  /**
   * Read and write permission as integer value. <code>WRITE_INT</code> is less than <code>ADMIN_INT</code> and greater than
   * <code>READ_INT</code>
   */
  ...
  /**
   * Read only permission as integer value. <code>READ_INT</code> is less than <code>WRITE_INT</code> and greater than
   * <code>NOACCESS_INT</code>
   */
  ...
  /**
   * No access permission as integer value. <code>NOACCESS_INT</code> is less than <code>READ_INT</code> and greater than
   * <code>HIDDEN_INT</code>
   */
  ...
  /**
   * No access permission as integer value. <code>HIDDEN_INT</code> is less than <code>NOACCESS_INT</code> and greater than
   * <code>HIDDEN_INT</code>
   */
  ...
  /**
   * Compares this object against the specified object. The result is <code>true</code> if and only if the argument is a
   * <code>SdaiPermission</code> and is of type equal to
   ...
   * The following is true for any returned object except DEFAULT: <code>getPermissionByType(type).getType() == type</code>. If
   * no <code>SdaiPermission</code> matches the specified integer value, DEFAULT is returned.
   *
