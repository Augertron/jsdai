...
public class JsdaiLangAccessor {
  ...
  static protected EExplicit_attribute[] getEntityExplicitAttributes(EEntity_definition definition) throws SdaiException {
  ...
  static protected EExplicit_attribute[] getExplicitAttributesByPartialEntities(EEntity_definition definition) throws SdaiException {
  ...
  static protected EEntity_definition findDictionaryEntityDefinition(SdaiModel modelDictionary, String entityName) throws SdaiException {
    if (modelDictionary.getMode() == SdaiModel.NO_ACCESS) {
      modelDictionary.startReadOnlyAccess();
    }
  ...
  static protected EEntity_definition findSchemaEntityDefinition(SdaiModel model, String entityName) throws SdaiException {
    return model.underlying_schema.getEntityDefinition(entityName);
  }

  static protected EEntity_definition findSchemaEntityDefinitionFast(SdaiModel model, String entityName) throws SdaiException {
    return ((SchemaDefinition) model.underlying_schema).getEntityDefinitionFast(entityName);
  }

  static protected EEntity_definition findSchemaEntityDefinition(ESchema_definition schema, String entityName) throws SdaiException {
    return schema.getEntityDefinition(entityName);
  }

  static protected EEntity_definition findSchemaEntityDefinitionFast(ESchema_definition schema, String entityName) throws SdaiException {
    return ((SchemaDefinition) schema).getEntityDefinitionFast(entityName);
  }

  static protected EDefined_type findSchemaDefinedType(SdaiModel model, String typeName) throws SdaiException {
    return model.underlying_schema.getDefinedType(typeName);
  }

  static protected EDefined_type findSchemaDefinedTypeFast(SdaiModel model, String typeName) throws SdaiException {
    return ((SchemaDefinition) model.underlying_schema).getDefinedTypeFast(typeName);
  }

  static protected EDefined_type findSchemaDefinedType(ESchema_definition schema, String typeName) throws SdaiException {
    return schema.getDefinedType(typeName);
  }

  static protected EDefined_type findSchemaDefinedTypeFast(ESchema_definition schema, String typeName) throws SdaiException {
    return ((SchemaDefinition) schema).getDefinedTypeFast(typeName);
  }

  static protected EAttribute findAttributeFast(EEntity_definition entityDef, String attrName) throws SdaiException {
  ...
  static protected EAttribute findAttribute(EEntity_definition entityDef, String attrName) throws SdaiException {
    EAttribute attr = findAttributeFast(entityDef, attrName);
    if (attr != null) {
      return attr;
    }
    else {
      throw new SdaiException(SdaiException.AT_NDEF, "Attribute " + entityDef.getName(null) + "." + attrName);
    }
  }

  static protected ASdaiModel getModels(SdaiRepository repo) throws SdaiException {
    return repo.models;
  }

  static protected ASchemaInstance getSchemaInstances(SdaiRepository repo) throws SdaiException {
    return repo.schemas;
  }
  ...
  static protected void setQueryLibProvider(SdaiTransaction transaction, QueryLibProvider queryLibProvider) {
  ...
  static protected SdaiModel getSchemaModelFromSystemRepository(String schemaName) throws SdaiException {
