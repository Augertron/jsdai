 ...
 * members of the EXPRESS type REAL. See <a href="Aggregate.html">Aggregate</a>
 * for detailed description of methods whose specializations are given here.
 */
public class Aaa_double extends CAggregate {

  Aaa_double() {
    super();
  }

  Aaa_double(EAggregation_type provided_type, CEntity instance) {
   ...
   * the first parameter is of type <code>Aa_double</code> and the second parameter is dropped.
   *
   * @param value
   * @return
   */
  public boolean isMember(Aa_double value) throws SdaiException {
   ...
   * with return value of type <code>Aa_double</code> instead of <code>Object</code>.
   *
   * @param index
   * @return
   */
  public Aa_double getByIndex(int index) throws SdaiException {
    return (Aa_double) getByIndexObject(index);
  }
   ...
   * EDefined_type [])} method - the return value is of type <code>Aa_double</code> instead of <code>Object</code> and the
   * second parameter is dropped.
   *
   * @param index
   * @return
   */
  public Aa_double createAggregateByIndex(int index) throws SdaiException {
    return (Aa_double) createAggregateByIndex(index, null);
  }
   ...
   * @return
   */
  public Aa_double addAggregateByIndex(int index) throws SdaiException {
    return (Aa_double) addAggregateByIndex(index, null);
  }
   ...
   * createAggregateUnordered(EDefined_type [])} method - the return value is of type <code>Aa_double</code> instead of
   * <code>Object</code> and the parameter is dropped.
   *
   * @return
   */
  public Aa_double createAggregateUnordered() throws SdaiException {
    return (Aa_double) createAggregateUnordered(null);
  }

  /**
   * It is a specialization of {@link Aggregate#removeUnordered(Object, EDefined_type []) removeUnordered(Object, EDefined_type
   * [])} method - the first parameter is of type <code>Aa_double</code> and the second parameter is dropped.
   *
   * @param value
   */
  public void removeUnordered(Aa_double value) throws SdaiException {
   ...
   * @return
   */
  public Aa_double getCurrentMember(SdaiIterator iter) throws SdaiException {
    return (Aa_double) getCurrentMemberObject(iter);
  }
   ...
   * createAggregateAsCurrentMember(SdaiIterator, EDefined_type [])} method - the return value is of type <code>Aa_double</code>
   * instead of <code>Object</code> and the second parameter is dropped.
   *
   * @param iter
   * @return
   */
  public Aa_double createAggregateAsCurrentMember(SdaiIterator iter) throws SdaiException {
    return (Aa_double) createAggregateAsCurrentMember(iter, null);
  }
   ...
   * createAggregateBefore(SdaiIterator, EDefined_type [])} method - the return value is of type <code>Aa_double</code> instead
   * of <code>Object</code> and the second parameter is dropped.
   *
   * @param iter
   * @return
   */
  public Aa_double createAggregateBefore(SdaiIterator iter) throws SdaiException {
    return (Aa_double) createAggregateBefore(iter, null);
  }
   ...
   * createAggregateAfter(SdaiIterator, EDefined_type [])} method - the return value is of type <code>Aa_double</code> instead
   * of <code>Object</code> and the second parameter is dropped.
   *
   * @param iter
   * @return
   */
  public Aa_double createAggregateAfter(SdaiIterator iter) throws SdaiException {
    return (Aa_double) createAggregateAfter(iter, null);
  }
