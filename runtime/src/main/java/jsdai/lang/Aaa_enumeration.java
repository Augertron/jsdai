 ...
 */
public class Aaa_enumeration extends CAggregate {

  Aaa_enumeration() {
    super();
  }

  Aaa_enumeration(EAggregation_type provided_type, CEntity instance) {
   ...
   * the first parameter is of type <code>Aa_enumeration</code> and the second parameter is dropped.
   *
   * @param value
   * @return
   */
  public boolean isMember(Aa_enumeration value) throws SdaiException {
   ...
   * with return value of type <code>Aa_enumeration</code> instead of <code>Object</code>.
   *
   * @param index
   * @return
   */
  public Aa_enumeration getByIndex(int index) throws SdaiException {
    return (Aa_enumeration) getByIndexObject(index);
  }
   ...
   * EDefined_type [])} method - the return value is of type <code>Aa_enumeration</code> instead of <code>Object</code> and the
   * second parameter is dropped.
   *
   * @param index
   * @return
   */
  public Aa_enumeration createAggregateByIndex(int index) throws SdaiException {
    return (Aa_enumeration) createAggregateByIndex(index, null);
  }
   ...
   * @return
   */
  public Aa_enumeration addAggregateByIndex(int index) throws SdaiException {
    return (Aa_enumeration) addAggregateByIndex(index, null);
  }
   ...
   * createAggregateUnordered(EDefined_type [])} method - the return value is of type <code>Aa_enumeration</code> instead of
   * <code>Object</code> and the parameter is dropped.
   *
   * @return
   */
  public Aa_enumeration createAggregateUnordered() throws SdaiException {
    return (Aa_enumeration) createAggregateUnordered(null);
  }

  /**
   * It is a specialization of {@link Aggregate#removeUnordered(Object, EDefined_type []) removeUnordered(Object, EDefined_type
   * [])} method - the first parameter is of type <code>Aa_enumeration</code> and the second parameter is dropped.
   *
   * @param value
   */
  public void removeUnordered(Aa_enumeration value) throws SdaiException {
   ...
   * @return
   */
  public Aa_enumeration getCurrentMember(SdaiIterator iter) throws SdaiException {
    return (Aa_enumeration) getCurrentMemberObject(iter);
  }
   ...
   * <code>Aa_enumeration</code> instead of <code>Object</code> and the second parameter is dropped.
   *
   * @param iter
   * @return
   */
  public Aa_enumeration createAggregateAsCurrentMember(SdaiIterator iter) throws SdaiException {
    return (Aa_enumeration) createAggregateAsCurrentMember(iter, null);
  }
   ...
   * createAggregateBefore(SdaiIterator, EDefined_type [])} method - the return value is of type <code>Aa_enumeration</code>
   * instead of <code>Object</code> and the second parameter is dropped.
   *
   * @param iter
   * @return
   */
  public Aa_enumeration createAggregateBefore(SdaiIterator iter) throws SdaiException {
    return (Aa_enumeration) createAggregateBefore(iter, null);
  }
   ...
   * createAggregateAfter(SdaiIterator, EDefined_type [])} method - the return value is of type <code>Aa_enumeration</code>
   * instead of <code>Object</code> and the second parameter is dropped.
   *
   * @param iter
   * @return
   */
  public Aa_enumeration createAggregateAfter(SdaiIterator iter) throws SdaiException {
    return (Aa_enumeration) createAggregateAfter(iter, null);
  }
