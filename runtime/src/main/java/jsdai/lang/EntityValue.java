...
//"   value: #" + ref.instance_identifier);
        if (base.express_type == DataType.ENTITY) {
          ...
          if (!given.isSubtypeOf((CEntity_definition) base)) {
            staticFields = StaticFields.get();
            printWarningToLogo(owning_session, AdditionalMessages.RD_WRRE, staticFields.current_instance_identifier, ref.instance_identifier);
            return null;
          }
//				} else {
...
//			return (CLateBindingEntity)val.reference;
      ...
      if (!redecl) {
        staticFields = StaticFields.get();
        printWarningToLogo(owning_session, AdditionalMessages.RD_RIRE, staticFields.current_instance_identifier);
      }
      return null;
    }
    if (!expr) {
   ...
   * @return
   */
  public Object getMixed(int index, CExplicit_attribute attr, CEntity inst) throws SdaiException {
    if (attr == null) {
      String base = SdaiSession.line_separator + AdditionalMessages.DI_ATNS;
      throw new SdaiException(SdaiException.SY_ERR, base);
    }
   ...
   * @return
   */
  public A_integer getIntegerAggregate(int index, CExplicit_attribute attr, CEntity inst) throws SdaiException {
    if (attr == null) {
      String base = SdaiSession.line_separator + AdditionalMessages.DI_ATNS;
      throw new SdaiException(SdaiException.SY_ERR, base);
    }
   ...
   * @return
   */
  public A_double getDoubleAggregate(int index, CExplicit_attribute attr, CEntity inst) throws SdaiException {
    if (attr == null) {
      String base = SdaiSession.line_separator + AdditionalMessages.DI_ATNS;
      throw new SdaiException(SdaiException.SY_ERR, base);
    }
   ...
   * @return
   */
  public A_string getStringAggregate(int index, CExplicit_attribute attr, CEntity inst) throws SdaiException {
    if (attr == null) {
      String base = SdaiSession.line_separator + AdditionalMessages.DI_ATNS;
      throw new SdaiException(SdaiException.SY_ERR, base);
    }
   ...
   * @return
   */
  public A_enumeration getLogicalAggregate(int index, CExplicit_attribute attr, CEntity inst) throws SdaiException {
    if (attr == null) {
      String base = SdaiSession.line_separator + AdditionalMessages.DI_ATNS;
      throw new SdaiException(SdaiException.SY_ERR, base);
    }
   ...
   * @return
   */
  public A_boolean getBooleanAggregate(int index, CExplicit_attribute attr, CEntity inst) throws SdaiException {
    if (attr == null) {
      String base = SdaiSession.line_separator + AdditionalMessages.DI_ATNS;
      throw new SdaiException(SdaiException.SY_ERR, base);
    }
   ...
   * @return
   */
  public A_enumeration getEnumerationAggregate(int index, CExplicit_attribute attr, CEntity inst) throws SdaiException {
    if (attr == null) {
      String base = SdaiSession.line_separator + AdditionalMessages.DI_ATNS;
      throw new SdaiException(SdaiException.SY_ERR, base);
    }
   ...
   * @return
   */
  public A_binary getBinaryAggregate(int index, CExplicit_attribute attr, CEntity inst) throws SdaiException {
    if (attr == null) {
      String base = SdaiSession.line_separator + AdditionalMessages.DI_ATNS;
      throw new SdaiException(SdaiException.SY_ERR, base);
    }
   ...
   * @return
   */
  public Aggregate getInstanceAggregate(int index, CExplicit_attribute attr, CEntity inst) throws SdaiException {
    if (attr == null) {
      String base = SdaiSession.line_separator + AdditionalMessages.DI_ATNS;
      throw new SdaiException(SdaiException.SY_ERR, base);
    }
...
//		return values[index].getInstanceAggregate(attr, inst);
   ...
   * @return
   */
  public Aggregate getMixedAggregate(int index, CExplicit_attribute attr, CEntity inst) throws SdaiException {
    if (attr == null) {
      String base = SdaiSession.line_separator + AdditionalMessages.DI_ATNS;
      throw new SdaiException(SdaiException.SY_ERR, base);
    }
...
//		return values[index].getMixedAggregate(attr, inst);
   ...
   * @return
   */
  public Aa_integer getInteger2Aggregate(int index, CExplicit_attribute attr, CEntity inst) throws SdaiException {
    if (attr == null) {
      String base = SdaiSession.line_separator + AdditionalMessages.DI_ATNS;
      throw new SdaiException(SdaiException.SY_ERR, base);
    }
   ...
   * @return
   */
  public Aa_double getDouble2Aggregate(int index, CExplicit_attribute attr, CEntity inst) throws SdaiException {
    if (attr == null) {
      String base = SdaiSession.line_separator + AdditionalMessages.DI_ATNS;
      throw new SdaiException(SdaiException.SY_ERR, base);
    }
   ...
   * @return
   */
  public Aa_string getString2Aggregate(int index, CExplicit_attribute attr, CEntity inst) throws SdaiException {
    if (attr == null) {
      String base = SdaiSession.line_separator + AdditionalMessages.DI_ATNS;
      throw new SdaiException(SdaiException.SY_ERR, base);
    }
   ...
   * @return
   */
  public Aa_integer getLogical2Aggregate(int index, CExplicit_attribute attr, CEntity inst) throws SdaiException {
    if (attr == null) {
      String base = SdaiSession.line_separator + AdditionalMessages.DI_ATNS;
      throw new SdaiException(SdaiException.SY_ERR, base);
    }
   ...
   * @return
   */
  public Aa_boolean getBoolean2Aggregate(int index, CExplicit_attribute attr, CEntity inst) throws SdaiException {
    if (attr == null) {
      String base = SdaiSession.line_separator + AdditionalMessages.DI_ATNS;
      throw new SdaiException(SdaiException.SY_ERR, base);
    }
   ...
   * @return
   */
  public Aa_enumeration getEnumeration2Aggregate(int index, CExplicit_attribute attr, CEntity inst) throws SdaiException {
    if (attr == null) {
      String base = SdaiSession.line_separator + AdditionalMessages.DI_ATNS;
      throw new SdaiException(SdaiException.SY_ERR, base);
    }
   ...
   * @return
   */
  public Aaa_double getDouble3Aggregate(int index, CExplicit_attribute attr, CEntity inst) throws SdaiException {
    if (attr == null) {
      String base = SdaiSession.line_separator + AdditionalMessages.DI_ATNS;
      throw new SdaiException(SdaiException.SY_ERR, base);
    }
...
//			values[index].reference = value;
   ...
   * @param attr
   */
  public void setMixed(int index, Object value, CExplicit_attribute attr, int sel_number) throws SdaiException {
    if (attr == null) {
      String base = SdaiSession.line_separator + AdditionalMessages.DI_ATNS;
      throw new SdaiException(SdaiException.SY_ERR, base);
    }
...
//			if (value.myType.check_aggregation_double()) {
      if (!value.myType.check_aggregation_double()) {
        ...
        if ((owner != null && !owner.owning_model.repository.session.a_double3_overflow && !SdaiSession.getSession().a_double3_overflow)
            || value instanceof A_double3) {
   ...
   * @param value
   */
  public void setEnumerationAggregate(int index, A_enumeration value, CExplicit_attribute attr) throws SdaiException {
    if (values == null) {
      values = new Value[SdaiSession.NUMBER_OF_VALUES];
    }
    if (values.length <= index) {
   ...
   * @param value
   */
  public void setMixedAggregate(int index, CAggregate value, CExplicit_attribute attr) throws SdaiException {
    if (values == null) {
      values = new Value[SdaiSession.NUMBER_OF_VALUES];
    }
    if (values.length <= index) {
   ...
   * @param value
   */
  public void setEnumeration2Aggregate(int index, Aa_enumeration value, CExplicit_attribute attr) throws SdaiException {
    if (values == null) {
      values = new Value[SdaiSession.NUMBER_OF_VALUES];
    }
    if (values.length <= index) {
...
//				AdditionalMessages.RD_PHFI + PhFileReader.phys_file + SdaiSession.line_separator +
   ...
   * Prints a warning message to logo file.
   */
  static void printWarningToLogo(SdaiSession session, String text, long inst_ident, CExplicit_attribute attr) throws SdaiException {
    String str;
    if (attr == null) {
      str = "";
    }
...
//				AdditionalMessages.RD_PHFI + PhFileReader.phys_file + SdaiSession.line_separator +
  ...
  static void printWarningToLogo(SdaiSession session, String text, long inst_ident, String attr_name) throws SdaiException {
    String str;
    if (attr_name == null) {
      str = "";
    }
    ...
    if (session != null && session.logWriterSession != null) {
      session.printlnSession(text + SdaiSession.line_separator + AdditionalMessages.RD_INST + inst_ident + str);
    }
    else {
      SdaiSession.println(text + SdaiSession.line_separator + AdditionalMessages.RD_INST + inst_ident + str);
    }
  }

  static void printWarningToLogo(SdaiSession session, String text, long inst_ident, String entity_name, String part_entity_name) throws SdaiException {
    String str = SdaiSession.line_separator + AdditionalMessages.RD_ENT + entity_name + SdaiSession.line_separator + AdditionalMessages.RD_SENT
        + part_entity_name;
    if (session != null && session.logWriterSession != null) {
      session.printlnSession(text + SdaiSession.line_separator + AdditionalMessages.RD_INST + inst_ident + str);
    }
   ...
   * Prints a warning message to logo file.
   */
  static void printWarningToLogo(SdaiSession session, String text, long inst_ident, long referenced_inst) throws SdaiException {
    if (session != null && session.logWriterSession != null) {
      session.printlnSession(text + SdaiSession.line_separator +
//				AdditionalMessages.RD_PHFI + PhFileReader.phys_file + SdaiSession.line_separator +
          AdditionalMessages.RD_INST + inst_ident + SdaiSession.line_separator + AdditionalMessages.RD_IREF + referenced_inst);
    }
    else {
      SdaiSession.println(text + SdaiSession.line_separator +
//				AdditionalMessages.RD_PHFI + PhFileReader.phys_file + SdaiSession.line_separator +
   ...
   * Prints a warning message to logo file.
   */
  static void printWarningToLogo(SdaiSession session, String text, long inst_ident, CExplicit_attribute attr, long referenced_inst) throws SdaiException {
    String str;
    if (attr == null) {
      str = "";
    }
    ...
    if (session != null && session.logWriterSession != null) {
      session.printlnSession(text + SdaiSession.line_separator +
//				AdditionalMessages.RD_PHFI + PhFileReader.phys_file + SdaiSession.line_separator +
          AdditionalMessages.RD_INST + inst_ident + str + SdaiSession.line_separator + AdditionalMessages.RD_IREF + referenced_inst);
    }
    else {
      SdaiSession.println(text + SdaiSession.line_separator +
//				AdditionalMessages.RD_PHFI + PhFileReader.phys_file + SdaiSession.line_separator +
   ...
   * Besides current class, this method is used in <code>SdaiModel</code> and <code>PhFileReader</code>.
   */
