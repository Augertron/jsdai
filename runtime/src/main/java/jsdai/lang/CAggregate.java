...
/**
 * This class is for internal JSDAI use only. Applications shall use only <code>Aggregate</code> or one of the specialized
 * extensions of <code>CAggregate</code>.
 */
...
public class CAggregate extends A_basis implements Aggregate {
   ...
   * java array;
   * 2) for EXPRESS LIST type a chain of objects of class <code>ListElement</code> is created; in the java array
   * <code>myData</code> only the first (head) and
   ...
   * If this aggregate is not created to be a value of an entity instance, then <code>null</code> is returned.
   */
  /*
   ...
   * extensions of this class, for example <code>ALine</code>, using java <code>newInstance</code> method.
  ...
  /**
   * The constructor used to create special aggregate of listeners in classes <code>CEntity</code> and
   * <code>SdaiRepository</code>.
   *
   * @param provided_type
   */
   ...
   * aggregates for simple data types, that is, <code>A_integer</code>, <code>A_string</code> and so on.
   *
   * @param provided_type
   * @param aggr_owner
   */
   ...
   * applying <code>newInstance</code> method. This occurs in <code>CEntity</code> class.
   */
...
//		synchronized (syncObject) {
    ...
    Object[] myDataA;
    if (myType != null && (myType.shift <= SdaiSession.INST_AGGR && myType.shift >= SdaiSession.ALL_INST_AGGR)) {
    ...
    if (myType != null && myType.express_type == DataType.ARRAY && myData == null) {
      ...
      return arr_type.getUpper_index(null).getBound_value(null) - arr_type.getLower_index(null).getBound_value(null) + 1;
    }
    else {
      if (myLength < 0) {
...
//		} // syncObject
   ...
   * going through all started <code>SdaiModel</code>s in an <code>ASdaiModel</code>. This set is returned by
   * <code>getInstances</code> method (one of two its variations) in class <code>ASdaiModel</code>.
   * The set is represented by an aggregate in which the array <code>myData</code> contains two elements: the first coincides
    ...
    if (amod.myType == null || amod.myType.express_type == DataType.LIST) {
      ...
      while (element != null) {
        ...
        if (myDataA[1] == model.extent_type) {
          ...
          true_extent_index = model.underlying_schema.owning_model.schemaData.findEntityExtentIndex((CEntity_definition) myDataA[1]);
          ...
          true_extent_index = model.underlying_schema.owning_model.schemaData.findEntityExtentIndex((Class) myDataA[1]);
          if (true_extent_index < 0) {
            element = element.next;
            continue;
          }
   ...
   * going through all started <code>SdaiModel</code>s in an <code>ASdaiModel</code>. This set is returned by
   * <code>getExactInstances</code> method (one of two its variations) in class <code>ASdaiModel</code>.
   * The set is represented by an aggregate in which the array <code>myData</code> contains two elements: the first coincides
   * with the corresponding element
   * in the list <code>ASdaiModel</code> from which this set was constructed,
...
//		} // syncObject
  ...
  private boolean checkValue(Object value, Object agg_value, int sel_number) throws SdaiException {
    ...
    if (value instanceof String) {
      ...
      if (value != null && ((String) value).equals(agg_value)) {
        return true;
      }
      return false;
    }
...
//		} // syncObject
   ...
   * of a specified entity data type and all its subtypes in an <code>SdaiModel</code>. This set is returned by
   * <code>getInstances</code> method (one of two its variations with parameter specifying an entity)
   * in class <code>SdaiModel</code>. The set is represented by an aggregate in
   * which the array <code>myData</code> contains two elements: the first is an <code>SdaiModel</code> containing instances,
   * whereas the second is the
    ...
    while (index >= 0) {
      ...
      if (index >= 0) {
        ...
        if ((model.sim_status[index] & SdaiModel.SIM_SORTED) != 0) {
          int ind = model.find_instance(0, model.lengths[index] - 1, index, ((CEntity) value).instance_identifier);
  ...
  /**
   * Checks if a submitted value belongs to the set which consists of instances
   * of a specified entity data type (but not its subtypes) in an <code>SdaiModel</code>. This set is returned by
   * <code>getExactInstances</code> method (one of two its variations) in class <code>SdaiModel</code>.
   * The set is represented by an aggregate in which the array <code>myData</code> contains two elements: the first is an
   * <code>SdaiModel</code> containing
   ...
   * of an <code>SdaiModel</code>. This set is returned by <code>getInstances</code> method in class <code>SdaiModel</code>.
  ...
  boolean isMemberInstancesAll(EEntity value) throws SdaiException {
    ...
    for (int i = 0; i < model.lengths.length; i++) {
      if (model.lengths[i] <= 0) {
        continue;
      }
      if (!(cl.isInstance(model.instances_sim[i][0]))) {
        continue;
      }
      //if (model.sorted[i]) {
      if ((model.sim_status[i] & SdaiModel.SIM_SORTED) != 0) {
        int ind = model.find_instance(0, model.lengths[i] - 1, i, ((CEntity) value).instance_identifier);
...
//		synchronized (syncObject) {
    ...
    if (myType != null
        && (myType.shift == SdaiSession.ASDAIMODEL_INST_ALL || myType.shift == SdaiSession.ASDAIMODEL_INST
        || myType.shift == SdaiSession.ASDAIMODEL_INST_EXACT)) {
      ASdaiModel amod;
...
//		} // syncObject
   ...
   * of instances of a specified entity data type and all its subtypes in an <code>SdaiModel</code>. This set is returned by
   * <code>getInstances</code> method (one of two its variations with parameter specifying an entity)
   * in class <code>SdaiModel</code>. The set is represented by an aggregate in
   * which the array <code>myData</code> contains two elements: the first is an <code>SdaiModel</code> containing instances,
   * whereas the second is the
  ...
  /**
   * Given an index, returns the element with this index in the set which consists
   * of instances of a specified entity data type (but not its subtypes) in an <code>SdaiModel</code>. This set is returned by
   * <code>getExactInstances</code> method (one of two its variations) in class <code>SdaiModel</code>.
   * The set is represented by an aggregate in which the array <code>myData</code> contains two elements: the first is an
   * <code>SdaiModel</code> containing
   * instances, whereas the second is the underlying schema of this model.
  ...
  /**
   * Given an index, returns the element with this index in the set which consists
   * of all instances of an <code>SdaiModel</code>. This set is returned by <code>getInstances</code> method in class
   * <code>SdaiModel</code>.
   * The set is represented by an aggregate in which the first element of the
   * array <code>myData</code> is an <code>SdaiModel</code> whose instances are
   * considered.
  ...
  private SdaiModel getModelWithEntity(ASdaiModel amod, ListElement st_element, int mod_index, int st_extent, int count) throws SdaiException {
    SdaiModel model;
   ...
   * subtypes collected going through all started <code>SdaiModel</code>s in an <code>ASdaiModel</code>. This set is returned by
   * <code>getInstances</code> method (one of two its variations) in class <code>ASdaiModel</code>.
   * The set is represented by an aggregate in which the array <code>myData</code> contains two elements: the first coincides
   * with the corresponding element
   * in the list <code>ASdaiModel</code> from which this set was constructed,
   ...
   * subtypes) collected going through all started <code>SdaiModel</code>s in an <code>ASdaiModel</code>. This set is returned
   * by <code>getExactInstances</code> method (one of two its variations) in class <code>ASdaiModel</code>.
   * The set is represented by an aggregate in which the array <code>myData</code> contains two elements: the first coincides
   * with the corresponding element
   * in the list <code>ASdaiModel</code> from which this set was constructed,
   * whereas the second represents an entity (either definition or class)
  ...
  Object getByIndexListOfModelsExact(int index) throws SdaiException {
    ...
    if (amod.myType == null || amod.myType.express_type == DataType.LIST) {
      ...
      while (element != null) {
        ...
        if ((model.mode & SdaiModel.MODE_MODE_MASK) == SdaiModel.READ_ONLY && model.repository != SdaiSession.systemRepository) {
          true_extent_index = model.find_entityRO(model.underlying_schema.owning_model.schemaData.entities[true_extent_index]);
        }
        if (true_extent_index >= 0) {
          count += model.lengths[true_extent_index];
        }
...
//		synchronized (syncObject) {
    ...
    try {
      ...
      if (SdaiSession.debug2) {
        System.out.println("   CAggregate  sel_number = " + sel_number + "    aggr_member: " + aggr_member.getClass().getName());
      }
    }
...
//		synchronized (syncObject) {
    if (myType == null || myType.shift == SdaiSession.PRIVATE_AGGR || myType.shift <= SdaiSession.INST_AGGR) {
      throw new SdaiException(SdaiException.AI_NVLD);
    }
    if (getOwner() == null) {
      throw new SdaiException(SdaiException.AI_NEXS);
...
//		synchronized (syncObject) {
    ...
    myLength++;
    if (myType != null && (myType.shift != SdaiSession.PRIVATE_AGGR || getOwner() instanceof SdaiRepository)) {
      owner.modified();
      fireSdaiEvent(SdaiEvent.MODIFIED, -1, null);
    }
    else if (myType == null) {
...
//		synchronized (syncObject) {
    ...
    if (owning_instance != null) {
      if (owning_model.repository.session.undo_redo_file != null && owning_model.repository != SdaiSession.systemRepository) {
...
//		synchronized (syncObject) {
    ...
    if (myType.shift <= SdaiSession.INST_AGGR && myType.shift >= SdaiSession.ALL_INST_AGGR) {
      ...
      if (myType.shift == SdaiSession.ALL_INST_AGGR) {
        if (iter.myOuterIndex < 0 || iter.myOuterIndex >= model.lengths.length || model.lengths[iter.myOuterIndex] <= iter.myIndex) {
...
//		} // syncObject
  ...
  Object getCurrentMemberListOfModels(SdaiIterator iter) throws SdaiException {
    ...
    if (myDataA[1] == model.extent_type) {
      ...
      index = model.underlying_schema.owning_model.schemaData.findEntityExtentIndex((CEntity_definition) myDataA[1]);
      if (index < 0) {
        throw new SdaiException(SdaiException.ED_NVLD, myDataA[1]);
      }
    }
    else {
      index = model.underlying_schema.owning_model.schemaData.findEntityExtentIndex((Class) myDataA[1]);
      if (index == -1) {
...
//		} // syncObject
   ...
   * @return
   */
  protected Aggregate pCreateAggregateAsCurrentMember(SdaiIterator iter, int path) throws SdaiException {
//		synchronized (syncObject) {
    EDefined_type select[] = myType.select.getSelectArray(path);
...
//		} // syncObject
   ...
   * @param value
   */
  protected void pSetCurrentMember(SdaiIterator iter, Object value, int path) throws SdaiException {
//		synchronized (syncObject) {
    EDefined_type select[] = myType.select.getSelectArray(path);
...
//		} // syncObject
   ...
   * @param value
   */
  protected void pSetCurrentMember(SdaiIterator iter, int value, int path) throws SdaiException {
//		synchronized (syncObject) {
    EDefined_type select[] = myType.select.getSelectArray(path);
    setCurrentMember(iter, value, select);
//		} // syncObject
...
//		} // syncObject
   ...
   * @param value
   */
  protected void pSetCurrentMember(SdaiIterator iter, double value, int path) throws SdaiException {
//		synchronized (syncObject) {
    EDefined_type select[] = myType.select.getSelectArray(path);
    setCurrentMember(iter, value, select);
//		} // syncObject
...
//		} // syncObject
   ...
   * @param value
   */
  protected void pSetCurrentMember(SdaiIterator iter, boolean value, int path) throws SdaiException {
//		synchronized (syncObject) {
    EDefined_type select[] = myType.select.getSelectArray(path);
    setCurrentMember(iter, value, select);
//		} // syncObject
...
//		} // syncObject
   ...
   * @param value
   */
  protected void pAddBefore(SdaiIterator iter, Object value, int path) throws SdaiException {
//		synchronized (syncObject) {
    EDefined_type select[] = myType.select.getSelectArray(path);
...
//		} // syncObject
   ...
   * @param value
   */
  protected void pAddBefore(SdaiIterator iter, int value, int path) throws SdaiException {
//		synchronized (syncObject) {
    EDefined_type select[] = myType.select.getSelectArray(path);
    addBefore(iter, value, select);
//		} // syncObject
...
//		} // syncObject
   ...
   * @param value
   */
  protected void pAddBefore(SdaiIterator iter, double value, int path) throws SdaiException {
//		synchronized (syncObject) {
    EDefined_type select[] = myType.select.getSelectArray(path);
    addBefore(iter, value, select);
//		} // syncObject
...
//		} // syncObject
   ...
   * @param value
   */
  protected void pAddBefore(SdaiIterator iter, boolean value, int path) throws SdaiException {
//		synchronized (syncObject) {
    EDefined_type select[] = myType.select.getSelectArray(path);
    addBefore(iter, value, select);
//		} // syncObject
...
//		} // syncObject
   ...
   * @param value
   */
  protected void pAddAfter(SdaiIterator iter, Object value, int path) throws SdaiException {
//		synchronized (syncObject) {
    EDefined_type select[] = myType.select.getSelectArray(path);
...
//		} // syncObject
   ...
   * @param value
   */
  protected void pAddAfter(SdaiIterator iter, int value, int path) throws SdaiException {
//		synchronized (syncObject) {
    EDefined_type select[] = myType.select.getSelectArray(path);
    addAfter(iter, value, select);
//		} // syncObject
...
//		} // syncObject
   ...
   * @param value
   */
  protected void pAddAfter(SdaiIterator iter, double value, int path) throws SdaiException {
//		synchronized (syncObject) {
    EDefined_type select[] = myType.select.getSelectArray(path);
    addAfter(iter, value, select);
//		} // syncObject
...
//		} // syncObject
   ...
   * @param value
   */
  protected void pAddAfter(SdaiIterator iter, boolean value, int path) throws SdaiException {
//		synchronized (syncObject) {
    EDefined_type select[] = myType.select.getSelectArray(path);
    addAfter(iter, value, select);
//		} // syncObject
...
//		} // syncObject
   ...
   * @return
   */
  protected Aggregate pCreateAggregateBefore(SdaiIterator iter, int path) throws SdaiException {
//		synchronized (syncObject) {
    EDefined_type select[] = myType.select.getSelectArray(path);
...
//		} // syncObject
   ...
   * @return
   */
  protected Aggregate pCreateAggregateAfter(SdaiIterator iter, int path) throws SdaiException {
//		synchronized (syncObject) {
    EDefined_type select[] = myType.select.getSelectArray(path);
...
//		synchronized (syncObject) {
    ...
    if (myType != null && (myType.shift != SdaiSession.PRIVATE_AGGR || getOwner() instanceof SdaiRepository) && init_ln > 0) {
      owner.modified();
      fireSdaiEvent(SdaiEvent.MODIFIED, -1, null);
    }
    else if (myType == null) {
...
//		} // syncObject
   ...
   * its length. Invoked in this class, in <code>SdaiIterator</code> and in <code>SchemaDefinition</code>.
   */
   ...
   * returned. This method is invoked in get methods like <code>pGetByIndexObject</code> used by compiler generated early
   * binding
   ...
   * returned. This method is invoked in get methods like <code>pGetCurrentMemberObject</code> used by compiler generated early
   * binding
   * methods and also in <code>pTestCurrentMember</code> and <code>testCurrentMemberI</code>.
   */
  private int getCurrentSelectionNrAsCurrentMember(SdaiIterator it, boolean resolve_connector) throws SdaiException {
    if (it.myAggregate != this) {
      String base = SdaiSession.line_separator + AdditionalMessages.IR_IMPR;
      throw new SdaiException(SdaiException.SY_ERR, base);
    }
   ...
   * Method is invoked in <code>getCurrentSelectionNrByIndex</code> and in <code>getCurrentSelectionNrAsCurrentMember</code>.
   */
   ...
   * recursively for its elements by invoking <code>updateInverseListAggregate</code> method. The second parameter specifies the
   * new value of the aggregate.
   * If its type is entity instance, then the owner of the current aggregate
   * is added to the inverse list of this entity instance.
   */
  private void updateInverseList(Object current_value, Object new_value) throws SdaiException {
    CEntity owning_instance = getOwningInstance();
  ...
  private void updateInverseList(Object current_value, Object new_value, CEntity owning_instance) throws SdaiException {
    if (current_value instanceof CEntity) {
      CEntity ex_member = (CEntity) current_value;
      if (!ex_member.owning_model.optimized) {
        ex_member.inverseRemove(owning_instance);
        ...
        if (myLength == 1) {
          if (myData == null) {
            if (myType.express_type == DataType.ARRAY && !((CArray_type) myType).getOptional_flag(null)) {
              if (return_res == 1 && myType.allow_entity_aggregate(myType)) {
                return_res = 2;
              }
            }
          }
      ...
      if (sel_number <= 0) {
        if (myLength == 1) {
          if (myData instanceof CEntity) {
            ...
            if (to_ent.owning_model != null && !to_ent.owning_model.closingAll && !to_ent.owning_model.optimized
...
//		} // syncObject
   ...
   * represented by a connector. To this end, <code>resolveConnector</code> method in <code>CEntity</code> class is invoked. An
   * element of the aggregate to be
   ...
   * The method is invoked in classes <code>EntityValue</code> and <code>Value</code>. It is used when reading either an
   * exchange structure
   * or a JSDAI binary file.
   */
  void setValue(AggregationType aggr_type, CEntity inst, Value val, boolean mixed, boolean inverse) throws SdaiException {
    int sel_number = 0;
    boolean typed = mixed;
    ...
    for (int i = 0; i < val.length; i++) {
      ...
      if (next_type == null) {
        ...
        if (typed) {
          if (SdaiSession.debug2) {
            System.out.println(" !!  element_type = " + element_type.getClass().getName());
          }
          for_adding = val_for_element.getAggregateMixedValue(start_def, inst);
          sel_number = val_for_element.sel_number;
          if (SdaiSession.debug2) {
            System.out.println("  IN AGGREGATE sel_number = " + sel_number);
          }
          if (sel_number <= 0) {
            for_adding = null;
            bug_found = true;
        ...
        if (SdaiSession.debug2) {
          System.out.println("    In CAggregate: " + next_type.getAggregateClass().getName());
        }
        if (SdaiSession.debug2) {
          System.out.println(" In CAggregate aggr_type inst ident = " + next_type.instance_identifier);
        }
...
//"   typed: " + typed);
        ...
        switch (type) {
          case 0:
            if (!write_select) {
              ...
              setForNonList(for_adding, count, getIntegerWithValue(bug_found ? 1 : sel_number), inst);
            }
            break;
          case 1:
            if (for_adding == null) {
  ...
  void setInstance2Value(CEntity inst, Value val, boolean mixed, boolean inverse) throws SdaiException {
    owner = inst;
    int type;
    if (myType.express_type == DataType.LIST) {
      type = 1;
   ...
   * the owner of the aggregate. The method is invoked in <code>setValue</code> method of this class and in classes
  ...
  void setForNonList(Object value, int index, Integer sel_number, CEntity inst) throws SdaiException {
    ...
    Object obj = null;
    if (myType.express_type == DataType.ARRAY) {
      SdaiContext context = new SdaiContext(inst);
      EBound bound = ((CArray_type) myType).getLower_index(null);
//			int lower_index = bound.getBound_value(null, context);
      int lower_index;
      if (bound instanceof CPopulation_dependent_bound) {
        lower_index = ((CPopulation_dependent_bound) bound).getBound_value(null, inst, context);
      }
      else {
        lower_index = bound.getBound_value(null);
      }
      EBound upper_bound = ((CArray_type) myType).getUpper_index(null);
//			int upper_index = upper_bound.getBound_value(null, context);
      int upper_index;
      if (upper_bound instanceof CPopulation_dependent_bound) {
        upper_index = ((CPopulation_dependent_bound) upper_bound).getBound_value(null, inst, context);
      }
      else {
      ...
      if (index > upper_index - lower_index) {
        if (inst != null) {
          ...
          EntityValue.printWarningToLogo(inst.owning_model.repository.session, AdditionalMessages.RD_EXAR, inst.instance_identifier,
   ...
   * represented by the second parameter. The method is invoked in <code>setValue</code> method of this class and in classes
   * <code>EntityValue</code> and <code>Value</code>.
   */
  ...
  private boolean isValueCorrect(Object value, CEntity inst) throws SdaiException {
    ...
    if (value == null) {
      if (inst != null) {
        StaticFields staticFields = StaticFields.get();
        EntityValue.printWarningToLogo(inst.owning_model.repository.session, AdditionalMessages.RD_UNSV, inst.instance_identifier,
            staticFields.current_attribute);
      }
      return false;
    }
   ...
   * The method is invoked in <code>validateAggregatesUniqueness</code> method in <code>CEntity</code> class.
   */
  boolean checkUniquenessViolation(AggregationType aggr_type) throws SdaiException {
    ...
    if (aggr_type.express_type == DataType.LIST) {
      ...
      if (sel_number <= 1) {
        ...
        element = element.next.next;
        while (element != null) {
          if (element.object != null && check_list_for_uniqueness(element.object, element.next.object, 2, j, a_type)) {
            return true;
          }
          j++;
          element = element.next.next;
      ...
      if ((aggr_type.express_type == DataType.ARRAY) && (!((CArray_type) aggr_type).getUnique_flag(null))) {
        return false;
      }
      int val_type;
      long long_number = 0;
      ...
      for (j = 1; j < myLength; j++) {
        ...
        for (k = 0; k < j; k++) {
          ...
          if (sel_number <= 1) {
            if (compare_values(myDataA[index], myDataA[current_index], val_type, long_number, doub_number, str)) {
              return true;
            }
          }
          else {
   ...
   * this class.
   */
  private boolean check_list_for_uniqueness(Object value, Object selection, int sel_number, int last_index, int a_type) {
    int val_type;
    long long_number = 0;
    double doub_number = 0.;
    String str = null;
   ...
   * The method is invoked in <code>checkUniquenessViolation</code> and <code>check_list_for_uniqueness</code> methods of this
   * class.
   */
  private boolean compare_values(Object value1, Object value2, int val_type, long long_number, double doub_number, String str) {
    switch (val_type) {
      case 0:
        if (value1 == value2) {
          return true;
   ...
   * The method is invoked in <code>validateArrayNotOptional</code> method in <code>CEntity</code> class.
   */
   ...
   * <p>
   * <pre>    Aggregate agg = ...;
   *    System.out.println("aggregate: " + agg);</pre> &nbsp;&nbsp;&nbsp;&nbsp;The string printed will be like this:
   *
   * <pre>
   * aggregate: (#1008,PARAMETER_VALUE(1.5),(#1523,#36,#9912));
   * </pre>
   *
...
//System.out.println("  CAggregate  str_index = " + str_index + "  val.tag = " + val.tag);
    ...
    if (str_index < 0) {
      if (staticFields.entity_values.entityValues[0] == null) {
        staticFields.entity_values.entityValues[0] = new EntityValue(ss);
      }
      staticFields.entity_values.entityValues[0].setInstanceAggregate(0, this);
      val = staticFields.entity_values.entityValues[0].values[0];
      str_index = get_value(staticFields, true, false, val, str_index, ss);
    }
    return new String(staticFields.instance_as_string, 0, str_index + 1);
  }
   ...
   */
  private int get_value(StaticFields staticFields, boolean first, boolean agg_found, Value val, int index, SdaiSession ss) throws SdaiException {
    Value value_next;
    boolean first_next;
   ...
   * Writes to a byte array the elements of the set which consists of instances
   * of a specified entity data type (but not its subtypes) in an <code>SdaiModel</code>. This set is returned by
   * <code>getExactInstances</code> method (one of two its variations) in class <code>SdaiModel</code>. The set
   * is represented by an aggregate in which the array <code>myData</code> contains two elements: the first is an
   * <code>SdaiModel</code> containing
   ...
   * instances of an <code>SdaiModel</code>. This set is returned by <code>getInstances</code> method in class
   * <code>SdaiModel</code>. The set
  ...
  private int writeExpressNested3AggrValue(StaticFields staticFields, int str_index, Aggregate aggr, boolean first) throws SdaiException {
    ...
    boolean first_inside = true;
    while (it3.next()) {
      str_index = writeExpressNested2AggrValue(staticFields, str_index, ((Aa_double) aggr).getCurrentMember(it3), SdaiSession.EXPRESSIONS_DOUBLE2_AGGR,
          first_inside);
      first_inside = false;
    }
    if (str_index + 1 >= staticFields.instance_as_string.length) {
...
//if (str==null) System.out.println("CAggregate    str is NULL");
//else System.out.println("CAggregate    str is POS");
...
//				if (SdaiSession.toStringUnicode) {
   ...
   * leads to a bigger array. This method besides this class is also used in <code>SdaiModel</code>.
   */
      ...
      if (underlying_type.express_type >= DataType.SELECT && underlying_type.express_type <= DataType.ENT_EXT_EXT_SELECT) {
        ...
        if (value instanceof Integer) {
          ...
          if (underlying_type.express_type == DataType.EXTENSIBLE_ENUM || underlying_type.express_type == DataType.EXTENDED_EXTENSIBLE_ENUM) {
            ...
            ee = ((EExtensible_enumeration_type) underlying_type).getElements(null, owning_mod.repository.session.sdai_context);
          }
          else {
   ...
   * type (specified by the first parameter). This method is applied (in <code>analyse_value</code>) when members of the
   * aggregate are not of select
   * type.
   */
  private boolean analyse_simple_value(ESimple_type simple, Object value) throws SdaiException {
    ...
    if (dt.express_type == DataType.NUMBER) {
      if ((value instanceof Double && !((Double) value).isNaN()) || (value instanceof Integer && ((Integer) value).intValue() != Integer.MIN_VALUE)) {
        return true;
      }
    }
   ...
   */
  private boolean analyse_select_value(int tag, SelectType sel_type, int sel_number, Object value) throws SdaiException {
    int int_value;
    int width;
    EBound bound;
    switch (tag) {
   ...
   */
  boolean analyse_entity_in_select(SelectType sel_type, CEntity_definition value_type) throws SdaiException {
    ANamed_type sels;
...
//				a_type = (EAggregation_type)member_type;
    ...
    if (aggr_type.express_type == DataType.LIST) {
      ...
      if (select <= 1) {
        ...
        if (myType.shift == SdaiSession.ASDAIMODEL_INST) {
          ...
          CArray_type arr_type = (CArray_type) myType;
          ln = arr_type.getUpper_index(null).getBound_value(null) - arr_type.getLower_index(null).getBound_value(null) + 1;
        }
        else {
          ln = myLength;
        }
  ...
  private void setAggrMember(Value val, int index, Object value, int sel_number, AggregationType aggr_type) throws SdaiException {
    if (value == null) {
...
//				val.nested_values[index].init(a_type);
  ...
  private DataType analyse_member_type(AggregationType aggr_type) throws SdaiException {
    ...
    if ((type.express_type >= DataType.LIST && type.express_type <= DataType.AGGREGATE) || type.express_type == DataType.ENTITY) {
      return type;
    }
    else if (type.express_type != DataType.DEFINED_TYPE) {
      return null;
  ...
  void usedin(CEntity referenced, CEntity referencing, CEntity_definition entityDef, Value result) throws SdaiException {
    if (myType == null) {
      throw new SdaiException(SdaiException.FN_NAVL);
    }
    int sel_number = 1;
...
// Shortcuts for aggregates of mixed selects
  ...
  /**
   * It is a specialization of {@link #isMember(Object, EDefined_type []) isMember(Object, EDefined_type [])} method - the first
   * parameter is of type <code>EEntity</code> and the second parameter is dropped.
   *
   * @param value
   * @return
   */
  ...
  /**
   * It is a specialization of {@link #setByIndex(int, Object, EDefined_type []) setByIndex(int, Object, EDefined_type [])}
  ...
  /**
   * It is a specialization of {@link #addByIndex(int, Object, EDefined_type []) addByIndex(int, Object, EDefined_type [])}
   * method - the second parameter is of type <code>EEntity</code> and the third parameter is dropped.
   *
   * @param index
   * @param value
  ...
  /**
   * It is a specialization of {@link #addUnordered(Object, EDefined_type []) addUnordered(Object, EDefined_type [])} method -
   * the first parameter is of type <code>EEntity</code> and the second parameter is dropped.
   *
   * @param value
   */
  ...
  /**
   * It is a specialization of {@link #removeUnordered(Object, EDefined_type []) removeUnordered(Object, EDefined_type [])}
  ...
  /**
   * It is a specialization of {@link #setCurrentMember(SdaiIterator, Object, EDefined_type []) setCurrentMember(SdaiIterator,
   * Object, EDefined_type [])} method - the second parameter is of type <code>EEntity</code> and the third parameter is
   * dropped.
   *
   * @param iter
   * @param value
  ...
  /**
   * It is a specialization of {@link #addBefore(SdaiIterator, Object, EDefined_type []) addBefore(SdaiIterator, Object,
   * EDefined_type [])} method - the second parameter is of type <code>EEntity</code> and the third parameter is dropped.
   *
   * @param iter
   * @param value
   */
  ...
  /**
   * It is a specialization of {@link #addAfter(SdaiIterator, Object, EDefined_type []) addAfter(SdaiIterator, Object,
   * EDefined_type [])} method - the second parameter is of type <code>EEntity</code> and the third parameter is dropped.
   *
   * @param iter
   * @param value
  ...
  public boolean equals(Object obj) {
    if (obj instanceof CAggregate) {
      ...
      boolean isEquals = new EqualsBuilder().append(owner, other.owner).append(length, otherLength).append(myType, other.myType).isEquals();
      if (isEquals) {
...
//System.out.println("CAggregate ??????????? 2  member: " + myDataA[i]);
  ...
  public int hashCode() {
    ...
    int hashCode = (owner == null ? 0 : owner.hashCode()) ^ myLength ^ (myType == null ? 0 : myType.hashCode());
    if (myData != null) {
      if (myData instanceof Object[]) {
        Object[] myDataA = (Object[]) myData;
        int length = myLength + 1;
