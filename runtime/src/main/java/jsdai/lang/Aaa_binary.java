 ...
 * members of the EXPRESS type BINARY. See <a href="Aggregate.html">Aggregate</a>
 * for detailed description of methods whose specializations are given here.
 */
public class Aaa_binary extends CAggregate {

  Aaa_binary() {
    super();
  }

  Aaa_binary(EAggregation_type provided_type, CEntity instance) {
   ...
   * the first parameter is of type <code>Aa_binary</code> and the second parameter is dropped.
   *
   * @param value
   * @return
   */
  public boolean isMember(Aa_binary value) throws SdaiException {
   ...
   * with return value of type <code>Aa_binary</code> instead of <code>Object</code>.
   *
   * @param index
   * @return
   */
  public Aa_binary getByIndex(int index) throws SdaiException {
    return (Aa_binary) getByIndexObject(index);
  }
   ...
   * EDefined_type [])} method - the return value is of type <code>Aa_binary</code> instead of <code>Object</code> and the
   * second parameter is dropped.
   *
   * @param index
   * @return
   */
  public Aa_binary createAggregateByIndex(int index) throws SdaiException {
    return (Aa_binary) createAggregateByIndex(index, null);
  }
   ...
   * @return
   */
  public Aa_binary addAggregateByIndex(int index) throws SdaiException {
    return (Aa_binary) addAggregateByIndex(index, null);
  }
   ...
   * createAggregateUnordered(EDefined_type [])} method - the return value is of type <code>Aa_binary</code> instead of
   * <code>Object</code> and the parameter is dropped.
   *
   * @return
   */
  public Aa_binary createAggregateUnordered() throws SdaiException {
    return (Aa_binary) createAggregateUnordered(null);
  }

  /**
   * It is a specialization of {@link Aggregate#removeUnordered(Object, EDefined_type []) removeUnordered(Object, EDefined_type
   * [])} method - the first parameter is of type <code>Aa_binary</code> and the second parameter is dropped.
   *
   * @param value
   */
  public void removeUnordered(Aa_binary value) throws SdaiException {
   ...
   * @return
   */
  public Aa_binary getCurrentMember(SdaiIterator iter) throws SdaiException {
    return (Aa_binary) getCurrentMemberObject(iter);
  }
   ...
   * createAggregateAsCurrentMember(SdaiIterator, EDefined_type [])} method - the return value is of type <code>Aa_binary</code>
   * instead of <code>Object</code> and the second parameter is dropped.
   *
   * @param iter
   * @return
   */
  public Aa_binary createAggregateAsCurrentMember(SdaiIterator iter) throws SdaiException {
    return (Aa_binary) createAggregateAsCurrentMember(iter, null);
  }
   ...
   * createAggregateBefore(SdaiIterator, EDefined_type [])} method - the return value is of type <code>Aa_binary</code> instead
   * of <code>Object</code> and the second parameter is dropped.
   *
   * @param iter
   * @return
   */
  public Aa_binary createAggregateBefore(SdaiIterator iter) throws SdaiException {
    return (Aa_binary) createAggregateBefore(iter, null);
  }
   ...
   * createAggregateAfter(SdaiIterator, EDefined_type [])} method - the return value is of type <code>Aa_binary</code> instead
   * of <code>Object</code> and the second parameter is dropped.
   *
   * @param iter
   * @return
   */
  public Aa_binary createAggregateAfter(SdaiIterator iter) throws SdaiException {
    return (Aa_binary) createAggregateAfter(iter, null);
  }
