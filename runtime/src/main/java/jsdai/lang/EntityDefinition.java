...
public interface EntityDefinition extends ENamed_type {
   ...
   * passed to the method's parameter, then <code>SdaiException</code> ED_NDEF is thrown.
   * <p>
   * <B>Example:</B>
   * <p>
   * <pre>    EVector vect = ...;
   ...
   *    boolean is_vect_subtype_of_item = def_vect.isSubtypeOf(def_item);</pre>
   * <p>
   *
   ...
   * <pre>    EVector vect = ...;
   *    EEntity_definition def_vect = vect.getInstanceType();
   *    AExplicit_attribute attributes = def_vect.getExplicit_attributes(null);</pre>
   * <p>
   *
   ...
   * an older version of JSDAI, in which this method was assigned to <code>EEntity_definition</code> class of
   ...
   * <B>Example:</B>
   * <p>
   * <pre>    	SdaiModel mod_xim = repo.createSdaiModel("mod_xim",
   ...
   *    boolean valid = edef.isValidFor(mod_xim.getUnderlyingSchema());</pre>
   * <p>
   *
   ...
   * <B>Example:</B>
   * <p>
   * <pre>    	SdaiModel mod_kin = repo.createSdaiModel("mod_kin", SKinematic_structure_schema.class);
   *    EEntity_definition edef = mod_kin.getUnderlyingSchema().getEntityDefinition("gear_pair");
   *    boolean valid = edef.isValidFor(SAp210_electronic_assembly_interconnect_and_packaging_design_xim.class);</pre>
   * <p>
   *
