...
abstract class SessionAggregate extends A_basis implements Aggregate {
   ...
   */
  static final byte[] MODELS = { (byte) 'S', (byte) 'd', (byte) 'a', (byte) 'i', (byte) 'M', (byte) 'o', (byte) 'd', (byte) 'e', (byte) 'l', (byte) 's' };

  /**
   * A constant representing a string used in <code>toString</code> method in
   * class <code>ASchemaInstance</code> extending the current class.
   */
  static final byte[] SCHEMA_INSTANCES = { (byte) 'S', (byte) 'c', (byte) 'h', (byte) 'e', (byte) 'm', (byte) 'a', (byte) 'I', (byte) 'n', (byte) 's',
      (byte) 't', (byte) 'a', (byte) 'n', (byte) 'c', (byte) 'e', (byte) 's' };

  /**
   * A constant representing a string used in <code>toString</code> method in
   * class <code>ASdaiRepository</code> extending the current class.
   */
  static final byte[] REPOSITORIES = { (byte) 'S', (byte) 'd', (byte) 'a', (byte) 'i', (byte) 'R', (byte) 'e', (byte) 'p', (byte) 'o', (byte) 's',
      (byte) 'i', (byte) 't', (byte) 'o', (byte) 'r', (byte) 'i', (byte) 'e', (byte) 's' };

  /**
   * A constant representing a string used in <code>toString</code> method in
   * class <code>AEntityExtent/code> extending the current class.
   */
  static final byte[] ENTITY_EXTENTS = { (byte) 'E', (byte) 'n', (byte) 't', (byte) 'i', (byte) 't', (byte) 'y', (byte) 'E', (byte) 'x', (byte) 't',
      (byte) 'e', (byte) 'n', (byte) 't', (byte) 's' };
   ...
   * objects of classes <code>ASdaiModel</code>, <code>ASchemaInstance</code>, <code>ASdaiRepository</code>, and
   * <code>AEntityExtent</code>.
   */
...
//		synchronized (syncObject) {
    ...
    if (CAggregate.class.isAssignableFrom(bottom_class) || getClass().isAssignableFrom(bottom_class)) {
...
//		} // syncObject
   ...
   * - <code>delete</code> and <code>removeSdaiModel</code> in <code>SchemaInstance</code>;
   * - several methods in <code>SdaiModel</code>;
   * - several methods in <code>SdaiRepository</code>;
...
//		} // syncObject
  ...
  public Aggregate createAggregateAsCurrentMember(SdaiIterator iter, EDefined_type select[]) throws SdaiException {
    throw new SdaiException(SdaiException.FN_NAVL);
  }
...
//		} // syncObject
  ...
  public Aggregate createAggregateBefore(SdaiIterator iter, EDefined_type select[]) throws SdaiException {
    throw new SdaiException(SdaiException.FN_NAVL);
  }

  public Aggregate createAggregateAfter(SdaiIterator iter, EDefined_type select[]) throws SdaiException {
    throw new SdaiException(SdaiException.FN_NAVL);
  }
...
//		} // syncObject
   ...
   * leads to a bigger array. This method is used in extensions of this class: <code>ASdaiModel</code>,
   * <code>ASchemaInstance</code>, <code>ASdaiRepository</code>, <code>AEntityExtent</code>.
   */
  ...
  boolean isSessionAvailable() {
    ...
    else if (owning_obj instanceof CEntity) {
      SdaiModel model = ((CEntity) owning_obj).owning_model;
      return model.repository != null ? model.repository.session != null : false;
    }
    else {
      return false;
