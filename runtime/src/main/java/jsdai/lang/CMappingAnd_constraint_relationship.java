...
public class CMappingAnd_constraint_relationship extends CInstance_constraint implements MappingConstraintPath, MappingConstraintMatcher {
  ...
  public void mapUsersForward(ObjectMapping mappingContext, Set instances) throws SdaiException {
    ...
    ((MappingConstraintPath) selfInterface.getElement1(null)).mapUsersForward(mappingContext, instances);
  ...
  public void mapUsersBackward(ObjectMapping mappingContext, Set instances) throws SdaiException {
    throw new SdaiException(SdaiException.FN_NAVL, "Path constraint can not be called as part of backward references: " + this);
  }
  ...
  public MatcherInstances findForward(MappingContext mappingContext, MatcherInstances instances, boolean decCacheUseCnt) throws SdaiException {
    ...
    if (outInstances != null) {
      ...
      EAnd_constraint_relationship selfInterface = (EAnd_constraint_relationship) this;
      outInstances = ((MappingConstraintMatcher) selfInterface.getElement1(null)).findForward(mappingContext, instances, false);
      outInstances = outInstances.intersect(((MappingConstraintMatcher) selfInterface.getElement2(null)).findForward(mappingContext, instances, false));
      mappingContext.setCacheInstances(this, instances, outInstances, decCacheUseCnt,
          new EEntity[] { selfInterface.getElement1(null), selfInterface.getElement2(null) });
      return outInstances;
    }
  }
  ...
  public MatcherInstances findPathForward(MappingContext mappingContext, MatcherInstances instances, boolean decCacheUseCnt) throws SdaiException {
    ...
    if (outInstances != null) {
      ...
      EAnd_constraint_relationship selfInterface = (EAnd_constraint_relationship) this;
      outInstances = ((MappingConstraintMatcher) selfInterface.getElement1(null)).findPathForward(mappingContext, instances, false);
      EEntity element2 = selfInterface.getElement2(null);
      MatcherInstances allInInstances = mappingContext.newAllInstances(MatcherInstances.STATUS_FORWARD);
      ...
      if (cachedInstances != null) {
        element2OutInstances = cachedInstances.getChildCacheInstances(element2, allInInstances);
      }
      if (element2OutInstances == null) {
        element2OutInstances = ((MappingConstraintMatcher) element2).findForward(mappingContext, allInInstances, true);
        foundElement2OutInstances = true;
      }
      outInstances = outInstances.intersect(element2OutInstances);
      cachedInstances = mappingContext
          .setCacheInstances(this, instances, outInstances, decCacheUseCnt, new EEntity[] { selfInterface.getElement1(null) });
      if (foundElement2OutInstances && cachedInstances.remainingGetCount > 0) {
        cachedInstances.addChildCacheInstances(element2, allInInstances, element2OutInstances);
      }
      return outInstances;
    }
  }
  ...
  public EEntity[] findDependentInstances() throws SdaiException {
    EAnd_constraint_relationship selfInterface = (EAnd_constraint_relationship) this;
    return new EEntity[] { selfInterface.getElement1(null), selfInterface.getElement2(null) };
  }
