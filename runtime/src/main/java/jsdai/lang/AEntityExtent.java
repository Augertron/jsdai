...
public class AEntityExtent extends SessionAggregate {
   ...
   * the first parameter is of type <code>EntityExtent</code> and the
   ...
   * <B>Example:</B>
   * <p>
   * <pre>    AEntityExtent extent_aggr = ...;
   *    System.out.println(extent_aggr);</pre> &nbsp;&nbsp;&nbsp;&nbsp;The string printed will be like this:
   *
   * <pre>
   * EntityExtents: cartesian_point, vector, direction, line
   * </pre>
   *
