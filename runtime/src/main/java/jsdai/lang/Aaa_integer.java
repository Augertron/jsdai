...
public class Aaa_integer extends CAggregate {
   ...
   * the first parameter is of type <code>Aa_integer</code> and the second parameter is dropped.
   *
   * @param value
   * @return
   */
   ...
   * EDefined_type [])} method - the return value is of type <code>Aa_integer</code> instead of <code>Object</code> and the
   ...
   * createAggregateUnordered(EDefined_type [])} method - the return value is of type <code>Aa_integer</code> instead of
   ...
   * <code>Aa_integer</code> instead of <code>Object</code> and the second parameter is dropped.
   *
   * @param iter
   * @return
   */
   ...
   * createAggregateBefore(SdaiIterator, EDefined_type [])} method - the return value is of type <code>Aa_integer</code> instead
   ...
   * createAggregateAfter(SdaiIterator, EDefined_type [])} method - the return value is of type <code>Aa_integer</code> instead
   * of <code>Object</code> and the second parameter is dropped.
   *
   * @param iter
   * @return
