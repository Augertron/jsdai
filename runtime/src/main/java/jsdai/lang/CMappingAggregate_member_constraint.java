...
public class CMappingAggregate_member_constraint extends CConstraint_attribute implements MappingConstraintPath, MappingConstraintMatcher {
  ...
  public void mapUsersForward(ObjectMapping mappingContext, Set instances) throws SdaiException {
    ...
    mappingContext.attributePathPush(selfInterface.testMember(null) ? selfInterface.getMember(null) : -1);
    try {
  ...
  public MatcherInstances findForward(MappingContext mappingContext, MatcherInstances instances, boolean decCacheUseCnt) throws SdaiException {
    ...
    if (outInstances != null) {
      ...
      EAggregate_member_constraint selfInterface = (EAggregate_member_constraint) this;
      instances.attributePathPush(selfInterface.testMember(null) ? selfInterface.getMember(null) : -1);
