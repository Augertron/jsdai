...
//   Mixed usage
  ...
  static final String DI_WRMP = "Method getBound_value(EBound type, CEntity inst, SdaiContext context) shall be used"; // PopulationDependentBound
  ...
  static final String VA_FATV = "Internal error: Failed to identify the type of the value";
  ...
  static final String RD_WRAG = "Error: reference to an instance of wrong type, it is dropped from the aggregate.";
