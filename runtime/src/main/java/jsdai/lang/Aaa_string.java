...
public class Aaa_string extends CAggregate {
   ...
   * the first parameter is of type <code>Aa_string</code> and the second parameter is dropped.
   *
   * @param value
   * @return
   */
   ...
   * EDefined_type [])} method - the return value is of type <code>Aa_string</code> instead of <code>Object</code> and the
   ...
   * createAggregateUnordered(EDefined_type [])} method - the return value is of type <code>Aa_string</code> instead of
   ...
   * createAggregateAsCurrentMember(SdaiIterator, EDefined_type [])} method - the return value is of type <code>Aa_string</code>
   ...
   * createAggregateBefore(SdaiIterator, EDefined_type [])} method - the return value is of type <code>Aa_string</code> instead
   ...
   * createAggregateAfter(SdaiIterator, EDefined_type [])} method - the return value is of type <code>Aa_string</code> instead
   * of <code>Object</code> and the second parameter is dropped.
   *
   * @param iter
   * @return
