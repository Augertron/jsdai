...
public interface EEntity extends SdaiEventSource {
   ...
   *    String name = (String)vect.get_object(attr);</pre>
   *
   ...
   *
   * <P><B>Example:</B>
   * <P><pre>    ETrimmed_curve curve = ...;
   *    EAttribute attr = curve.getAttributeDefinition("sense_agreement");
   *    boolean agreement = curve.get_boolean(attr);</pre>
   *
   * @param attribute the attribute which value is needed.
   ...
   *
   * <P><B>Example:</B>
   * <P><pre>    EComposite_curve_segment segment = ...;
   *    ASdaiModel domain = ...;
   *    EInverse_attribute inv_attr = (EInverse_attribute)segment.getAttributeDefinition("using_curves");
   *    AEntity inv_aggr = segment.get_inverse(inv_attr, domain);</pre>
   *
   ...
   * <P><pre>    EDefined_type [] selection = new EDefined_type[3];
   *    EAttribute attr = ...;
   *    EEntity instance= ...;
   ...
   * <P><pre>    EMeasure_with_unit instance = ...;
   ...
   * <P><B>Example:</B>
   * <P><pre>    EVector vect = ...;
   *    EAttribute attr = vect.getAttributeDefinition("magnitude");</pre>
   * <p>
   *
   ...
   * <P><B>Example:</B>
   * <P><pre>    EEntity inst = ...;
   *    SdaiModel owner = inst.findEntityInstanceSdaiModel();</pre>
   * <p>
   *
   ...
   * <P><B>Example:</B>
   * <P><pre>    EEntity inst = ...;
   *    EEntity_definition def = inst.getInstanceType();</pre>
   * <p>
   *
   ...
   *    boolean is_of_def = inst.isInstanceOf(def);</pre>
   * <p>
   *
   ...
   *    boolean is_of_cl = inst.isInstanceOf(cl);</pre>
   * <p>
   *
   ...
   *    boolean is_vect_an_item = vect.isKindOf(def);</pre>
   * <p>
   *
   * @param type the given type (instance of EEntity_definition).
   ...
   * <P><B>Example:</B>
   * <P><pre>    EVector vect = ...;
   *    boolean is_vect_an_item = vect.isKindOf(ERepresentation_item.class);</pre>
   * <p>
   *
   * @param type <code>java.lang.Class</code> object which describes java class
   *             representing some entity instance.
   ...
   *    dir.findEntityInstanceUsers(domain, dir_list);</pre>
   * <p>
   *
   ...
   *    product.findEntityInstanceUsedin(attrib, null, formations);</pre>
   * <P><B>Example 2</B> illustrating early binding alternative:
   * <P><pre>    EProduct product = ...;
   *    AProduct_definition_formation formations = new AProduct_definition_formation();
   *    CProduct_definition_formation.usedinOf_product(null, product, null, formations);</pre>
   * <p>
   *
   ...
   * <P><pre>    EProduct pro = ...;
   *    EDirection dir = ...;
   *    AAttribute attribute_list = new AAttribute();
   *    pro.findInstanceRoles(null, attribute_list);
   *    ASdaiModel domain = ...;
   *    dir.findInstanceRoles(domain, attribute_list);
   *    // The obtained attributes could be used when invoking
   *    // <code>findEntityInstanceUsedin</code> method as shown below.
   *    EAttribute attrib = attribute_list.getByIndexEntity(1);
   *    AProduct_definition_formation formations = new AProduct_definition_formation();
   *    pro.findEntityInstanceUsedin(attrib, null, formations);</pre>
   * <p>
   *
   * @param domain the list of <code>SdaiModel</code>s specifying the
   ...
   *    ATrimming_select aggr = curve.createAggregate(attr, null);</pre>
   *
   ...
   * <P><B>Example:</B>
   * <P><pre>    EEntity inst = ...;
   *    String ident = inst.getPersistentLabel();</pre>
   ...
   * <P><B>Example:</B>
   * <P><pre>    EVector vect = ...;
   *    System.out.println("instance: " + vect);</pre>
   ...
   * <P><B>Example:</B>
   * <P><pre>    EEntity_definition armEntity = ....
   ...
   * <P><pre>    EVector vect1 = ...;
   *    EVector vect2 = ...;
   *    boolean equal = vect1.compareValuesBoolean(vect2);</pre>
   *
...
*/
  ...
  /**
   * Returns the value of the specified attribute in the form of an
   * object of type <code>Value</code>. The attribute value is wrapped
   * in that object.
   * <p> The list of cases when <code>SdaiException</code> is thrown
   * contains the following items:
   * <ul><li> AT_NDEF if no attribute is submitted;
   * <li> AT_NVLD if attribute is not from this entity;
   * <li> VA_NSET if attribute has no value assigned.</ul>
   *
   * <P><B>Example:</B>
   * <P><pre>
   *    SdaiModel mod = repo.findSdaiModel("default");
   *    ESchema_definition sch_def = mod.getUnderlyingSchema();
   *    EEntity inst_901 = repo.getSessionIdentifier("#901");
   *    EAttribute attrib = inst_901.getAttributeDefinition("value_component");
   *    SdaiModel a_work_model = repo.createSdaiModel("working", sch_def);
   *    a_work_model.startReadWriteAccess();
   *    SdaiContext context = new SdaiContext(sch_def, null, a_work_model);
   *    Value va = inst_901.get(attrib, context);
   *    EDefined_type sel[] = new EDefined_type [5];
   *    int val_tp = va.test(sel);
   *    // Now "sel" array contains select path specifying the attribute value
   *    </pre>
   *
   * @param attribute the attribute whose value is asked.
   * @param context   context where the derived attribute value is calculated.
   * @return
   * @throws SdaiException EI_NEXS, entity instance does not exist.
   * @throws SdaiException AT_NDEF, attribute not defined.
   * @throws SdaiException AT_NVLD, attribute invalid.
   ...
   *    EDirection dir = (EDirection)val.getInstance();</pre>
   *
   * @param attribute the attribute which value is needed.
   ...
   *    // move and inst4055 point to the same entity instance </pre>
   * <p>
   *
   ...
   *    // copy and inst2241 point to the same entity instance </pre>
   * <p>
   *
