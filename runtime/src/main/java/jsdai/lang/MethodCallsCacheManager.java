...
// 	}
  ...
  static MethodCallsCache methodCallsCache(SdaiSession session, Object cacheId) {
    synchronized (session) {
...
// 				session.methodCallsCacheMap.clear();
  ...
  private static class PrintStatisticThread extends Thread {
    private final SdaiSession session;
    ...
    public void run() {
      ...
      while (cacheIter.hasNext()) {
        ...
        System.out.println(entry.getKey() + ": size = " + cache.getCacheSize() + " gets: " + cache.getCallsCount() + " sets: " + cache.getUniqueCalls()
            + " hits: " + cache.getHits());
      }
      ...
      System.out.println("findMostSpecificMappingsMillis: " + Mapping.findMostSpecificMappingsMillis);
      System.out.println("addMostSpecificMappingsMillis: " + Mapping.addMostSpecificMappingsMillis);
      System.out.println("getMappedAttributeEntityMillis: " + ObjectMapping.getMappedAttributeEntityMillis);
      //System.out.println(": " + );
    }
  }
