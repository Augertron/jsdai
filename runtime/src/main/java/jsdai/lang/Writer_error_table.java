...
class Writer_error_table {
  ...
  Writer_error_table() throws SdaiException {
    ...
    /* Writer errors */
    val = messages.put(new Integer(PhFileWriter.INTERNAL_ERROR_WR), "  Writer error: Internal error.");
    if (val != null) {
    ...
    val = messages.put(new Integer(PhFileWriter.REDEFINE_IN_USER_DEFINED), "  Writer error: Redefinition is not allowed in user-defined entity.");
    if (val != null) {
      String base = "\n" + AdditionalMessages.WR_OUT + "\n     Unable to initialize table of messages";
      throw new SdaiException(SdaiException.SY_ERR, base);
    }
    ...
    val = messages.put(new Integer(PhFileWriter.ENTITY_NOT_FOUND_FOR_WRITER), "  Writer error: Entity not found in the table.");
    if (val != null) {
      String base = "\n" + AdditionalMessages.WR_OUT + "\n     Unable to initialize table of messages";
      throw new SdaiException(SdaiException.SY_ERR, base);
    }
