...
class SchemaInstanceDictionaryImpl extends SchemaInstance {
  ...
  SchemaInstanceDictionaryImpl(String given_name, CSchema_definition schema, SdaiRepository given_repository) throws SdaiException {
    super(given_name, schema, given_repository);
  }

  SchemaInstanceDictionaryImpl(String given_name, SdaiRepository given_repository, SdaiModel given_dictionary, SdaiModel given_schema_model)
...
//		} // syncObject
  ...
  public void delete() throws SdaiException {
    throw new SdaiException(SdaiException.FN_NAVL, "Schema instances in the system repository cannot be deleted by the user.");
  }

  public void addSdaiModel(SdaiModel model) throws SdaiException {
//		synchronized (syncObject) {
    if (!allow_model) {
      throw new SdaiException(SdaiException.FN_NAVL, "Schema instances in the system repository cannot be modified by the user.");
    }
