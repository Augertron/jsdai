 ...
 */
public class Aa_binary extends CAggregate {

  Aa_binary() {
    super();
  }

  Aa_binary(EAggregation_type provided_type, CEntity instance) {
   ...
   * the first parameter is of type <code>A_binary</code> and the second parameter is dropped.
   *
   * @param value
   * @return
   */
   ...
   * with return value of type <code>A_binary</code> instead of <code>Object</code>.
   *
   * @param index
   * @return
   */
  public A_binary getByIndex(int index) throws SdaiException {
    return (A_binary) getByIndexObject(index);
  }
   ...
   * EDefined_type [])} method - the return value is of type <code>A_binary</code> instead of <code>Object</code> and the second
  ...
  public A_binary createAggregateByIndex(int index) throws SdaiException {
    return (A_binary) createAggregateByIndex(index, null);
  }
  ...
  public A_binary addAggregateByIndex(int index) throws SdaiException {
    return (A_binary) addAggregateByIndex(index, null);
  }
   ...
   * createAggregateUnordered(EDefined_type [])} method - the return value is of type <code>A_binary</code> instead of
   * <code>Object</code> and the parameter is dropped.
   *
   * @return
   */
  public A_binary createAggregateUnordered() throws SdaiException {
    return (A_binary) createAggregateUnordered(null);
  }

  /**
   * It is a specialization of {@link Aggregate#removeUnordered(Object, EDefined_type []) removeUnordered(Object, EDefined_type
   * [])} method - the first parameter is of type <code>A_binary</code> and the second parameter is dropped.
   *
   * @param value
   */
  ...
  public A_binary getCurrentMember(SdaiIterator iter) throws SdaiException {
    return (A_binary) getCurrentMemberObject(iter);
  }
   ...
   * createAggregateAsCurrentMember(SdaiIterator, EDefined_type [])} method - the return value is of type <code>A_binary</code>
  ...
  public A_binary createAggregateAsCurrentMember(SdaiIterator iter) throws SdaiException {
    return (A_binary) createAggregateAsCurrentMember(iter, null);
  }
   ...
   * createAggregateBefore(SdaiIterator, EDefined_type [])} method - the return value is of type <code>A_binary</code> instead
  ...
  public A_binary createAggregateBefore(SdaiIterator iter) throws SdaiException {
    return (A_binary) createAggregateBefore(iter, null);
  }
   ...
   * createAggregateAfter(SdaiIterator, EDefined_type [])} method - the return value is of type <code>A_binary</code> instead of
  ...
  public A_binary createAggregateAfter(SdaiIterator iter) throws SdaiException {
    return (A_binary) createAggregateAfter(iter, null);
  }
