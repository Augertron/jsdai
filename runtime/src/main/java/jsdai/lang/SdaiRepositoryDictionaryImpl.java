...
class SdaiRepositoryDictionaryImpl extends SdaiRepository {
  ...
  SdaiRepositoryDictionaryImpl(SdaiSession session, String name, Object location, boolean fCheckNameLocation) throws SdaiException {
  ...
  protected SdaiRepository createVirtualRepository(String name) throws SdaiException {
    throw new SdaiException(SdaiException.SS_NAVL, "This method can not be used with system repository");
  }
...
//		} // syncObject
  ...
  SchemaInstance createDictionarySchemaInstance(String given_name, CSchema_definition schema) throws SdaiException {
  ...
  void loadSchemaInstances(Properties index, HashMap models_from_index_files) throws SdaiException {
    ...
    for (Enumeration e = index.propertyNames(); e.hasMoreElements(); ) {
      ...
      if (prop_key.startsWith("IM.")) { //-- imported model
        if (!prop_key.equals("IM." + SdaiSession.DICT_MODEL_NAME) && !prop_key.equals("IM." + SdaiSession.MAPP_MODEL_NAME)
            && !prop_key.equals("IM." + SdaiSession.COMP_MODEL_NAME)) {
