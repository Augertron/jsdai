...
public class SdaiEvent extends EventObject {
  ...
  /**
   * Shared mode lock was removed from remote <code>SdaiRepository</code>, <code>SchemaInstance</code>, or
   * <code>SdaiModel</code> on JSDAI-DB
   *
   * @since 4.1.0
   */
  ...
  /**
   * Exclusive mode lock was removed from remote <code>SdaiRepository</code>, <code>SchemaInstance</code>, or
   * <code>SdaiModel</code> on JSDAI-DB
   *
   * @since 4.1.0
   */
  ...
  /**
   * All locks was removed from remote <code>SdaiRepository</code>, <code>SchemaInstance</code>, or <code>SdaiModel</code> on
   * JSDAI-DB
   *
   * @since 4.1.0
   */
  ...
  /**
   * Event item value to indicate modification of remote <code>SdaiRepository</code>, <code>SchemaInstance</code>,
  ...
  /**
   * Event item value to indicate modification of both remote <code>SdaiRepository</code>, <code>SchemaInstance</code>,
