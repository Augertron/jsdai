...
public class Aa_integer extends CAggregate {
   ...
   * the first parameter is of type <code>A_integer</code> and the second parameter is dropped.
   *
   * @param value
   * @return
   */
   ...
   * EDefined_type [])} method - the return value is of type <code>A_integer</code> instead of <code>Object</code> and the
   ...
   * createAggregateUnordered(EDefined_type [])} method - the return value is of type <code>A_integer</code> instead of
   ...
   * createAggregateAsCurrentMember(SdaiIterator, EDefined_type [])} method - the return value is of type <code>A_integer</code>
   ...
   * createAggregateBefore(SdaiIterator, EDefined_type [])} method - the return value is of type <code>A_integer</code> instead
   ...
   * createAggregateAfter(SdaiIterator, EDefined_type [])} method - the return value is of type <code>A_integer</code> instead
   * of <code>Object</code> and the second parameter is dropped.
   *
   * @param iter
   * @return
