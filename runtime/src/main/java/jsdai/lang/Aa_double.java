 ...
 */
public class Aa_double extends CAggregate {

  Aa_double() {
    super();
  }

  Aa_double(EAggregation_type provided_type, CEntity instance) {
   ...
   * the first parameter is of type <code>A_double</code> and the second parameter is dropped.
   *
   * @param value
   * @return
   */
   ...
   * with return value of type <code>A_double</code> instead of <code>Object</code>.
   *
   * @param index
   * @return
   */
  public A_double getByIndex(int index) throws SdaiException {
    return (A_double) getByIndexObject(index);
  }
   ...
   * EDefined_type [])} method - the return value is of type <code>A_double</code> instead of <code>Object</code> and the second
  ...
  public A_double createAggregateByIndex(int index) throws SdaiException {
    return (A_double) createAggregateByIndex(index, null);
  }
  ...
  public A_double addAggregateByIndex(int index) throws SdaiException {
    return (A_double) addAggregateByIndex(index, null);
  }
   ...
   * createAggregateUnordered(EDefined_type [])} method - the return value is of type <code>A_double</code> instead of
   * <code>Object</code> and the parameter is dropped.
   *
   * @return
   */
  public A_double createAggregateUnordered() throws SdaiException {
    return (A_double) createAggregateUnordered(null);
  }

  /**
   * It is a specialization of {@link Aggregate#removeUnordered(Object, EDefined_type []) removeUnordered(Object, EDefined_type
   * [])} method - the first parameter is of type <code>A_double</code> and the second parameter is dropped.
   *
   * @param value
   */
  ...
  public A_double getCurrentMember(SdaiIterator iter) throws SdaiException {
    return (A_double) getCurrentMemberObject(iter);
  }
   ...
   * createAggregateAsCurrentMember(SdaiIterator, EDefined_type [])} method - the return value is of type <code>A_double</code>
  ...
  public A_double createAggregateAsCurrentMember(SdaiIterator iter) throws SdaiException {
    return (A_double) createAggregateAsCurrentMember(iter, null);
  }
   ...
   * createAggregateBefore(SdaiIterator, EDefined_type [])} method - the return value is of type <code>A_double</code> instead
  ...
  public A_double createAggregateBefore(SdaiIterator iter) throws SdaiException {
    return (A_double) createAggregateBefore(iter, null);
  }
   ...
   * createAggregateAfter(SdaiIterator, EDefined_type [])} method - the return value is of type <code>A_double</code> instead of
  ...
  public A_double createAggregateAfter(SdaiIterator iter) throws SdaiException {
    return (A_double) createAggregateAfter(iter, null);
  }
