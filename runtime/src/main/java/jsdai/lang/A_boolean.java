...
public class A_boolean extends A_integerPrimitive {
  ...
  /**
   * It is a specialization of {@link Aggregate#isMember(boolean, EDefined_type []) isMember(boolean, EDefined_type [])} method
...
//		} // syncObject
  ...
  /**
   * It is a specialization of {@link Aggregate#setByIndex(int, boolean, EDefined_type []) setByIndex(int, boolean,
...
//		} // syncObject
  ...
  /**
   * It is a specialization of {@link Aggregate#addByIndex(int, boolean, EDefined_type []) addByIndex(int, boolean,
   * EDefined_type [])} method - the third parameter is dropped.
   *
   * @param index
   * @param value
...
//		} // syncObject
  ...
  public final void addByIndex(int index, boolean value, EDefined_type select[]) throws SdaiException {
...
//		} // syncObject
  ...
  /**
   * It is a specialization of {@link Aggregate#addUnordered(boolean, EDefined_type []) addUnordered(boolean, EDefined_type [])}
...
//		} // syncObject
  ...
  /**
   * It is a specialization of {@link Aggregate#removeUnordered(boolean, EDefined_type []) removeUnordered(boolean,
   * EDefined_type [])} method - the second parameter is dropped.
   *
   * @param value
   */
...
//		} // syncObject
  ...
  /**
   * It is a specialization of {@link Aggregate#setCurrentMember(SdaiIterator, boolean, EDefined_type [])
   * setCurrentMember(SdaiIterator, boolean, EDefined_type [])} method - the third parameter is dropped.
   *
   * @param iter
   * @param value
   */
...
//		} // syncObject
  ...
  public final void setCurrentMember(SdaiIterator iter, boolean value, EDefined_type select[]) throws SdaiException {
  ...
  /**
   * It is a specialization of {@link Aggregate#addBefore(SdaiIterator, boolean, EDefined_type []) addBefore(SdaiIterator,
   * boolean, EDefined_type [])} method - the third parameter is dropped.
   *
   * @param iter
   * @param value
   */
...
//		} // syncObject
  ...
  public final void addBefore(SdaiIterator iter, boolean value, EDefined_type select[]) throws SdaiException {
  ...
  /**
   * It is a specialization of {@link Aggregate#addAfter(SdaiIterator, boolean, EDefined_type []) addAfter(SdaiIterator,
   * boolean, EDefined_type [])} method - the third parameter is dropped.
   *
   * @param iter
   * @param value
...
//		} // syncObject
  ...
  public final void addAfter(SdaiIterator iter, boolean value, EDefined_type select[]) throws SdaiException {
    addAfter(iter, value);
  }
