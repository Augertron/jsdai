...
public interface SdaiQuery {
   ...
   * @throws SdaiException if an error occurs during the operation
   *                       or in underlying JSDAI operations
   * @deprecated This method does not support <code>&lt;items&gt;</code> constraint. For queries V1.1 the preferred way is to
   * use {@link #getResultSet(String)}.
   */
