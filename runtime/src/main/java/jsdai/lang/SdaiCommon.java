...
abstract class SdaiCommon {
  ...
  protected static final int feature_level = 1; // 0 is for version 1.0, and 1 is for version 1.1
// level 0 features:
...
//  - implementation class 5;
  ...
  protected abstract SdaiCommon getOwner();

  protected abstract void modified() throws SdaiException;
