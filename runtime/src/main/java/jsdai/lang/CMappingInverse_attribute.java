...
public abstract class CMappingInverse_attribute extends AttributeDefinition implements MappingConstraintPath, MappingConstraintMatcher {
  ...
  public MatcherInstances findForward(MappingContext mappingContext, MatcherInstances instances, boolean decCacheUseCnt) throws SdaiException {
    ...
    if (outInstances != null) {
      ...
      EInverse_attribute selfInterface = (EInverse_attribute) this;
      return CMappingExplicit_attribute.generalFindBackward(selfInterface.getInverted_attr(null), mappingContext, instances.dup(), decCacheUseCnt);
    }
  }
  ...
  public MatcherInstances findBackward(MappingContext mappingContext, MatcherInstances instances, boolean decCacheUseCnt) throws SdaiException {
    ...
    if (outInstances != null) {
      ...
      EInverse_attribute selfInterface = (EInverse_attribute) this;
      return CMappingExplicit_attribute.generalFindForward(selfInterface.getInverted_attr(null), mappingContext, instances.dup(), false, decCacheUseCnt);
    }
  }
  ...
  public MatcherInstances findPathBackward(MappingContext mappingContext, MatcherInstances instances, boolean decCacheUseCnt) throws SdaiException {
    ...
    if (outInstances != null) {
      ...
      EInverse_attribute selfInterface = (EInverse_attribute) this;
      return CMappingExplicit_attribute.generalFindForward(selfInterface.getInverted_attr(null), mappingContext, instances.dup(), true, decCacheUseCnt);
    }
  }
