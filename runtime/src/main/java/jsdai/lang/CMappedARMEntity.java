...
public abstract class CMappedARMEntity extends CEntity implements EMappedARMEntity {
  ...
  static private String attributeStateStrings[] = new String[] { "ATTRIBUTES_UNKNOWN", "ATTRIBUTES_UNMODIFIED", "ATTRIBUTES_MODIFIED" };
  ...
  AEntity_definition parseComplexType() throws SdaiException {
    ...
    for (int i = 0; i < ifaces.length; i++) {
      if (EMappedARMEntity.class.isAssignableFrom(ifaces[i]) && (ifaces[i] != EMappedARMEntity.class)) {
        ...
        try {
          Class armClass = Class.forName(className, true, SdaiClassLoaderProvider.getDefault().getClassLoader());
...
//		parseComplexTypeRecursion(model, edef.getName(null), res);
  ...
  public boolean applyMappedAttributes(SdaiContext context) throws SdaiException {
    if (Implementation.mappingSupport) {
      ...
      ObjectMapping objectMapping = Mapping.getEntityMapping(owning_model.repository.session, context.domain, context.mappingDomain);
      ...
      for (int i = entityAttr.length - 1; i >= 0; i--) {
        ...
        CGeneric_attribute_mapping.usedinSource(null, entityAttr[i], context.mappingDomain, attMappings);
        ...
        while (attMapIter.next()) {
          ...
          if (assignMappedValue(context, entityAttr[i], domain, attrValue, null, -1, attMapping, null)) {
            break;
          }
        }
      }
   ...
   * @since 3.6.0
   */
  public boolean assignMappedValue(SdaiContext context, EExplicit_attribute attribute, Object attrValue, EGeneric_attribute_mapping genAttMapping)
      throws SdaiException {
    if (Implementation.mappingSupport) {
      return assignMappedValue(context, attribute, attribute.getDomain(null), attrValue, null, -1, genAttMapping, null);
    }
    else {
      throw new SdaiException(SdaiException.FN_NAVL, AdditionalMessages.MP_NAVL);
    }
   ...
   * @since 3.6.0
   */
  public boolean assignMappedValue(SdaiContext context, EExplicit_attribute attribute, Object attrValue, ANamed_type dataType) throws SdaiException {
    if (Implementation.mappingSupport) {
      return assignMappedValue(context, attribute, attribute.getDomain(null), attrValue, null, -1, null, dataType);
    }
    else {
      throw new SdaiException(SdaiException.FN_NAVL, AdditionalMessages.MP_NAVL);
    }
  ...
  private boolean assignMappedValue(SdaiContext context, Object attrOrAggr, EEntity domain, Object attrValue, EDefined_type selectTypes[], int selectPos,
      EGeneric_attribute_mapping genAttMapping, ANamed_type dataType) throws SdaiException {
    if (domain instanceof ESimple_type) {
      ...
      try {
        ...
        SdaiException wrapper = new SdaiException(e.getErrorId(), e, "Exception for instance: " + this + "\nattribute: " + attrOrAggr + " value: "
            + attrValue + " value class: " + attrValue.getClass() + " selectTypes: " + (selectTypes != null ? selectTypes[0] : null) + " mapping: "
            + genAttMapping + "\n");
        wrapper.initCause(e);
        throw wrapper;
      }
      ...
      if (aggregate != null) {
        ...
        assignMappedValue(context, aggregate, aggregationType.getElement_type(null), attrValue, selectTypes, selectPos, genAttMapping, dataType);
      }
      return false;
    }
      ...
      if (selectTypes != null && newDomain instanceof ESelect_type) {
        ...
        while (selectionIter.next()) {
          ...
          if (selection instanceof EDefined_type
              && assignMappedValue(context, attrOrAggr, selection, attrValue, selectTypes, 0, genAttMapping, dataType)) {
            return true;
          }
        }
        return false;
        ...
        return assignMappedValue(context, attrOrAggr, newDomain, attrValue, selectTypes, selectPos + 1, genAttMapping, dataType);
      }
      else {
        return false;
      }
      ...
      if (attrValue instanceof EEntity) {
        EEntity attrInstance = findOrBuildMappedInstance(context, (EEntity) attrValue, (EEntity_definition) domain,
            (genAttMapping != null) ? BUILD_FLAG_BUILD : BUILD_FLAG_FIND_NOT_NULL);
        if (attrInstance != null) {
          try {
            assignAttrOrAggr(attrOrAggr, attrInstance, null);
          }
          catch (SdaiException e) {
            SdaiException wrapper = new SdaiException(e.getErrorId(), e, "Exception for instance: " + this + "\nattribute: " + attrOrAggr
                + " value: " + attrValue + " value class: " + attrValue.getClass() + " attrInstance: " + attrInstance + " mapping: "
                + genAttMapping + "\n");
            wrapper.initCause(e);
            throw wrapper;
          }
        ...
        while (aggregateIter.next()) {
          ...
          EEntity attrInstance = findOrBuildMappedInstance(context, aggrInst, domainDefinition, (genAttMapping != null) ? BUILD_FLAG_BUILD
              : BUILD_FLAG_FIND_NOT_NULL);
          if (attrInstance != null) {
            assignAttrOrAggr(attrOrAggr, attrInstance, null);
          }
        }
        ...
        while (collectionIter.hasNext()) {
          ...
          if (value instanceof EEntity) {
            EEntity attrInstance = findOrBuildMappedInstance(context, (EEntity) value, domainDefinition, (genAttMapping != null) ? BUILD_FLAG_BUILD
                : BUILD_FLAG_FIND_NOT_NULL);
            if (attrInstance != null) {
              assignAttrOrAggr(attrOrAggr, attrInstance, null);
            }
      ...
      if (attrValue instanceof String) {
        ...
        attrValue = new Integer(LangUtils.convertEnumerationStringToInt((String) attrValue, (EEnumeration_type) domain));
        try {
          assignAttrOrAggr(attrOrAggr, attrValue, selectTypes);
        }
        catch (SdaiException e) {
          SdaiException wrapper = new SdaiException(e.getErrorId(), e, "Exception for instance: " + this + "\nattribute: " + attrOrAggr
              + "origValue: " + origValue + " value: " + attrValue + " domain: " + domain + " selectTypes: " + selectTypes + " mapping: "
              + genAttMapping + "\n");
          wrapper.initCause(e);
          throw wrapper;
        }
        ...
        throw new SdaiException(SdaiException.FN_NAVL, "No support for EEnumeration_type attributes yet: " + this + "\n" + genAttMapping + "\n"
            + domain + "\n" + attrValue);
      }
    }
      ...
      if (attrValue instanceof EEntity || attrValue instanceof AEntity || attrValue instanceof Collection) {
        EAttribute_mapping attrMapping = (EAttribute_mapping) genAttMapping;
        EEntity domainEntity;
        if (attrMapping != null && attrMapping.testDomain(null) && (domainEntity = attrMapping.getDomain(null)) instanceof EEntity_mapping) {
          ...
          if (attrValue instanceof EEntity) {
            ...
            AEntity_mapping mostSpecificMappings = instance.findMostSpecificMappings(context.domain, context.mappingDomain, baseMappings,
            ...
            if (mostSpecificMappings.getMemberCount() > 0) {
              EEntity attrInstance = Mapping.buildMappedInstance(instance, context, mostSpecificMappings.getByIndex(1));
              if (attrInstance != null) {
                assignAttrOrAggr(attrOrAggr, attrInstance, null);
                return true;
              }
            ...
            while (aggregateIter.next()) {
              EEntity aggrInst = aggregate.getCurrentMemberEntity(aggregateIter);
              AEntity_mapping mostSpecificMappings = aggrInst.findMostSpecificMappings(context.domain, context.mappingDomain, baseMappings,
                  EEntity.NO_RESTRICTIONS);
              //FIXME: What if more than one mapping is returned in mostSpecificMappings?
              if (mostSpecificMappings.getMemberCount() > 0) {
                EEntity attrInstance = Mapping.buildMappedInstance(aggrInst, context, mostSpecificMappings.getByIndex(1));
                if (attrInstance != null) {
                  assignAttrOrAggr(attrOrAggr, attrInstance, null);
                  aggResult = true;
                }
          ...
          if (attrValue instanceof EEntity) {
            if (!assignGeneralEntitySelect(context, attrOrAggr, selectDomain, (EEntity) attrValue, genAttMapping != null)) {
              //FIXME: implement the case when entity domain as entity_mapping isn't given
              throw new SdaiException(SdaiException.FN_NAVL, "No support for selects yet (1): " + this + "\nattrOrAggr: " + attrOrAggr
            ...
            while (aggregateIter.next()) {
              EEntity aggrInst = aggregate.getCurrentMemberEntity(aggregateIter);
              aggResult |= assignGeneralEntitySelect(context, attrOrAggr, selectDomain, aggrInst, genAttMapping != null);
            }
            return aggResult;
          }
          else {
            ...
            while (collectionIter.hasNext()) {
              ...
              if (value instanceof EEntity) {
                ...
                aggResult |= assignGeneralEntitySelect(context, attrOrAggr, selectDomain, (EEntity) value, genAttMapping != null);
              }
            }
            return aggResult;
          }
        ...
        if (genAttMapping != null) {
          dataType = genAttMapping.testData_type(null) ? genAttMapping.getData_type(null) : null;
        }
        if (dataType == null) {
          ...
          for (int i = 0; i < domainType.count; i++) {
            if (domainType.paths[i].length == 1) {
              ...
              if ((attrValue instanceof String && selectDomain instanceof EString_type)
                  || (attrValue instanceof Integer && selectDomain instanceof EInteger_type)
                  || (attrValue instanceof Double && selectDomain instanceof EReal_type)) {
          ...
          if (select != null) {
            ...
            throw new SdaiException(SdaiException.SY_ERR, "No suitable select path found: " + this + "\n" + genAttMapping + "\n" + domain + "\n"
                + attrValueString);
          }
        }
        else {
          ...
          while (selectionIter.next()) {
            ENamed_type selection = selections.getCurrentMember(selectionIter);
            if (selection instanceof EDefined_type
                && assignMappedValue(context, attrOrAggr, selection, attrValue, select, 0, genAttMapping, dataType)) {
              return true;
            }
          }
          return false;
...
// 											this + "\n" + genAttMapping + "\n" + domain);
  ...
  private void assignAttrOrAggr(Object attrOrAggr, Object attrValue, EDefined_type[] select) throws SdaiException {
  ...
  private Aggregate createAttrOrAggr(Object attrOrAggr, EDefined_type[] selectTypes, boolean mandatoryOnly) throws SdaiException {
    if (attrOrAggr instanceof EAttribute) {
      EAttribute attribute = (EAttribute) attrOrAggr;
      if (mandatoryOnly && (!(attribute instanceof EExplicit_attribute) || ((EExplicit_attribute) attribute).getOptional_flag(null))) {
        return null;
      }
    ...
    throw new SdaiException(SdaiException.SY_ERR, "FATAL! Nothing known about this attrOrAggr type: " + attrOrAggr);
  }

  private boolean assignGeneralEntitySelect(SdaiContext context, Object attrOrAggr, ESelect_type selectDomain, EEntity attrValue, boolean build)
      throws SdaiException {
    ANamed_type selections = selectDomain.getSelections(null);
    SdaiIterator selectionIter = selections.createIterator();
    int entDefCount = 0;
    while (selectionIter.next()) {
      ...
      if (selection instanceof EEntity_definition) {
        entDefCount++;
        EEntity attrInstance = findOrBuildMappedInstance(context, attrValue, (EEntity_definition) selection, build ? BUILD_FLAG_BUILD
            : BUILD_FLAG_FIND_NULL);
        if (attrInstance != null) {
          assignAttrOrAggr(attrOrAggr, attrInstance, null);
          return true;
        }
        ...
        if (definedTypeDomain instanceof ESelect_type) {
          if (assignGeneralEntitySelect(context, attrOrAggr, (ESelect_type) definedTypeDomain, attrValue, build)) {
            return true;
          }
        }
      }
    ...
    if (entDefCount == 1) {
      ...
      while (selectionIter.next()) {
        ENamed_type selection = selections.getCurrentMember(selectionIter);
        if (selection instanceof EEntity_definition) {
          EMappedARMEntity attrInstance = (EMappedARMEntity) context.mappedWorkingModel.createEntityInstance((EEntity_definition) selection);
          attrInstance.setAimInstance(attrValue);
  ...
  static private EEntity findOrBuildMappedInstance(SdaiContext context, EEntity instance, EEntity_definition entityDefinition, int buildFlag)
      throws SdaiException {
    EEntity armInstance = (buildFlag == BUILD_FLAG_BUILD) ? instance.buildMappedInstance(context, entityDefinition) : instance
        .findLinkedMappedInstance(entityDefinition);
  ...
  public void removeAimData(SdaiContext context) throws SdaiException {
    if (Implementation.mappingSupport) {
      throw new SdaiException(SdaiException.EX_NSUP, "removeAimData is not implemented in generic level");
    }
    else {
      throw new SdaiException(SdaiException.FN_NAVL, AdditionalMessages.MP_NAVL);
    }
  ...
  static EMappedARMEntity findLinkedMappedInstance(EEntity aimInstance, EEntity_definition mappedInstanceType) throws SdaiException {
    CMappedARMEntity firstArm = (CMappedARMEntity) aimInstance.getTemp(TEMP_KEY_ARM_SIDE);
    while (firstArm != null) {
      ...
      if (firstArmType == mappedInstanceType || ((CEntityDefinition) firstArmType).isSubtypeOf(mappedInstanceType)) {
        return firstArm;
      }
      firstArm = firstArm.nextArm;
    }
   ...
   */
  public void addAggregateItemSimple(EEntity parentInstance, EExplicit_attribute attribute, EEntity targetValue, boolean useIndexMask, int index)
      throws SdaiException {
    ...
    if (parentInstance.testAttribute(attribute, null) != 0) {
      ...
      aggregateValue = getICM().createAggregate(parentInstance, attribute, null);
    }
...
//				aggr.addUnordered(finalAimInstance, null);
  ...
  EEntity goThroughEntityConstraint(EEntity finalAimInstance, EEntity_constraint ec, EEntity generatedInstance, boolean useGeneratedInstance)
      throws SdaiException {
      ...
      if (attributeSelect instanceof EExplicit_attribute) {
        ...
        if (finalAimInstance.testAttribute(attribute, types) != 0) {
          ...
          if (obj != generatedInstance) {
            throw new SdaiException(SdaiException.VA_NVLD, "Instance values should be equal:" + obj + ", " + generatedInstance);
          }
        }
        else {
    ...
    if (attributeSelect instanceof EExplicit_attribute) {
      ...
      throw new SdaiException(SdaiException.ED_NVLD, "This type of attribute is not supported yet." + attributeSelect);
      // return null;
    }
  }
  ...
  EEntity makeConstraintStep(EEntity finalAimInstance, EEntity constraints, EEntity generatedInstance, boolean useGeneratedInstance) throws SdaiException {
    if (constraints instanceof EExplicit_attribute) {
      ...
      if (finalAimInstance == null) {
        throw new SdaiException(SdaiException.VA_NVLD, "makeConstraintStep() returned null on constraint: " + element1);
      }
...
//			System.out.println("Warning: Or_relationship_constraint was met - using element2 branch: " + ocr);
      ...
      throw new SdaiException(SdaiException.EI_NVLD, " This type of constraint is not implemented in makeConstraintStep(): " + constraints.toString());
    }
  }
  ...
  protected void setAttributeValue(EEntity finalAimInstance, EAttribute_value_constraint avc) throws SdaiException {
    ...
    if (attr instanceof EExplicit_attribute) {
      ...
      if (avc instanceof EString_constraint) {
        ...
        throw new SdaiException(SdaiException.ED_NVLD, "This type of attribute_value_constraints isn't implemented yet: " + avc.toString());
      }
    }
      ...
      throw new SdaiException(SdaiException.ED_NVLD, "This kind of attribute isn't supported in setAttributeValue(): " + attr.toString());
    }
  ...
  protected boolean useGeneratedInstance(EEntity constraints) throws SdaiException {
    ...
    if ((subConstraint instanceof EPath_constraint) || (subConstraint instanceof EAnd_constraint_relationship)) {
      return false;
    }
  ...
  private void createAttributeFromPath(EEntity finalAimInstance, EAttribute armAttribute, EEntity constraints, EEntity_definition targetDefinition,
      EEntity generatedAimInstance, boolean useGeneratedInstance, EDefined_type[] types) throws SdaiException {
    if (constraints instanceof EExplicit_attribute) {
      ...
      createAttributeFromPath(finalAimInstance, armAttribute, acr.getElement1(null), targetDefinition, generatedAimInstance, useGeneratedInstance(acr),
          types);
    }
      ...
      throw new SdaiException(SdaiException.ED_NVLD, "This type of constraint not supported for createAttributeFromPath(): " + constraints.toString());
    }
  }
...
//		throw new SdaiException(SdaiException.ED_NVLD, " This type of entity isn't checked in getFinalARMdefintion.");
  ...
  protected boolean matchesAttributeMappingValue(EAttribute_mapping_value amv) throws SdaiException {
    ...
    if (!(attr instanceof EExplicit_attribute)) {
      throw new SdaiException(SdaiException.ED_NVLD, "This type of attribute_mapping_value source is not implemented in matchesAttributeMappingValue(): "
          + attr);
    }
...
//			Boolean instance_value = (Boolean) get_object(expl_attr);
      ...
      throw new SdaiException(SdaiException.ED_NVLD, " This type of attribute_mapping_value is not implemented in matchesAttributeMappingValue()." + amv);
    }
    return false;
  }
  ...
  protected Method findAttributeSetter(Class entityClass, EAttribute attribute) throws SdaiException {
    try {
      ...
      if (className.startsWith("C")) {
        attributeDomain = Class.forName(packageName + ".E" + className.substring(1), true, SdaiClassLoaderProvider.getDefault().getClassLoader());
      }
  ...
  protected Method findAttributeSetter(Class entityClass, String attributeName, Class attributeDomain) {
    ...
    try {
      ...
      Class cxClass = Class.forName(cxClassName, true, SdaiClassLoaderProvider.getDefault().getClassLoader());
...
//			unsetMappedAttribute(contextTmp, gam);
      ...
      if ((armAttribute instanceof EExplicit_attribute) && (target instanceof EExplicit_attribute)) {
       ...
       * createAttributeFromPath(aimInstance, (EAttribute) armAttribute, constraints, mappingTarget, generatedInstance,
       * false, null);
       * continue;
       * } else if (obj instanceof AEntity) {
       * AEntity ae = (AEntity) obj;
...
//		}
  ...
  protected static String listAttributes(AAttribute aat, String message) throws SdaiException {
    ...
    for (int i = 1; i <= aat.getMemberCount(); i++) {
      EAttribute eat = aat.getByIndex(i);
...
///////////////
  ...
  void unsetAttributeRecursion(EEntity finalAimInstance, SdaiContext context, EEntity constraints) throws SdaiException {
    if (constraints instanceof EExplicit_attribute) {
      ...
      if ((users.getMemberCount() == 0) || ((users.getMemberCount() == 1) && (users.isMember(finalAimInstance)))) {
  ...
  private void unsetMappedAttribute(SdaiContext context, EGeneric_attribute_mapping attribute) throws SdaiException {
    ObjectMapping objectMapping = Mapping.getEntityMapping(owning_model.repository.session, context.domain, context.mappingDomain);
    Object mappedInstance = objectMapping.getMappedAttribute(aimInstance, attribute, EEntity.NO_RESTRICTIONS, false);
    if (mappedInstance != null) {
      unsetAttributeRecursion(aimInstance, context, attribute.getConstraints(null));
    }
  }

  protected void setSimpleAttributes(EEntity_definition exactAIMType, EEntity armInstance, SdaiContext context, EAttribute[] attributePairs)
      throws SdaiException {
  ...
  protected void setSimpleAttributes(EEntity_definition exactAIMType, EEntity attributesInstance, EEntity armInstance, SdaiContext context,
  ...
  protected void setSimpleAttribute(EEntity attributesInstance, EAttribute aimAttribute, EAttribute armAttribute, SdaiContext context, EDefined_type[] types)
      throws SdaiException {
...
//				System.out.println(": " + equals);
    ...
    protected void storeAggregate(EEntity persistentObject, AEntity value, EAttribute attr, LinkedList instancesList, LinkedList persistentInstances)
        throws SdaiException {
    ...
    protected void replaceAttributes(EEntity instance, EEntity persistentInstance, LinkedList instances, LinkedList persistentInstances)
        throws SdaiException {
