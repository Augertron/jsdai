  ...
  void PrintToken() {
    ...
    switch (type) {
      ...
      case PhFileReader.ERROR:
        str_type = "error";
        System.out.println("SCANNER>  " + str_type + " error_index=" + integer + " line=" + line + " column=" + column);
        break;
      ...
      case PhFileReader.INSTANCE_NAME:
        ...
        System.out.println("SCANNER>  " + str_type + " instance=" + integer + " line=" + line + " column=" + column);
        break;
      case PhFileReader.INTEGER:
        str_type = "INTEGER";
        System.out.println("SCANNER>  " + str_type + " value=" + integer + " line=" + line + " column=" + column);
        break;
      ...
      case PhFileReader.REAL:
        str_type = "REAL";
        System.out.println("SCANNER>  " + str_type + " value=" + real + " line=" + line + " column=" + column);
        break;
