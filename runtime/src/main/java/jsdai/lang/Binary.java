...
public final class Binary {
   ...
   * A correspondence between a value of binary data type and its <code>String</code> representation is defined as follows.
   ...
   * <p>
   * If the <code>String</code> submitted cannot be mapped to a bit sequence according to the above rules, then SdaiException
   * VA_NVLD is thrown.
   *
...
//		} // syncObject
  ...
  /**
   * Initializes a newly created <code>Binary</code> object so that it
   * represents the sequence of bits described by the argument of type <code>byte</code> array.
   * A correspondence between a value of binary data type and its <code>byte</code> array representation is defined as follows.
   ...
   * <p>
   * If the <code>byte</code> array submitted cannot be mapped to a bit sequence according to the above rules, then
   * SdaiException VA_NVLD is thrown.
   *
...
//		} // syncObject
   ...
   * <B>Example:</B>
   * <p>
   * <pre>    Binary bin = ...; // suppose that value is 0100101011
   *    System.out.println("Binary value: " + bin);
   * </pre> &nbsp;&nbsp;&nbsp;&nbsp;The following string will be printed:
   *
   * <pre>
   * Binary value: 212B
   * </pre>
...
//		} // syncObject
   ...
   *    }</pre> &nbsp;&nbsp;&nbsp;&nbsp;The following lines will be printed:
   *
   * <pre>
   * i = 0  value = 2
   * </pre>
...
//		} // syncObject
   ...
   * @return <code>true</code> if and only if the argument is not <code>null</code> and represents the same sequence of bits as
   * this <code>Binary</code> object; <code>false</code> otherwise.
   */
