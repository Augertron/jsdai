...
/**
 * This class gives methods to convert time values from <code>long</code> to <code>String</code> representation and vice versa.
...
public class SdaiCalendar extends java.util.GregorianCalendar {
  ...
  /**
   * Converts the time value specified by <code>String</code> to <code>long</code> equivalent. The format of the description by
   * string
   * is specified in ISO 8601 (for details, see ISO 10303-21::9.2.2 file_name).
   * <p>
   * <B>Example:</B>
   * <p>
   * <pre>    SdaiCalendar cal = ...;
   *    String time = "2000-06-25T06:04:02";
   *    long time_as_long = cal.timeStampToLong(time);
   *    System.out.println("Time: " + time_as_long);</pre> &nbsp;&nbsp;&nbsp;&nbsp;The following line will be printed:
   *
   * <pre>
   * Time: 961909442000
   * </pre>
...
//		} // syncObject
  ...
  /**
   * Converts the time value from <code>long</code> to <code>String</code> representation. The format of the time description by
   * string
   * is specified in ISO 8601 (for details, see ISO 10303-21::9.2.2 file_name).
   * <p>
   * <B>Example:</B>
   ...
   *    System.out.println("Time: " + time);</pre> &nbsp;&nbsp;&nbsp;&nbsp;The following line will be printed:
   *
   * <pre>
