...
public class Aaa_boolean extends CAggregate {
   ...
   * the first parameter is of type <code>Aa_boolean</code> and the second parameter is dropped.
   *
   * @param value
   * @return
   */
   ...
   * EDefined_type [])} method - the return value is of type <code>Aa_boolean</code> instead of <code>Object</code> and the
   ...
   * createAggregateUnordered(EDefined_type [])} method - the return value is of type <code>Aa_boolean</code> instead of
   ...
   * <code>Aa_boolean</code> instead of <code>Object</code> and the second parameter is dropped.
   *
   * @param iter
   * @return
   */
   ...
   * createAggregateBefore(SdaiIterator, EDefined_type [])} method - the return value is of type <code>Aa_boolean</code> instead
   ...
   * createAggregateAfter(SdaiIterator, EDefined_type [])} method - the return value is of type <code>Aa_boolean</code> instead
   * of <code>Object</code> and the second parameter is dropped.
   *
   * @param iter
   * @return
