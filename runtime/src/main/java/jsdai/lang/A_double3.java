...
class A_double3 extends A_double {
  ...
  /**
   * It is a specialization of {@link Aggregate#isMember(double, EDefined_type []) isMember(double, EDefined_type [])} method -
   * the second parameter is dropped.
   */
...
//		} // syncObject
  ...
  /**
   * It is a specialization of {@link Aggregate#setByIndex(int, double, EDefined_type []) setByIndex(int, double, EDefined_type
...
//		} // syncObject
  ...
  /**
   * It is a specialization of {@link Aggregate#addByIndex(int, double, EDefined_type []) addByIndex(int, double, EDefined_type
   * [])} method - the third parameter is dropped.
   */
...
//		} // syncObject
  ...
  public final void addByIndex(int index, double value, EDefined_type select[]) throws SdaiException {
    addByIndex(index, value);
  }

  public final void addByIndex(int index, Object value, EDefined_type select[]) throws SdaiException {
    double valueDouble;
    try {
      valueDouble = ((Double) value).doubleValue();
    }
...
//		} // syncObject
  ...
  /**
   * It is a specialization of {@link Aggregate#addUnordered(double, EDefined_type []) addUnordered(double, EDefined_type [])}
...
//		} // syncObject
  ...
  /**
   * It is a specialization of {@link Aggregate#removeUnordered(double, EDefined_type []) removeUnordered(double, EDefined_type
   * [])} method - the second parameter is dropped.
   */
...
//		} // syncObject
  ...
  /**
   * It is a specialization of {@link Aggregate#setCurrentMember(SdaiIterator, double, EDefined_type [])
   * setCurrentMember(SdaiIterator, double, EDefined_type [])} method - the third parameter is dropped.
   */
...
//		} // syncObject
  ...
  public final void setCurrentMember(SdaiIterator it, double value, EDefined_type select[]) throws SdaiException {
    setCurrentMember(it, value);
  }

  public final void setCurrentMember(SdaiIterator it, Object value, EDefined_type select[]) throws SdaiException {
    double valueDouble;
    try {
      valueDouble = ((Double) value).doubleValue();
    }
  ...
  /**
   * It is a specialization of {@link Aggregate#addBefore(SdaiIterator, double, EDefined_type []) addBefore(SdaiIterator,
   * double, EDefined_type [])} method - the third parameter is dropped.
   */
...
//		} // syncObject	
  ...
  public final void addBefore(SdaiIterator it, double value, EDefined_type select[]) throws SdaiException {
    addBefore(it, value);
  }

  public final void addBefore(SdaiIterator it, Object value, EDefined_type select[]) throws SdaiException {
    double valueDouble;
    try {
      valueDouble = ((Double) value).doubleValue();
    }
  ...
  /**
   * It is a specialization of {@link Aggregate#addAfter(SdaiIterator, double, EDefined_type []) addAfter(SdaiIterator, double,
   * EDefined_type [])} method - the third parameter is dropped.
   */
...
//		} // syncObject
  ...
  public final void addAfter(SdaiIterator it, double value, EDefined_type select[]) throws SdaiException {
    addAfter(it, value);
  }

  public final void addAfter(SdaiIterator it, Object value, EDefined_type select[]) throws SdaiException {
    double valueDouble;
    try {
      valueDouble = ((Double) value).doubleValue();
    }
