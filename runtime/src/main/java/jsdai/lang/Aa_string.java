 ...
 */
public class Aa_string extends CAggregate {

  Aa_string() {
    super();
  }

  Aa_string(EAggregation_type provided_type, CEntity instance) {
   ...
   * the first parameter is of type <code>A_string</code> and the second parameter is dropped.
   *
   * @param value
   * @return
   */
   ...
   * with return value of type <code>A_string</code> instead of <code>Object</code>.
   *
   * @param index
   * @return
   */
  public A_string getByIndex(int index) throws SdaiException {
    return (A_string) getByIndexObject(index);
  }
   ...
   * EDefined_type [])} method - the return value is of type <code>A_string</code> instead of <code>Object</code> and the second
  ...
  public A_string createAggregateByIndex(int index) throws SdaiException {
    return (A_string) createAggregateByIndex(index, null);
  }
  ...
  public A_string addAggregateByIndex(int index) throws SdaiException {
    return (A_string) addAggregateByIndex(index, null);
  }
   ...
   * createAggregateUnordered(EDefined_type [])} method - the return value is of type <code>A_string</code> instead of
   * <code>Object</code> and the parameter is dropped.
   *
   * @return
   */
  public A_string createAggregateUnordered() throws SdaiException {
    return (A_string) createAggregateUnordered(null);
  }

  /**
   * It is a specialization of {@link Aggregate#removeUnordered(Object, EDefined_type []) removeUnordered(Object, EDefined_type
   * [])} method - the first parameter is of type <code>A_string</code> and the second parameter is dropped.
   *
   * @param value
   */
  ...
  public A_string getCurrentMember(SdaiIterator iter) throws SdaiException {
    return (A_string) getCurrentMemberObject(iter);
  }
   ...
   * createAggregateAsCurrentMember(SdaiIterator, EDefined_type [])} method - the return value is of type <code>A_string</code>
  ...
  public A_string createAggregateAsCurrentMember(SdaiIterator iter) throws SdaiException {
    return (A_string) createAggregateAsCurrentMember(iter, null);
  }
   ...
   * createAggregateBefore(SdaiIterator, EDefined_type [])} method - the return value is of type <code>A_string</code> instead
  ...
  public A_string createAggregateBefore(SdaiIterator iter) throws SdaiException {
    return (A_string) createAggregateBefore(iter, null);
  }
   ...
   * createAggregateAfter(SdaiIterator, EDefined_type [])} method - the return value is of type <code>A_string</code> instead of
   * <code>Object</code> and the second parameter is dropped.
   *
   * @param iter
   * @return
   */
  public A_string createAggregateAfter(SdaiIterator iter) throws SdaiException {
    return (A_string) createAggregateAfter(iter, null);
  }

  boolean check_Aa_string() throws SdaiException {
    A_string aggr_el;
    if (myLength <= 0) {
      return true;
    }
    ...
    if (myType == null || myType.express_type == DataType.LIST) {
      ListElement element;
      if (myLength == 1) {
        aggr_el = (A_string) myData;
        if (!aggr_el.check_A_string()) {
          return false;
        }
      }
      else if (myLength == 2) {
        ...
        while (element != null) {
          aggr_el = (A_string) element.object;
          if (!aggr_el.check_A_string()) {
            return false;
          }
