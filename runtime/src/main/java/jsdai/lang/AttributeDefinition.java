...
//			Class cl = ((CEntity)inst.getInstanceType()).owning_model.schemaData.super_inst.getClass();
      ...
      if (dt == null) {
        String base = SdaiSession.line_separator + AdditionalMessages.DI_NOTF + SdaiSession.line_separator + AdditionalMessages.DI_NAME
            + constructName();
      ...
      if (dt.express_type >= DataType.SET && dt.express_type <= DataType.BAG) {
        ...
        String base = SdaiSession.line_separator + AdditionalMessages.DI_WRDT + SdaiSession.line_separator + AdditionalMessages.DI_NAME
            + constructName() + SdaiSession.line_separator + AdditionalMessages.DI_CODE + dt.express_type;
