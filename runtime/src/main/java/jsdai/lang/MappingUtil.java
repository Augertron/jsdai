 ...
 * classes known as M classes. <BR>
 * Here is an example how derived classes can be used: <BR>
 *
 * <pre>
 * import jsdai.MAp214.*;
 * import jsdai.lang.*;
...
public class MappingUtil {
   ...
   * setXX method."
   */
  public static final String setErrorString1 = "Attempt to determine which attribute_mapping" + " to use failed: type of given instance should"
   ...
   */
  public static final String testErrorString1 = "Attempt to determine  type of returned" + " value failed: you may need to regenerate your classes with"
   ...
   * @param conformanceClass <p>
   * @return
   */
  protected static boolean compatibleObjectValue(Object value, Class conformanceClass, boolean parseAggregate) throws SdaiException {
    if (parseAggregate) {
      if (value instanceof ArrayList) {
   ...
   * @return
   */
  protected static boolean compatibleObjectValue(Object value, Class conformanceClass) throws SdaiException {
    if (value instanceof ArrayList) {
      ArrayList aValue = (ArrayList) value;
      int valueSize = aValue.size();
      for (int j = 0; j < valueSize; j++) {
  ...
  protected static Object getAllValuesForAttribute(ASdaiModel domain, ASdaiModel metaDomain, EExplicit_attribute atr, EEntity instance) throws SdaiException {
    if (instance == null) {
      return null;
    }
   ...
   * @return
   */
  protected static Object getAnyValueForAttribute(ASdaiModel domain, ASdaiModel metaDomain, EExplicit_attribute atr, EEntity instance) throws SdaiException {
    Object o = null;
    if (instance == null) {
   ...
   * null is returned.
   */
  protected static Object getAnyValueForAttribute(ASdaiModel domain, ASdaiModel metaDomain, EExplicit_attribute atr, EEntity instance,
  ...
  protected static boolean isCompatible(Class entityType, EEntity target, Hashtable entities2Class) {
  ...
  protected static Aggregate findEntityMappings(EEntity_definition mappedEntity, ASdaiModel mappingDomain, Hashtable entities2Class) {
    ...
    try {
      ...
      while (it.next()) {
        ...
        if (target instanceof EEntity_definition) {
          ...
          Class exactClass = Class.forName(fullName, true, SdaiClassLoaderProvider.getDefault().getClassLoader());
  ...
  public static EAttribute findArmAttribute(EEntity_definition entity, String attributeName) {
    try {
      ...
      while (i.next()) {
        EAttribute att = attributes.getCurrentMember(i);
  ...
  protected static Aggregate findAttrMappings(Aggregate entMappings, EExplicit_attribute attr, ASdaiModel mappingDomain) {
   ...
   * @return
   */
  protected static AAttribute_mapping findAttrMappingsAsRef(Aggregate entMappings, EExplicit_attribute attr, ASdaiModel mappingDomain) {
  ...
  private static boolean acceptableMapping(EEntity_mapping entMap, Aggregate validMappings) throws SdaiException {
   ...
   * @return
   */
  public static EGeneric_attribute_mapping findAttributeMapping(EEntity_mapping em, EAttribute attribute, String dataTypeName, ASdaiModel mappingDomain) {
    try {
  ...
  protected static AEntity findMappingInstances(EEntity_mapping entityMapping, ASdaiModel targetDomain, ASdaiModel mappingDomain, AEntity targetAgg, int mode)
      throws SdaiException {
    return targetAgg.findMappingInstances(entityMapping, targetDomain, mappingDomain, mode);
  }

  protected static AEntity findMappingInstances(EEntity_mapping entityMapping, ASdaiModel targetDomain, ASdaiModel mappingDomain, int mode)
      throws SdaiException {
    return targetDomain.findMappingInstances(entityMapping, targetDomain, mappingDomain, mode);
  }
