...
public class LateBindingWriter extends Iso1030328Writer {
  ...
  protected boolean startRootElement(String namespaceURI, String localName, String qName, Attributes attr, String[] prefixes, String[] uris)
    ...
    if ((valueOf(namespaceURI).equals(""))) {
      if (localName.equals(ISO_10303_28) && "LB".equals(attr.getValue("", "representation_category")) && "PDTS".equals(attr.getValue("", "version"))) {
        ctxTop = 0;
  ...
  public void startDocument() throws SAXException {
    ...
    attrAttHandlers = new ContextHandler[] { new IntegerLitAttHnd(), new RealLitAttHnd(), new StringLitAttHnd(), new LogicalLitAttHnd(),
        new EntityRefAttHnd(), null, null, new AggregateAttHnd(), new EnumRefAttHnd(), terminalHandler };
    ...
    attrAggHandlers = new ContextHandler[] { new IntegerLitAggHnd(), new RealLitAggHnd(), new StringLitAggHnd(), new LogicalLitAggHnd(),
        new EntityRefAggHnd(), null, null, new AggregateAggHnd(), new EnumRefAggHnd(), terminalHandler };
  ...
  private class SchemaPopulationHandler extends TerminalHandler {
    protected void handleElement(Attributes attr) throws SAXException, SdaiException {
      ...
      SchemaInstance schInstance = repository.createSchemaInstance(name, findSchemaClass(governingSchema));
  ...
  private class AttributeBaseHnd extends ContextHandler {
    ...
    protected ContextHandler makeHandlerForElement(ContextHandler handlers[], String localName) throws SAXException, SdaiException {
      ...
      else if (localName.equals(BAG_LITERAL) || localName.equals(SET_LITERAL) || localName.equals(LIST_LITERAL) || localName.equals(ARRAY_LITERAL)) {
  ...
  private class AttributeInstTwoHnd extends AttributeBaseHnd {
    ...
    protected void handleElement(Attributes attr) throws SAXException, SdaiException {
      ...
      try {
        attribute = findAttribute(entityDef[entityDefTop], attr.getValue("", "express_attribute_name"));
      }
      catch (SdaiException e) {
        processRecoverableHandlerException(e);
        return;
  ...
  private class TypeLitHnd extends TypeBaseHnd {
    ...
    private final ContextHandler[] handlers;
  ...
  private class LogicalLitAttHnd extends ContextHandler {
    ...
    protected ContextHandler newHandlerForElement(String namespaceURI, String localName, String qname) throws SAXException, SdaiException {
      if (valueOf(namespaceURI).equals("") && (localName.equals("true") || localName.equals("false") || localName.equals("unknown"))) {
  ...
  private abstract class EnumRefBaseHnd extends CharContextHandler {
    ...
    protected void endElement() throws SAXException, SdaiException {
      ...
      EEnumeration_type enumType = (EEnumeration_type) definedType.getDomain(null);
