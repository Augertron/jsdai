...
public class EarlyBindingV2Writer extends Iso1030328Writer {
  ...
  protected boolean startRootElement(String namespaceURI, String localName, String qName, Attributes attr, String[] prefixes, String[] uris)
      throws SAXException {
  ...
  private void processAttributeStart(int attrType, String refId, boolean inherited) throws SAXException, SdaiException {
  ...
  private boolean processAttributeStartNested(int attrType, EEntity domain, String refId, boolean inherited) throws SAXException, SdaiException {
    if (domain instanceof EAggregation_type) {
      if (inherited) {
        attrAggType[attrDepth] = ATTR_INHERITED;
        if (refId != null) {
          return processAttributeStartNested(ATTR_ATTR_AGG, ((EAggregation_type) domain).getElement_type(null), refId, inherited);
        }
      }
      ...
      ANamed_type selections = ((ESelect_type) domain).getSelections(null, repository.getSession().getSdaiContext());
      ...
      return processAttributeStartNested(attrType, ((EDefined_type) domain).getDomain(null), refId, inherited);
    }
    ...
    if (domain instanceof ESimple_type) {
      if (domain instanceof EString_type) {
        ...
        if ("true".equals(value) || "false".equals(value) || "unknown".equals(value)) {
          ...
          throw new SAXNotSupportedException("Expected true/false/unknown but found: " + value + " for attribute: " + attributes[attributeTop]);
        }
      }
    }
      ...
      if (enumIndex > 0) {
        throw new SAXNotSupportedException("Unknown enumeration value: " + value + " for attribute: " + attributes[attributeTop]);
      }
    }
  ...
  private void fillSelectPath(String path, EDefined_type extraDefType, boolean top) throws SAXException, SdaiException {
  ...
  private class AttributeHandler extends CharContextHandler {
    ...
    protected ContextHandler newHandlerForElement(String namespaceURI, String localName, String qname) throws SAXException, SdaiException {
      if (valueOf(namespaceURI).equals("")) {
        ...
        throw new SAXNotSupportedException("Unsupported attribute value: " + localName + " in namespace: " + namespaceURI);
      }
    }
  ...
  private class AttrTypeValueHandler extends CharContextHandler {
    ...
    protected void handleElement(Attributes attr) throws SAXException, SdaiException {
      ...
      try {
        ...
        definedType = namedType instanceof EDefined_type ? (EDefined_type) namedType : null;
      }
      catch (SdaiException e) {
        processRecoverableHandlerException(e);
        return;
      ...
      attrDomainTop++;
      attrDomains[attrDomainTop] = definedType != null ? definedType.getDomain(null) : attrDomains[attrDomainTop - 1];
    }
