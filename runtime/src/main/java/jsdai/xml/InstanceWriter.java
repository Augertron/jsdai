...
// 	private long startMillis;
  ...
  protected abstract boolean startRootElement(String namespaceURI, String localName, String qName, Attributes attr, String[] prefixes, String[] uris)
      throws SAXException;
...
// 		System.out.println((System.currentTimeMillis() - startMillis)/1000.0);
  ...
  protected Class findSchemaClass(String schemaName) throws SAXException, SdaiException {
    ...
    if (schemaName.equalsIgnoreCase("SDAI_DICTIONARY_SCHEMA")) {
      ...
      formattedSchemaName = schemaName.substring(0, 1).toUpperCase() + schemaName.substring(1).toLowerCase();
  ...
  protected EDefined_type findDefinedType(String definedTypeName, String schemaName) throws SAXException, SdaiException {
    if (schemaName == null) {
      ...
      if (defTypesForSchema == null) {
        ...
        SdaiRepository dictionaryRep = model.getUnderlyingSchema().findEntityInstanceSdaiModel().getRepository();
        SdaiModel schemaModel = dictionaryRep.findSdaiModel(schemaName.toUpperCase() + SdaiSession.DICTIONARY_NAME_SUFIX);
        ADefined_type definedTypeAgg = (ADefined_type) schemaModel.getInstances(EDefined_type.class);
  ...
  protected EEntity_definition findEntityDefintion(String entityName, String schemaName) throws SAXException, SdaiException {
  ...
  protected class ContextHandler {
    ...
    protected ContextHandler newHandlerForElement(String namespaceURI, String localName, String qname) throws SAXException, SdaiException {
      pushHandler(contextHandler, null);
      return contextHandler;
    }

    protected void pushHandler(ContextHandler handler, String elem) throws SAXException, SdaiException {
      ctxHandlerStack[++ctxTop] = handler;
      ctxElemStack[ctxTop] = elem;
    }

    protected ContextHandler popHandler() throws SAXException, SdaiException {
      ctxTop--;
      return ctxHandlerStack[ctxTop + 1];
    }

    protected void handleElement(Attributes attr) throws SAXException, SdaiException {
    }
    ...
    protected void characters(char charArray[], int start, int length) throws SAXException, SdaiException {
    }
  }
...
// 			int aggMemberCount = aggregates[attrDepth].getMemberCount() + 1;
    ...
    protected Aggregate addAggAggregate() throws SdaiException {
// 			int aggMemberCount = aggregates[attrDepth].getMemberCount() + 1;
      return aggregates[attrDepth].addAggregateByIndex(++aggIndexes[attrDepth], attrSelect[attrDepth]);
    }
  }
  ...
  protected static class EntityInstInstCr extends Creator {
    private final EEntity instance;
  ...
  protected static class AggregateAttCr extends Creator {
    protected void processCreate(InstanceWriter instanceWriter) throws SdaiException {
      instanceWriter.aggregates[instanceWriter.attrDepth + 1] = instanceWriter.currentInstance.createAggregate(instanceWriter.currentAttribute,
  ...
  protected static class EntityRefAttCr extends Creator {
    ...
    protected void processCreate(InstanceWriter instanceWriter) throws SdaiException {
      ...
      instanceWriter.currentInstance.set(instanceWriter.currentAttribute, referencedInstance, instanceWriter.attrSelect[instanceWriter.attrDepth]);
...
// 	}
  ...
  protected static class SelectLitCr extends Creator {
    private final EDefined_type definedType;
    ...
    protected void processCreate(InstanceWriter instanceWriter) throws SdaiException {
      instanceWriter.attrSelect[instanceWriter.attrDepth][instanceWriter.attrSelectTop[instanceWriter.attrDepth]] = definedType;
      instanceWriter.attrSelect[instanceWriter.attrDepth][++instanceWriter.attrSelectTop[instanceWriter.attrDepth]] = null;
    }
  ...
  protected static class IntegerLitAttCr extends Creator {
    ...
    protected void processCreate(InstanceWriter instanceWriter) throws SdaiException {
      instanceWriter.currentInstance.set(instanceWriter.currentAttribute, intVal, instanceWriter.attrSelect[instanceWriter.attrDepth]);
// 			System.out.println(currentInstance);
    }
...
// 			System.out.println(currentInstance);
  ...
  protected static class RealLitAttCr extends Creator {
    ...
    protected void processCreate(InstanceWriter instanceWriter) throws SdaiException {
      instanceWriter.currentInstance.set(instanceWriter.currentAttribute, doubleVal, instanceWriter.attrSelect[instanceWriter.attrDepth]);
// 			System.out.println(currentInstance);
    }
...
// 			System.out.println(currentInstance);
  ...
  protected static class LogicalLitAttCr extends Creator {
    ...
    protected void processCreate(InstanceWriter instanceWriter) throws SdaiException {
      instanceWriter.currentInstance.set(instanceWriter.currentAttribute, logicalVal, instanceWriter.attrSelect[instanceWriter.attrDepth]);
// 			System.out.println(currentInstance);
    }
...
// 			System.out.println(currentInstance);
  ...
  protected static class StringLitAttCr extends Creator {
    ...
    protected void processCreate(InstanceWriter instanceWriter) throws SdaiException {
      instanceWriter.currentInstance.set(instanceWriter.currentAttribute, stringVal, instanceWriter.attrSelect[instanceWriter.attrDepth]);
// 			System.out.println(currentInstance);
    }
...
// 			System.out.println(currentInstance);
  ...
  protected static class EnumRefAttCr extends Creator {
    ...
    protected void processCreate(InstanceWriter instanceWriter) throws SdaiException {
      instanceWriter.currentInstance.set(instanceWriter.currentAttribute, enumIndex, instanceWriter.attrSelect[instanceWriter.attrDepth]);
    }
