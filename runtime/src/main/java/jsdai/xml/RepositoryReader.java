...
public class RepositoryReader extends SdaiXmlReader {
  ...
  public void parse(InputSource input) throws IOException, SAXException {
    try {
      ...
      attributes.clear();
      attributes.addAttribute(null, "name", "name", "NMTOKEN", repository.getName());
      ...
      while (modelIter.next()) {
        ...
        attributes.clear();
        attributes.addAttribute(null, "name", "name", "NMTOKEN", model.getName());
      ...
      while (schemaIter.next()) {
        ...
        attributes.clear();
        attributes.addAttribute(null, "name", "name", "NMTOKEN", schema.getName());
