 ...
 * constructed with non default constructor or have at least one <code>set</code> method called before it is passed to JSDAI
 * reader.
 *
...
public class SdaiInputSource extends InputSource {
  ...
  /**
   * Creates a new empty SDAI input source. At least one <code>set</code> should be called afterward to put the object into
   * valid state.
   */
   ...
   * The repository is set by {@link #SdaiInputSource(SdaiRepository)} or {@link #setRepository}.
   *
   ...
   * The schema instance is set by {@link #SdaiInputSource(SchemaInstance)} or {@link #setSchemaInstance}.
   *
  ...
  public void setSchemaInstances(ASchemaInstance schInstances) throws SdaiException {
    ...
    while (schInstIter.next()) {
      ...
      if (this.repository == null) {
        ...
        throw new SdaiException(SdaiException.RP_NEXS, "All schema instances should belong to the same repository");
      }
   ...
   * The schema instance aggregate is set by {@link #SdaiInputSource(SdaiRepository)}, {@link #SdaiInputSource(ASchemaInstance)}
   * , {@link #setRepository},
   ...
   * The model is set by {@link #SdaiInputSource(SdaiModel)} or {@link #setModel}.
   *
  ...
  public void setModels(ASdaiModel models) throws SdaiException {
    ...
    while (modelIter.next()) {
      ...
      if (this.repository == null) {
        ...
        throw new SdaiException(SdaiException.RP_NEXS, "All models should belong to the same repository");
      }
    }
    this.schInstance = null;
    this.schInstances = null;
   ...
   * The model aggregates are set by {@link #SdaiInputSource(SdaiRepository)}, {@link #SdaiInputSource(SchemaInstance)},
   * {@link #SdaiInputSource(ASchemaInstance)}, {@link #SdaiInputSource(ASdaiModel)}, {@link #setRepository},
   * {@link #setSchemaInstance}, {@link #setSchemaInstances} or {@link #setModels}.
   *
