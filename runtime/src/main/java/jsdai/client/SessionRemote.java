...
public interface SessionRemote {
  ...
  public SdaiRepository createSdaiRepositoryImpl(SdaiSession session, String name, String location, boolean fCheckNameLocation) throws SdaiException;
   ...
   *                     <code>model.getModRemote() != null &amp;&amp; model.getMode() == {@link SdaiModel#NO_ACCESS}</code> should be
   *                     <code>true</code>
  ...
  void lock(ASdaiRepository repositories, ASchemaInstance schInstances, ASdaiModel models, int maxwait) throws SdaiException;
