...
public class SdaiExceptionRemote extends SdaiException {
  ...
  private static final String[] errorDescriptions = { "Model was changed by another session: ", "Model was deleted by another session: ",
      "Model write error: ", "Schema instance was changed by another session: ", "Schema instance was deleted by another session: ",
