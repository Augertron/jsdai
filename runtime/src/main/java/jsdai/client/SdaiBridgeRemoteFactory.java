...
/**
 * <p>
 * Factory for creating {@link SdaiBridgeRemote} instances, with discovery and configuration features similar to that employed by
 * standard Java APIs such as JAXP.
 * </p>
 *
 * <p>
 * Created: Fri Dec 17 10:28:49 2004
 * </p>
 *
 * <p>
 * <strong>IMPLEMENTATION NOTE</strong> - This implementation is heavily based on the SAXParserFactory and DocumentBuilderFactory
 * implementations (corresponding to the JAXP pluggability APIs) found in Apache Xerces.
 * </p>
 *
...
public abstract class SdaiBridgeRemoteFactory {
  ...
  /**
   * Usage:<br> <code>SdaiBridgeRemoteFactory sdaiBridgeRemoteFactory = </code><br>
   * <code>    SdaiBridgeRemoteFactory.newInstance();</code><br> <code>SdaiBridgeRemote sdaiBridgeRemote = </code><br>
  ...
  public static SdaiBridgeRemoteFactory newInstance() throws SdaiException {
    try {
      ...
      ClassLoader contextClassLoader = (ClassLoader) AccessController.doPrivileged(new PrivilegedExceptionAction() {
      ...
      if (factory == null) {
        throw new SdaiException(SdaiException.SY_ERR, "Could not create SdaiBridgeRemoteFactory instance "
   ...
   *
   * @return
   * @throws SdaiException if a suitable class loader cannot be identified.
   */
  protected static ClassLoader getContextClassLoader() throws SdaiException {
    ...
    try {
      ...
      try {
        ...
        throw (SdaiException) new SdaiException(SdaiException.SY_ERR, "Unexpected IllegalAccessException").initCause(e);
      }
        ...
        if (e.getTargetException() instanceof SecurityException) {
          ...
          throw (SdaiException) new SdaiException(SdaiException.SY_ERR, "Unexpected InvocationTargetException").initCause(e.getTargetException());
        }
      }
    }
  ...
  /**
   * Return a new instance of the specified <code>SdaiBridgeRemoteFactory</code> implementation class, loaded by the specified
   * class loader.
   ...
   */
  protected static SdaiBridgeRemoteFactory createFactory(final String factoryClassName, final ClassLoader classLoader) throws SdaiException,
      PrivilegedActionException {
    Object result = AccessController.doPrivileged(new PrivilegedExceptionAction() {
      public Object run() throws SdaiException {
        ...
        try {
          ...
          if (factoryClass != null && !SdaiBridgeRemoteFactory.class.isAssignableFrom(factoryClass)) {
            return new SdaiException(SdaiException.SY_ERR, "The chosen SdaiBridgeRemoteFactory " + "implementation does not extend "
                + "SdaiBridgeRemoteFactory. " + "Please check your configuration.").initCause(e);
          }
          return new SdaiException(SdaiException.SY_ERR, e.getMessage()).initCause(e);
        }
      }
    });
  ...
  protected static String getService(final ClassLoader contextClassLoader, final String serviceId) throws IOException {
