...
public interface SdaiRepositoryRemote extends SdaiEventSource {
   ...
   * @return
   */
  public SchemaInstanceRemote createRemoteSchemaInstance(SchemaInstanceHeader header) throws SdaiException;
...
// 											 String[] names, long[] crcs) throws SdaiException;
  ...
  public SchemaInstanceRemote getRemoteSchemaInstance(SchemaInstanceRemote current) throws SdaiException;
