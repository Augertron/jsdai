...
public class ApplicationAssertionGenerator {
   ...
   * repositories=path
   * <p>
   * The location of jsdai.properties file itself may be provided on the command line too, for example, in the current
   * directory:
   * <p>
  ...
  public static final void main(String args[]) throws SdaiException, IOException {
    ...
    for (int ihi = 0; ihi < args.length; ihi++) {
      ...
      else if (args[ihi].equalsIgnoreCase("-sgml")) {
        ihi++;
        if (ihi < args.length) {
          if (args[ihi].substring(0, 1).equals("-")) {
...
// System.out.println("Testing2: " + testing_str2);
    ...
    while (i_entities.hasNext()) {
      ...
      String current_arm_entity_name_normalized = current_arm_entity_name.substring(0, 1).toUpperCase()
          + current_arm_entity_name.substring(1).toLowerCase();
...
// pw.println("<!--  \tattribute: " + current_attribute_name + " -->");
        ...
        for (int i = 0; i < entity_types.size(); i++) {
          ...
          if (already_processed_entity_types.add(ed)) {
            ...
            String attribute_type_entity_name_normalized = attribute_type_entity_name.substring(0, 1).toUpperCase()
                + attribute_type_entity_name.substring(1).toLowerCase();
            ...
            while (iter3.next()) {
              EAttribute attribute3 = attributes.getCurrentMember(iter3);
  ...
  AttributeInfo getInverseInfo(EEntity_definition main_entity, EEntity_definition attribute_entity, EAttribute direct_attribute) throws SdaiException {
    ...
    while (iter.next()) {
      EAttribute attribute = attributes.getCurrentMember(iter);
  ...
  void handleAggregationType(EAggregation_type at, Vector result, AdditionalInfo data) throws SdaiException {
    ...
    if (element_type instanceof EEntity_definition) {
      ...
      else if (at instanceof EArray_type) {
  ...
  void handleSelectType(ESelect_type st, Vector result, AdditionalInfo data) throws SdaiException {
    ...
    while (iter.next()) {
      ENamed_type element = nt.getCurrentMember(iter);
    ...
    if (info.is_aggregate) {
      ...
      if (info.is_array) {
        ...
        if (number == 1) {
          ...
          pw.println("Each " + main_entity_name + " has " + attribute_name + " defined by exactly " + number2words(number) + " "
              + attribute_entity_name + " objects.");
        }
      }
      else {
        if (info.min == Integer.MIN_VALUE) {
          if (info.max == Integer.MIN_VALUE) {
            pw.println("Each " + main_entity_name + " has " + attribute_name + " defined by zero, one, or more " + attribute_entity_name
                + " objects.");
          }
          else {
          ...
          switch (info.min) {
            case 1:
              ...
              break;
            default:
              pw.println("Each " + main_entity_name + " has " + attribute_name + " defined by exactly " + number2words(info.min) + " "
                  + attribute_entity_name + " objects.");
              break;
          }
        }
        else if (info.max == Integer.MIN_VALUE) {
          if (info.min == 0) {
            pw.println("Each " + main_entity_name + " has " + attribute_name + " defined by zero, one, or more " + attribute_entity_name
                + " objects.");
          }
          else {
            pw.println("Each " + main_entity_name + " has " + attribute_name + " defined by " + number2words(info.min) + " or more "
                + attribute_entity_name + " objects.");
          }
        }
        else {
          if (info.min == 0) {
            switch (info.max) {
              case 1:
                ...
                break;
              case 2:
                pw.println("Each " + main_entity_name + " has " + attribute_name + " defined by zero, one, or two " + attribute_entity_name
                    + " objects.");
                break;
              case 3:
                pw.println("Each " + main_entity_name + " has " + attribute_name + " defined by zero, one, two, or three " + attribute_entity_name
                    + " objects.");
                break;
              case 4:
                pw.println("Each " + main_entity_name + " has " + attribute_name + " defined by zero, one, two, three, or four "
                    + attribute_entity_name + " objects.");
                break;
              default:
                pw.println("Each " + main_entity_name + " has " + attribute_name + " defined by zero, or up to " + number2words(info.max) + " "
                    + attribute_entity_name + " objects.");
                break;
            }
          }
            ...
            switch (info.max) {
              case 2:
                ...
                break;
              case 3:
                pw.println("Each " + main_entity_name + " has " + attribute_name + " defined by one, two, or three " + attribute_entity_name
                    + " objects.");
                break;
              case 4:
                pw.println("Each " + main_entity_name + " has " + attribute_name + " defined by one, two, three, or four " + attribute_entity_name
                    + " objects.");
                break;
              default:
                pw.println("Each " + main_entity_name + " has " + attribute_name + " defined by one, two, and up to " + number2words(info.max)
                    + " " + attribute_entity_name + " objects.");
                break;
            }
          }
            ...
            switch (info.max) {
              case 3:
                pw.println("Each " + main_entity_name + " has " + attribute_name + " defined by two or three " + attribute_entity_name
                    + " objects.");
                break;
              case 4:
                pw.println("Each " + main_entity_name + " has " + attribute_name + " defined by two, three, or four " + attribute_entity_name
                    + " objects.");
                break;
              default:
                pw.println("Each " + main_entity_name + " has " + attribute_name + " defined by two, three, and up to " + number2words(info.max)
                    + " " + attribute_entity_name + " objects.");
                break;
            }
          }
            ...
            switch (info.max) {
              case 4:
                pw.println("Each " + main_entity_name + " has " + attribute_name + " defined by three or four " + attribute_entity_name
                    + " objects.");
                break;
              default:
                pw.println("Each " + main_entity_name + " has " + attribute_name + " defined by three, four, and up to " + number2words(info.max)
                    + " " + attribute_entity_name + " objects.");
                break;
            }
          }
          else {
            pw.println("Each " + main_entity_name + " has " + attribute_name + " defined by from " + number2words(info.min) + " to "
                + number2words(info.max) + " " + attribute_entity_name + " objects.");
          }
...
// Each E2 defines attr1 for zero, or one E1 objects
      ...
      if (info.min == Integer.MIN_VALUE) {
        ...
        switch (info.min) {
          case 1:
            ...
            break;
          default:
            pw.println("Each " + attribute_entity_name + " defines " + attribute_name + " for exactly " + number2words(info.min) + " "
                + main_entity_name + " objects.");
            break;
        }
      }
      else if (info.max == Integer.MIN_VALUE) {
        if (info.min == 0) {
          ...
          pw.println("Each " + attribute_entity_name + " defines " + attribute_name + " for " + number2words(info.min) + " or more "
              + main_entity_name + " objects.");
        }
      }
      else {
        ...
        if (info.min == 0) {
          switch (info.max) {
            ...
            case 2:
              ...
              break;
            case 3:
              pw.println("Each " + attribute_entity_name + " defines " + attribute_name + " for zero, one, two, or three " + main_entity_name
                  + " objects.");
              break;
            case 4:
              pw.println("Each " + attribute_entity_name + " defines " + attribute_name + " for zero, one, two, three, or four " + main_entity_name
                  + " objects.");
              break;
            default:
              pw.println("Each " + attribute_entity_name + " defines " + attribute_name + " for zero, or up to " + number2words(info.max) + " "
                  + main_entity_name + " objects.");
              break;
          }
        }
          ...
          switch (info.max) {
            ...
            case 3:
              ...
              break;
            case 4:
              pw.println("Each " + attribute_entity_name + " defines " + attribute_name + " for one, two, three, or four " + main_entity_name
                  + " objects.");
              break;
            default:
              pw.println("Each " + attribute_entity_name + " defines " + attribute_name + " for one, two, and up to " + number2words(info.max) + " "
                  + main_entity_name + " objects.");
              break;
          }
        }
          ...
          switch (info.max) {
            case 3:
              ...
              break;
            case 4:
              pw.println("Each " + attribute_entity_name + " defines " + attribute_name + " for two, three, or four " + main_entity_name
                  + " objects.");
              break;
            default:
              pw.println("Each " + attribute_entity_name + " defines " + attribute_name + " for two, three, and up to " + number2words(info.max)
                  + " " + main_entity_name + " objects.");
              break;
          }
        }
          ...
          switch (info.max) {
            case 4:
              ...
              break;
            default:
              pw.println("Each " + attribute_entity_name + " defines " + attribute_name + " for three, four, and up to " + number2words(info.max)
                  + " " + main_entity_name + " objects.");
              break;
          }
        }
        else {
          pw.println("Each " + attribute_entity_name + " defines " + attribute_name + " for from " + number2words(info.min) + " to "
              + number2words(info.max) + " " + main_entity_name + " objects.");
        }
  ...
  String number2words(int number) {
    String english_0_19[] = { "zero", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten", "eleven", "twelve", "thirteen",
