...
public class SearchForCycles {
  ...
  static Set enumAllUsefroms(ASdaiModel domain, ESchema_definition schema, boolean includeReferenceFroms, boolean includePartialInterfaceSpec)
  ...
  private static Map enumUsefroms(SdaiRepository repo, String[] roots, boolean includeReferenceFroms, boolean includePartialInterfaceSpec)
      throws SdaiException {
  ...
  private static void enumUsefroms(ASdaiModel domain, Map schemas, Map usefroms, String schemaName, boolean includeReferenceFroms,
  ...
  public static List getCycles(SdaiRepository repo, String[] roots, boolean includeReferenceFroms, boolean includePartialInterfaceSpec) throws SdaiException {
