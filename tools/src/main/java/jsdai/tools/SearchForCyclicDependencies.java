  ...
  public static final void main(String args[], jsdai.util.UtilMonitor monitor) {
    ...
    try {
      ...
      for (int i = 0; i < args.length; i++) {
        ...
        if (args[i].equalsIgnoreCase("-include_reference_froms")) {
          flag_include_reference_froms = true;
        }
        if (args[i].equalsIgnoreCase("-ir")) {
          flag_include_reference_froms = true;
        }
        if (args[i].equalsIgnoreCase("-include_partial")) {
          flag_include_partial = true;
        }
        if (args[i].equalsIgnoreCase("-ip")) {
          flag_include_partial = true;
        }
        if (args[i].equalsIgnoreCase("-oc")) {
          flag_only_cyclic = true;
        }
        if (args[i].equalsIgnoreCase("-only_cyclic")) {
          flag_only_cyclic = true;
        }
        if (args[i].equalsIgnoreCase("-redundant")) {
          flag_search_for_redundant_use_froms = true;
        }
        if (args[i].equalsIgnoreCase("-ruf")) {
          flag_search_for_redundant_use_froms = true;
        }
...
//			CInterface_specification.usedinCurrent_schema(null, asd, null, specifications);
  ...
  public static Runnable initAsRunnable(final String sdaireposDirectory, final String[] args, final jsdai.util.UtilMonitor monitor) throws SdaiException {
