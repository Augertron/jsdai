...
import jsdai.SExtended_dictionary_schema.CReference_from_specification;
...
public class SearchForRedundantUsefroms {
  ...
  public static SdaiRepository getSystemRepository() throws SdaiException {
  ...
  public static ASdaiModel activateModels(SdaiRepository repo) throws SdaiException {
  ...
  private static Map findRedundantUsefroms(SdaiRepository repo, String[] roots, boolean includeReferenceFroms, boolean includePartialInterfaceSpec)
  ...
  private static Set getUsefroms(ASdaiModel domain, EGeneric_schema_definition schema, boolean includeReferenceFroms, boolean includePartialInterfaceSpec,
      Map usefromCashe, Map redUsefroms) throws SdaiException {
    ...
    for (SdaiIterator i = aInterfaces.createIterator(); i.next(); ) {
      ...
      if (!myUsefroms.contains(foreignName)) {
        ...
        Set usefroms = getUsefroms(domain, foreignSchema, includeReferenceFroms, includePartialInterfaceSpec, usefromCashe, redUsefroms);
   ...
   * @param includeReferenceFroms       if set to <code>true</code>, then <code>reference_from_specifications</code> will be used together with
   *                                    <code>use_from_specifications</code>. Otherwise only <code>use_from_specifications</code> will be used.
   ...
   * that have redundant interface specifications and as values containing <code>Collection</code> of redundant
   * interface specifications (<code>String</code>).
   * @throws SdaiException
   */
  public static Map getRedundantInterfaceSpecifications(SdaiRepository repo, String[] rootSchemas, boolean includeReferenceFroms,
      boolean includePartialInterfaceSpec) throws SdaiException {

    Map redUsefroms = findRedundantUsefroms(repo, rootSchemas, includeReferenceFroms, includePartialInterfaceSpec);
    List cycles = SearchForCycles.getCycles(repo, rootSchemas, includeReferenceFroms, includePartialInterfaceSpec);
