...
public abstract class CMappingAttribute_mapping_logical_value extends CMappingAttribute_mapping_value {
	protected CMappingAttribute_mapping_logical_value() { }
	
	protected Object getMappedValueObject() throws SdaiException {
		return new Integer(((EAttribute_mapping_logical_value)this).getMapped_value(null));
	}

} // CMappingAttribute_mapping_logical_value
