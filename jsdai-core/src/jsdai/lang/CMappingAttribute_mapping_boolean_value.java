...
public abstract class CMappingAttribute_mapping_boolean_value extends CMappingAttribute_mapping_value {
	protected CMappingAttribute_mapping_boolean_value() { }

	protected Object getMappedValueObject() throws SdaiException {
		return Boolean.valueOf(((EAttribute_mapping_boolean_value)this).getMapped_value(null));
	}
	
} // CMappingAttribute_mapping_boolean_value
