...
/* Generated By:JJTree: Do not edit this line. X_EnumerationRef.java */
...
public class X_EnumerationRef extends SimpleNode {
		int value;
		String name = null;
		jsdai.SExtended_dictionary_schema.EData_type dt = null;
	  SdaiModel current_model;

  public X_EnumerationRef(int id) {
    super(id);
  }

  public X_EnumerationRef(Compiler2 p, int id) {
    super(p, id);
  }
