...
// %modified: 1016210368779 %

/* Generated By:JJTree: Do not edit this line. X_DomainRuleLogicalExpression.java */
package jsdai.expressCompiler;

import java.util.*;


public class X_DomainRuleLogicalExpression
  extends SimpleNode {
  public X_DomainRuleLogicalExpression(int id) {
    super(id);
  }

  public X_DomainRuleLogicalExpression(Compiler2 p, int id) {
    super(p, id);
  }
      ...
      for (int i = 0; i < children.length; ++i) {
        ...
        if (jc != null) {
          if (jc.active) {
            ...
            printDDebug("### X_DomainRuleLogicalExpression: " + jc.generated_java, jc);
						//						jc.pw.println("/* In DomainRuleLogicalExpression: */" + jc.generated_java);
          } // jc active
