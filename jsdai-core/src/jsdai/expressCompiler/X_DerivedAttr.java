...
// %modified: 1016210368546 %

/* Generated By:JJTree: Do not edit this line. X_DerivedAttr.java */
...
public class X_DerivedAttr extends SimpleNode {
  EEntity_definition owner_entity;
  EAttribute attribute;
  SdaiModel current_model;

  boolean is_parameter = false;

  // type is known, we can get domain here from attribute
  public X_DerivedAttr(int id) {
    super(id);
  }

  public X_DerivedAttr(Compiler2 p, int id) {
    super(p, id);
  }
  ...
  String getStaticTypeFieldName(JavaClass jc) throws SdaiException {
    ...
    rt = ((EDerived_attribute) attribute).getDomain(null);
		...
		is_parameter = false;
		if (rt instanceof EParameter) {
			rt = ((EParameter)rt).getParameter_type(null);
			is_parameter = true;
		}
    ...
    if (rt instanceof EEntity_definition) {
      ...
      type_name = "_st" + 
                  constructAggregationTypeBaseTypeNameString((EAggregation_type) rt, current_model)
                    .toLowerCase();
    	if ((rt instanceof EArray_type) && (is_parameter)) {
    		type_name = "ExpressTypes.ARRAY_GENERIC_TYPE";
    	}
...
// System.out.println("<> rt model: " + rt.findEntityInstanceSdaiModel());    	
  ...
  String constructTypeAndFromReferencedSchemaClass(EDefined_type ed)
    ...
    //    if (entity_model != current_model) { // break schema prefix construction
...
//        result += "_2PDB";
      ...
      result += "_2UNSET";
      // this may be the case of general array, we need to do something about it
    }
