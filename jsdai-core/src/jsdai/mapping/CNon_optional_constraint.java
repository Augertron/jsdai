...
public class CNon_optional_constraint extends CEntity implements ENon_optional_constraint {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CNon_optional_constraint.class, SMapping.ss);
