...
public class CAggregate_member_constraint extends CEntity implements EAggregate_member_constraint {
	...
	public jsdai.lang.EEntity getAttribute(EAggregate_member_constraint type) throws jsdai.lang.SdaiException { // case 1
		a1 = get_instance_select(a1);
		return (jsdai.lang.EEntity)a1;
	}

	public void setAttribute(EAggregate_member_constraint type, jsdai.lang.EEntity value) throws jsdai.lang.SdaiException { // case 1
