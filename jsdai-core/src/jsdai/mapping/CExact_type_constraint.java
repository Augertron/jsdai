...
public class CExact_type_constraint extends CEntity implements EExact_type_constraint {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CExact_type_constraint.class, SMapping.ss);

	/*----------------------------- Attributes -----------*/

	protected Object a0; // domain - non-java inheritance - ENTITY entity_definition
	protected static final jsdai.dictionary.CExplicit_attribute a0$ = CEntity.initExplicitAttribute(definition, 0);
	protected Object a1; // constraints - non-java inheritance - SELECT constraint_select
