...
// Java class implementing entity instance_equal

package jsdai.mapping;
import jsdai.lang.*;

public class CInstance_equal extends CEntity implements EInstance_equal {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CInstance_equal.class, SMapping.ss);

	/*----------------------------- Attributes -----------*/

	protected Object a0; // element2 - non-java inheritance - SELECT constraint_select
	protected static final jsdai.dictionary.CExplicit_attribute a0$ = CEntity.initExplicitAttribute(definition, 0);
	protected Object a1; // element1 - non-java inheritance - SELECT constraint_select
	...
	public jsdai.lang.EEntity getElement1(EInstance_constraint type) throws jsdai.lang.SdaiException { // case 1
		a1 = get_instance_select(a1);
		return (jsdai.lang.EEntity)a1;
	}

	public void setElement1(EInstance_constraint type, jsdai.lang.EEntity value) throws jsdai.lang.SdaiException { // case 1
