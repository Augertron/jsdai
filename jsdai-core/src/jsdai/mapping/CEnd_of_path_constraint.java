...
public class CEnd_of_path_constraint extends CEntity implements EEnd_of_path_constraint {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CEnd_of_path_constraint.class, SMapping.ss);
	...
	public jsdai.lang.EEntity getConstraints(EEnd_of_path_constraint type) throws jsdai.lang.SdaiException { // case 1
		a0 = get_instance_select(a0);
		return (jsdai.lang.EEntity)a0;
	}

	public void setConstraints(EEnd_of_path_constraint type, jsdai.lang.EEntity value) throws jsdai.lang.SdaiException { // case 1
