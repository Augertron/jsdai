...
public class CAttribute_mapping_int_value extends CEntity implements EAttribute_mapping_int_value {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CAttribute_mapping_int_value.class, SMapping.ss);
