...
public class CInner_declaration$subtype_constraint_declaration extends CEntity implements EInner_declaration, ESubtype_constraint_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CInner_declaration$subtype_constraint_declaration.class, SExtended_dictionary_schema.ss);
