...
public class CEntity_declaration$inner_declaration extends CEntity implements EEntity_declaration, EInner_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CEntity_declaration$inner_declaration.class, SExtended_dictionary_schema.ss);
