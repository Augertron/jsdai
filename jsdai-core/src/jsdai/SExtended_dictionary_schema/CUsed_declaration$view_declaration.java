...
public class CUsed_declaration$view_declaration extends CEntity implements EUsed_declaration, EView_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CUsed_declaration$view_declaration.class, SExtended_dictionary_schema.ss);
