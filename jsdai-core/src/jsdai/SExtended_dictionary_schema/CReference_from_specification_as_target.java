...
public class CReference_from_specification_as_target extends CReference_from_specification_as implements EReference_from_specification_as_target {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CReference_from_specification_as_target.class, SExtended_dictionary_schema.ss);
