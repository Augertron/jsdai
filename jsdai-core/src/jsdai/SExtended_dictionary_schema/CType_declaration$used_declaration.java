...
public class CType_declaration$used_declaration extends CEntity implements EType_declaration, EUsed_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CType_declaration$used_declaration.class, SExtended_dictionary_schema.ss);
