...
public class CEntity_declaration$referenced_declaration extends CEntity implements EEntity_declaration, EReferenced_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CEntity_declaration$referenced_declaration.class, SExtended_dictionary_schema.ss);
