...
public class CBag_type extends CVariable_size_aggregation_type implements EBag_type {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CBag_type.class, SExtended_dictionary_schema.ss);
