...
public class CEntity_declaration$implicit_declaration extends CEntity implements EEntity_declaration, EImplicit_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CEntity_declaration$implicit_declaration.class, SExtended_dictionary_schema.ss);
