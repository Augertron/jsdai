...
public class CReferenced_declaration$type_declaration extends CEntity implements EReferenced_declaration, EType_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CReferenced_declaration$type_declaration.class, SExtended_dictionary_schema.ss);
