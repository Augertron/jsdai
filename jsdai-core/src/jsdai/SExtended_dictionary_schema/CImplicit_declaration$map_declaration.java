...
public class CImplicit_declaration$map_declaration extends CEntity implements EImplicit_declaration, EMap_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CImplicit_declaration$map_declaration.class, SExtended_dictionary_schema.ss);
