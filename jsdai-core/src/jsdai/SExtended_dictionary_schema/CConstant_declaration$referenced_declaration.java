...
// Java class implementing entity constant_declaration$referenced_declaration

package jsdai.SExtended_dictionary_schema;
import jsdai.lang.*;

public class CConstant_declaration$referenced_declaration extends CEntity implements EConstant_declaration, EReferenced_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CConstant_declaration$referenced_declaration.class, SExtended_dictionary_schema.ss);
	...
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		// partial entity: constant_declaration
