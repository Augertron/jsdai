...
public class CMap_declaration$used_declaration extends CEntity implements EMap_declaration, EUsed_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CMap_declaration$used_declaration.class, SExtended_dictionary_schema.ss);
