...
public class CMap_declaration$referenced_declaration extends CEntity implements EMap_declaration, EReferenced_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CMap_declaration$referenced_declaration.class, SExtended_dictionary_schema.ss);
