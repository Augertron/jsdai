...
public class CLocal_declaration$map_declaration extends CEntity implements ELocal_declaration, EMap_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CLocal_declaration$map_declaration.class, SExtended_dictionary_schema.ss);
