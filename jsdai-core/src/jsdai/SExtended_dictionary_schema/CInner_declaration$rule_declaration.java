...
public class CInner_declaration$rule_declaration extends CEntity implements EInner_declaration, ERule_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CInner_declaration$rule_declaration.class, SExtended_dictionary_schema.ss);
