...
// Java class implementing entity procedure_declaration$referenced_declaration

package jsdai.SExtended_dictionary_schema;
import jsdai.lang.*;

public class CProcedure_declaration$referenced_declaration extends CEntity implements EProcedure_declaration, EReferenced_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CProcedure_declaration$referenced_declaration.class, SExtended_dictionary_schema.ss);
	...
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		// partial entity: procedure_declaration
