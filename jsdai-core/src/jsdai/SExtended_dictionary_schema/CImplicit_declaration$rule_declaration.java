...
public class CImplicit_declaration$rule_declaration extends CEntity implements EImplicit_declaration, ERule_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CImplicit_declaration$rule_declaration.class, SExtended_dictionary_schema.ss);
