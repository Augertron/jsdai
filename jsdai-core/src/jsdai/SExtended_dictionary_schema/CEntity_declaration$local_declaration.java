...
public class CEntity_declaration$local_declaration extends CEntity implements EEntity_declaration, ELocal_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CEntity_declaration$local_declaration.class, SExtended_dictionary_schema.ss);
