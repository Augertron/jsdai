...
public class CLocal_declaration$type_declaration extends CEntity implements ELocal_declaration, EType_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CLocal_declaration$type_declaration.class, SExtended_dictionary_schema.ss);
