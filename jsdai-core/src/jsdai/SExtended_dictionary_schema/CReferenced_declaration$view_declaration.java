...
public class CReferenced_declaration$view_declaration extends CEntity implements EReferenced_declaration, EView_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CReferenced_declaration$view_declaration.class, SExtended_dictionary_schema.ss);
