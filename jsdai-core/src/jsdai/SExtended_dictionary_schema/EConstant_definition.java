...
public interface EConstant_definition extends EEntity {
	...
	EEntity getDomain(EConstant_definition type) throws SdaiException; // case 1

	void setDomain(EConstant_definition type, EEntity value) throws SdaiException; // case 1
	...
	EEntity getConstant_value(EConstant_definition type) throws SdaiException; // case 1

	void setConstant_value(EConstant_definition type, EEntity value) throws SdaiException; // case 1
