...
public class CImplicit_declaration$view_declaration extends CEntity implements EImplicit_declaration, EView_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CImplicit_declaration$view_declaration.class, SExtended_dictionary_schema.ss);
