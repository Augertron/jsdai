...
public class CInner_declaration$type_declaration extends CEntity implements EInner_declaration, EType_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CInner_declaration$type_declaration.class, SExtended_dictionary_schema.ss);
