...
public class CEntity_declaration$used_declaration extends CEntity implements EEntity_declaration, EUsed_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CEntity_declaration$used_declaration.class, SExtended_dictionary_schema.ss);
