...
public class CConstant_declaration$inner_declaration extends CEntity implements EConstant_declaration, EInner_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CConstant_declaration$inner_declaration.class, SExtended_dictionary_schema.ss);
