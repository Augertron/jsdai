...
public class CImplicit_declaration$type_declaration extends CEntity implements EImplicit_declaration, EType_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CImplicit_declaration$type_declaration.class, SExtended_dictionary_schema.ss);
