...
public class CFunction_declaration$inner_declaration extends CEntity implements EFunction_declaration, EInner_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CFunction_declaration$inner_declaration.class, SExtended_dictionary_schema.ss);
