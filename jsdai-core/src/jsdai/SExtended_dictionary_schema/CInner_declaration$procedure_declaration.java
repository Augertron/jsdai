...
public class CInner_declaration$procedure_declaration extends CEntity implements EInner_declaration, EProcedure_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CInner_declaration$procedure_declaration.class, SExtended_dictionary_schema.ss);
