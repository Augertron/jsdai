...
// Java class implementing entity entity_select_type$extended_select_type$non_extensible_select_type

package jsdai.SExtended_dictionary_schema;
import jsdai.lang.*;

public class CEntity_select_type$extended_select_type$non_extensible_select_type extends CEntity implements EEntity_select_type, EExtended_select_type, ENon_extensible_select_type {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CEntity_select_type$extended_select_type$non_extensible_select_type.class, SExtended_dictionary_schema.ss);
	...
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a2 = (ANamed_type)av.entityValues[4].getInstanceAggregate(0, a2$, this);
	}
	...
	protected void getAll(ComplexEntityValue av) throws SdaiException {
		...
		av.entityValues[4].setInstanceAggregate(0, a2);
	}
