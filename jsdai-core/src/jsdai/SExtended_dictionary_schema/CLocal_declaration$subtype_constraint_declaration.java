...
// Java class implementing entity local_declaration$subtype_constraint_declaration

package jsdai.SExtended_dictionary_schema;
import jsdai.lang.*;

public class CLocal_declaration$subtype_constraint_declaration extends CEntity implements ELocal_declaration, ESubtype_constraint_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CLocal_declaration$subtype_constraint_declaration.class, SExtended_dictionary_schema.ss);
