...
public class CData_type_declaration$implicit_declaration extends CEntity implements EData_type_declaration, EImplicit_declaration {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CData_type_declaration$implicit_declaration.class, SExtended_dictionary_schema.ss);
