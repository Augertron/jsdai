...
public class CExtended_select_type$extensible_select_type extends CEntity implements EExtended_select_type, EExtensible_select_type {
	public static final jsdai.dictionary.CEntity_definition definition = initEntityDefinition(CExtended_select_type$extensible_select_type.class, SExtended_dictionary_schema.ss);
