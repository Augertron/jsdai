...
public interface EMap_or_view_partition extends EEntity {
	...
	EEntity getParent(EMap_or_view_partition type) throws SdaiException; // case 1

	void setParent(EMap_or_view_partition type, EEntity value) throws SdaiException; // case 1
