...
public class CDeclaration extends CEntity implements EDeclaration {
	...
	public Value getParent_schema(EDeclaration type, SdaiContext _context) throws SdaiException {
				...
				return (jsdai.SExtended_dictionary_schema.FGet_schema_definition.run(_context, Value.alloc(jsdai.SExtended_dictionary_schema.CGeneric_schema_definition.definition).set(_context, get(a0$))));
	}
