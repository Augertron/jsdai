...
public class CSelect_type extends SelectType implements ESelect_type {
	...
	public static int usedinSelections(ESelect_type type, ENamed_type instance, ASdaiModel domain, AEntity result) throws SdaiException {
		return ((CEntity)instance).makeUsedin(definition, a1$, domain, result);
	}
