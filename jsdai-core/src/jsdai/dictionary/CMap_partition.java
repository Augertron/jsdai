...
public class CMap_partition extends CEntity implements EMap_partition {
	...
	protected static jsdai.dictionary.CInverse_attribute i0$ = CEntity.initInverseAttribute(definition, 0);
