...
// Java class implementing entity bag_type

package jsdai.dictionary;
import jsdai.lang.*;

public class CBag_type extends AggregationType implements EBag_type {
	...
	protected Object a2; // lower_bound - non-java inheritance - ENTITY bound
	protected static jsdai.dictionary.CExplicit_attribute a2$;
	protected Object a3; // upper_bound - non-java inheritance - ENTITY bound
	...
	protected void setAll(ComplexEntityValue av) throws SdaiException {
		...
		a2 = av.entityValues[3].getInstance(0, this);
		a3 = av.entityValues[3].getInstance(1, this);
	}
