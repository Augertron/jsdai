...
public class CEntity_select_type$extended_select_type$non_extensible_select_type extends SelectType implements EEntity_select_type, EExtended_select_type, ENon_extensible_select_type {
	...
	public ANamed_type getSelections(ESelect_type type) throws SdaiException {
		return getSelectionsExtensible(a2$, null);
	}
