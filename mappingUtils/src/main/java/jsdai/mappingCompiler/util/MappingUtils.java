...
import jsdai.SExtended_dictionary_schema.CAggregation_type;
...
import jsdai.SMapping_schema.CAggregate_member_constraint;
import jsdai.SMapping_schema.CAttribute_value_constraint;
import jsdai.SMapping_schema.CConstraint_relationship;
import jsdai.SMapping_schema.CEntity_constraint;
import jsdai.SMapping_schema.CInstance_constraint;
import jsdai.SMapping_schema.CInverse_attribute_constraint;
import jsdai.SMapping_schema.CPath_constraint;
import jsdai.SMapping_schema.CSelect_constraint;
...
//		return instance.
   ...
   */
  public static jsdai.dictionary.EEnumeration_type getEnumerationTypeFromMappingAttribute(EEntity attribute, ASchemaInstance schemaInstance)
   ...
   * @retruns enumeration type, or null if there was some problems.
   */
  public static jsdai.dictionary.EEnumeration_type getEnumerationTypeFromAggregateType(EAggregation_type type, ASchemaInstance schemaInstance)
      throws SdaiException {
    jsdai.dictionary.EEnumeration_type rv = null;
  ...
  public static jsdai.dictionary.EEntity_definition convertToLang(EEntity_definition a, jsdai.lang.ASchemaInstance schemaInstances)
  ...
  public static Object getEndType(EAttribute_mapping attributeMapping) throws SdaiException {
    ...
    if (attributeMapping != null) {
      if (attributeMapping.testPath(null)) {
        ...
        if (n > 0) {
          rv = MappingUtilOperations.getEndType(path.getByIndex(n));
        }
      }
      else {
