...
public class AttributeMappingsForEntity {
  ...
  public AttributeMappingsForEntity(EntityAST entity, MappingPathParser parser) throws SdaiException, MappingSemanticException {
  ...
  public static EntityAST extractStartEntity(EntityAST entity, MappingPathParser parser) throws SdaiException, MappingSemanticException {
