...
public class MappingForAttribute {
  ...
  private void createConstraintsAndPath(MappingDataWalker mappingDataWalker) throws MappingSemanticException, RecognitionException, SdaiException {
    if (!stateParsed) {
      if (state != null) {
        path = new LinkedList();
  ...
  public EEntity getConstraints(MappingDataWalker mappingDataWalker) throws MappingSemanticException, RecognitionException, SdaiException {
    createConstraintsAndPath(mappingDataWalker);
    return constraints;
  }

  public LinkedList getPath(MappingDataWalker mappingDataWalker) throws MappingSemanticException, RecognitionException, SdaiException {
    createConstraintsAndPath(mappingDataWalker);
    return path;
  }
}
