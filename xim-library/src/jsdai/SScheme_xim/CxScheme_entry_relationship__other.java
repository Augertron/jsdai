...
public class CxScheme_entry_relationship__other extends CScheme_entry_relationship__other implements EMappedXIMEntity{
...
/*	public boolean testName(EAction_method_relationship type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			EScheme_entry_relationship__other armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxScheme_entry_relationship.setMappingConstraints(context, armEntity);
		armEntity.setName(null, "other");
