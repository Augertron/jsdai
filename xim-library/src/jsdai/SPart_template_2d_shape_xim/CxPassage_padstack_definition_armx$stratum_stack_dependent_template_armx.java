...
import jsdai.SPart_template_2d_shape_mim.*;
...
public class CxPassage_padstack_definition_armx$stratum_stack_dependent_template_armx extends CPassage_padstack_definition_armx$stratum_stack_dependent_template_armx implements EMappedXIMEntity
{
...
/*	public boolean testName(EProduct_definition type) throws SdaiException {
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CPassage_padstack_definition$stratum_stack_dependent_template.definition);
...
//		 It is derived, so can't unset it unsetLocation(context, this);
	...
	*/
	public static void setMappingConstraints(SdaiContext context, CPassage_padstack_definition_armx$stratum_stack_dependent_template_armx armEntity) throws SdaiException
	{
		unsetMappingConstraints(context, armEntity);
		
		CxPassage_padstack_definition_armx.setMappingConstraints(context, armEntity);
		CxStratum_stack_dependent_template_armx.setMappingConstraints(context, armEntity);
	}

	public static void unsetMappingConstraints(SdaiContext context, CPassage_padstack_definition_armx$stratum_stack_dependent_template_armx armEntity) throws SdaiException
	{
		CxPassage_padstack_definition_armx.unsetMappingConstraints(context, armEntity);
