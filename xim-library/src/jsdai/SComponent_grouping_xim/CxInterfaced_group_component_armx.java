...
import jsdai.SInterface_component_xim.*;
import jsdai.SProduct_definition_schema.*;
import jsdai.SProduct_property_definition_schema.*;
import jsdai.SProduct_view_definition_xim.*;
import jsdai.SShape_property_assignment_xim.*;

public class CxInterfaced_group_component_armx
		extends
			CInterfaced_group_component_armx implements EMappedXIMEntity{
...
*/
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CInterfaced_group_component.definition);
			...
			// group_interface_component 
			setGroup_interface_component(context, this); 
			...
			unsetGroup_interface_component(null); 
	}
	...
	public void removeAimData(SdaiContext context) throws SdaiException {
			...
			// group_interface_component 
			unsetGroup_interface_component(context, this); 
	}
	 ...
	 * <p>
	 * mapping_constraints; 
	 *  interfaced_group_component_definition &lt;=
	...
	public static void setMappingConstraints(SdaiContext context,
			EInterfaced_group_component_armx armEntity) throws SdaiException {
...
///// Item_shape
	...
	//********** "interfaced_group_component" attributes

	/**
	* Sets/creates data for group_interface_component attribute.
	*
	* <p>
	*  attribute_mapping group_interface_component_interface_component (group_interface_component
	* , (*PATH*), interface_component);
	* 	interfaced_group_component_definition <=
	* 	assembly_group_component_definition <=
	* 	component_definition <=
	* 	product_definition <-
	...
	* @throws SdaiException
	*/
	public static void setGroup_interface_component(SdaiContext context, EInterfaced_group_component_armx armEntity) throws SdaiException
	{
		//unset old values
		unsetGroup_interface_component(context, armEntity);

		if (armEntity.testGroup_interface_component(null))
		{

			AInterface_component_armx aArmGroup_interface_component = armEntity.getGroup_interface_component(null);

			EInterface_component_armx armGroup_interface_component = null;
			for (int i = 1; i <= aArmGroup_interface_component.getMemberCount(); i++) {
				armGroup_interface_component = aArmGroup_interface_component.getByIndex(i);

				EProduct_definition_relationship product_definition_relationship = (EProduct_definition_relationship) context.working_model.createEntityInstance(EProduct_definition_relationship.class);
				product_definition_relationship.setId(null, "");
				product_definition_relationship.setName(null, "group interface component");
				product_definition_relationship.setRelating_product_definition(null, armEntity);
				product_definition_relationship.setRelated_product_definition(null, armGroup_interface_component);
			}
		}
	}
	...
	/**
	* Unsets/deletes data for group_interface_component attribute.
	*
	* @param context SdaiContext.
	* @param armEntity arm entity.
	* @throws SdaiException
	*/
	public static void unsetGroup_interface_component(SdaiContext context, EInterfaced_group_component_armx armEntity) throws SdaiException
	{
		jsdai.SProduct_definition_schema.AProduct_definition_relationship aRelationship = new jsdai.SProduct_definition_schema.AProduct_definition_relationship();
		jsdai.SProduct_definition_schema.CProduct_definition_relationship.usedinRelating_product_definition(null, armEntity, context.domain, aRelationship);
		jsdai.SProduct_definition_schema.EProduct_definition_relationship relationship = null;

		for (int i = 1; i <= aRelationship.getMemberCount(); i++) {
			relationship = aRelationship.getByIndex(i);
			if (relationship.testName(null) && relationship.getName(null).equals("group interface component")) {
