...
public class CxLinear_array_placement_group_component_armx
		extends
			CLinear_array_placement_group_component_armx implements EMappedXIMEntity{
...
*/
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CLinear_array_placement_group_component.definition);
	      ...
	      // element
			...
			setInitial_node_positive_x_displacement(context, this);
	      
			// terminus_node_positive_x_displacement
			setTerminus_node_positive_x_displacement(context, this);
	...
	public void removeAimData(SdaiContext context) throws SdaiException {
	      ...
	      // element
			...
			// initial_node_positive_x_displacement
			unsetInitial_node_positive_x_displacement(context, this);
	      
			// terminus_node_positive_x_displacement
			unsetTerminus_node_positive_x_displacement(context, this);
	...
	public static void setMappingConstraints(SdaiContext context,
			ELinear_array_placement_group_component_armx armEntity) throws SdaiException {
...
///// Item_shape
	...
	//********** "linear_array_placement_group_component" attributes
	...
	* @throws SdaiException
	*/
	public static void setElement(SdaiContext context, ELinear_array_placement_group_component_armx armEntity) throws SdaiException
	{
		//unset old values
		...
		if (armEntity.testElement(null))
		{
			...
			AAssembly_component_placement_link aArmElement = armEntity.getElement(null);

			EAssembly_component_placement_link armElement = null;
	...
	* @throws SdaiException
	*/
	public static void unsetElement(SdaiContext context, ELinear_array_placement_group_component_armx armEntity) throws SdaiException
	{
	...
	* @throws SdaiException
	*/
	public static void setTerminus_node_positive_x_displacement(SdaiContext context, ELinear_array_placement_group_component_armx armEntity) throws SdaiException
	{
		//unset old values
		unsetTerminus_node_positive_x_displacement(context, armEntity);

		if (armEntity.testTerminus_node_positive_x_displacement(null))
		{

			ELength_measure_with_unit armTerminus_node_positive_x_displacement = armEntity.getTerminus_node_positive_x_displacement(null);
			//EA armTerminus_node_positive_x_displacement.createAimData(context);
			ERepresentation_item aimDisplacement;
			if ( !(armTerminus_node_positive_x_displacement instanceof EMeasure_representation_item)) {
				aimDisplacement = (ERepresentation_item)context.working_model.substituteInstance(armTerminus_node_positive_x_displacement, CLength_measure_with_unit$measure_representation_item.definition);
	            aimDisplacement.setName(null, "");
				
				//EA armTerminus_node_positive_x_displacement.setAimInstance(aimDisplacement);
			}
			else
				aimDisplacement = (ERepresentation_item)armTerminus_node_positive_x_displacement;				

			//property_definition
			EProperty_definition property_definition = CxAP210ARMUtilities.createProperty_definition(context, null, "linear array placement group properties", null, armEntity, true);
		   ...
		   EProperty_definition_representation property_definition_representation = (EProperty_definition_representation)
			...
			if (property_definition_representation.testUsed_representation(null)) {
				...
				representation.setName(null, "linear array properties");
...
/*					if (!representation_context.testUnits(null)) {
			...
			aimDisplacement.setName(null, "terminus element positive x displacement");
	...
	* @throws SdaiException
	*/
	public static void unsetTerminus_node_positive_x_displacement(SdaiContext context, ELinear_array_placement_group_component_armx armEntity) throws SdaiException
	{
		//property_definition
		...
		for (int i = 1; i <= aProperty_definition.getMemberCount(); i++) {
			...
			if (property_definition.testName(null) && property_definition.getName(null).equals("linear array placement group properties")) {
				...
				for (int j = 1; j <= aProperty_definition_representation.getMemberCount(); j++) {
					...
					if (property_definition_representation.testUsed_representation(null)) {
						...
						if (representation.testName(null) && representation.getName(null).equals("linear array properties")) {
							if (representation.testItems(null)) {
								...
								while (k <= aItem.getMemberCount()) {
									...
									if (item.testName(null) && item.getName(null).equals("terminus element positive x displacement")) {
...
// New since WDxxx
   ...
   * @throws SdaiException
   */
   public static void setInitial_node_positive_x_displacement(SdaiContext context, ELinear_array_placement_group_component_armx armEntity) throws SdaiException
   {
      //unset old values
      unsetInitial_node_positive_x_displacement(context, armEntity);

      if (armEntity.testInitial_node_positive_x_displacement(null))
      {

         jsdai.SMeasure_schema.ELength_measure_with_unit armInitial_node_positive_x_displacement = armEntity.getInitial_node_positive_x_displacement(null);
...
/*               if (!representation_context.testUnits(null)) {
         ...
         aimDisplacement.setName(null, "initial element positive x displacement");
         representation.getItems(null).addUnordered(aimDisplacement);
      }
   }
   ...
   * @throws SdaiException
   */
   public static void unsetInitial_node_positive_x_displacement(SdaiContext context, ELinear_array_placement_group_component_armx armEntity) throws SdaiException
   {
      //property_definition
      EProperty_definition property_definition = null;
      AProperty_definition aProperty_definition = new AProperty_definition();
               ...
               if (property_definition_representation.testUsed_representation(null)) {
                  ...
                  if (representation.testName(null) && representation.getName(null).equals("linear array properties")) {
                     if (representation.testItems(null)) {
                        ...
                        while (k <= aItem.getMemberCount()) {
                           item = aItem.getByIndex(k);
                           if (item.testName(null) && item.getName(null).equals("initial element positive x displacement")) {
                              aItem.removeUnordered(item);
                           } else {
                              k++;
                           }
...
// New since Modularization
   ...
   */
   ...
   public static void setLocation_uncertainty(SdaiContext context, ELinear_array_placement_group_component_armx armEntity) throws SdaiException
   {
      //unset old values
...
//                                                new LangUtils.Attribute_and_value_structure(jsdai.SRepresentation_schema.CRepresentation_context.attributeContext_type(null), "array parametric context")
   ...
   * @throws SdaiException
   */
   public static void unsetLocation_uncertainty(SdaiContext context, ELinear_array_placement_group_component_armx armEntity) throws SdaiException
   {
      //property_definition
      EProperty_definition property_definition = null;
      AProperty_definition aProperty_definition = new AProperty_definition();
