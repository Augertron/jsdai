...
public class CxLibrary_view_definition extends CLibrary_view_definition implements EMappedXIMEntity
{
...
/*	public boolean testName(EProduct_definition type) throws SdaiException {
	...
	*/
	public static void setMappingConstraints(SdaiContext context, ELibrary_view_definition armEntity) throws SdaiException
	{
		unsetMappingConstraints(context, armEntity);
		
		CxExternally_defined_view_definition.setMappingConstraints(context, armEntity);
	}

	public static void unsetMappingConstraints(SdaiContext context, ELibrary_view_definition armEntity) throws SdaiException
	{
		CxExternally_defined_view_definition.unsetMappingConstraints(context, armEntity);
	}	
	//********** "managed_design_object" attributes
