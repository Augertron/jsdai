...
import jsdai.SProduct_breakdown_xim.CxBreakdown_element_definition;
import jsdai.SProduct_definition_schema.EProduct_definition;
import jsdai.SProduct_view_definition_xim.*;

public class CxPhysical_element_definition extends CPhysical_element_definition implements EMappedXIMEntity{
...
/*	public boolean testName(EProduct_definition type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			EPhysical_element_definition armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxBreakdown_element_definition.setMappingConstraints(context, armEntity);
      ...
      LangUtils.Attribute_and_value_structure[] pdcS = {
            ...
            CProduct_definition_context.attributeName(null), "conceptual definition")
         };
	...
	public static void unsetMappingConstraints(SdaiContext context,
			EPhysical_element_definition armEntity) throws SdaiException {
		CxBreakdown_element_definition.unsetMappingConstraints(context, armEntity);
		if(!armEntity.testFrame_of_reference(null))
			return;
		EProduct_definition_context pdc = armEntity.getFrame_of_reference(null);
		if(!pdc.getName(null).equals("conceptual definition"))
