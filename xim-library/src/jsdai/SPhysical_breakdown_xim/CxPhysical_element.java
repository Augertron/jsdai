...
public class CxPhysical_element extends CPhysical_element implements EMappedXIMEntity
{
...
/*	public static int usedinFrame_of_reference(EProduct type, jsdai.SApplication_context_schema.EProduct_context instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	*/
	public static void setMappingConstraints(SdaiContext context, EPhysical_element armEntity) throws SdaiException
	{
		CxBreakdown_element.setMappingConstraints(context, armEntity);
		
		String name = "conceptual product";
	...
	public static void unsetMappingConstraints(SdaiContext context, EPhysical_element armEntity) throws SdaiException
	{
