...
import jsdai.SPart_feature_grouping_mim.CComposite_array_shape_aspect;
import jsdai.SPhysical_unit_usage_view_xim.*;
import jsdai.SProduct_property_definition_schema.EShape_aspect;

public class CxPart_array_feature extends CPart_array_feature implements EMappedXIMEntity{
...
/*	public boolean testProduct_definitional(EShape_aspect type) throws SdaiException {
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CComposite_array_shape_aspect.definition);
	...
	public static void setMappingConstraints(SdaiContext context,
			EPart_array_feature armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxPart_group_feature.setMappingConstraints(context, armEntity);
	}
	...
	public static void unsetMappingConstraints(SdaiContext context,
			EPart_array_feature armEntity) throws SdaiException {
		CxPart_group_feature.unsetMappingConstraints(context, armEntity);
	}
