...
public class CxPackaged_connector_component_interface_terminal extends CPackaged_connector_component_interface_terminal implements EMappedXIMEntity{
...
/*	public boolean testProduct_definitional(EShape_aspect type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			EPackaged_connector_component_interface_terminal armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);

		CxPhysical_component_interface_terminal_armx.setMappingConstraints(context, armEntity);
		armEntity.setDescription(null, "packaged connector component interface terminal");
