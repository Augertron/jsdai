...
package jsdai.SVia_component_xim;
...
import jsdai.SInterconnect_module_connection_routing_xim.EStratum_feature_conductive_join_armx;
...
import jsdai.SVia_component_mim.CBonded_conductive_base_blind_via;

public class CxBonded_conductive_base_blind_via_armx
		extends
			CBonded_conductive_base_blind_via_armx implements EMappedXIMEntity{
...
*/
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CBonded_conductive_base_blind_via.definition);
	...
	public void removeAimData(SdaiContext context) throws SdaiException {
			...
			// Features_join
			unsetFeatures_join(context, this);			
	...
	public static void setMappingConstraints(SdaiContext context,
			EBonded_conductive_base_blind_via_armx armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxBlind_via_armx.setMappingConstraints(context, armEntity);
	}
	...
	public static void unsetMappingConstraints(SdaiContext context,
			EBonded_conductive_base_blind_via_armx armEntity) throws SdaiException {
		CxBlind_via_armx.unsetMappingConstraints(context, armEntity);
...
///// Item_shape
	...
	*/
	...
	//********** "bonded_conductive_base_blind_via" attributes

	/**
	* Sets/creates data for features_join attribute.
	*
	* <p>
	...
	* @throws SdaiException
	*/
	public static void setFeatures_join(SdaiContext context, EBonded_conductive_base_blind_via_armx armEntity) throws SdaiException
	{
		//unset old values
		unsetFeatures_join(context, armEntity);

		if (armEntity.testFeatures_join(null))
		{
			EStratum_feature_conductive_join_armx armFeatures_join = armEntity.getFeatures_join(null);

			// SA
			// PDC
	      LangUtils.Attribute_and_value_structure[] saStructure = {
	            new LangUtils.Attribute_and_value_structure(CShape_aspect.attributeOf_shape(null), armEntity)
	         };
	      ...
	      if(!esa.testProduct_definitional(null))
			...
			shape_aspect_relationship.setName(null, "features join");
			shape_aspect_relationship.setRelated_shape_aspect(null, esa);
			// PDS -> SFCJ
	      LangUtils.Attribute_and_value_structure[] pdsStructure = {
	            new LangUtils.Attribute_and_value_structure(CProduct_definition_shape.attributeDefinition(null), armFeatures_join)
	         };
	      ...
	      LangUtils.Attribute_and_value_structure[] sa2Structure = {
	            new LangUtils.Attribute_and_value_structure(CShape_aspect.attributeOf_shape(null), epds)
	         };
	         EShape_aspect esa2 = (EShape_aspect)
	            LangUtils.createInstanceIfNeeded(context, CShape_aspect.definition, sa2Structure);
	...
	/**
	* Unsets/deletes data for features_join attribute.
	*
	* @param context SdaiContext.
	* @param armEntity arm entity.
	* @throws SdaiException
	*/
	public static void unsetFeatures_join(SdaiContext context, EBonded_conductive_base_blind_via_armx armEntity) throws SdaiException
	{
		...
		for (int j = 1; j <= asa.getMemberCount(); j++) {
			...
			for (int i = 1; i <= aRelationship.getMemberCount(); i++) {
				...
				if (relationship.testName(null) && relationship.getName(null).equals("features join")) {
