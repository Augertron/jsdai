...
public class CxInterfacial_connection_armx
		extends
			CInterfacial_connection_armx implements EMappedXIMEntity{
...
//			unsetId_x(context, this);
	...
	public static void setMappingConstraints(SdaiContext context,
			EInterfacial_connection_armx armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxVia_armx.setMappingConstraints(context, armEntity);
	}
	...
	public static void unsetMappingConstraints(SdaiContext context,
			EInterfacial_connection_armx armEntity) throws SdaiException {
		CxVia_armx.unsetMappingConstraints(context, armEntity);
	}
