...
public class CxProject_relationship__sequence extends CProject_relationship__sequence implements EMappedXIMEntity{
...
/*	public boolean testName(EOrganizational_project_relationship type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			EProject_relationship__sequence armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxProject_relationship.setMappingConstraints(context, armEntity);
		armEntity.setRelation_type(null, "sequence");
	}
