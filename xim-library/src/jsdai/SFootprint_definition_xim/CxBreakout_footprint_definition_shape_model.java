...
/*	public boolean testName(ERepresentation type) throws SdaiException {
	...
	*/
	public static void setMappingConstraints(SdaiContext context, EBreakout_footprint_definition_shape_model armEntity) throws SdaiException
	{
		unsetMappingConstraints(context, armEntity);
		CxStructured_template_planar_shape_model.setMappingConstraints(context, armEntity);
		CxAP210ARMUtilities.setRepresentationDescription(context, armEntity, "breakout footprint definition shape model");
	}

	public static void unsetMappingConstraints(SdaiContext context, EBreakout_footprint_definition_shape_model armEntity) throws SdaiException
	{
	...
	*/
  // SR <- PDR -> PD -> FD
	public static void setShape_characterized_definition(SdaiContext context, EBreakout_footprint_definition_shape_model armEntity) throws SdaiException
	{
	...
	* @throws SdaiException
	*/
	public static void unsetShape_characterized_definition(SdaiContext context, EBreakout_footprint_definition_shape_model armEntity) throws SdaiException
	{
	...
	* @throws SdaiException
	*/
	public static void setShape_environment(SdaiContext context, EBreakout_footprint_definition_shape_model armEntity) throws SdaiException
	{
	...
	* @throws SdaiException
	*/
	public static void unsetShape_environment(SdaiContext context, EBreakout_footprint_definition_shape_model armEntity) throws SdaiException
	{
	...
	* @throws SdaiException
	*/
	public static void setShape_material_condition(SdaiContext context, EBreakout_footprint_definition_shape_model armEntity) throws SdaiException
	{
	...
	* @throws SdaiException
	*/
	public static void unsetShape_material_condition(SdaiContext context, EBreakout_footprint_definition_shape_model armEntity) throws SdaiException
	{
		CxPart_template_shape_model.unsetShape_environment(context, armEntity);
	}
	...
	*/
  // SR <- PDR -> PD -> FD
	public static void setReference_shape(SdaiContext context, EBreakout_footprint_definition_shape_model armEntity) throws SdaiException
	{
		//unset old values
		unsetReference_shape(context, armEntity);

		if (armEntity.testReference_shape(null)){
			EShape_representation armShape = armEntity.getReference_shape(null);
		 // RR
	...
	* @throws SdaiException
	*/
	public static void unsetReference_shape(SdaiContext context, EBreakout_footprint_definition_shape_model armEntity) throws SdaiException
	{
