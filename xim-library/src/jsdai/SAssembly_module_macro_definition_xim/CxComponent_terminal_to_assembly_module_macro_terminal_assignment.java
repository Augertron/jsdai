...
public class CxComponent_terminal_to_assembly_module_macro_terminal_assignment extends CComponent_terminal_to_assembly_module_macro_terminal_assignment implements EMappedXIMEntity{
...
/*	public boolean testName(EShape_aspect_relationship type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			EComponent_terminal_to_assembly_module_macro_terminal_assignment armEntity) throws SdaiException {
		CxComponent_feature_to_physical_usage_view_assignment.setMappingConstraints(context, armEntity);
		armEntity.setDescription(null, "component terminal to assembly module macro terminal assignment");
	}
