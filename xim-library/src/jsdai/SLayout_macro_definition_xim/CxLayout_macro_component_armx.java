...
import jsdai.SLayered_interconnect_module_with_printed_component_design_xim.*;
import jsdai.SLayout_macro_definition_mim.CLayout_macro_component;
...
public class CxLayout_macro_component_armx
		extends
			CLayout_macro_component_armx implements EMappedXIMEntity{
...
*/
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CLayout_macro_component.definition);
			...
			// design_definition 
			setDesign_definition(context, this);
	...
	public void removeAimData(SdaiContext context) throws SdaiException {
			...
			// design_definition 
			unsetDesign_definition(context, this);
	...
	public static void setMappingConstraints(SdaiContext context,
			ELayout_macro_component_armx armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxPrinted_component_armx.setMappingConstraints(context, armEntity);
	}
	...
	public static void unsetMappingConstraints(SdaiContext context,
			ELayout_macro_component_armx armEntity) throws SdaiException {
		CxPrinted_component_armx.unsetMappingConstraints(context, armEntity);
	}
...
*/
	//********** "layout_macro_component" attributes

	/**
	* Sets/creates data for design_definition attribute.
	*
	* <p>
	*  attribute_mapping design_definition_layout_macro_definition (design_definition
	...
	* @throws SdaiException
	*/
	public static void setDesign_definition(SdaiContext context, ELayout_macro_component_armx armEntity) throws SdaiException
	{
		//unset old values
		unsetDesign_definition(context, armEntity);

		if (armEntity.testDesign_definition(null))
		{

			ELayout_macro_definition_armx armDesign_definition = armEntity.getDesign_definition(null);
			...
			product_definition_relationship.setName(null, "design definition");
			product_definition_relationship.setRelated_product_definition(null, armEntity);
			product_definition_relationship.setRelating_product_definition(null, armDesign_definition);
		}
	}


	/**
	* Unsets/deletes data for design_definition attribute.
	*
	* @param context SdaiContext.
	* @param armEntity arm entity.
	* @throws SdaiException
	*/
	public static void unsetDesign_definition(SdaiContext context, ELayout_macro_component_armx armEntity) throws SdaiException
	{
		...
		jsdai.SProduct_definition_schema.CProduct_definition_relationship.usedinRelated_product_definition(null, armEntity, context.domain, aRelationship);
		...
		for (int i = 1; i <= aRelationship.getMemberCount(); i++) {
			...
			if (relationship.testName(null) && relationship.getName(null).equals("design definition")) {
