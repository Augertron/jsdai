...
import jsdai.SVia_component_mim.CPlated_conductive_base_blind_via;
import jsdai.SVia_component_xim.CxPlated_conductive_base_blind_via_armx;
...
public class CxPlated_conductive_base_blind_via_armx$structured_layout_component_sub_assembly_relationship_with_component_xim extends CPlated_conductive_base_blind_via_armx$structured_layout_component_sub_assembly_relationship_with_component_xim implements EMappedXIMEntity,XimEntityStandalone
{
...
*/	
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CPlated_conductive_base_blind_via.definition);
	...
	*/
	public static void setMappingConstraints(SdaiContext context, CPlated_conductive_base_blind_via_armx$structured_layout_component_sub_assembly_relationship_with_component_xim armEntity) throws SdaiException
	{
		unsetMappingConstraints(context, armEntity);
		CxPlated_conductive_base_blind_via_armx.setMappingConstraints(context, armEntity);
		CxStructured_layout_component_sub_assembly_relationship_with_component_xim.setMappingConstraints(context, armEntity);
	}

	public static void unsetMappingConstraints(SdaiContext context, CPlated_conductive_base_blind_via_armx$structured_layout_component_sub_assembly_relationship_with_component_xim armEntity) throws SdaiException
	{
		CxPlated_conductive_base_blind_via_armx.unsetMappingConstraints(context, armEntity);
