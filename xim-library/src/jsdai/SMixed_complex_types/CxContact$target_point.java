...
import jsdai.SGeometric_tolerance_xim.CxTarget_circle;
import jsdai.SGeometric_tolerance_xim.CxTarget_point;
import jsdai.SGeometric_tolerance_xim.ETarget_circle;
...
public class CxContact$target_point extends CContact$target_point implements EMappedXIMEntity
{
...
/*	public boolean testTarget_id(EDatum_target type) throws SdaiException {
	 ...
	 */
	public static void setMappingConstraints(SdaiContext context, CContact$target_point armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxTarget_point.setMappingConstraints(context, armEntity);
...
//		armEntity.setProduct_definitional(null, ELogical.UNKNOWN);
	 ...
	 * @throws SdaiException
	 */
	public static void unsetMappingConstraints(SdaiContext context, CContact$target_point armEntity) throws SdaiException {
		CxTarget_point.unsetMappingConstraints(context, armEntity);
	...
	public static void setDiameter(SdaiContext context, ETarget_circle armEntity) throws SdaiException {
		CxTarget_circle.setDiameter(context, armEntity);
	}
	 ...
	 * @throws SdaiException
	 */
	public static void unsetDiameter(SdaiContext context, ETarget_circle armEntity) throws SdaiException {
		CxTarget_circle.unsetProperty(context, armEntity);
	}
