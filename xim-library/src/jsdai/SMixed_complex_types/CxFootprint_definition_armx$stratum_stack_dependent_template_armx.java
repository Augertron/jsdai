...
public class CxFootprint_definition_armx$stratum_stack_dependent_template_armx extends CFootprint_definition_armx$stratum_stack_dependent_template_armx implements EMappedXIMEntity
{
...
/*	public boolean testName(EProduct_definition type) throws SdaiException {
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CFootprint_definition$stratum_stack_dependent_template.definition);
...
//		 It is derived, so can't unset it unsetLocation(context, this);
	...
	*/
	public static void setMappingConstraints(SdaiContext context, CFootprint_definition_armx$stratum_stack_dependent_template_armx armEntity) throws SdaiException
	{
		unsetMappingConstraints(context, armEntity);
		
		CxFootprint_definition_armx.setMappingConstraints(context, armEntity);
		CxStratum_stack_dependent_template_armx.setMappingConstraints(context, armEntity);
	}

	public static void unsetMappingConstraints(SdaiContext context, CFootprint_definition_armx$stratum_stack_dependent_template_armx armEntity) throws SdaiException
	{
		CxFootprint_definition_armx.unsetMappingConstraints(context, armEntity);
   ...
   */
 	...
 	public static void unsetPhysical_characteristic(SdaiContext context, ETemplate_definition armEntity) throws SdaiException
   {
	...
	public static void setReference_package(SdaiContext context, EFootprint_definition_armx armEntity)
		throws SdaiException {
		CxFootprint_definition_armx.setReference_package(context, armEntity);
	}
