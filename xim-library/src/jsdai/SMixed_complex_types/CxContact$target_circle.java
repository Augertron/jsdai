...
public class CxContact$target_circle extends CContact$target_circle implements EMappedXIMEntity
{
...
/*	public boolean testTarget_id(EDatum_target type) throws SdaiException {
	 ...
	 */
	public static void setMappingConstraints(SdaiContext context, CContact$target_circle armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxTarget_circle.setMappingConstraints(context, armEntity);
...
//		armEntity.setProduct_definitional(null, ELogical.UNKNOWN);
	 ...
	 * @throws SdaiException
	 */
	public static void unsetMappingConstraints(SdaiContext context, CContact$target_circle armEntity) throws SdaiException {
		CxTarget_circle.unsetMappingConstraints(context, armEntity);
