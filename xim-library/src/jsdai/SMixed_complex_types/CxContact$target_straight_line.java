...
import jsdai.SGeometric_tolerance_xim.CxTarget_straight_line;
import jsdai.SGeometric_tolerance_xim.ETarget_straight_line;
...
public class CxContact$target_straight_line extends CContact$target_straight_line implements EMappedXIMEntity
{
...
/*	public boolean testTarget_id(EDatum_target type) throws SdaiException {
	 ...
	 */
	public static void setMappingConstraints(SdaiContext context, CContact$target_straight_line armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxTarget_straight_line.setMappingConstraints(context, armEntity);
...
//		armEntity.setProduct_definitional(null, ELogical.UNKNOWN);
	 ...
	 * @throws SdaiException
	 */
	public static void unsetMappingConstraints(SdaiContext context, CContact$target_straight_line armEntity) throws SdaiException {
		CxTarget_straight_line.unsetMappingConstraints(context, armEntity);
	 ...
	 * @throws SdaiException
	 */
	public static void setTarget_length(SdaiContext context, ETarget_straight_line armEntity) throws SdaiException {
		CxTarget_straight_line.setTarget_length(context, armEntity);
	}
	 ...
	 * @throws SdaiException
	 */
	public static void unsetProperty(SdaiContext context, ETarget_straight_line armEntity) throws SdaiException {
		CxTarget_straight_line.unsetProperty(context, armEntity);
	}
