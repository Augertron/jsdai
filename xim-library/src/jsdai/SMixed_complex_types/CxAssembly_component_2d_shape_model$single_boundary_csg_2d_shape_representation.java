...
public class CxAssembly_component_2d_shape_model$single_boundary_csg_2d_shape_representation extends CAssembly_component_2d_shape_model$single_boundary_csg_2d_shape_representation implements EMappedXIMEntity
{
...
/*	public boolean testName(ERepresentation type) throws SdaiException {
	...
	*/
	public static void setMappingConstraints(SdaiContext context, CAssembly_component_2d_shape_model$single_boundary_csg_2d_shape_representation armEntity) throws SdaiException
	{
		unsetMappingConstraints(context, armEntity);
		CxAssembly_component_2d_shape_model.setMappingConstraints(context, armEntity);
	}

	public static void unsetMappingConstraints(SdaiContext context, CAssembly_component_2d_shape_model$single_boundary_csg_2d_shape_representation armEntity) throws SdaiException
	{
