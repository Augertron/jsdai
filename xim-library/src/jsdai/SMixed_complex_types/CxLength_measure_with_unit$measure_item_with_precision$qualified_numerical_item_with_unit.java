...
public class CxLength_measure_with_unit$measure_item_with_precision$qualified_numerical_item_with_unit extends CLength_measure_with_unit$measure_item_with_precision$qualified_numerical_item_with_unit implements EMappedXIMEntity
{
...
/*	public static int usedinQualifiers(EQualified_representation_item type, EEntity instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	*/
	public static void setMappingConstraints(SdaiContext context, CLength_measure_with_unit$measure_item_with_precision$qualified_numerical_item_with_unit armEntity) throws SdaiException
	{
	...
	public static void unsetMappingConstraints(SdaiContext context, CLength_measure_with_unit$measure_item_with_precision$qualified_numerical_item_with_unit armEntity) throws SdaiException
	{
