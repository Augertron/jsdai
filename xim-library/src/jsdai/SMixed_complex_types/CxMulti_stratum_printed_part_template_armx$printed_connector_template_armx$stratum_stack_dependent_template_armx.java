...
public class CxMulti_stratum_printed_part_template_armx$printed_connector_template_armx$stratum_stack_dependent_template_armx extends CMulti_stratum_printed_part_template_armx$printed_connector_template_armx$stratum_stack_dependent_template_armx implements EMappedXIMEntity
{
...
/*	public boolean testName(EProduct_definition type) throws SdaiException {
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CMulti_stratum_printed_part_template$printed_connector_template$stratum_stack_dependent_template.definition);
...
//		 It is derived, so can't unset it unsetLocation(context, this);
	...
	*/
	public static void setMappingConstraints(SdaiContext context, CMulti_stratum_printed_part_template_armx$printed_connector_template_armx$stratum_stack_dependent_template_armx armEntity) throws SdaiException
	{
		unsetMappingConstraints(context, armEntity);
		
		CxMulti_stratum_printed_part_template_armx.setMappingConstraints(context, armEntity);
		CxPrinted_connector_template_armx.setMappingConstraints(context, armEntity);
		CxStratum_stack_dependent_template_armx.setMappingConstraints(context, armEntity);
	}

	public static void unsetMappingConstraints(SdaiContext context, CMulti_stratum_printed_part_template_armx$printed_connector_template_armx$stratum_stack_dependent_template_armx armEntity) throws SdaiException
	{
		CxMulti_stratum_printed_part_template_armx.unsetMappingConstraints(context, armEntity);
		CxPrinted_connector_template_armx.unsetMappingConstraints(context, armEntity);
