...
public class CxInternal_probe_access_area_armx$land_with_join_terminal_xim$plated_passage_dependent_land_armx$stratum_feature_template_component_with_stratum_feature_xim$structured_layout_component_sub_assembly_relationship_with_component_xim extends CInternal_probe_access_area_armx$land_with_join_terminal_xim$plated_passage_dependent_land_armx$stratum_feature_template_component_with_stratum_feature_xim$structured_layout_component_sub_assembly_relationship_with_component_xim implements EMappedXIMEntity,XimEntityStandalone
{
...
/*	public boolean testProduct_definitional(EShape_aspect type) throws SdaiException {
		return test_logical(a31);
	}
	public int getProduct_definitional(EShape_aspect type) throws SdaiException {
		return get_logical(a31);
	}*/
	public void setProduct_definitional(EShape_aspect type, int value) throws SdaiException {
		a31 = set_logical(value);
	}
	...
	/*	public boolean testDescription(EShape_aspect type) throws SdaiException {
		return test_string(a29);
	}
	public String getDescription(EShape_aspect type) throws SdaiException {
		return get_string(a29);
	}*/
	public void setDescription(EShape_aspect type, String value) throws SdaiException {
		a29 = set_string(value);
	}
...
/*	public static int usedinFormation(EProduct_definition type, EProduct_definition_formation instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public EProduct_definition_formation getFormation(EProduct_definition type) throws SdaiException {
		a14 = get_instance(a14);
		return (EProduct_definition_formation)a14;
	}*/
...
/*	public static int usedinFrame_of_reference(EProduct_definition type, jsdai.SApplication_context_schema.EProduct_definition_context instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public jsdai.SApplication_context_schema.EProduct_definition_context getFrame_of_reference(EProduct_definition type) throws SdaiException {
		a15 = get_instance(a15);
		return (jsdai.SApplication_context_schema.EProduct_definition_context)a15;
	}*/
...
/*	public static int usedinDefinition(EProperty_definition type, EEntity instance, ASdaiModel domain, AEntity result) throws SdaiException {
		return ((CEntity)instance).makeUsedin(definition, a27$, domain, result);
	}
	public boolean testDefinition(EProperty_definition type) throws SdaiException {
		return test_instance(a27);
	}

	public EEntity getDefinition(EProperty_definition type) throws SdaiException { // case 1
		a27 = get_instance_select(a27);
		return (EEntity)a27;
	}
*/
	public void setDefinition(EProperty_definition type, EEntity value) throws SdaiException { // case 1
		a27 = set_instanceX(a27, value);
	}

	public void unsetDefinition(EProperty_definition type) throws SdaiException {
		a27 = unset_instance(a27);
	}
...
/*	public static int usedinRelating_product_definition(EProduct_definition_relationship type, EProduct_definition instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public EProduct_definition getRelating_product_definition(EProduct_definition_relationship type) throws SdaiException {
		return (EProduct_definition)get_instance(a19);
	}*/
...
*/	
	...
	*/
	public static void setMappingConstraints(SdaiContext context, CInternal_probe_access_area_armx$land_with_join_terminal_xim$plated_passage_dependent_land_armx$stratum_feature_template_component_with_stratum_feature_xim$structured_layout_component_sub_assembly_relationship_with_component_xim armEntity) throws SdaiException
	{
	...
	public static void unsetMappingConstraints(SdaiContext context, CInternal_probe_access_area_armx$land_with_join_terminal_xim$plated_passage_dependent_land_armx$stratum_feature_template_component_with_stratum_feature_xim$structured_layout_component_sub_assembly_relationship_with_component_xim armEntity) throws SdaiException
	{
