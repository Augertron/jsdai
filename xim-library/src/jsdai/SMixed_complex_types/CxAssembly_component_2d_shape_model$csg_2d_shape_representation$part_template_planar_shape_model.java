...
public class CxAssembly_component_2d_shape_model$csg_2d_shape_representation$part_template_planar_shape_model extends CAssembly_component_2d_shape_model$csg_2d_shape_representation$part_template_planar_shape_model implements EMappedXIMEntity
{
...
/*	public boolean testName(ERepresentation type) throws SdaiException {
	...
	*/
	public static void setMappingConstraints(SdaiContext context, CAssembly_component_2d_shape_model$csg_2d_shape_representation$part_template_planar_shape_model armEntity) throws SdaiException
	{
	...
	public static void unsetMappingConstraints(SdaiContext context, CAssembly_component_2d_shape_model$csg_2d_shape_representation$part_template_planar_shape_model armEntity) throws SdaiException
	{
		//	Order is importatnt as AC2DS is subtype of FSD and only in this way magic strings can be synchronized
