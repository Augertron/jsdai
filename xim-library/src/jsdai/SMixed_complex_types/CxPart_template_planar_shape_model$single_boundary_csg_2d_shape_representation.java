...
public class CxPart_template_planar_shape_model$single_boundary_csg_2d_shape_representation extends CPart_template_planar_shape_model$single_boundary_csg_2d_shape_representation implements EMappedXIMEntity
{
...
/*	public boolean testName(ERepresentation type) throws SdaiException {
	...
	*/
	public static void setMappingConstraints(SdaiContext context, CPart_template_planar_shape_model$single_boundary_csg_2d_shape_representation armEntity) throws SdaiException
	{
	...
	public static void unsetMappingConstraints(SdaiContext context, CPart_template_planar_shape_model$single_boundary_csg_2d_shape_representation armEntity) throws SdaiException
	{
		//	Order is importatnt as AC2DS is subtype of FSD and only in this way magic strings can be synchronized
