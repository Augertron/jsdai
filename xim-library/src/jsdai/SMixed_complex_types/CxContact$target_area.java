...
public class CxContact$target_area extends CContact$target_area implements EMappedXIMEntity
{
...
/*	public boolean testTarget_id(EDatum_target type) throws SdaiException {
	 ...
	 */
	public static void setMappingConstraints(SdaiContext context, CContact$target_area armEntity) throws SdaiException {
...
//		armEntity.setProduct_definitional(null, ELogical.UNKNOWN);
	 ...
	 * @throws SdaiException
	 */
	public static void unsetMappingConstraints(SdaiContext context, CContact$target_area armEntity) throws SdaiException {
