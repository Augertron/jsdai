...
public class CxGeometric_placement$usage_concept_usage_relationship_armx extends CGeometric_placement$usage_concept_usage_relationship_armx implements EMappedXIMEntity, RepresentationMapAttributesImplementer
{
...
/*	public boolean testName(ERepresentation_item type) throws SdaiException {
	...
	*/
	public static void setMappingConstraints(SdaiContext context, CGeometric_placement$usage_concept_usage_relationship_armx armEntity) throws SdaiException
	{
	...
	public static void unsetMappingConstraints(SdaiContext context, CGeometric_placement$usage_concept_usage_relationship_armx armEntity) throws SdaiException
	{
   ...
   */
  // MI -> RM -> SR
	public static void setTemplate_definition(SdaiContext context, CGeometric_placement$usage_concept_usage_relationship_armx armEntity) throws SdaiException
	{
  ...
  public static void unsetTemplate_definition(SdaiContext context,
  		CGeometric_placement$usage_concept_usage_relationship_armx armEntity) throws
     SdaiException {
  	CxGeometric_placement_operation.unsetTemplate_definition(context, armEntity);  	
  }

  public static void setSource(SdaiContext context, CGeometric_placement$usage_concept_usage_relationship_armx armEntity)throws SdaiException{
  	CxGeometric_placement_operation.setSource(context, armEntity);  	
  }
  
  public static void unsetSource(SdaiContext context, CGeometric_placement$usage_concept_usage_relationship_armx armEntity)throws SdaiException{
  	CxGeometric_placement_operation.unsetSource(context, armEntity);  	
  }

  // UCUR
  /* Now it is the same as template_definition  
  public static void setAssociated_shape_definition(SdaiContext context, CGeometric_placement$usage_concept_usage_relationship_armx armEntity)throws SdaiException{
  	CxUsage_concept_usage_relationship_armx.setAssociated_shape_definition(context, armEntity);  	
  }
  
  public static void unsetAssociated_shape_definition(SdaiContext context, CGeometric_placement$usage_concept_usage_relationship_armx armEntity)throws SdaiException{
