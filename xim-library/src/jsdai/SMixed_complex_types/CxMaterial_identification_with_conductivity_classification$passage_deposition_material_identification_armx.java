/*
 * $Id$passage_deposition_material_identification_armx.java,v 1.6 2008/05/29 16:08:46 vaidas Exp $
 *
...
public class CxMaterial_identification_with_conductivity_classification$passage_deposition_material_identification_armx extends CMaterial_identification_with_conductivity_classification$passage_deposition_material_identification_armx implements EMappedXIMEntity
{
	...
	*/
	public static void setMappingConstraints(SdaiContext context, CMaterial_identification_with_conductivity_classification$passage_deposition_material_identification_armx armEntity) throws SdaiException
	{
		CxMaterial_identification_with_conductivity_classification.setMappingConstraints(context, armEntity);
		CxPassage_deposition_material_identification_armx.setMappingConstraints(context, armEntity);		
		unsetMappingConstraints(context, armEntity);
	}

	public static void unsetMappingConstraints(SdaiContext context, CMaterial_identification_with_conductivity_classification$passage_deposition_material_identification_armx armEntity) throws SdaiException
	{
		CxMaterial_identification_with_conductivity_classification.unsetMappingConstraints(context, armEntity);
		CxPassage_deposition_material_identification_armx.unsetMappingConstraints(context, armEntity);		
	}
