...
import jsdai.SAssembly_module_design_xim.CxAssembly_module;
import jsdai.SAssembly_module_design_xim.EAssembly_module;
...
public class CxPca$physical_unit_network_definition_armx extends
		CPca$physical_unit_network_definition_armx implements EMappedXIMEntity{
...
/*	public boolean testName(jsdai.SProduct_property_definition_schema.EProperty_definition type) throws SdaiException {
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CAssembly_definition$physical_unit_network_definition.definition);
	...
	public static void setMappingConstraints(SdaiContext context,
			EAssembly_module armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxAssembly_module.setMappingConstraints(context, armEntity);
	}
	...
	public static void unsetMappingConstraints(SdaiContext context,
			EAssembly_module armEntity) throws SdaiException {
		CxAssembly_module.unsetMappingConstraints(context, armEntity);
	}
