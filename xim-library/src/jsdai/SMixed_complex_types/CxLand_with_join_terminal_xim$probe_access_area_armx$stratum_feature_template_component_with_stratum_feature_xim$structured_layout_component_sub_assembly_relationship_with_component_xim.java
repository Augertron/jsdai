...
public class CxLand_with_join_terminal_xim$probe_access_area_armx$stratum_feature_template_component_with_stratum_feature_xim$structured_layout_component_sub_assembly_relationship_with_component_xim extends CLand_with_join_terminal_xim$probe_access_area_armx$stratum_feature_template_component_with_stratum_feature_xim$structured_layout_component_sub_assembly_relationship_with_component_xim implements EMappedXIMEntity,XimEntityStandalone
{
...
public EProduct_definition_shape getOf_shape(EShape_aspect type) throws SdaiException {
	return (EProduct_definition_shape)get_instance(a27);
}*/
...
/*	public boolean testProduct_definitional(EShape_aspect type) throws SdaiException {
		return test_logical(a28);
	}
	public int getProduct_definitional(EShape_aspect type) throws SdaiException {
		return get_logical(a28);
	}*/
	public void setProduct_definitional(EShape_aspect type, int value) throws SdaiException {
		a28 = set_logical(value);
	}
...
/*	public static int usedinFormation(EProduct_definition type, EProduct_definition_formation instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public EProduct_definition_formation getFormation(EProduct_definition type) throws SdaiException {
		...
		return (EProduct_definition_formation)a11;
	}*/
...
/*	public static int usedinDefinition(EProperty_definition type, EEntity instance, ASdaiModel domain, AEntity result) throws SdaiException {
		return ((CEntity)instance).makeUsedin(definition, a24$, domain, result);
	}
	public boolean testDefinition(EProperty_definition type) throws SdaiException {
		return test_instance(a24);
	}

	public EEntity getDefinition(EProperty_definition type) throws SdaiException { // case 1
		a24 = get_instance_select(a24);
		return (EEntity)a24;
	}
*/
...
/*	public static int usedinRelating_product_definition(EProduct_definition_relationship type, EProduct_definition instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public EProduct_definition getRelating_product_definition(EProduct_definition_relationship type) throws SdaiException {
		return (EProduct_definition)get_instance(a16);
	}*/
...
*/	
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CLand_with_join_terminal$probe_access_area$stratum_feature_template_component_with_stratum_feature.definition); //$structured_layout_component_sub_assembly_relationship_with_component.definition);
...
//		unsetId_x(context, this);
	...
	*/
	public static void setMappingConstraints(SdaiContext context, CLand_with_join_terminal_xim$probe_access_area_armx$stratum_feature_template_component_with_stratum_feature_xim$structured_layout_component_sub_assembly_relationship_with_component_xim armEntity) throws SdaiException
	{
	...
	public static void unsetMappingConstraints(SdaiContext context, CLand_with_join_terminal_xim$probe_access_area_armx$stratum_feature_template_component_with_stratum_feature_xim$structured_layout_component_sub_assembly_relationship_with_component_xim armEntity) throws SdaiException
	{
