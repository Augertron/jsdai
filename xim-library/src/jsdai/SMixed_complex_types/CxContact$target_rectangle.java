...
import jsdai.SGeometric_tolerance_xim.CxTarget_rectangle;
import jsdai.SGeometric_tolerance_xim.ETarget_rectangle;
...
public class CxContact$target_rectangle extends CContact$target_rectangle implements EMappedXIMEntity
{
...
/*	public boolean testTarget_id(EDatum_target type) throws SdaiException {
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTarget_length(context, this);
		
		setTarget_width(context, this);

		setDerived_from(context, this);
		
		unsetTarget_length(null);
		
		unsetTarget_width(null);
	 ...
	 */
	public static void setMappingConstraints(SdaiContext context, CContact$target_rectangle armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxTarget_rectangle.setMappingConstraints(context, armEntity);
...
//		armEntity.setProduct_definitional(null, ELogical.UNKNOWN);
	 ...
	 * @throws SdaiException
	 */
	public static void unsetMappingConstraints(SdaiContext context, CContact$target_rectangle armEntity) throws SdaiException {
		CxTarget_rectangle.unsetMappingConstraints(context, armEntity);
		CxContact.unsetMappingConstraints(context, armEntity);
	}

	/**
	 * Sets/creates data for Target_length attribute.
	 * 
	 * 
	 * @param context
	 *            SdaiContext.
	 ...
	 * @throws SdaiException
	 */
	public static void setTarget_length(SdaiContext context, ETarget_rectangle armEntity) throws SdaiException {
		CxTarget_rectangle.setTarget_length(context, armEntity);
	}

	/**
	 * Sets/creates data for Target_width attribute.
	 * 
	 * 
	 * @param context
	 *            SdaiContext.
	 ...
	 * @throws SdaiException
	 */
	public static void setTarget_width(SdaiContext context, ETarget_rectangle armEntity) throws SdaiException {
		CxTarget_rectangle.setTarget_width(context, armEntity);
	}
	 ...
	 * @throws SdaiException
	 */
	public static void unsetProperty(SdaiContext context, ETarget_rectangle armEntity) throws SdaiException {
		CxTarget_rectangle.unsetProperty(context, armEntity);
	}
