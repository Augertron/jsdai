...
public class CxAssembly_component_2d_shape_model$planar_path_shape_model_with_parameters extends CAssembly_component_2d_shape_model$planar_path_shape_model_with_parameters implements EMappedXIMEntity
{
...
/*	public boolean testName(ERepresentation type) throws SdaiException {
	...
	*/
	public static void setMappingConstraints(SdaiContext context, CAssembly_component_2d_shape_model$planar_path_shape_model_with_parameters armEntity) throws SdaiException
	{
	...
	public static void unsetMappingConstraints(SdaiContext context, CAssembly_component_2d_shape_model$planar_path_shape_model_with_parameters armEntity) throws SdaiException
	{
		//	Order is importatnt as AC2DS is subtype of FSD and only in this way magic strings can be synchronized
