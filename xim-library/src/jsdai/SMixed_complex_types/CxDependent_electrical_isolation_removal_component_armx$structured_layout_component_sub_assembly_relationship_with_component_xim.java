...
import jsdai.SLand_mim.CDependent_electrical_isolation_removal_component;
import jsdai.SLand_xim.CxDependent_electrical_isolation_removal_component_armx;
...
import jsdai.SLayered_interconnect_module_design_xim.CxMaterial_removal_laminate_component_armx;
import jsdai.SLayered_interconnect_module_design_xim.CxStructured_layout_component_sub_assembly_relationship_armx;
import jsdai.SLayered_interconnect_module_design_xim.EMaterial_removal_laminate_component_armx;
...
public class CxDependent_electrical_isolation_removal_component_armx$structured_layout_component_sub_assembly_relationship_with_component_xim extends CDependent_electrical_isolation_removal_component_armx$structured_layout_component_sub_assembly_relationship_with_component_xim implements EMappedXIMEntity,XimEntityStandalone
{
...
*/	
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CDependent_electrical_isolation_removal_component.definition);
...
//		unsetId_x(context, this);
        ...
        // design_intent : SET [1:?] OF stratum_feature_template_component_or_stratum;
		unsetDesign_intent(context, this);
	...
	*/
	public static void setMappingConstraints(SdaiContext context, CDependent_electrical_isolation_removal_component_armx$structured_layout_component_sub_assembly_relationship_with_component_xim armEntity) throws SdaiException
	{
		unsetMappingConstraints(context, armEntity);
		CxDependent_electrical_isolation_removal_component_armx.setMappingConstraints(context, armEntity);
		CxStructured_layout_component_sub_assembly_relationship_with_component_xim.setMappingConstraints(context, armEntity);
	}

	public static void unsetMappingConstraints(SdaiContext context, CDependent_electrical_isolation_removal_component_armx$structured_layout_component_sub_assembly_relationship_with_component_xim armEntity) throws SdaiException
	{
		CxDependent_electrical_isolation_removal_component_armx.unsetMappingConstraints(context, armEntity);
...
/* Material_removal_laminate_component_armx attributes */
	
	/* DERIVED
	// Causal_item
	public static void setCausal_item(SdaiContext context, EMaterial_removal_laminate_component_armx armEntity) throws SdaiException
	{
		CxMaterial_removal_laminate_component_armx.setCausal_item(context, armEntity);
	}
	
	public static void unsetCausal_item(SdaiContext context, EMaterial_removal_laminate_component_armx armEntity) throws SdaiException
	{
		CxMaterial_removal_laminate_component_armx.unsetCausal_item(context, armEntity);
	}
*/	
	// design_intent
	public static void setDesign_intent(SdaiContext context, EMaterial_removal_laminate_component_armx armEntity) throws SdaiException
	{
		CxMaterial_removal_laminate_component_armx.setDesign_intent(context, armEntity);
	}
	
	public static void unsetDesign_intent(SdaiContext context, EMaterial_removal_laminate_component_armx armEntity) throws SdaiException
	{
		CxMaterial_removal_laminate_component_armx.unsetDesign_intent(context, armEntity);
	}

	// explicitly_created
	public static void setExplicitly_created(SdaiContext context, EMaterial_removal_laminate_component_armx armEntity) throws SdaiException
	{
		CxMaterial_removal_laminate_component_armx.setExplicitly_created(context, armEntity);
	}
	
	public static void unsetExplicitly_created(SdaiContext context, EMaterial_removal_laminate_component_armx armEntity) throws SdaiException
	{
		CxMaterial_removal_laminate_component_armx.unsetExplicitly_created(context, armEntity);
	}
