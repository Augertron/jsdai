...
public class CxCsg_2d_shape_representation$physical_unit_planar_keepout_shape_model extends CCsg_2d_shape_representation$physical_unit_planar_keepout_shape_model implements EMappedXIMEntity
{
...
/*	public boolean testName(ERepresentation type) throws SdaiException {
	...
	*/
	public static void setMappingConstraints(SdaiContext context, CxCsg_2d_shape_representation$physical_unit_planar_keepout_shape_model armEntity) throws SdaiException
	{
		unsetMappingConstraints(context, armEntity);
		CxPhysical_unit_planar_keepout_shape_model.setMappingConstraints(context, armEntity);
	}

	public static void unsetMappingConstraints(SdaiContext context, CxCsg_2d_shape_representation$physical_unit_planar_keepout_shape_model armEntity) throws SdaiException
	{
