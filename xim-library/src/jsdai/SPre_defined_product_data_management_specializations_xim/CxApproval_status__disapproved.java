...
public class CxApproval_status__disapproved extends CApproval_status__disapproved implements EMappedXIMEntity{
...
/*	public boolean testName(EApproval_status type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			EApproval_status__disapproved armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		armEntity.setName(null, "disapproved");
	}
