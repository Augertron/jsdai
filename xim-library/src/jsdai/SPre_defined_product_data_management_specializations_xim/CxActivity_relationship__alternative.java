...
public class CxActivity_relationship__alternative extends CActivity_relationship__alternative implements EMappedXIMEntity{
...
/*	public boolean testName(EAction_relationship type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			EActivity_relationship__alternative armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);

		CxPre_defined_activity_relationship.setMappingConstraints(context, armEntity);
		armEntity.setName(null, "alternative");
	}
