...
public class CxActivity_relationship__decomposition extends CActivity_relationship__decomposition implements EMappedXIMEntity{
...
/*	public boolean testName(EAction_relationship type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			CxActivity_relationship__decomposition armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);

		CxPre_defined_activity_relationship.setMappingConstraints(context, armEntity);
		armEntity.setName(null, "decomposition");
	}
	...
	public static void unsetMappingConstraints(SdaiContext context,
			EActivity_relationship__decomposition armEntity) throws SdaiException {
