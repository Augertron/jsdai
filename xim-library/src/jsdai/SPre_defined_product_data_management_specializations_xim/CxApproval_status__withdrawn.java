...
public class CxApproval_status__withdrawn extends CApproval_status__withdrawn implements EMappedXIMEntity{
...
/*	public boolean testName(EApproval_status type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			EApproval_status__withdrawn armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		armEntity.setName(null, "withdrawn");
	}
