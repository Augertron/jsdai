...
public class CxApplied_organization_assignment__supplying_organization extends CApplied_organization_assignment__supplying_organization implements EMappedXIMEntity{
...
/*	public static int usedinRole(EOrganization_assignment type, jsdai.SPerson_organization_schema.EOrganization_role instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			EApplied_organization_assignment__supplying_organization armEntity) throws SdaiException {
		...
		LangUtils.Attribute_and_value_structure[] roleStructure = {new LangUtils.Attribute_and_value_structure(
				COrganization_role.attributeName(null), "supplying organization")};
