...
public class CxPre_defined_activity_relationship extends CPre_defined_activity_relationship implements EMappedXIMEntity{
	...
	public static void setMappingConstraints(SdaiContext context,
			EPre_defined_activity_relationship armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);

		CxActivity_relationship.setMappingConstraints(context, armEntity);
	}
	...
	public static void unsetMappingConstraints(SdaiContext context,
			EPre_defined_activity_relationship armEntity) throws SdaiException {
		CxActivity_relationship.unsetMappingConstraints(context, armEntity);
	}
