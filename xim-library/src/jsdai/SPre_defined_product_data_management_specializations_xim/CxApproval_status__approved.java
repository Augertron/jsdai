...
public class CxApproval_status__approved extends CApproval_status__approved implements EMappedXIMEntity{
...
/*	public boolean testName(EApproval_status type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			EApproval_status__approved armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		armEntity.setName(null, "approved");
	}
