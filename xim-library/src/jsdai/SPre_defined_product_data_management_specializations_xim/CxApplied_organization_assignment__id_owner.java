...
public class CxApplied_organization_assignment__id_owner extends CApplied_organization_assignment__id_owner implements EMappedXIMEntity{
...
/*	public static jsdai.dictionary.EAttribute attributeRole(EOrganization_assignment type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			EApplied_organization_assignment__id_owner armEntity) throws SdaiException {
		...
		LangUtils.Attribute_and_value_structure[] roleStructure = {new LangUtils.Attribute_and_value_structure(
				COrganization_role.attributeName(null), "id owner")};
