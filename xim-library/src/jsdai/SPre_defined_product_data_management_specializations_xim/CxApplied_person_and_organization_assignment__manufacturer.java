...
public class CxApplied_person_and_organization_assignment__manufacturer extends CApplied_person_and_organization_assignment__manufacturer implements EMappedXIMEntity{
...
/*	public static int usedinRole(EPerson_and_organization_assignment type, jsdai.SPerson_organization_schema.EPerson_and_organization_role instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			EApplied_person_and_organization_assignment__manufacturer armEntity) throws SdaiException {
		...
		LangUtils.Attribute_and_value_structure[] roleStructure = {new LangUtils.Attribute_and_value_structure(
				CPerson_and_organization_role.attributeName(null), "manufacturer")};
