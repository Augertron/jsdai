...
public class CxSecurity_classification__confidential  extends CSecurity_classification__confidential implements EMappedXIMEntity{
	 ...
	 * 		security_classification
			...
			security_classification_level.name = 'classified'}
	 * </p>
	 * 
	 * @param context
	 *            SdaiContext.
	...
	public static void setMappingConstraints(SdaiContext context,
			ESecurity_classification__confidential armEntity) throws SdaiException {
	...
	public static void unsetMappingConstraints(SdaiContext context,
			ESecurity_classification__confidential armEntity) throws SdaiException {
		CxPre_defined_security_classification.unsetMappingConstraints(context, armEntity);		
