...
public class CxApplied_date_and_time_assignment__release_date extends CApplied_date_and_time_assignment__release_date implements EMappedXIMEntity{
...
/*	public static int usedinRole(EDate_and_time_assignment type, jsdai.SDate_time_schema.EDate_time_role instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			EApplied_date_and_time_assignment__release_date armEntity) throws SdaiException {
		...
		LangUtils.Attribute_and_value_structure[] roleStructure = {new LangUtils.Attribute_and_value_structure(
				CDate_time_role.attributeName(null), "release date")};
