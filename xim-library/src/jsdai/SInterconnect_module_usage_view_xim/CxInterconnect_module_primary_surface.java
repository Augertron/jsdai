...
public class CxInterconnect_module_primary_surface extends CInterconnect_module_primary_surface implements EMappedXIMEntity{
...
/*	public boolean testProduct_definitional(EShape_aspect type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			EInterconnect_module_primary_surface armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);

		CxInterconnect_module_surface_feature.setMappingConstraints(context, armEntity);
		armEntity.setDescription((EShape_aspect)null, "interconnect module primary surface");
	}
