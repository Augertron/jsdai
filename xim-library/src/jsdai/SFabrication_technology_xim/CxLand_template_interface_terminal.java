...
public class CxLand_template_interface_terminal extends CLand_template_interface_terminal implements EMappedXIMEntity{
...
/*	public boolean testProduct_definitional(EShape_aspect type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			ELand_template_interface_terminal armEntity) throws SdaiException {
 ...
 public static void setConnection_zone_category(SdaiContext context, ELand_template_terminal_armx armEntity) throws
    SdaiException {
 	CxLand_template_terminal_armx.setConnection_zone_category(context, armEntity); 	
 }
 ...
 public static void unsetConnection_zone_category(SdaiContext context, ELand_template_terminal_armx armEntity) throws
    SdaiException {
 	CxLand_template_terminal_armx.unsetConnection_zone_category(context, armEntity); 	
 }
