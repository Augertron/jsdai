...
public class CxDefault_via_definition extends CDefault_via_definition implements EMappedXIMEntity
{
...
/*	public boolean testDescription(ECharacterized_object type) throws SdaiException {
	...
	*  shape_aspect
	*  {shape_aspect
	*  shape_aspect.description = 'default via definition'}
	...
	*/
	public static void setMappingConstraints(SdaiContext context, EDefault_via_definition armEntity) throws SdaiException
	{
		...
		armEntity.setDescription((ECharacterized_object)null, "default via definition");
	}
