...
public class CxThermal_isolation_requirement extends CThermal_isolation_requirement implements EMappedXIMEntity
{
...
/*	public static int usedinFrame_of_reference(EProduct_definition type, jsdai.SApplication_context_schema.EProduct_definition_context instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	*/
	public static void setMappingConstraints(SdaiContext context, EThermal_isolation_requirement armEntity) throws SdaiException
	{
		unsetMappingConstraints(context, armEntity);
		
		CxRequirement_view_definition.setMappingConstraints(context, armEntity);
		CxAP210ARMUtilities.setProduct_definitionName(context, armEntity, "thermal isolation requirement");
	}

	public static void unsetMappingConstraints(SdaiContext context, EThermal_isolation_requirement armEntity) throws SdaiException
	{
