...
import jsdai.SMixed_complex_types.CRepresentation_relationship_with_transformation$shape_representation_relationship;
import jsdai.SRepresentation_schema.*;

public class CxGeometric_relationship_with_placement_transformation extends CGeometric_relationship_with_placement_transformation implements EMappedXIMEntity
{
...
/*	public static int usedinTransformation_operator(ERepresentation_relationship_with_transformation type, EEntity instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CRepresentation_relationship_with_transformation$shape_representation_relationship.definition);
	...
	*/
	public static void setMappingConstraints(SdaiContext context, EGeometric_relationship_with_placement_transformation armEntity) throws SdaiException
	{
		unsetMappingConstraints(context, armEntity);
		CxGeometric_model_relationship_with_transformation.setMappingConstraints(context, armEntity);

	}

	public static void unsetMappingConstraints(SdaiContext context, EGeometric_relationship_with_placement_transformation armEntity) throws SdaiException
	{
		CxGeometric_model_relationship_with_transformation.unsetMappingConstraints(context, armEntity);
	}
	...
	* @throws SdaiException
	*/
	public static void setSource(SdaiContext context, CxGeometric_relationship_with_placement_transformation armEntity) throws SdaiException
	{
	...
	public static void unsetSource(SdaiContext context, CxGeometric_relationship_with_placement_transformation armEntity) throws SdaiException
	{
		if(armEntity.testTransformation_operator2(null)){
			EItem_defined_transformation eidt = 
	...
	* @throws SdaiException
	*/
	public static void setTarget(SdaiContext context, CxGeometric_relationship_with_placement_transformation armEntity) throws SdaiException
	{
	...
	public static void unsetTarget(SdaiContext context, CxGeometric_relationship_with_placement_transformation armEntity) throws SdaiException
	{
		if(armEntity.testTransformation_operator2(null)){
			EItem_defined_transformation eidt = 
				(EItem_defined_transformation)armEntity.getTransformation_operator2(null);
