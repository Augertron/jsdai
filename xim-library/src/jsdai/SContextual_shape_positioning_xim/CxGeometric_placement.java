...
public class CxGeometric_placement extends CGeometric_placement implements EMappedXIMEntity, RepresentationMapAttributesImplementer
{
...
/*	public boolean testName(ERepresentation_item type) throws SdaiException {
	...
	*/
	public static void setMappingConstraints(SdaiContext context, EGeometric_placement armEntity) throws SdaiException
	{
		unsetMappingConstraints(context, armEntity);
		CxGeometric_placement_operation.setMappingConstraints(context, armEntity);
	}

	public static void unsetMappingConstraints(SdaiContext context, EGeometric_placement armEntity) throws SdaiException
	{
