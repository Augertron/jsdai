...
/*	public boolean testName(ERepresentation_relationship type) throws SdaiException {
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CComponent_2d_location.definition);
	...
	*/
	public static void setMappingConstraints(SdaiContext context, EComponent_2d_location_armx armEntity) throws SdaiException
	{
	...
	*/
	// CL -> DRI
	public static void setPlacement_fixed(SdaiContext context, EComponent_2d_location_armx armEntity) throws SdaiException {
		...
		if (armEntity.testPlacement_fixed(null)) {
			...
			if(armPlacement_fixed)
				CxAP210ARMUtilities.setDerviedDescription(context, armEntity, "placement fixed");
			else
				CxAP210ARMUtilities.setDerviedDescription(context, armEntity, "placement not fixed");
		}
	}

	public static void unsetPlacement_fixed(SdaiContext context, EComponent_2d_location_armx armEntity) throws SdaiException {
		if (armEntity.testPlacement_fixed(null)) {
