...
public class CxUsage_view_level_non_feature_shape_model extends CUsage_view_level_non_feature_shape_model implements EMappedXIMEntity
{
	...
	*/
	...
	public static void setMappingConstraints(SdaiContext context, ENon_feature_shape_model armEntity) throws SdaiException
	{
		...
		CxAP210ARMUtilities.setRepresentationId(context, armEntity, "uvlnfsm");
	}
