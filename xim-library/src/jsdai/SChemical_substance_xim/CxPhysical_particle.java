...
public class CxPhysical_particle extends CPhysical_particle implements EMappedXIMEntity
{
...
/*	public jsdai.SApplication_context_schema.AProduct_context getFrame_of_reference(EProduct type) throws SdaiException {
	...
	public void fillAIMGaps(SdaiContext context, CxPhysical_particle armEntity)throws SdaiException{
		if(!armEntity.testFrame_of_reference2(null)){
	      // Kind of AIM GAP
	      LangUtils.Attribute_and_value_structure[] pcxStructure = {
	            new LangUtils.Attribute_and_value_structure(
	            CProduct_context.attributeName(null), "physical particle")
	         };
	...
	public void unfillAIMGaps(CxPhysical_particle armEntity)throws SdaiException{
	...
	*/
	public static void setMappingConstraints(SdaiContext context, EPhysical_particle armEntity) throws SdaiException
	{
		
	  CxSubstance.setMappingConstraints(context, armEntity);
      LangUtils.Attribute_and_value_structure[] pcStructure = {
            new LangUtils.Attribute_and_value_structure(
            CProduct_related_product_category.attributeName(null), "physical particle")
         };
	...
	public static void unsetMappingConstraints(SdaiContext context, EPhysical_particle armEntity) throws SdaiException
	{
		CxSubstance.unsetMappingConstraints(context, armEntity);
		String name = "physical particle";
