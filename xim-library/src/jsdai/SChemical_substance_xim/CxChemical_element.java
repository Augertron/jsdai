...
public class CxChemical_element extends CChemical_element implements EMappedXIMEntity
{
...
/*	public jsdai.SApplication_context_schema.AProduct_context getFrame_of_reference(EProduct type) throws SdaiException {
	...
	public void fillAIMGaps(SdaiContext context, CxChemical_element armEntity)throws SdaiException{
		if(!armEntity.testFrame_of_reference2(null)){
	      // Kind of AIM GAP
	      LangUtils.Attribute_and_value_structure[] pcxStructure = {
	            new LangUtils.Attribute_and_value_structure(
	            CProduct_context.attributeName(null), "chemical element")
	         };
	...
	public void unfillAIMGaps(CxChemical_element armEntity)throws SdaiException{
	...
	*/
	public static void setMappingConstraints(SdaiContext context, EChemical_element armEntity) throws SdaiException
	{
		
	  CxSubstance.setMappingConstraints(context, armEntity);
      LangUtils.Attribute_and_value_structure[] pcStructure = {
            new LangUtils.Attribute_and_value_structure(
            CProduct_related_product_category.attributeName(null), "chemical element")
         };
	...
	public static void unsetMappingConstraints(SdaiContext context, EChemical_element armEntity) throws SdaiException
	{
		CxSubstance.unsetMappingConstraints(context, armEntity);
		String name = "chemical element";
