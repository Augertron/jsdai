...
public class CxSubstance extends CSubstance implements EMappedXIMEntity
{
...
/*	public jsdai.SApplication_context_schema.AProduct_context getFrame_of_reference(EProduct type) throws SdaiException {
	...
	public void fillAIMGaps(SdaiContext context, CxSubstance armEntity)throws SdaiException{
		if(!armEntity.testFrame_of_reference2(null)){
	      // Kind of AIM GAP
	      LangUtils.Attribute_and_value_structure[] pcxStructure = {
	            new LangUtils.Attribute_and_value_structure(
	            CProduct_context.attributeName(null), "substance")
	         };
	...
	public void unfillAIMGaps(CSubstance armEntity)throws SdaiException{
	...
	*/
	public static void setMappingConstraints(SdaiContext context, ESubstance armEntity) throws SdaiException
	{

      LangUtils.Attribute_and_value_structure[] pcStructure = {
            new LangUtils.Attribute_and_value_structure(
            CProduct_related_product_category.attributeName(null), "substance")
         };
