...
public class CxGuided_wave_bare_die_terminal extends CGuided_wave_bare_die_terminal implements EMappedXIMEntity{
...
/*	public boolean testProduct_definitional(EShape_aspect type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			EGuided_wave_bare_die_terminal armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxMinimally_defined_bare_die_terminal_armx.setMappingConstraints(context, armEntity);
		armEntity.setDescription(null, "guided wave bare die terminal");
	}
