...
import jsdai.SLayered_interconnect_simple_template_mim.CLand_physical_template;
import jsdai.SPart_template_xim.*;
import jsdai.SProduct_definition_schema.EProduct_definition;
import jsdai.SProduct_property_definition_schema.EProperty_definition;
import jsdai.SProduct_view_definition_xim.*;

public class CxLand_physical_template_armx extends CLand_physical_template_armx implements EMappedXIMEntity
{
...
/*	public boolean testName(EProduct_definition type) throws SdaiException {
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CLand_physical_template.definition);
...
//		unsetId_x(context, this);
	...
	*/
	public static void setMappingConstraints(SdaiContext context, EStratum_feature_template_armx armEntity) throws SdaiException
	{
		...
		CxStratum_feature_template_armx.setMappingConstraints(context, armEntity);
	}
	...
	{
		CxStratum_feature_template_armx.unsetMappingConstraints(context, armEntity);
	}	
	//********** "managed_design_object" attributes
