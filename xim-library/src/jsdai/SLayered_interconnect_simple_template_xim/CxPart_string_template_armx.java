...
import jsdai.SLayered_interconnect_simple_template_mim.CPart_string_template;
import jsdai.SPart_template_xim.*;
import jsdai.SProduct_definition_schema.EProduct_definition;
import jsdai.SProduct_property_definition_schema.*;
import jsdai.SProduct_view_definition_xim.*;
import jsdai.SShape_property_assignment_xim.*;
import jsdai.SText_appearance_xim.EText_alignment_armx;

public class CxPart_string_template_armx extends CPart_string_template_armx implements EMappedXIMEntity
{
...
/*	public boolean testName(EProduct_definition type) throws SdaiException {
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CPart_string_template.definition);
		...
		setString_alignment(context, this);
	...
	public void removeAimData(SdaiContext context) throws SdaiException {
		...
		unsetString_alignment(context, this);
	}
	...
	*/
	public static void setMappingConstraints(SdaiContext context, EPart_string_template_armx armEntity) throws SdaiException
	{
	...
	public static void unsetMappingConstraints(SdaiContext context, EPart_string_template_armx armEntity) throws SdaiException
	{
   ...
   */
 	...
 	public static void unsetPhysical_characteristic(SdaiContext context, ETemplate_definition armEntity) throws SdaiException
   {
 	...
 	/**
 	* Sets/creates data for string_alignment attribute.
 	*
 	...
 	*/
    // PST <- PD
 	public static void setString_alignment(SdaiContext context, EPart_string_template_armx armEntity) throws SdaiException
 	{
 		unsetString_alignment(context, armEntity);
 		if(armEntity.testString_alignment(null)){
 			int allignment = armEntity.getString_alignment(null);
 			EProperty_definition epd = (EProperty_definition)
 				context.working_model.createEntityInstance(CProperty_definition.definition);
 			epd.setName(null, "string alignment");
 			epd.setDescription(null, EText_alignment_armx.toString(allignment).toLowerCase().replace('_', ' '));
 	...
 	/**
 	* Unsets/deletes data for string_alignment attribute.
 	*
 	* @param context SdaiContext.
 	* @param armEntity arm entity.
 	* @throws SdaiException
 	*/
 	public static void unsetString_alignment(SdaiContext context, EPart_string_template_armx armEntity) throws SdaiException
   {
 		...
 		for(int i=1;i<=apd.getMemberCount();i++){
 			...
 			if((epd.testName(null))&&(epd.getName(null).equals("string alignment"))){
