...
import jsdai.SAltered_package_mim.CAltered_package_terminal;
import jsdai.SPackage_xim.*;
import jsdai.SPhysical_unit_usage_view_xim.*;
import jsdai.SProduct_property_definition_schema.*;

public class CxAltered_package_terminal_armx extends CAltered_package_terminal_armx implements EMappedXIMEntity{
...
/*	public boolean testProduct_definitional(EShape_aspect type) throws SdaiException {
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CAltered_package_terminal.definition);
	...
	public static void setMappingConstraints(SdaiContext context,
			EAltered_package_terminal_armx armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxPackage_terminal_armx.setMappingConstraints(context, armEntity);
	}
	...
	public static void unsetMappingConstraints(SdaiContext context,
			EAltered_package_terminal_armx armEntity) throws SdaiException {
		CxPackage_terminal_armx.unsetMappingConstraints(context, armEntity);
	}
...
////////////////////////////////////////////////////////////////////
	...
	*
	* <p>
	*  attribute_mapping terminal_to_be_altered_package_terminal (terminal_to_be_altered
	...
	*/
	...
	{
		//unset old values
		unsetTerminal_to_be_altered(context, armEntity);

		if (armEntity.testTerminal_to_be_altered(null))
		{
			EPackage_terminal_armx armTerminal_to_be_altered = armEntity.getTerminal_to_be_altered(null);
			...
			shape_aspect_relationship.setName(null, "terminal to be altered");
			shape_aspect_relationship.setRelated_shape_aspect(null, armEntity);
			shape_aspect_relationship.setRelating_shape_aspect(null, armTerminal_to_be_altered);
		}
	}
	...
	*/
	public static void unsetTerminal_to_be_altered(SdaiContext context, EAltered_package_terminal_armx armEntity) throws SdaiException
	{
		...
		for (int i = 1; i <= aRelationship.getMemberCount(); i++) {
			...
			if (relationship.testName(null) && relationship.getName(null).equals("terminal to be altered")) {
