...
import jsdai.SAssembly_module_with_macro_component_mim.CAssembly_module_macro_component;
...
public class CxAssembly_module_macro_component_armx
		extends
			CAssembly_module_macro_component_armx implements EMappedXIMEntity{
...
*/
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CAssembly_module_macro_component.definition);
...
//			unsetId_x(context, this);	
	...
	public static void setMappingConstraints(SdaiContext context,
			EAssembly_module_macro_component_armx armEntity) throws SdaiException {
...
*/
	//**********assembly_module_macro_component attributes
	/**
	...
	* @throws SdaiException
	*
	*  attribute_mapping design_definition_assembly_module (design_definition
	* , (*PATH*), assembly_module);
	* 	component_definition <=
	* 	product_definition <-
	...
	* 	product_category
	* 	product_category.name = `assembly module']
	...
	*/
/*	
	public static void setDesign_definition(SdaiContext context, EAssembly_module_macro_component_armx armEntity) throws SdaiException {
		//unset old values
		unsetDesign_definition(context, armEntity);

		if (armEntity.testDesign_definition(null)) {

			EAssembly_module armDesign_definition = armEntity.getDesign_definition(null);

			//product_definition_relationship
		   EProduct_definition_relationship product_definition_relationship = (EProduct_definition_relationship)
																								context.working_model.createEntityInstance(EProduct_definition_relationship.class);
...
*/
	...
	*/
/*	
	public static void unsetDesign_definition(SdaiContext context, EAssembly_module_macro_component_armx armEntity) throws SdaiException
	{
