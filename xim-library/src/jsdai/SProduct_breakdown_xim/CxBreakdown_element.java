...
/*	public static int usedinFrame_of_reference(EProduct type, jsdai.SApplication_context_schema.EProduct_context instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public static void fillAIMGaps(SdaiContext context, EBreakdown_element armEntity)throws SdaiException{
		if(armEntity instanceof CxBreakdown_element){
			CxBreakdown_element be = (CxBreakdown_element)armEntity;
			if(be.testFrame_of_reference2(null)){
				return;
			}
		}
		if(armEntity instanceof CxZone_element){
			CxZone_element ze = (CxZone_element)armEntity;
			if(ze.testFrame_of_reference2(null)){
				return;
			}
		}
		if(armEntity instanceof CxPhysical_element){
			CxPhysical_element pe = (CxPhysical_element)armEntity;
			if(pe.testFrame_of_reference2(null)){
				return;
			}
		}
	      // Kind of AIM GAP
	      LangUtils.Attribute_and_value_structure[] pcxStructure = {
	            ...
	            CProduct_context.attributeName(null), "breakdown element")
	         };
	...
	public static void unfillAIMGaps(EBreakdown_element armEntity)throws SdaiException{
	...
	*/
	public static void setMappingConstraints(SdaiContext context, EBreakdown_element armEntity) throws SdaiException
	{
		String name = "breakdown element";
	...
	public static void unsetMappingConstraints(SdaiContext context, EBreakdown_element armEntity) throws SdaiException
	{
		String name = "breakdown element";
