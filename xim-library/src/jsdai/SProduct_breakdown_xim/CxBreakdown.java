...
public class CxBreakdown extends CBreakdown implements EMappedXIMEntity
{
...
/*	public static int usedinFrame_of_reference(EProduct type, jsdai.SApplication_context_schema.EProduct_context instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public static void fillAIMGaps(SdaiContext context, CxBreakdown armEntity)throws SdaiException{
		if(!armEntity.testFrame_of_reference2(null)){
	      // Kind of AIM GAP
	      LangUtils.Attribute_and_value_structure[] pcxStructure = {
	            new LangUtils.Attribute_and_value_structure(
	            CProduct_context.attributeName(null), "breakdown")
	         };
	...
	public static void unfillAIMGaps(EBreakdown armEntity)throws SdaiException{
	...
	*/
	public static void setMappingConstraints(SdaiContext context, EBreakdown armEntity) throws SdaiException
	{
	...
	public static void unsetMappingConstraints(SdaiContext context, EBreakdown armEntity) throws SdaiException
	{
		String name = "breakdown";
