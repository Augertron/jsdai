...
public class CxBreakdown_element_definition extends CBreakdown_element_definition implements EMappedXIMEntity{
...
/*	public boolean testName(EProduct_definition type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			EBreakdown_element_definition armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxProduct_view_definition.setMappingConstraints(context, armEntity);
		// specific subtypes set context at their Cxs
		if(armEntity.getInstanceType() != CBreakdown_element_definition.definition){
			return;
		}
      ...
      LangUtils.Attribute_and_value_structure[] pdcS = {
            ...
            CProduct_definition_context.attributeName(null), "breakdown element definition")
         };
	...
	public static void unsetMappingConstraints(SdaiContext context,
		...
		if(!pdc.getName(null).equals("breakdown element definition"))
