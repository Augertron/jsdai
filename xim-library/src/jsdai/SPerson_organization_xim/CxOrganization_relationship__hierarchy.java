...
public class CxOrganization_relationship__hierarchy
		extends
		COrganization_relationship__hierarchy implements EMappedXIMEntity {
...
/*	public boolean testName(EOrganization_relationship type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			EOrganization_relationship__hierarchy armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		armEntity.setName(null, "hierarchy");
	}
