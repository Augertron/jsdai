...
public class CxOrganization_relationship__reorganization
		extends
		COrganization_relationship__reorganization implements EMappedXIMEntity {
...
/*	public boolean testName(EOrganization_relationship type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			EOrganization_relationship__reorganization armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		armEntity.setName(null, "reorganization");
	}
