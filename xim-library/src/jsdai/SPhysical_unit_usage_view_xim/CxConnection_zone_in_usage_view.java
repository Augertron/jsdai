...
public class CxConnection_zone_in_usage_view extends CConnection_zone_in_usage_view implements EMappedXIMEntity
{
...
/*	public boolean testProduct_definitional(EShape_aspect type) throws SdaiException {
	...
	*/
	public static void setMappingConstraints(SdaiContext context, EConnection_zone_in_usage_view armEntity) throws SdaiException
	{
		CxConnection_zone.setMappingConstraints(context, armEntity);
		armEntity.setName(null, "connection zone in usage view");
	}

	public static void unsetMappingConstraints(SdaiContext context, EConnection_zone_in_usage_view armEntity) throws SdaiException
	{
