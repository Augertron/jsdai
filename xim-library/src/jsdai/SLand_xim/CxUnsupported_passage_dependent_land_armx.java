...
import jsdai.SLand_mim.CUnsupported_passage_dependent_land;
import jsdai.SLayered_interconnect_module_design_xim.CxStratum_feature_template_component_armx;
import jsdai.SLayered_interconnect_module_design_xim.EUnsupported_passage_armx;
...
public class CxUnsupported_passage_dependent_land_armx
		extends
			CUnsupported_passage_dependent_land_armx implements EMappedXIMEntity{
...
*/
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CUnsupported_passage_dependent_land.definition);
	 ...
	 *  product_definition
	 *  {product_definition
	 *  [product_definition.description = 'unsupported passage dependent non functional land']
	 *  [product_definition
	...
	public static void setMappingConstraints(SdaiContext context,
			EUnsupported_passage_dependent_land_armx armEntity) throws SdaiException {
...
///// Item_shape
  ...
  public static void unsetAlternate_land_definition(SdaiContext context, ELand_armx armEntity) throws SdaiException {
	...
	//********** "Plated_passage_dependent_non_functional_land" attributes
	...
	*  {product_definition
	*  product_definition.description = 'unsupported passage'}
	*  product_definition =&gt;
	*  component_definition =&gt;
	*  assembly_component =&gt;
	...
	*/
	...
	{
		//unset old values
		unsetReference_passage(context, armEntity);

		if (armEntity.testReference_passage(null))
		{

			EUnsupported_passage_armx armReference_passage = armEntity.getReference_passage(null);
			...
			epdr.setDescription(null, "reference passage");
		}
	}
	...
	*/
	public static void unsetReference_passage(SdaiContext context, EUnsupported_passage_dependent_land_armx armEntity) throws SdaiException
	{
		...
		for (int i = 1; i <= aRelationship.getMemberCount(); i++) {
			...
			if (relationship.testName(null) && relationship.getName(null).equals("reference passage")) {
