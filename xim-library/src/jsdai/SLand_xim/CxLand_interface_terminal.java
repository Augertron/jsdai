...
public class CxLand_interface_terminal extends CLand_interface_terminal implements EMappedXIMEntity{
...
/*	public boolean testProduct_definitional(EShape_aspect type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			ELand_interface_terminal armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);

		CxLaminate_component_interface_terminal_armx.setMappingConstraints(context, armEntity);
		armEntity.setDescription(null, "land interface terminal");
	}
