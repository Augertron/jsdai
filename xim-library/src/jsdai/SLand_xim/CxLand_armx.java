...
*/
	 ...
	 *  product_definition
	 *  {[(product_definition.description = 'functional land')
	 *  (product_definition.description = 'via dependent land')
	 *  (product_definition.description = 'component termination passage dependent land')
	 *  (product_definition.description = 'contact size dependent land')
	 *  (product_definition.description = 'component termination passage and contact size dependent land')
	 *  (product_definition.description = 'via and contact size dependent land')]
	 *  [product_definition
	...
	public static void setMappingConstraints(SdaiContext context,
			ELand_armx armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxStratum_feature_template_component_armx.setMappingConstraints(context, armEntity);
		armEntity.setDescription((EProduct_definition)null, "functional land");
	}
...
///// Item_shape
    ...
    *
    *
    *  attribute_mapping alternate_land_definition_land_physical_template (alternate_land_definition
    * , (*PATH*), land_physical_template);
    * 	land &lt;=
    *  assembly_component &lt;=	
    *  component_definition &lt;=
    *  product_definition &lt;-
   ...
   public static void setAlternate_land_definition(SdaiContext context, ELand_armx armEntity) throws SdaiException {
      //unset old values
      unsetAlternate_land_definition(context, armEntity);

      if (armEntity.testAlternate_land_definition(null)) {

         ELand_physical_template_armx armAlternate_land_definition = armEntity.getAlternate_land_definition(null);
         ...
         epdr.setRelating_product_definition(null, armAlternate_land_definition);
         epdr.setRelated_product_definition(null, armEntity);
         epdr.setName(null, "alternate instantiated template");
      }
   }
...
/*		if(((CEntity)relationship).testAttributeFast(CProduct_definition_relationship.attributeName(null), null) < 0){
        ...
        if (relationship.testName(null) && relationship.getName(null).equals("alternate instantiated template")) {
