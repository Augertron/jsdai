...
import jsdai.SLayered_interconnect_module_design_xim.CxLaminate_component_join_terminal_armx;
import jsdai.SProduct_property_definition_schema.EShape_aspect;

public class CxLand_join_terminal extends CLand_join_terminal implements EMappedXIMEntity{
...
/*	public boolean testProduct_definitional(EShape_aspect type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			ELand_join_terminal armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);

		CxLaminate_component_join_terminal_armx.setMappingConstraints(context, armEntity);
		armEntity.setDescription(null, "land join terminal");
	}
