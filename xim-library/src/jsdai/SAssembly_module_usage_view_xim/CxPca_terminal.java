...
public class CxPca_terminal extends CPca_terminal implements EMappedXIMEntity{
...
/*	public boolean testProduct_definitional(EShape_aspect type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			EPca_terminal armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxAssembly_module_terminal_armx.setMappingConstraints(context, armEntity);
		armEntity.setDescription(null, "pca terminal");
	}
