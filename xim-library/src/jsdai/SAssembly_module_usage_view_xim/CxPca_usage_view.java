...
import jsdai.SAssembly_module_usage_view_mim.CAssembly_definition;
...
public class CxPca_usage_view
		extends
		CPca_usage_view implements EMappedXIMEntity {
...
/*	public boolean testName(jsdai.SProduct_property_definition_schema.EProperty_definition type) throws SdaiException {
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CAssembly_definition.definition);
	...
	public static void setMappingConstraints(SdaiContext context,
		...
		CxAssembly_module_usage_view.setMappingConstraints(context, armEntity);
	}
	...
	public static void unsetMappingConstraints(SdaiContext context,
			EPart_usage_view armEntity) throws SdaiException {
		CxAssembly_module_usage_view.unsetMappingConstraints(context, armEntity);
	}
	...
	*/
	...
	{
		CxAssembly_module_usage_view.setImplemented_function(context, armEntity);		
	}
	...
	*/
	...
	{
		CxAssembly_module_usage_view.unsetImplemented_function(context, armEntity);		
	}
	...
	* @throws SdaiException
	*/
	public static void setMaximum_negative_component_height(SdaiContext context, EPca_usage_view armEntity) throws SdaiException
	{
		//unset old values
		...
		if (armEntity.testMaximum_negative_component_height(null))
		{
			...
			armMaximum_negative_component_height.setName(null, "maximum negative component height");
			relateRepresentation(context, armEntity, armMaximum_negative_component_height);
		}
	}
	...
	* @throws SdaiException
	*/
	public static void unsetMaximum_negative_component_height(SdaiContext context, EAssembly_module_usage_view armEntity) throws SdaiException
	{
		//property_definition
	...
	* @throws SdaiException
	*/
	public static void setMaximum_positive_component_height(SdaiContext context, EPca_usage_view armEntity) throws SdaiException
	{
		//unset old values
		...
		if (armEntity.testMaximum_positive_component_height(null))
		{
			...
			armMaximum_positive_component_height.setName(null, "maximum positive component height");
			relateRepresentation(context, armEntity, armMaximum_positive_component_height);
		}
	}
	...
	* @throws SdaiException
	*/
	public static void unsetMaximum_positive_component_height(SdaiContext context, EAssembly_module_usage_view armEntity) throws SdaiException
	{
		//property_definition
		EProperty_definition property_definition = null;
		AProperty_definition aProperty_definition = new AProperty_definition();
		...
		for (int i = 1; i <= aProperty_definition.getMemberCount(); i++) {
			...
			for (int j = 1; j <= aProperty_definition_representation.getMemberCount(); j++) {
				...
				if (property_definition_representation.testUsed_representation(null)) {
					...
					if (representation.testName(null) && representation.getName(null).equals("maximum positive component height")) {
						property_definition_representation.deleteApplicationInstance();
					}
				}
			}
