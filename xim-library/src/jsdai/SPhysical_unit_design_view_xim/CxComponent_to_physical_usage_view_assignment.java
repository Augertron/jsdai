...
public class CxComponent_to_physical_usage_view_assignment extends CComponent_to_physical_usage_view_assignment implements EMappedXIMEntity
{
...
/*	public boolean testName(EProduct_definition_relationship type) throws SdaiException {
	...
	*/
	public static void setMappingConstraints(SdaiContext context, EComponent_to_physical_usage_view_assignment armEntity) throws SdaiException
	{
		armEntity.setName(null, "component to physical usage view assignment");
	}

	public static void unsetMappingConstraints(SdaiContext context, EComponent_to_physical_usage_view_assignment armEntity) throws SdaiException
	{
