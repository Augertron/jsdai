...
/*	public static int usedinItem_element(ECompound_representation_item type, ERepresentation_item instance, ASdaiModel domain, AEntity result) throws SdaiException {
	 ...
	 */
	public static void setMappingConstraints(SdaiContext context, EUpper_lower_toleranced_datum armEntity) throws SdaiException {
	 ...
	 * @throws SdaiException
	 */
	public static void unsetMappingConstraints(SdaiContext context, EUpper_lower_toleranced_datum armEntity) throws SdaiException {
		armEntity.unsetItem_element(null);
	}

	/**
	 * Sets/creates data for mapping of upper_tolerance_value attribute.
	 * 
	 * <p>
	...
	public static void setUpper_tolerance_value(SdaiContext context, EUpper_lower_toleranced_datum armEntity) throws SdaiException {
		unsetUpper_tolerance_value(context, armEntity);
		if(armEntity.testUpper_tolerance_value(null)){
			EMeasure_representation_item value = armEntity.getUpper_tolerance_value(null);
			ARepresentation_item items = armEntity.getItem_element(null, (ESet_representation_item)null);
			items.addUnordered(value);
			value.setName(null, "upper tolerance value");
		}
	}
	...
	public static void unsetUpper_tolerance_value(SdaiContext context, EUpper_lower_toleranced_datum armEntity) throws SdaiException {
		...
		for(int i=1;i<=items.getMemberCount();i++){
			...
			if((item.testName(null))&&(item.getName(null).equals("upper tolerance value"))){
	...
	/**
	 * Sets/creates data for mapping of lower_tolerance_value attribute.
	 * 
	 * <p>
	...
	public static void setLower_tolerance_value(SdaiContext context, EUpper_lower_toleranced_datum armEntity) throws SdaiException {
		unsetLower_tolerance_value(context, armEntity);
		if(armEntity.testLower_tolerance_value(null)){
			EMeasure_representation_item value = armEntity.getLower_tolerance_value(null);
			ARepresentation_item items = armEntity.getItem_element(null, (ESet_representation_item)null);
			items.addUnordered(value);
			value.setName(null, "lower tolerance value");
		}
	}
	...
	public static void unsetLower_tolerance_value(SdaiContext context, EUpper_lower_toleranced_datum armEntity) throws SdaiException {
		...
		for(int i=1;i<=items.getMemberCount();i++){
			...
			if((item.testName(null))&&(item.getName(null).equals("lower tolerance value"))){
				item.deleteApplicationInstance();
			}
		}
	}
