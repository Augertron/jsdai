...
public class CxSingle_instance
		extends
			CSingle_instance implements EMappedXIMEntity{
...
/*	public static int usedinFrame_of_reference(EProduct_definition type, jsdai.SApplication_context_schema.EProduct_definition_context instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			ESingle_instance armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxProduct_occurrence.setMappingConstraints(context, armEntity);
		CxAP210ARMUtilities.setProduct_definitionName(context, armEntity, "single instance");
		/* Removed this constraint as overlapping with Part_occurrence
		// PDC
