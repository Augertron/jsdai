...
public class CxFunctional_version extends CFunctional_version  implements EMappedXIMEntity
{
	...
	*/
	public static void setMappingConstraints(SdaiContext context, EFunctional_version armEntity) throws SdaiException
	{
...
/*      LangUtils.Attribute_and_value_structure[] pcStructure = {
	...
	public static void unsetMappingConstraints(SdaiContext context, EFunctional_version armEntity) throws SdaiException
	{
		//	Constraints must be set at product/template level anyway, so do nothing here.
/*      LangUtils.Attribute_and_value_structure[] pcStructure = {
            new LangUtils.Attribute_and_value_structure(
