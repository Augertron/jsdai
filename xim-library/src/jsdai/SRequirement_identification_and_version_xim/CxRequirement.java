...
public class CxRequirement
		extends
		CRequirement implements EMappedXIMEntity {

	// Methods taken from CProduct.java
...
/*	public jsdai.SApplication_context_schema.AProduct_context getFrame_of_reference2(EProduct type) throws SdaiException {
	...
	// ENDOF Methods taken from CProduct.java
	...
	public static void setMappingConstraints(SdaiContext context,
			ERequirement armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		
      LangUtils.Attribute_and_value_structure[] pcStructure = {
            new LangUtils.Attribute_and_value_structure(
            CProduct_related_product_category.attributeName(null), "requirement")
         };
	...
	public void fillAIMGaps(SdaiContext context, CxRequirement armEntity)throws SdaiException{
		if(!armEntity.testFrame_of_reference2(null)){
	      // Kind of AIM GAP
	      LangUtils.Attribute_and_value_structure[] pcxStructure = {
	            new LangUtils.Attribute_and_value_structure(
	            CProduct_context.attributeName(null), "requirement")
	         };
	...
	public void unfillAIMGaps(ERequirement armEntity)throws SdaiException{
