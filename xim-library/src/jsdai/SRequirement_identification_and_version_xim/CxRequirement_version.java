...
public class CxRequirement_version extends CRequirement_version implements EMappedXIMEntity
{
	...
	*/
	public static void setMappingConstraints(SdaiContext context, ERequirement_version armEntity) throws SdaiException
	{
...
/*      LangUtils.Attribute_and_value_structure[] pcStructure = {
	...
	public static void unsetMappingConstraints(SdaiContext context, ERequirement_version armEntity) throws SdaiException
	{
		//	Constraints must be set at product/template level anyway, so do nothing here.
/*      LangUtils.Attribute_and_value_structure[] pcStructure = {
            new LangUtils.Attribute_and_value_structure(
