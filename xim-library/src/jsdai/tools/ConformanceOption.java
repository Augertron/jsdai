...
public class ConformanceOption {/* Remove this comment is you want to use this class
	private String id;
	// stuff, which is needed because of possiblity to refer one CO from another CO 
	private List<String> cos;
	private List<String> armEntities; 
	private List<String> mimEntities;
	private boolean fullyProcessed;

	public ConformanceOption(String coId) {
		this.id = coId;
		cos = new ArrayList<String>();
		armEntities = new ArrayList<String>();
		mimEntities = new ArrayList<String>();
	...
	public List<String> getArmEntities() {
		return armEntities;
	}
	...
	public List<String> getMimEntities() {
		return mimEntities;
	}
	...
	public void processCoReference(ConformanceOption coRef) {
		...
		List<String> coRefArmEntities = coRef.getArmEntities();
		armEntities.addAll(coRefArmEntities);
		List<String> coRefMimEntities = coRef.getMimEntities();
