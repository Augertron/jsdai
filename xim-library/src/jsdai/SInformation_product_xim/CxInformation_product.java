...
package jsdai.SInformation_product_xim;
...
public class CxInformation_product extends CInformation_product implements EMappedXIMEntity
{
...
/*	public static int usedinFrame_of_reference(EProduct type, jsdai.SApplication_context_schema.EProduct_context instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	*  product_category
	*  product_category.name='software'}	
	...
	*/
	public static void setMappingConstraints(SdaiContext context, EInformation_product armEntity) throws SdaiException
	{
	...
	public static void unsetMappingConstraints(SdaiContext context, EInformation_product armEntity) throws SdaiException
	{
		String name = "information";
