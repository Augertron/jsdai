...
public class CxItem_shape extends CItem_shape implements EMappedXIMEntity{
...
/*	public boolean testName(EProperty_definition type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			EProduct_definition_shape armEntity) throws SdaiException {
...
//		}
	...
	public static void setId_x(SdaiContext context,
		...
		if(armEntity.testId_x(null)){
			CxAP210ARMUtilities.setProperty_definitionId(context, armEntity, armEntity.getId_x(null));
		}
	}
	...
	public static void unsetId_x(SdaiContext context,
			EItem_shape armEntity) throws SdaiException {
		if(armEntity.testId_x(null)){
			CxAP210ARMUtilities.setProperty_definitionId(context, armEntity, "");
		}
	}
