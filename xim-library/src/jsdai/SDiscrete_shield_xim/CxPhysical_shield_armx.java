...
package jsdai.SDiscrete_shield_xim;
...
import jsdai.SAssembly_component_placement_requirements_xim.EPlacement_group_requirement_definition;
...
public class CxPhysical_shield_armx
		extends
			CPhysical_shield_armx implements EMappedXIMEntity{
...
*/
	...
	public static void setMappingConstraints(SdaiContext context,
			EPhysical_shield_armx armEntity) throws SdaiException {
...
///// Item_shape
	...
	* , (*PATH*), component_feature);
            <aa attribute="shielded_item" assertion_to="Assembly_component">
                <aimelt xml:space="preserve">PATH</aimelt>
                <refpath xml:space="preserve">discrete_shield &lt;=
assembly_component &lt;=
component_definition &lt;=
product_definition &lt;-
...
assembly_component
            ...
            <aa attribute="shielded_item" assertion_to="Placement_group">
                <aimelt xml:space="preserve">PATH</aimelt>
                <refpath xml:space="preserve">discrete_shield &lt;=
assembly_component &lt;=					
component_definition &lt;=
...
physical_connectivity_definition
	...
	*/
	...
	public static void setShielded_item(SdaiContext context, EPhysical_shield_armx armEntity) throws SdaiException
	{
		...
		{
			APhysical_shieldable_item aArmShielded_item = armEntity.getShielded_item(null);
			...
			for (int i = 1; i <= aArmShielded_item.getMemberCount(); i++) {
				...
				if ((armShielded_item instanceof EAssembly_component_armx)||
					(armShielded_item instanceof EPlacement_group_requirement_definition)){
						CxAP210ARMUtilities.createProduct_definition_relationship(
															context,
															"shielded item",
															(EProduct_definition) armShielded_item,
															armEntity, false);
				//component_feature
            // DS <- SAR -> CF (AC, PG) //	DS <- SAR -> PCD
	...
	/**
	* Unsets/deletes data for Physical_shield attribute.
	*
	* @param context SdaiContext.
	* @param armEntity arm entity.
	* @throws SdaiException
