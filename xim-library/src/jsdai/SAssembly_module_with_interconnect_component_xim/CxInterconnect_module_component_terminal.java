...
public class CxInterconnect_module_component_terminal extends CInterconnect_module_component_terminal implements EMappedXIMEntity{
...
/*	public boolean testProduct_definitional(EShape_aspect type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			 EInterconnect_module_component_terminal armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);

		CxPhysical_component_terminal_armx.setMappingConstraints(context, armEntity);
		armEntity.setDescription(null, "interconnect module component terminal");
	}
