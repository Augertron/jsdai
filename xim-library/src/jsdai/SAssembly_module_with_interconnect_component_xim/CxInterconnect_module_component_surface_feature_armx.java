...
import jsdai.SAssembly_module_with_interconnect_component_mim.CInterconnect_module_component_surface_feature;
import jsdai.SComponent_feature_xim.*;
import jsdai.SPhysical_component_feature_xim.CxPhysical_component_feature_armx;
import jsdai.SProduct_property_definition_schema.EShape_aspect;

public class CxInterconnect_module_component_surface_feature_armx extends CInterconnect_module_component_surface_feature_armx implements EMappedXIMEntity{
...
/*	public boolean testProduct_definitional(EShape_aspect type) throws SdaiException {
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CInterconnect_module_component_surface_feature.definition);
	...
	public static void setMappingConstraints(SdaiContext context,
			EInterconnect_module_component_surface_feature_armx armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);

		CxPhysical_component_feature_armx.setMappingConstraints(context, armEntity);
		armEntity.setDescription(null, "interconnect module component surface feature");
	}
	...
	public static void unsetMappingConstraints(SdaiContext context,
			EInterconnect_module_component_surface_feature_armx armEntity) throws SdaiException {
		CxPhysical_component_feature_armx.unsetMappingConstraints(context, armEntity);
