...
public class CxApplied_independent_material_property extends CApplied_independent_material_property implements EMappedXIMEntity{
...
/*	public boolean testName(EProperty_definition type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			EApplied_independent_material_property armEntity) throws SdaiException {
	...
	*/
	// 
	public static void setBase_independent_property(SdaiContext context, EApplied_independent_material_property armEntity) throws SdaiException
	{
	...
	* @throws SdaiException
	*/
	public static void unsetBase_independent_property(SdaiContext context, EApplied_independent_material_property armEntity) throws SdaiException
	{
		CxApplied_independent_property.unsetBase_independent_property(context, armEntity);
	}
