...
/*	public boolean testName(EProperty_definition type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
		...
		CxAssigned_property.setMappingConstraints(context, armEntity);
		// Kind of AIM gap - DERIVED attribute
		EGeneral_property property = armEntity.getBase_independent_property(null);
		if(property.testName(null))
			armEntity.setName(null, property.getName(null));
		// System.err.println(armEntity+" "+property);		
	}
	...
	public static void unsetMappingConstraints(SdaiContext context,
			EApplied_independent_property armEntity) throws SdaiException {
		CxAssigned_property.unsetMappingConstraints(context, armEntity);
	}
	...
	*/
	...
	{
		//unset old values
		unsetBase_independent_property(context, armEntity);

		if (armEntity.testBase_independent_property(null))
		{
			// System.err.println(" Prop "+armEntity);
			EGeneral_property property = armEntity.getBase_independent_property(null);
			...
			egpa.setBase_definition(null, property);
			egpa.setName(null, "");
		}
	}
