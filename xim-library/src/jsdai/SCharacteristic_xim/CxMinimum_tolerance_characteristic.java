...
public class CxMinimum_tolerance_characteristic extends CMinimum_tolerance_characteristic implements EMappedXIMEntity
{
...
/*	public boolean testName(ERepresentation type) throws SdaiException {
	...
	*/
	public static void setMappingConstraints(SdaiContext context, EMinimum_tolerance_characteristic armEntity) throws SdaiException
	{
		unsetMappingConstraints(context, armEntity);
		CxTolerance_characteristic.setMappingConstraints(context, armEntity);
		armEntity.setName((ERepresentation)null, "minimum tolerance");
	}

	public static void unsetMappingConstraints(SdaiContext context, EMinimum_tolerance_characteristic armEntity) throws SdaiException
	{
