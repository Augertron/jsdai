...
public class CxPlus_minus_tolerance_characteristic extends CPlus_minus_tolerance_characteristic implements EMappedXIMEntity
{
...
/*	public boolean testName(ERepresentation type) throws SdaiException {
	...
	*/
	public static void setMappingConstraints(SdaiContext context, EPlus_minus_tolerance_characteristic armEntity) throws SdaiException
	{
		unsetMappingConstraints(context, armEntity);
		CxTolerance_characteristic.setMappingConstraints(context, armEntity);
		armEntity.setName((ERepresentation)null, "plus minus tolerance");
	}

	public static void unsetMappingConstraints(SdaiContext context, EPlus_minus_tolerance_characteristic armEntity) throws SdaiException
	{
