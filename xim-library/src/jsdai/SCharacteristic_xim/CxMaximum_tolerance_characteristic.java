...
public class CxMaximum_tolerance_characteristic extends CMaximum_tolerance_characteristic implements EMappedXIMEntity
{
...
/*	public boolean testName(ERepresentation type) throws SdaiException {
	...
	*/
	public static void setMappingConstraints(SdaiContext context, EMaximum_tolerance_characteristic armEntity) throws SdaiException
	{
		unsetMappingConstraints(context, armEntity);
		CxTolerance_characteristic.setMappingConstraints(context, armEntity);
		armEntity.setName((ERepresentation)null, "maximum tolerance");
	}

	public static void unsetMappingConstraints(SdaiContext context, EMaximum_tolerance_characteristic armEntity) throws SdaiException
	{
