...
public class CxSymmetrical_tolerance_characteristic extends CSymmetrical_tolerance_characteristic implements EMappedXIMEntity
{
...
/*	public boolean testName(ERepresentation type) throws SdaiException {
	...
	*/
	public static void setMappingConstraints(SdaiContext context, ESymmetrical_tolerance_characteristic armEntity) throws SdaiException
	{
		unsetMappingConstraints(context, armEntity);
		CxTolerance_characteristic.setMappingConstraints(context, armEntity);
		armEntity.setName((ERepresentation)null, "symmetrical tolerance");
	}

	public static void unsetMappingConstraints(SdaiContext context, ESymmetrical_tolerance_characteristic armEntity) throws SdaiException
	{
