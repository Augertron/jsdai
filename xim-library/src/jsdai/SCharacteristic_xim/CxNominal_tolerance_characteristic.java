...
public class CxNominal_tolerance_characteristic extends CNominal_tolerance_characteristic implements EMappedXIMEntity
{
...
/*	public boolean testName(ERepresentation type) throws SdaiException {
	...
	*/
	public static void setMappingConstraints(SdaiContext context, ENominal_tolerance_characteristic armEntity) throws SdaiException
	{
		unsetMappingConstraints(context, armEntity);
		CxTolerance_characteristic.setMappingConstraints(context, armEntity);
		armEntity.setName((ERepresentation)null, "nominal tolerance");
	}

	public static void unsetMappingConstraints(SdaiContext context, ENominal_tolerance_characteristic armEntity) throws SdaiException
	{
