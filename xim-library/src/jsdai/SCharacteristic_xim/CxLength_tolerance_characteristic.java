...
/*	public boolean testName(ERepresentation type) throws SdaiException {
	...
	*/
	public static void setMappingConstraints(SdaiContext context, ELength_tolerance_characteristic armEntity) throws SdaiException
	{
		unsetMappingConstraints(context, armEntity);
		CxTolerance_characteristic.setMappingConstraints(context, armEntity);
		CxAP210ARMUtilities.setDerviedDescription(context, armEntity, "length tolerance");
	}

	public static void unsetMappingConstraints(SdaiContext context, ELength_tolerance_characteristic armEntity) throws SdaiException
	{
		CxTolerance_characteristic.unsetMappingConstraints(context, armEntity);
		CxAP210ARMUtilities.setDerviedDescription(context, armEntity, "");
	}
