...
public class CxGeometric_tolerance_relationship__precedence extends CGeometric_tolerance_relationship__precedence implements EMappedXIMEntity
{
...
/*	public boolean testName(EGeometric_tolerance_relationship type) throws SdaiException {
	 ...
	 */
	public static void setMappingConstraints(SdaiContext context, EGeometric_tolerance_relationship__precedence armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		armEntity.setName(null, "precedence");
	}
	 ...
	 * @throws SdaiException
	 */
	public static void unsetMappingConstraints(SdaiContext context, EGeometric_tolerance_relationship__precedence armEntity) throws SdaiException {
