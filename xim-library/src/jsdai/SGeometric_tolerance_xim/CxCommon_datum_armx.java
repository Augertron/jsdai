...
public class CxCommon_datum_armx extends CCommon_datum_armx implements EMappedXIMEntity
{
...
//			unsetMade_up_by(context, this);
	 ...
	 */
	public static void setMappingConstraints(SdaiContext context, ECommon_datum_armx armEntity) throws SdaiException {
		...
		if(!armEntity.testIdentification(null)){
			armEntity.setIdentification(null, "");
		}
	}
