...
import jsdai.SAic_geometric_tolerances.CCylindricity_tolerance;
import jsdai.SMixed_complex_types.CCylindricity_tolerance$geometric_tolerance_with_defined_unit;
import jsdai.SMixed_complex_types.CCylindricity_tolerance$geometric_tolerance_with_defined_unit$modified_geometric_tolerance;
import jsdai.SMixed_complex_types.CCylindricity_tolerance$modified_geometric_tolerance;
...
public class CxCylindricity_tolerance_armx extends CCylindricity_tolerance_armx implements EMappedXIMEntity
{
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		if(testModification(null)){
			if(testSegment_size(null)){
				setTemp("AIM", CCylindricity_tolerance$geometric_tolerance_with_defined_unit$modified_geometric_tolerance.definition);
			}else{
				setTemp("AIM", CCylindricity_tolerance$modified_geometric_tolerance.definition);
			}
		}else{
			if(testSegment_size(null)){
				setTemp("AIM", CCylindricity_tolerance$geometric_tolerance_with_defined_unit.definition);				
			}else{
				setTemp("AIM", CCylindricity_tolerance.definition);
			}
		}
