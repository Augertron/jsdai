...
public class CxTarget_rectangle extends CTarget_rectangle implements EMappedXIMEntity
{
...
//		unsetParameter_reference(null);
	...
	public static void setMappingConstraints(SdaiContext context,
			ETarget_rectangle armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxPlaced_target.setMappingConstraints(context, armEntity);
		armEntity.setDescription((EShape_aspect)null, "rectangle");
	}
...
*/
	...
	public static void setTarget_length(SdaiContext context, ETarget_rectangle armEntity) throws SdaiException {
		if(armEntity.testTarget_length(null)){
			ELength_measure_with_unit elmwu = armEntity.getTarget_length(null);
			...
			eri.setName(null, "target length");
	...
	public static void setTarget_width(SdaiContext context, ETarget_rectangle armEntity) throws SdaiException {
		if(armEntity.testTarget_width(null)){
			ELength_measure_with_unit elmwu = armEntity.getTarget_width(null);
			ERepresentation_item eri;
			if(!(elmwu instanceof ERepresentation_item)){
				eri = (ERepresentation_item)context.working_model.substituteInstance(elmwu, 
						CLength_measure_with_unit$measure_representation_item.definition);
