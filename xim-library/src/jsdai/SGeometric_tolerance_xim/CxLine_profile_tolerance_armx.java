...
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_defined_area_unit$geometric_tolerance_with_modifiers$line_profile_tolerance$unequally_disposed_geometric_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_defined_area_unit$line_profile_tolerance$modified_geometric_tolerance$unequally_disposed_geometric_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_defined_area_unit$line_profile_tolerance$unequally_disposed_geometric_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_defined_unit$geometric_tolerance_with_modifiers$line_profile_tolerance$unequally_disposed_geometric_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_defined_unit$line_profile_tolerance$modified_geometric_tolerance$unequally_disposed_geometric_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_defined_unit$line_profile_tolerance$unequally_disposed_geometric_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_modifiers$line_profile_tolerance$unequally_disposed_geometric_tolerance;
import jsdai.SShape_tolerance_schema.CLine_profile_tolerance$modified_geometric_tolerance$unequally_disposed_geometric_tolerance;
import jsdai.SShape_tolerance_schema.CLine_profile_tolerance$unequally_disposed_geometric_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_defined_area_unit$line_profile_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_defined_area_unit$geometric_tolerance_with_modifiers$line_profile_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_defined_area_unit$line_profile_tolerance$modified_geometric_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_defined_unit$geometric_tolerance_with_modifiers$line_profile_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_datum_reference$geometric_tolerance_with_defined_unit$line_profile_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_datum_reference$geometric_tolerance_with_defined_unit$line_profile_tolerance$modified_geometric_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_modifiers$line_profile_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_datum_reference$line_profile_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_datum_reference$line_profile_tolerance$modified_geometric_tolerance;
...
public class CxLine_profile_tolerance_armx extends CLine_profile_tolerance_armx implements EMappedXIMEntity
{
...
/*	public boolean testModifier(EModified_geometric_tolerance type) throws SdaiException {
		...
		if(testUnequally_disposed_tolerance_zone_displacement(null)){
			if(testArea_unit_type(null)){
				if(testModification_new(null)){
					setTemp("AIM", CGeometric_tolerance_with_defined_area_unit$geometric_tolerance_with_modifiers$line_profile_tolerance$unequally_disposed_geometric_tolerance.definition);				
				}else{
					if(testModification(null)){
						setTemp("AIM", CGeometric_tolerance_with_defined_area_unit$line_profile_tolerance$modified_geometric_tolerance$unequally_disposed_geometric_tolerance.definition);
					}else{
						setTemp("AIM", CGeometric_tolerance_with_defined_area_unit$line_profile_tolerance$unequally_disposed_geometric_tolerance.definition);				
					}
				}
			}else{
				if(testModification_new(null)){
					if(testSegment_size(null)){
						setTemp("AIM", CGeometric_tolerance_with_defined_unit$geometric_tolerance_with_modifiers$line_profile_tolerance$unequally_disposed_geometric_tolerance.definition);				
					}else{
						setTemp("AIM", CGeometric_tolerance_with_modifiers$line_profile_tolerance$unequally_disposed_geometric_tolerance.definition);
					}
				}else{
					if(testModification(null)){
						if(testSegment_size(null)){
							setTemp("AIM", CGeometric_tolerance_with_defined_unit$line_profile_tolerance$modified_geometric_tolerance$unequally_disposed_geometric_tolerance.definition);
						}else{
							setTemp("AIM", CLine_profile_tolerance$modified_geometric_tolerance$unequally_disposed_geometric_tolerance.definition);
						}
					}else{
						if(testSegment_size(null)){
							setTemp("AIM", CGeometric_tolerance_with_defined_unit$line_profile_tolerance$unequally_disposed_geometric_tolerance.definition);				
						}else{
							setTemp("AIM", CLine_profile_tolerance$unequally_disposed_geometric_tolerance.definition);
						}
					}
				}
			}
			...
			if(testArea_unit_type(null)){
				if(testModification_new(null)){
					setTemp("AIM", CGeometric_tolerance_with_defined_area_unit$geometric_tolerance_with_modifiers$line_profile_tolerance.definition);				
				}else{
					if(testModification(null)){
						setTemp("AIM", CGeometric_tolerance_with_defined_area_unit$line_profile_tolerance$modified_geometric_tolerance.definition);
					}else{
						setTemp("AIM", CGeometric_tolerance_with_defined_area_unit$line_profile_tolerance.definition);				
					}
				}
			}else{
				if(testModification_new(null)){
					if(testSegment_size(null)){
						setTemp("AIM", CGeometric_tolerance_with_defined_unit$geometric_tolerance_with_modifiers$line_profile_tolerance.definition);				
					}else{
						setTemp("AIM", CGeometric_tolerance_with_modifiers$line_profile_tolerance.definition);
					}
				}else{
					if(testModification(null)){
						if(testSegment_size(null)){
							setTemp("AIM", CGeometric_tolerance_with_datum_reference$geometric_tolerance_with_defined_unit$line_profile_tolerance$modified_geometric_tolerance.definition);
						}else{
							setTemp("AIM", CGeometric_tolerance_with_datum_reference$line_profile_tolerance$modified_geometric_tolerance.definition);
						}
					}else{
						if(testSegment_size(null)){
							setTemp("AIM", CGeometric_tolerance_with_datum_reference$geometric_tolerance_with_defined_unit$line_profile_tolerance.definition);				
						}else{
							setTemp("AIM", CGeometric_tolerance_with_datum_reference$line_profile_tolerance.definition);
						}
					}
				}
			}
	...
	public static void setMappingConstraints(SdaiContext context,
			ELine_profile_tolerance_armx armEntity) throws SdaiException {
