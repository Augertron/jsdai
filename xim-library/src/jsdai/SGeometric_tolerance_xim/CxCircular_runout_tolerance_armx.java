...
import jsdai.SAic_geometric_tolerances.CCircular_runout_tolerance;
import jsdai.SMixed_complex_types.CCircular_runout_tolerance$geometric_tolerance_with_defined_unit;
import jsdai.SMixed_complex_types.CCircular_runout_tolerance$geometric_tolerance_with_defined_unit$modified_geometric_tolerance;
import jsdai.SMixed_complex_types.CCircular_runout_tolerance$modified_geometric_tolerance;
...
public class CxCircular_runout_tolerance_armx extends CCircular_runout_tolerance_armx implements EMappedXIMEntity
{
...
/*	public boolean testModifier(EModified_geometric_tolerance type) throws SdaiException {
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		if(testModification(null)){
			if(testSegment_size(null)){
				setTemp("AIM", CCircular_runout_tolerance$geometric_tolerance_with_defined_unit$modified_geometric_tolerance.definition);
			}else{
				setTemp("AIM", CCircular_runout_tolerance$modified_geometric_tolerance.definition);
			}
		}else{
			if(testSegment_size(null)){
				setTemp("AIM", CCircular_runout_tolerance$geometric_tolerance_with_defined_unit.definition);				
			}else{
				setTemp("AIM", CCircular_runout_tolerance.definition);
			}
		}
	...
	public static void setMappingConstraints(SdaiContext context,
			ECircular_runout_tolerance_armx armEntity) throws SdaiException {
