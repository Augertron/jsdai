...
import jsdai.SAic_geometric_tolerances.CStraightness_tolerance;
import jsdai.SMixed_complex_types.CGeometric_tolerance_with_defined_unit$modified_geometric_tolerance$straightness_tolerance;
import jsdai.SMixed_complex_types.CGeometric_tolerance_with_defined_unit$straightness_tolerance;
import jsdai.SMixed_complex_types.CModified_geometric_tolerance$straightness_tolerance;
...
public class CxStraightness_tolerance_armx extends CStraightness_tolerance_armx implements EMappedXIMEntity
{
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		if(testModification(null)){
			if(testSegment_size(null)){
				setTemp("AIM", CGeometric_tolerance_with_defined_unit$modified_geometric_tolerance$straightness_tolerance.definition);
			}else{
				setTemp("AIM", CModified_geometric_tolerance$straightness_tolerance.definition);
			}
		}else{
			if(testSegment_size(null)){
				setTemp("AIM", CGeometric_tolerance_with_defined_unit$straightness_tolerance.definition);				
			}else{
				setTemp("AIM", CStraightness_tolerance.definition);
			}
		}
