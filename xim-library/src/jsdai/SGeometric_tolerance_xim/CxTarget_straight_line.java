...
public class CxTarget_straight_line extends CTarget_straight_line implements EMappedXIMEntity
{
...
//		unsetParameter_reference(null);
	...
	public static void setMappingConstraints(SdaiContext context,
			ETarget_straight_line armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxPlaced_target.setMappingConstraints(context, armEntity);
		armEntity.setDescription((EShape_aspect)null, "line");
	}
