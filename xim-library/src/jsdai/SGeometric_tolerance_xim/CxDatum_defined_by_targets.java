...
public class CxDatum_defined_by_targets extends CDatum_defined_by_targets implements EMappedXIMEntity
{
...
//			unsetModification(context, this);
	...
	public static void setMappingConstraints(SdaiContext context,
			EDatum_defined_by_targets armEntity) throws SdaiException {
	...
	public static void setDefined_by(SdaiContext context,
		...
		if(armEntity.testDefined_by(null)){
			ADatum_target adt = armEntity.getDefined_by(null);
			for(int i=1,count=adt.getMemberCount(); i<=count; i++){
				EDatum_target edt = adt.getByIndex(i); 
