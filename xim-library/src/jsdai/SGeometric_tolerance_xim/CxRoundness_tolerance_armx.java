...
import jsdai.SAic_geometric_tolerances.CRoundness_tolerance;
import jsdai.SMixed_complex_types.CGeometric_tolerance_with_defined_unit$modified_geometric_tolerance$roundness_tolerance;
import jsdai.SMixed_complex_types.CGeometric_tolerance_with_defined_unit$roundness_tolerance;
import jsdai.SMixed_complex_types.CModified_geometric_tolerance$roundness_tolerance;
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		if(testModification(null)){
			if(testSegment_size(null)){
				setTemp("AIM", CGeometric_tolerance_with_defined_unit$modified_geometric_tolerance$roundness_tolerance.definition);
			}else{
				setTemp("AIM", CModified_geometric_tolerance$roundness_tolerance.definition);
			}
		}else{
			if(testSegment_size(null)){
				setTemp("AIM", CGeometric_tolerance_with_defined_unit$roundness_tolerance.definition);				
			}else{
				setTemp("AIM", CRoundness_tolerance.definition);
			}
		}
