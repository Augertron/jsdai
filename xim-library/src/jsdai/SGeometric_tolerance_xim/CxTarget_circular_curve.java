...
public class CxTarget_circular_curve extends CTarget_circular_curve implements EMappedXIMEntity
{
...
//		unsetParameter_reference(null);
	...
	public static void setMappingConstraints(SdaiContext context,
			ETarget_circular_curve armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxPlaced_target.setMappingConstraints(context, armEntity);
		armEntity.setDescription((EShape_aspect)null, "circular curve");
	}
