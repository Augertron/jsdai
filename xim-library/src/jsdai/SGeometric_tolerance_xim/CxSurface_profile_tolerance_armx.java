...
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_datum_reference$geometric_tolerance_with_defined_unit$modified_geometric_tolerance$surface_profile_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_datum_reference$geometric_tolerance_with_defined_unit$surface_profile_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_datum_reference$modified_geometric_tolerance$surface_profile_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_datum_reference$surface_profile_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_defined_area_unit$geometric_tolerance_with_modifiers$surface_profile_tolerance$unequally_disposed_geometric_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_defined_area_unit$geometric_tolerance_with_modifiers$surface_profile_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_defined_area_unit$modified_geometric_tolerance$surface_profile_tolerance$unequally_disposed_geometric_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_defined_area_unit$modified_geometric_tolerance$surface_profile_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_defined_area_unit$surface_profile_tolerance$unequally_disposed_geometric_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_defined_area_unit$surface_profile_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_defined_unit$geometric_tolerance_with_modifiers$surface_profile_tolerance$unequally_disposed_geometric_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_defined_unit$geometric_tolerance_with_modifiers$surface_profile_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_defined_unit$modified_geometric_tolerance$surface_profile_tolerance$unequally_disposed_geometric_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_defined_unit$surface_profile_tolerance$unequally_disposed_geometric_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_modifiers$surface_profile_tolerance$unequally_disposed_geometric_tolerance;
import jsdai.SShape_tolerance_schema.CGeometric_tolerance_with_modifiers$surface_profile_tolerance;
import jsdai.SShape_tolerance_schema.CModified_geometric_tolerance$surface_profile_tolerance$unequally_disposed_geometric_tolerance;
import jsdai.SShape_tolerance_schema.CSurface_profile_tolerance$unequally_disposed_geometric_tolerance;
...
public class CxSurface_profile_tolerance_armx extends CSurface_profile_tolerance_armx implements EMappedXIMEntity
{
...
/*	public boolean testModifier(EModified_geometric_tolerance type) throws SdaiException {
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		if(testUnequally_disposed_tolerance_zone_displacement(null)){
			if(testArea_unit_type(null)){
				if(testModification_new(null)){
					setTemp("AIM", CGeometric_tolerance_with_defined_area_unit$geometric_tolerance_with_modifiers$surface_profile_tolerance$unequally_disposed_geometric_tolerance.definition);				
				}else{
					if(testModification(null)){
						setTemp("AIM", CGeometric_tolerance_with_defined_area_unit$modified_geometric_tolerance$surface_profile_tolerance$unequally_disposed_geometric_tolerance.definition);
					}else{
						setTemp("AIM", CGeometric_tolerance_with_defined_area_unit$surface_profile_tolerance$unequally_disposed_geometric_tolerance.definition);				
					}
				}
			}else{
				if(testModification_new(null)){
					if(testSegment_size(null)){
						setTemp("AIM", CGeometric_tolerance_with_defined_unit$geometric_tolerance_with_modifiers$surface_profile_tolerance$unequally_disposed_geometric_tolerance.definition);				
					}else{
						setTemp("AIM", CGeometric_tolerance_with_modifiers$surface_profile_tolerance$unequally_disposed_geometric_tolerance.definition);
					}
				}else{
					if(testModification(null)){
						if(testSegment_size(null)){
							setTemp("AIM", CGeometric_tolerance_with_defined_unit$modified_geometric_tolerance$surface_profile_tolerance$unequally_disposed_geometric_tolerance.definition);
						}else{
							setTemp("AIM", CModified_geometric_tolerance$surface_profile_tolerance$unequally_disposed_geometric_tolerance.definition);
						}
					}else{
						if(testSegment_size(null)){
							setTemp("AIM", CGeometric_tolerance_with_defined_unit$surface_profile_tolerance$unequally_disposed_geometric_tolerance.definition);				
						}else{
							setTemp("AIM", CSurface_profile_tolerance$unequally_disposed_geometric_tolerance.definition);
						}
					}
				}
			}
			...
			if(testArea_unit_type(null)){
				if(testModification_new(null)){
					setTemp("AIM", CGeometric_tolerance_with_defined_area_unit$geometric_tolerance_with_modifiers$surface_profile_tolerance.definition);				
				}else{
					if(testModification(null)){
						setTemp("AIM", CGeometric_tolerance_with_defined_area_unit$modified_geometric_tolerance$surface_profile_tolerance.definition);
					}else{
						setTemp("AIM", CGeometric_tolerance_with_defined_area_unit$surface_profile_tolerance.definition);				
					}
				}
			}else{
				if(testModification_new(null)){
					if(testSegment_size(null)){
						setTemp("AIM", CGeometric_tolerance_with_defined_unit$geometric_tolerance_with_modifiers$surface_profile_tolerance.definition);				
					}else{
						setTemp("AIM", CGeometric_tolerance_with_modifiers$surface_profile_tolerance.definition);
					}
				}else{
					if(testModification(null)){
						if(testSegment_size(null)){
							setTemp("AIM", CGeometric_tolerance_with_datum_reference$geometric_tolerance_with_defined_unit$modified_geometric_tolerance$surface_profile_tolerance.definition);
						}else{
							setTemp("AIM", CGeometric_tolerance_with_datum_reference$modified_geometric_tolerance$surface_profile_tolerance.definition);
						}
					}else{
						if(testSegment_size(null)){
							setTemp("AIM", CGeometric_tolerance_with_datum_reference$geometric_tolerance_with_defined_unit$surface_profile_tolerance.definition);				
						}else{
							setTemp("AIM", CGeometric_tolerance_with_datum_reference$surface_profile_tolerance.definition);
						}
					}
				}
			}
	...
	public static void setMappingConstraints(SdaiContext context,
			ESurface_profile_tolerance_armx armEntity) throws SdaiException {
