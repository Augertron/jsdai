...
/*	public boolean testName(EProduct_definition type) throws SdaiException {
	...
	*/
	public static void setMappingConstraints(SdaiContext context, ESpecification_definition_armx armEntity) throws SdaiException
	{
		unsetMappingConstraints(context, armEntity);
		CxDocument_definition.setMappingConstraints(context, armEntity);
// None of subtype constraints should be set here - SEDS written		
/*      LangUtils.Attribute_and_value_structure[] pdcStructure = {
            new LangUtils.Attribute_and_value_structure(
            CApplication_context_element.attributeName(null), "template definition")
         };
	...
	public static void unsetMappingConstraints(SdaiContext context, ESpecification_definition_armx armEntity) throws SdaiException
	{
		CxDocument_definition.unsetMappingConstraints(context, armEntity);
