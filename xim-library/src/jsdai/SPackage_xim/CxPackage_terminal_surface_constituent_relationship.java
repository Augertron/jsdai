...
public class CxPackage_terminal_surface_constituent_relationship extends CPackage_terminal_surface_constituent_relationship implements EMappedXIMEntity{
...
/*	public boolean testName(EShape_aspect_relationship type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			EPackage_terminal_surface_constituent_relationship armEntity) throws SdaiException {
		CxShape_element_constituent_relationship.setMappingConstraints(context, armEntity);
		armEntity.setName(null, "package terminal surface constituent relationship");
	}
