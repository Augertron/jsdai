...
import jsdai.SShape_aspect_definition_schema.CApex$datum;
import jsdai.SShape_aspect_definition_schema.EDatum;

public class CxDatum_defined_by_apex extends CDatum_defined_by_apex implements EMappedXIMEntity
{
...
/*	public boolean testIdentification(EDatum type) throws SdaiException {
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CApex$datum.definition);
...
//			unsetModification(context, this);
	...
	public static void setMappingConstraints(SdaiContext context,
			EDatum_defined_by_apex armEntity) throws SdaiException {
