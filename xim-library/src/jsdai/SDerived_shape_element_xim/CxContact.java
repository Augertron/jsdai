...
public class CxContact extends CContact implements EMappedXIMEntity{
...
//			unsetId_x(context, this);
	 ...
	 */
	public static void setMappingConstraints(SdaiContext context, EContact armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);

		CxDerived_shape_element.setMappingConstraints(context, armEntity);
		armEntity.setName(null, "contact");
	}
	 ...
	 * @throws SdaiException
	 */
	public static void unsetMappingConstraints(SdaiContext context, EContact armEntity) throws SdaiException {
