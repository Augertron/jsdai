...
public class CxMinimally_defined_component_terminal extends CMinimally_defined_component_terminal implements EMappedXIMEntity{
...
/*	public boolean testDescription(EShape_aspect type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			 EMinimally_defined_component_terminal armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);

		CxPhysical_component_terminal_armx.setMappingConstraints(context, armEntity);
		armEntity.setDescription(null, "minimally defined component terminal");
	}
