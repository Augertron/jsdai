...
public class CxPackaged_component_join_terminal extends CPackaged_component_join_terminal implements EMappedXIMEntity{
...
/*	public boolean testProduct_definitional(EShape_aspect type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			EPackaged_component_join_terminal armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);

		CxPhysical_component_terminal_armx.setMappingConstraints(context, armEntity);
		armEntity.setDescription(null, "packaged component join terminal");
