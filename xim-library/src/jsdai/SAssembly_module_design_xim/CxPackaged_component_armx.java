...
import jsdai.SAltered_package_xim.EAltered_package;
import jsdai.SAssembly_module_design_mim.CPackaged_component;
...
public class CxPackaged_component_armx
		extends
			CPackaged_component_armx implements EMappedXIMEntity{
...
*/
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CPackaged_component.definition);
			...
			setSelected_package_alternate(context, this); 
			...
			// selected_package_alternate 
			unsetSelected_package_alternate(null); 
	...
	public void removeAimData(SdaiContext context) throws SdaiException {
			...
			// selected_package_alternate 
			unsetSelected_package_alternate(context, this); 
	...
	public static void setMappingConstraints(SdaiContext context,
			EPackaged_component_armx armEntity) throws SdaiException {
...
///// Item_shape
	...
	//**********packaged_component attributes
	/**
	* Sets/creates data for selected_package_alternate attribute.
	* @param context SdaiContext.
	* @param armEntity arm entity.
	* @throws SdaiException
	*
	*  attribute_mapping selected_package_alternate_altered_package (selected_package_alternate
	* , (*PATH*), altered_package);
	* 	packaged_component &lt;=
	*  component_definition &lt;=
	*  product_definition &lt;-
	...
	*
	*/
	public static void setSelected_package_alternate(SdaiContext context, EPackaged_component_armx armEntity) throws SdaiException {
		//unset old values
		unsetSelected_package_alternate(context, armEntity);

		if (armEntity.testSelected_package_alternate(null)) {

			EAltered_package armSelected_package_alternate = armEntity.getSelected_package_alternate(null);

		   EProduct_definition_relationship product_definition_relationship = (EProduct_definition_relationship)
			...
			product_definition_relationship.setName(null, "package alternate");
			product_definition_relationship.setDescription(null, "");
			product_definition_relationship.setRelated_product_definition(null, armEntity);
			product_definition_relationship.setRelating_product_definition(null, armSelected_package_alternate);
		}
	}

	/**
	 * Unsets data for selected_package_alternate attribute.
	 * @param context
	 * @param armEntity
	 * @throws SdaiException
	 */
	public static void unsetSelected_package_alternate(SdaiContext context, EPackaged_component_armx armEntity) throws SdaiException {
		...
		CProduct_definition_relationship.usedinRelated_product_definition(null, armEntity, context.domain, aProduct_definition_relationship);
		for (int i = 1; i <= aProduct_definition_relationship.getMemberCount(); i++) {
			...
			if (product_definition_relationship.testName(null) && product_definition_relationship.getName(null).equals("package alternate")) {
