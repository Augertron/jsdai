...
public class CxRouted_interconnect_component_armx
		extends
			CRouted_interconnect_component_armx implements EMappedXIMEntity{
...
*/
	 ...
	 *  product_definition
	 *  {[product_definition
	 *  product_definition.description = 'routed interconnect component']
	...
	public static void setMappingConstraints(SdaiContext context,
			ERouted_interconnect_component_armx armEntity) throws SdaiException {
...
///// Item_shape
	...
	//**********routed_interconnect_component attributes
	/**
...
/* Became redeclared no need to do anything	
	public static void setRouted_centreline_shape(SdaiContext context, ERouted_interconnect_component_armx armEntity) throws SdaiException {
		...
		if (armEntity.testRouted_centreline_shape(null)) {
			...
			EPath_area_with_parameters_armx armRouted_centreline_shape = armEntity.getRouted_centreline_shape(null);
