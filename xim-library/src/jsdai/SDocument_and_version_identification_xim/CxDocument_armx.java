...
package jsdai.SDocument_and_version_identification_xim;
...
public class CxDocument_armx extends CDocument_armx implements EMappedXIMEntity
{
...
/*	public static int usedinFrame_of_reference(EProduct type, jsdai.SApplication_context_schema.EProduct_context instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public static void fillAIMGaps(SdaiContext context, CxDocument_armx armEntity)throws SdaiException{
		if(!armEntity.testFrame_of_reference2(null)){
	      // Kind of AIM GAP
	      LangUtils.Attribute_and_value_structure[] pcxStructure = {
	            new LangUtils.Attribute_and_value_structure(
	            CProduct_context.attributeName(null), "document")
	         };
	...
	public static void unfillAIMGaps(EDocument_armx armEntity)throws SdaiException{
	...
	*/
	public static void setMappingConstraints(SdaiContext context, EDocument_armx armEntity) throws SdaiException
	{
	...
	public static void unsetMappingConstraints(SdaiContext context, EDocument_armx armEntity) throws SdaiException
	{
		String name = "document";
