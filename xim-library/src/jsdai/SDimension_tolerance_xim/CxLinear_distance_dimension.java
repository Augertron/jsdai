...
public class CxLinear_distance_dimension extends CLinear_distance_dimension implements EMappedXIMEntity
{
...
/*	public static int usedinRelated_shape_aspect(EShape_aspect_relationship type, EShape_aspect instance, ASdaiModel domain, AEntity result) throws SdaiException {
	 ...
	 */
	public static void setMappingConstraints(SdaiContext context, ELinear_distance_dimension armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxLocation_dimension.setMappingConstraints(context, armEntity);
		armEntity.setName(null, "linear distance");
	}
	 ...
	 * @throws SdaiException
	 */
	public static void unsetMappingConstraints(SdaiContext context, ELinear_distance_dimension armEntity) throws SdaiException {
	 ...
	 * @throws SdaiException
	 */
	public static void setOrientation(SdaiContext context, ELinear_distance_dimension armEntity) throws SdaiException {
	 ...
	 * @throws SdaiException
	 */
	public static void unsetOrientation(SdaiContext context, ELinear_distance_dimension armEntity) throws SdaiException {
	 ...
	 * @throws SdaiException
	 */
	public static void setTheoretical_exact(SdaiContext context, ELinear_distance_dimension armEntity) throws SdaiException {
	 ...
	 * @throws SdaiException
	 */
	public static void unsetTheoretical_exact(SdaiContext context, ELinear_distance_dimension armEntity) throws SdaiException {
	 ...
	 * @throws SdaiException
	 */
	public static void setAuxiliary(SdaiContext context, ELinear_distance_dimension armEntity) throws SdaiException {
