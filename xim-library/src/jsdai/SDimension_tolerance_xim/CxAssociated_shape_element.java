...
public class CxAssociated_shape_element extends CAssociated_shape_element implements EMappedXIMEntity{
...
//			unsetId_x(context, this);			
	...
	public static void setMappingConstraints(SdaiContext context,
			EAssociated_shape_element armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);

//		CxShape_element.setMappingConstraints(context, armEntity);
		
		EGeometric_item_specific_usage egisu = (EGeometric_item_specific_usage)
		...
		egisu.setDefinition(null, armEntity);
		if(armEntity.testUsed_representation(null)){
			egisu.setUsed_representation(null, armEntity.getUsed_representation(null));
		}
		if(armEntity.testIdentified_item(null)){
			egisu.setIdentified_item(null, armEntity.getIdentified_item(null));
		}
	}
