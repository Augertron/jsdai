...
import jsdai.SLayered_interconnect_module_design_mim.CInterconnect_module_edge_segment;
import jsdai.SGeneric_product_occurrence_xim.*;
import jsdai.SProduct_definition_schema.*;
import jsdai.SProduct_property_definition_schema.*;
import jsdai.SProduct_view_definition_xim.*;

public class CxInterconnect_module_edge_segment_armx
		extends
			CInterconnect_module_edge_segment_armx implements EMappedXIMEntity{
...
*/
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CInterconnect_module_edge_segment.definition);
...
//			unsetId_x(context, this);
	...
	public static void setMappingConstraints(SdaiContext context,
			EInterconnect_module_edge_segment_armx armEntity) throws SdaiException {
...
*/
	...
	*/
	...
	//********** "interconnect_module_edge_segment" attributes

	/**
	* Sets/creates data for composed_edge attribute.
	*
	* <p>
	*  attribute_mapping composed_edge_interconnect_module_edge (composed_edge
	* , (*PATH*), interconnect_module_edge);
	*  interconnect_module_edge_segment &lt;= 
	*  inter_stratum_feature &lt;=
	*  assembly_component &lt;=			
	...
	*  (product_definition .description = 'interconnect module edge')
	*  (product_definition .description = 'partially plated interconnect module edge')}
	*  product_definition =&gt;
	*  component_definition =&gt;
	*  assembly_component =&gt;
	*  inter_stratum_feature	
	...
	* @throws SdaiException
	*/
	public static void setComposed_edge(SdaiContext context, EInterconnect_module_edge_segment_armx armEntity) throws SdaiException
	{
		//unset old values
		unsetComposed_edge(context, armEntity);

		if (armEntity.testComposed_edge(null))
		{

			EInterconnect_module_edge_armx armComposed_edge = armEntity.getComposed_edge(null);
		   ...
		   epdr.setRelating_product_definition(null, armComposed_edge);
		   epdr.setName(null, "composed edge");
		}
	}
	...
	* @throws SdaiException
	*/
	public static void unsetComposed_edge(SdaiContext context, EInterconnect_module_edge_segment_armx armEntity) throws SdaiException
	{
		...
		for (int i = 1; i <= aRelationship.getMemberCount(); i++) {
			...
			if (relationship.testName(null) && relationship.getName(null).equals("composed edge")) {
	...
	*
	* <p>
	*  attribute_mapping start_vertex_edge_segment_vertex (start_vertex
	* , (*PATH*), edge_segment_vertex);
	* 	interconnect_module_edge_segment <=
	...
	* @throws SdaiException
	*/
	public static void setStart_vertex(SdaiContext context, EInterconnect_module_edge_segment_armx armEntity) throws SdaiException
	{
		//unset old values
		unsetStart_vertex(context, armEntity);

		if (armEntity.testStart_vertex(null))
		{
			EEdge_segment_vertex_armx armStart_vertex = armEntity.getStart_vertex(null);
			armEntity.setRelating_shape_aspect(null, armStart_vertex);
			armStart_vertex.setName(null, "single datum");
		}
	}
	...
	* @throws SdaiException
	*/
	public static void unsetStart_vertex(SdaiContext context, EInterconnect_module_edge_segment_armx armEntity) throws SdaiException
	{
	...
	*
	* <p>
	*  attribute_mapping end_vertex_edge_segment_vertex (end_vertex
	* , (*PATH*), edge_segment_vertex);
	* 	interconnect_module_edge_segment <=
	* 	shape_aspect_relationship
	...
	* @throws SdaiException
	*/
	public static void setEnd_vertex(SdaiContext context, EInterconnect_module_edge_segment_armx armEntity) throws SdaiException
	{
		//unset old values
		unsetEnd_vertex(context, armEntity);

		if (armEntity.testEnd_vertex(null))
		{
			EEdge_segment_vertex_armx armEnd_vertex = armEntity.getEnd_vertex(null);
			armEntity.setRelated_shape_aspect(null, armEnd_vertex);
			armEnd_vertex.setName(null, "single datum");
		}
	}
	...
	* @throws SdaiException
	*/
	public static void unsetEnd_vertex(SdaiContext context, EInterconnect_module_edge_segment_armx armEntity) throws SdaiException
	{
