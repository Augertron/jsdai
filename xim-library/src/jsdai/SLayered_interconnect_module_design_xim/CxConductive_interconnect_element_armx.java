...
public class CxConductive_interconnect_element_armx
		extends
			CConductive_interconnect_element_armx implements EMappedXIMEntity{
...
*/
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CConductive_interconnect_element.definition);
			...
			//name - this became a derived attribute - need not to set it
			...
			// composed_conductor 
			// setComposed_conductor(context, this);
			
			// Clean ARM specific attributes
			// unsetName_x(null); - this is DERIVED NOW
			// - this is derived at laminate_component
	...
	public void removeAimData(SdaiContext context) throws SdaiException {
			...
			//********** "design_discipline_item_definition" attributes
			//name - this is derived now - need not to unset it
			...
			// composed_conductor 
			// unsetComposed_conductor(context, this);
	 ...
	 *  (product_definition.description = 'unrouted conductive interconnect element')}
	...
	public static void setMappingConstraints(SdaiContext context,
			EConductive_interconnect_element_armx armEntity) throws SdaiException {
