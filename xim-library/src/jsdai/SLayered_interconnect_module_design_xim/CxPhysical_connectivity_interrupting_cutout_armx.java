...
import jsdai.SLayered_interconnect_module_design_mim.CPhysical_connectivity_interrupting_cutout;
...
public class CxPhysical_connectivity_interrupting_cutout_armx
		extends
			CPhysical_connectivity_interrupting_cutout_armx implements EMappedXIMEntity{
...
/*	public static int usedinDefinition(EProperty_definition type, EEntity instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CPhysical_connectivity_interrupting_cutout.definition);
			...
			// interrupted_connectivity_element 
			setInterrupted_connectivity_element(context, this); 
			...
			// interrupted_connectivity_element 
			unsetInterrupted_connectivity_element(null); 
	...
	public void removeAimData(SdaiContext context) throws SdaiException {
			...
			// interrupted_connectivity_element 
			unsetInterrupted_connectivity_element(context, this);
	...
	public static void setMappingConstraints(SdaiContext context,
			ECutout_armx armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxCutout_armx.setMappingConstraints(context, armEntity);
	}
	...
	public static void unsetMappingConstraints(SdaiContext context,
			ECutout_armx armEntity) throws SdaiException {
		CxCutout_armx.unsetMappingConstraints(context, armEntity);
	}
...
///// Item_shape
	...
	*/
	...
	//********** "physical_connectivity_interrupting_cutout" attributes

	/**
	* Sets/creates data for interrupted_connectivity_element attribute.
	*
	* <p>
	*  attribute_mapping interrupted_connectivity_element_conductive_interconnect_element (interrupted_connectivity_element
	* , (*PATH*), conductive_interconnect_element);
	* 	inter_stratum_feature &lt;=
	*  assembly_component &lt;=			
	*  component_definition &lt;=
	*  product_definition &lt;-
	...
	*  (product_definition.description = 'conductive interconnect element with user defined single transition')]
	*  [product_definition =&gt; 
	*  component_definition =&gt; 
	*  assembly_component]}
	...
	* @throws SdaiException
	*/
	public static void setInterrupted_connectivity_element(SdaiContext context, EPhysical_connectivity_interrupting_cutout_armx armEntity) throws SdaiException
	{
		//unset old values
		unsetInterrupted_connectivity_element(context, armEntity);

		if (armEntity.testInterrupted_connectivity_element(null))
		{

			AConductive_interconnect_element_armx aArmInterrupted_connectivity_element = armEntity.getInterrupted_connectivity_element(null);

			EConductive_interconnect_element_armx armInterrupted_connectivity_element = null;
			EProduct_definition_relationship epdr = null;
			for (int i = 1; i <= aArmInterrupted_connectivity_element.getMemberCount(); i++) {
				armInterrupted_connectivity_element = aArmInterrupted_connectivity_element.getByIndex(i);

				epdr = (EProduct_definition_relationship) context.working_model.createEntityInstance(
						CProduct_definition_relationship.definition);
				epdr.setName(null, "interrupted connectivity element");
				epdr.setRelated_product_definition(null, armEntity);
				epdr.setRelating_product_definition(null, armInterrupted_connectivity_element);
			}
		}
	}
	...
	/**
	* Unsets/deletes data for interrupted_connectivity_element attribute.
	*
	* @param context SdaiContext.
	* @param armEntity arm entity.
	* @throws SdaiException
	*/
	public static void unsetInterrupted_connectivity_element(SdaiContext context, EPhysical_connectivity_interrupting_cutout_armx armEntity) throws SdaiException
	{
		...
		for (int i = 1; i <= aRelationship.getMemberCount(); i++) {
			...
			if (relationship.testName(null) && relationship.getName(null).equals("interrupted connectivity element")) {
