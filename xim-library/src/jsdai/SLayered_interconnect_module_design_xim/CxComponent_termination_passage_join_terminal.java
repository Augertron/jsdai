...
public class CxComponent_termination_passage_join_terminal extends CComponent_termination_passage_join_terminal implements EMappedXIMEntity{
...
/*	public boolean testProduct_definitional(EShape_aspect type) throws SdaiException {
	...
	public static void setMappingConstraints(SdaiContext context,
			ELaminate_component_join_terminal_armx armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);

		CxComponent_terminal_armx.setMappingConstraints(context, armEntity);
		armEntity.setDescription(null, "component termination passage join terminal");
	}
