...
import jsdai.SLayered_interconnect_module_design_mim.CCutout_edge_segment;
import jsdai.SGeneric_product_occurrence_xim.*;
import jsdai.SProduct_definition_schema.*;
import jsdai.SProduct_property_definition_schema.*;
import jsdai.SProduct_view_definition_xim.*;

public class CxPlated_cutout_edge_segment_armx
		extends
			CPlated_cutout_edge_segment_armx implements EMappedXIMEntity{
...
*/
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CCutout_edge_segment.definition);
...
//			setId_x(context, this);
			...
			// composed_cutout 
			setComposed_cutout(context, this);
...
//			unsetId_x(context, this);
			...
			// composed_cutout 
			unsetComposed_cutout(context, this);
	...
	public static void setMappingConstraints(SdaiContext context,
			ECutout_edge_segment_armx armEntity) throws SdaiException {
...
*/
	...
	*/
	...
	//********** "cutout_edge_segment" attributes

	/**
	* Sets/creates data for composed_cutout attribute.
	*
	* <p>
	*  attribute_mapping composed_cutout_cutout (composed_cutout
	* , (*PATH*), cutout);
	*  cutout_edge_segment &lt;=
	*  inter_stratum_feature &lt;=
	*  assembly_component &lt;=
	...
	* @throws SdaiException
	*/
	public static void setComposed_cutout(SdaiContext context, ECutout_edge_segment_armx armEntity) throws SdaiException
	{
		//unset old values
		unsetComposed_cutout(context, armEntity);

		if (armEntity.testComposed_cutout(null))
		{

			ECutout_armx armComposed_cutout = armEntity.getComposed_cutout(null);
		   ...
		   EProduct_definition_relationship epdr = (EProduct_definition_relationship)
			...
			epdr.setRelating_product_definition(null, armComposed_cutout);
			epdr.setRelated_product_definition(null, armEntity);
			armComposed_cutout.setName((EProduct_definition_relationship)null, "composed cutout");
		}
	}


	/**
	* Unsets/deletes data for composed_cutout attribute.
	*
	* @param context SdaiContext.
	* @param armEntity arm entity.
	* @throws SdaiException
	*/
	public static void unsetComposed_cutout(SdaiContext context, ECutout_edge_segment_armx armEntity) throws SdaiException
	{
		...
		for (int i = 1; i <= aRelationship.getMemberCount(); i++) {
			...
			if (relationship.testName(null) && relationship.getName(null).equals("composed cutout")) {
