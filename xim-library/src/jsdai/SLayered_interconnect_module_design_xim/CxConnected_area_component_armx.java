...
import jsdai.SLayered_interconnect_module_design_mim.CConnected_area_component;
...
public class CxConnected_area_component_armx
		extends
			CConnected_area_component_armx implements EMappedXIMEntity{
...
*/
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CConnected_area_component.definition);
			...
			setAssociated_layer_connection_point(context, this); 
			...
			// associated_layer_connection_point 
			unsetAssociated_layer_connection_point(null); 
	...
	public void removeAimData(SdaiContext context) throws SdaiException {
			...
			// associated_layer_connection_point 
			unsetAssociated_layer_connection_point(context, this);
	...
	public static void setMappingConstraints(SdaiContext context,
			EConnected_area_component_armx armEntity) throws SdaiException {
...
///// Item_shape
	...
	*/
	...
	//********** "connected_area_component" attributes

	/**
	* Sets/creates data for associated_layer_connection_point attribute.
	*
	*
	*  attribute_mapping associated_layer_connection_point_layer_connection_point_link (associated_layer_connection_point
	...
	* @throws SdaiException
	*/
	public static void setAssociated_layer_connection_point(SdaiContext context, EConnected_area_component_armx armEntity) throws SdaiException
	{
		//unset old values
		unsetAssociated_layer_connection_point(context, armEntity);

		if (armEntity.testAssociated_layer_connection_point(null))
		{
         ...
         EShape_aspect
			...
			ALayer_connection_point_armx aArmAssociated_layer_connection_point = armEntity.getAssociated_layer_connection_point(null);

			ELayer_connection_point_armx armAssociated_layer_connection_point = null;
			EShape_aspect_relationship relationship = null;

			for (int i = 1; i <= aArmAssociated_layer_connection_point.getMemberCount(); i++) {
				armAssociated_layer_connection_point = aArmAssociated_layer_connection_point.getByIndex(i);

				//shape_aspect_relationship
				relationship = (EShape_aspect_relationship) context.working_model.createEntityInstance(EShape_aspect_relationship.class);
				relationship.setName(null, "associated layer connection point");
				relationship.setRelated_shape_aspect(null, armAssociated_layer_connection_point);
				relationship.setRelating_shape_aspect(null, esa);
			}
	...
	/**
	* Unsets/deletes data for associated_layer_connection_point attribute.
	*
	* @param context SdaiContext.
	* @param armEntity arm entity.
	* @throws SdaiException
	*/
	public static void unsetAssociated_layer_connection_point(SdaiContext context, EConnected_area_component_armx armEntity) throws SdaiException
	{
		...
		for (int j = 1; j <= asa.getMemberCount(); j++) {
			...
			for (int i = 1; i <= aRelationship.getMemberCount(); i++) {
				...
				if (relationship.testName(null) && relationship.getName(null).equals("associated layer connection point")) {
	...
	*/
	...
	/**
	* Sets/creates data for setIs_base attribute.
	* @param armEntity arm entity.
	* @throws SdaiException
	*/
	...
	*/
	...
	/**
	* Sets/creates data for setReplaced_component attribute.
	* @param armEntity arm entity.
	* @throws SdaiException
	*/
