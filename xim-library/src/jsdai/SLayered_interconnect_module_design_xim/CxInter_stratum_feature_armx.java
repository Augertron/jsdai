...
import jsdai.SLayered_interconnect_module_design_mim.CInter_stratum_feature;
...
public class CxInter_stratum_feature_armx
		extends
			CInter_stratum_feature_armx implements EMappedXIMEntity{
...
*/
	...
	public void createAimData(SdaiContext context) throws SdaiException {
		...
		setTemp("AIM", CInter_stratum_feature.definition);
	...
	public static void setMappingConstraints(SdaiContext context,
			EInter_stratum_feature_armx armEntity) throws SdaiException {
	...
	*/
	public static void setFeature_of_size(SdaiContext context, EInter_stratum_feature_armx armEntity) throws SdaiException
	{
		...
		if (armEntity.testFeature_of_size(null))
		{
			...
			property_definition.setName(null, "feature of size");
	...
	*/
	public static void unsetFeature_of_size(SdaiContext context, EInter_stratum_feature_armx armEntity) throws SdaiException
	{
		...
		for (int j = 1; j <= aPdr.getMemberCount(); j++) {
			property_definition = aPdr.getByIndex(j);
			if ((property_definition.testName(null))&&(property_definition.getName(null).equals("feature of size"))) {
	...
	public static void setVertical_extent(SdaiContext context, EInter_stratum_feature_armx armEntity)throws SdaiException{
		unsetVertical_extent(context, armEntity);
		if(armEntity.testVertical_extent(null)){
			EPassage_technology_allocation_to_stack_model_armx allocation = armEntity.getVertical_extent(null);
			...
			epdr.setName(null, "vertical extent");
			epdr.setRelating_property_definition(null, allocation);
	...
	public static void unsetVertical_extent(SdaiContext context, EInter_stratum_feature_armx armEntity)throws SdaiException{
		...
		while(iter.next()){
			...
			if((epdr.testName(null))&&(epdr.getName(null).equals("vertical extent"))){
