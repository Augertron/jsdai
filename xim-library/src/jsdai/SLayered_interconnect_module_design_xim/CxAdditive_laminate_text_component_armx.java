...
public class CxAdditive_laminate_text_component_armx
		extends
			CAdditive_laminate_text_component_armx implements EMappedXIMEntity{
...
//			unsetId_x(context, this);
	 ...
	 *  product_definition
	 *  {product_definition
	 *  [product_definition.description = 'laminate text component']
	 *  [product_definition
	...
	public static void setMappingConstraints(SdaiContext context,
			EAdditive_laminate_text_component_armx armEntity) throws SdaiException {
		unsetMappingConstraints(context, armEntity);
		CxGeneric_laminate_text_component_armx .setMappingConstraints(context, armEntity);
	}
	...
	public static void unsetMappingConstraints(SdaiContext context,
			EAdditive_laminate_text_component_armx armEntity) throws SdaiException {
		CxGeneric_laminate_text_component_armx .unsetMappingConstraints(context, armEntity);
	}
...
//			boolean found = false;
		for (int j = 1; j <= aPdr.getMemberCount(); j++) {
			...
			if (property_definition_representation.testUsed_representation(null)) {
				...
				if (representation.testItems(null)) {
					...
					if ((items.getMemberCount() == 0) && (CxAP210ARMUtilities.countEntityUsers(context, representation) <= 1)) {
	...
	//********** "laminate_text_component" attributes
	...
	* @throws SdaiException
	*/
	public static void setStratum_feature_implementation(SdaiContext context, EAdditive_laminate_text_component_armx armEntity) throws SdaiException
	{
		//unset old values
		...
		if (armEntity.testStratum_feature_implementation(null))
		{
         ...
         if(!esa.testProduct_definitional(null))
			...
			for (int i = 1; i <= aArmStratum_feature_implementation.getMemberCount(); i++) {
				...
				shape_aspect_relationship = (EShape_aspect_relationship) context.working_model.createEntityInstance(EShape_aspect_relationship.class);
				...
				shape_aspect_relationship.setRelating_shape_aspect(null, armStratum_feature_implementation);
			}
		}
	}
	...
	*/
	...
	public static void unsetStratum_feature_implementation(SdaiContext context, EGeneric_laminate_text_component_armx armEntity) throws SdaiException
	{
