...
public class CxPart extends CPart implements EMappedXIMEntity, PartImplementer
{
...
/*	public static int usedinFrame_of_reference(EProduct type, jsdai.SApplication_context_schema.EProduct_context instance, ASdaiModel domain, AEntity result) throws SdaiException {
	...
	public static void fillAIMGaps(SdaiContext context, EPart armEntity)throws SdaiException{
		PartImplementer temp = (PartImplementer)armEntity;
		if(!temp.testFrame_of_reference2(null)){
	      // Kind of AIM GAP
	      LangUtils.Attribute_and_value_structure[] pcxStructure = {
	            new LangUtils.Attribute_and_value_structure(
	            CProduct_context.attributeName(null), "part")
	         };
	...
	public static void unfillAIMGaps(EPart armEntity)throws SdaiException{
	...
	*/
	...
	{
		String name = "part";
		if(armEntity instanceof ERaw_material)
			name = "raw material";
