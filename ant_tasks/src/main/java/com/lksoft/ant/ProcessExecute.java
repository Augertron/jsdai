...
/**
 * Runs an external program. Extendes Ant Execute class with Process data.
 *
...
public class ProcessExecute {
   ...
   */
  public ProcessExecute(ExecuteStreamHandler streamHandler, ExecuteWatchdog watchdog) {
   ...
   *
   * <p>
   * This is emulated using the antRun scripts unless the OS is Windows NT in which case a cmd.exe is spawned, or MRJ and
   * setting user.dir works, or JDK 1.3 and there is official support in java.lang.Runtime.
   *
  ...
  public int execute() throws IOException {
    process = launch(project, getCommandline(), getEnvironment(), workingDirectory, useVMLauncher);
  ...
  private static class Java11CommandLauncher extends CommandLauncher {
    ...
    public Process exec(Project project, String[] cmd, String[] env) throws IOException {
      ...
      if (project != null) {
        project.log("Execute:Java11CommandLauncher: " + Commandline.describeCommand(newcmd), Project.MSG_DEBUG);
      }
  ...
  private static class Java13CommandLauncher extends CommandLauncher {
    ...
    public Process exec(Project project, String[] cmd, String[] env, File workingDir) throws IOException {
      try {
        if (project != null) {
          project.log("Execute:Java13CommandLauncher: " + Commandline.describeCommand(cmd), Project.MSG_DEBUG);
        }
