...
public class ToolsPreferences extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {

  public ToolsPreferences() {
    super(GRID);
	setPreferenceStore(ExpressCompilerPlugin.getDefault().getPreferenceStore());
    setDescription("General settings for JSDAI Express tools");
  }

  protected void createFieldEditors() {
    // add if needed anything for general preferences
		PlatformUI.getWorkbench().getHelpSystem().setHelp(getFieldEditorParent(), IExpressCompilerHelpContextIds.TOOLS_PREFERENCE_PAGE);
