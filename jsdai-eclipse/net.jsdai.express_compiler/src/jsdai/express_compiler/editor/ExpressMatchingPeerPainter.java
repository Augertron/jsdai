 ...
 * @since 2.1
 */
public final class ExpressMatchingPeerPainter implements IPainter, PaintListener {
   ...
   * @param matcher
   */
  public ExpressMatchingPeerPainter(ISourceViewer sourceViewer, ICharacterPairMatcher matcher) {
