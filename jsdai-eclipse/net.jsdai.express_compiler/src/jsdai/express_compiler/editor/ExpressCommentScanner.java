 ...
 */
public class ExpressCommentScanner extends RuleBasedScanner implements IExpressKeywords {
...
//	private ExpressColorProvider fColorProvider;
	 ...
	 */
	public ExpressCommentScanner(ExpressColorProvider provider) {	
...
*/
		...
		Color multi_bg = null;
		boolean multi_transparent = store.getBoolean(ExpressEditorPreferences.EXPRESS_MULTI_TRANSPARENT);
		if (!multi_transparent) {
			multi_bg = provider.getColor(provider.getColorPreference(ExpressEditorPreferences.EXPRESS_MULTI_BG_COLOR));
		}
...
//		ExpressColorProvider provider = ExpressCompilerPlugin.getDefault().getExpressColorProvider();
	...
	//	IToken multiComment = new Token(new TextAttribute(ExpressCompilerPlugin.getDefault().getExpressColorProvider().getColor(ExpressCompilerPlugin.getDefault().getExpressColorProvider().getColorPreference(ExpressEditorPreferences.EXPRESS_MULTI_COLOR))));
		IToken multiComment = new Token(new TextAttribute(provider.getColor(provider.getColorPreference(ExpressEditorPreferences.EXPRESS_MULTI_COLOR)), multi_bg, multi_flags));
