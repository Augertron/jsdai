 ...
 *
 */
public class ExpressXmlIndexSettingPage extends WizardPage {
	 ...
	 */
	public final static String STORE_SOURCE_NAMES_ID =	"ExpressXmlIndexSettingPage.STORE_SOURCE_NAMES_ID"; //$NON-NLS-1$
	public final static String STORE_LAST_SOURCE_NAME_ID =	"ExpressXmlIndexSettingPage.STORE_LAST_SOURCE_NAME_ID"; //$NON-NLS-1$
	public final static String STORE_JAVA_OPTION_ID =	"ExpressXmlIndexSettingPage.STORE_JAVA_OPTION_ID"; //$NON-NLS-1$

	/**
	 * 
	 * @param name
	 */
	public ExpressXmlIndexSettingPage(IPath projectPath, String name) {
		super(name);
	...
	public void createControl(Composite parent) {
		...
		destDirectoryGroup =
			new FileSelectGroup(mainComposite, "docDir", "Select Express XML Index directory", "Directory:",
					"Select Express XML Index directory", DIALOG_DIRECTORY, SWT.SAVE,
