 ...
 *
 */
public class WizardNameFileSelectionPage extends WizardPage implements Listener {
	/**
	 * changing of this string may requere clearing metadata info associated with WizardNameFileSelectionPage.STORE_SOURCE_NAMES_ID
	 */
	...
	protected String TEXT_LABEL = "Diagram name:";
	...
	protected Text sourceTextField;
  ...
  boolean textEntryChanged = false;
	...
	public final static String STORE_SOURCE_NAMES_ID =	"WizardNameFileSelectionPage.STORE_SOURCE_NAMES_ID"; //$NON-NLS-1$
	public final static String STORE_LAST_SOURCE_NAME_ID =	"WizardNameFileSelectionPage.STORE_LAST_SOURCE_NAME_ID"; //$NON-NLS-1$

	//public final static String STORE_SOURCE_TEXT_ID =	"WizardNameFileSelectionPage.STORE_SOURCE_TEXT_ID"; //$NON-NLS-1$
	public final static String STORE_LAST_SOURCE_TEXT_ID =	"WizardNameFileSelectionPage.STORE_LAST_SOURCE_TEXT_ID"; //$NON-NLS-1$

	/**
	 * 
	 * @param name
	 */
	public WizardNameFileSelectionPage(IPath projectPath, String name) {
		super(name);
	 ...
	 * @param dialog
	 */
	public WizardNameFileSelectionPage(IPath projectPath, String name, String label, String dialog, int dialogType, boolean none_available) {
	 ...
	 * @param extensions
	 */
	public WizardNameFileSelectionPage(IPath projectPath, String name, String label, String dialog, int dialogType, int dialogStyle, String[] extensions, boolean none_available) {
	...
	public void createControl(Composite parent) {
		...
		createSourceTextGroup(main_composite);
/*
...
*/	
	...
	private Composite sourceTextContainerGroup = null;
	/**
	...
	protected void createSourceTextGroup(Composite parent) {

		sourceTextContainerGroup = new Composite(parent, SWT.NONE);
		GridLayout layout = new GridLayout();
		layout.numColumns = 2;
		sourceTextContainerGroup.setLayout(layout);
		sourceTextContainerGroup.setFont(parent.getFont());
		sourceTextContainerGroup.setLayoutData(
			new GridData(GridData.HORIZONTAL_ALIGN_FILL | GridData.GRAB_HORIZONTAL));

		Label groupLabel = new Label(sourceTextContainerGroup, SWT.NONE);
		groupLabel.setText(TEXT_LABEL);
		groupLabel.setFont(parent.getFont());


		// source Text entry field (for diagram name)
		
		sourceTextField = new Text(sourceTextContainerGroup, SWT.SINGLE | SWT.BORDER);
		GridData data =
			new GridData(GridData.HORIZONTAL_ALIGN_FILL | GridData.GRAB_HORIZONTAL);
		data.widthHint = 250;
		sourceTextField.setLayoutData(data);
		sourceTextField.setFont(parent.getFont());

		sourceTextField.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				updateFromSourceField();
			}
		});
		...
		sourceTextField.addKeyListener(new KeyListener(){
			/*
			 * @see KeyListener.keyPressed
			 */
			public void keyPressed(KeyEvent e){
		...
		sourceTextField.addFocusListener(new FocusListener(){
			/*
			 * @see FocusListener.focusGained(FocusEvent)
			 */
			public void focusGained(FocusEvent e){
...
//			enableButtonGroup(false);
		...
		if ((this.sourceTextField.getText() == null) || (this.sourceTextField.getText().equals(""))) {
			return false;
		}
...
//		enableButtonGroup(true);
	...
	public void dispose() {
      ...
      settings.put(STORE_LAST_SOURCE_TEXT_ID, getDiagramName());
		}
		super.dispose();
	}
