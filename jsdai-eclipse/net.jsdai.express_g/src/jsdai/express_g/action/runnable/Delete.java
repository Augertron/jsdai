...
/**
 * Deletes selected items in the Diagram
 * 
 * @author Mantas Balnys
 *
 */
public class Delete extends ApplicationRunnable {

	/**
	 * 
	 */
	public Delete(CommandInvoker invoker) {
		super();
	}
	...
	public void run(IProgressMonitor monitor) throws InvocationTargetException,	InterruptedException {
		...
		if (command instanceof SelectCommand) ((SelectCommand)command).deleteSelected();
	}
